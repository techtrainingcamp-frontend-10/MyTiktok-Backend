				...
				function (e, t, n) {
									...
									return (
										...
										(function (e) {
											for (var t, n, i, r = '', o = 0; o < e.length; o++)
												55296 <= (t = e.charCodeAt(o)) && t <= 56319 && 56320 <= (n = e.charCodeAt(o + 1)) && n <= 57343
						...
						for (var i, r, o, a = n ? e.explicitTypes : e.implicitTypes, s = 0, c = a.length; s < c; s += 1)
							if (((r = a[s]).instanceOf || r.predicate) && (!r.instanceOf || ('object' == typeof t && t instanceof r.instanceOf)) && (!r.predicate || r.predicate(t))) {
								if (((e.tag = n ? r.tag : '?'), r.represent)) {
									if (((o = e.styleMap[r.tag] || r.defaultStyle), '[object Function]' === l.call(r.represent))) i = r.represent(t, o)
									else {
					...
					function ee(e, t, n, i, r, o) {
						...
						if ((u && (c = -1 !== (s = e.duplicates.indexOf(n))), ((null !== e.tag && '?' !== e.tag) || c || (2 !== e.indent && 0 < t)) && (r = !1), c && e.usedDuplicates[s])) e.dump = '*ref_' + s
							...
							if ((u && c && !e.usedDuplicates[s] && (e.usedDuplicates[s] = !0), '[object Object]' === a))
									...
									? ((function (e, t, n, i) {
											...
											for (r = 0, o = p.length; r < o; r += 1)
												(c = ''),
													...
													(a = n[(s = p[r])]),
													ee(e, t + 1, s, !0, !0, !0) &&
														((s = (null !== e.tag && '?' !== e.tag) || (e.dump && 1024 < e.dump.length)) && (e.dump && h === e.dump.charCodeAt(0) ? (c += '?') : (c += '? ')),
														(c += e.dump),
														s && (c += q(e, t)),
														ee(e, t + 1, a, !0, s) && (e.dump && h === e.dump.charCodeAt(0) ? (c += ':') : (c += ': '), (u += c += e.dump)))
											;(e.tag = l), (e.dump = u || '{}')
									  })(e, t, e.dump, r),
									...
									: ((function (e, t, n) {
											for (var i, r, o, a = '', s = e.tag, c = Object.keys(n), u = 0, l = c.length; u < l; u += 1)
												(o = ''),
													...
													(r = n[(i = c[u])]),
													ee(e, t, i, !1, !1) &&
														(1024 < e.dump.length && (o += '? '), (o += e.dump + (e.condenseFlow ? '"' : '') + ':' + (e.condenseFlow ? '' : ' ')), ee(e, t, r, !1, !1) && (a += o += e.dump))
											;(e.tag = s), (e.dump = '{' + a + '}')
									  })(e, t, e.dump),
									  c && (e.dump = '&ref_' + s + ' ' + e.dump))
				...
				function (e, t, n) {
					...
					var T = {
						YAML: function (e, t, n) {
							...
							null !== e.version && N(e, 'duplication of %YAML directive'),
								...
								null === (r = /^([0-9]+)\.([0-9]+)$/.exec(n[0])) && N(e, 'ill-formed argument of the YAML directive'),
								(i = parseInt(r[1], 10)),
								(r = parseInt(r[2], 10)),
								1 !== i && N(e, 'unacceptable YAML version of the document'),
								(e.version = n[0]),
								(e.checkLineBreaks = r < 2),
								1 !== r && 2 !== r && M(e, 'unsupported YAML version of the document')
						},
						TAG: function (e, t, n) {
							var i
							2 !== n.length && N(e, 'TAG directive accepts exactly two arguments'),
								(i = n[0]),
								(n = n[1]),
								k.test(i) || N(e, 'ill-formed tag handle (first argument) of the TAG directive'),
								m.call(e.tagMap, i) && N(e, 'there is a previously declared suffix for "' + i + '" tag handle'),
								j.test(n) || N(e, 'ill-formed tag prefix (second argument) of the TAG directive'),
								(e.tagMap[i] = n)
						},
					}
					function L(e, t, n, i) {
					...
					function U(e, t, n, i, r, o, a, s) {
						...
						if (Array.isArray(r))
							for (c = 0, u = (r = Array.prototype.slice.call(r)).length; c < u; c += 1)
								Array.isArray(r[c]) && N(e, 'nested arrays are not supported inside keys'), 'object' == typeof r && '[object Object]' === l(r[c]) && (r[c] = '[object Object]')
					...
					function W(e, t) {
						...
						if (34 === u) {
							for (e.kind = 'scalar', e.result = '', e.position++, n = i = e.position; 0 !== (u = e.input.charCodeAt(e.position)); ) {
								...
								if (92 === u) {
									if ((L(e, n, e.position, !0), S((u = e.input.charCodeAt(++e.position))))) Y(e, !1, t)
									else if (u < 256 && p[u]) (e.result += f[u]), e.position++
									else if (0 < (a = 120 === (c = u) ? 2 : 117 === c ? 4 : 85 === c ? 8 : 0)) {
										for (r = a, o = 0; 0 < r; r--)
											(u = e.input.charCodeAt(++e.position)),
												0 <= (a = 48 <= (s = u) && s <= 57 ? s - 48 : 97 <= (s = 32 | s) && s <= 102 ? s - 97 + 10 : -1) ? (o = (o << 4) + a) : N(e, 'expected hexadecimal character')
					...
					function K(e, t) {
						...
						for (null !== e.anchor && (e.anchorMap[e.anchor] = a), i = e.input.charCodeAt(e.position); 0 !== i && 45 === i && O(e.input.charCodeAt(e.position + 1)); )
							...
							else if (((n = e.line), P(e, t, x, !1, !0), a.push(e.result), Y(e, !0, -1), (i = e.input.charCodeAt(e.position)), (e.line === n || e.lineIndent > t) && 0 !== i))
					...
					function P(e, t, n, i, r) {
						...
						if (
							...
							(e.result = null),
							(o = a = s = A === n || x === n),
							i && Y(e, !0, -1) && ((f = !0), e.lineIndent > t ? (p = 1) : e.lineIndent === t ? (p = 0) : e.lineIndent < t && (p = -1)),
							1 === p)
						)
							for (
								;
											...
											for (; 0 !== a && !O(a); )
												33 === a &&
													(o
														...
														: ((n = e.input.slice(t - 1, e.position + 1)), k.test(n) || N(e, 'named tag handle cannot contain such characters'), (o = !0), (t = e.position + 1))),
													(a = e.input.charCodeAt(++e.position))
											;(i = e.input.slice(t, e.position)), C.test(i) && N(e, 'tag suffix cannot contain flow indicator characters')
										}
										return (
											i && !j.test(i) && N(e, 'tag name cannot contain such characters: ' + i),
											r
												? (e.tag = i)
												: m.call(e.tagMap, n)
												? (e.tag = e.tagMap[n] + i)
						...
						if (
													...
													for (null !== e.anchor && (e.anchorMap[e.anchor] = l), s = e.input.charCodeAt(e.position); 0 !== s; ) {
														if (((i = e.input.charCodeAt(e.position + 1)), (o = e.line), (a = e.position), (63 !== s && 58 !== s) || !O(i))) {
															...
															if (e.line === o) {
																...
																if (58 === s)
																	O((s = e.input.charCodeAt(++e.position))) || N(e, 'a whitespace character is expected after the key-value separator within a block mapping'),
															...
															63 === s
																? (m && (U(e, l, p, f, d, null), (f = d = h = null)), (r = m = g = !0))
																: m
																? (r = !(m = !1))
														...
														if (
															((e.line === o || e.lineIndent > t) &&
																(P(e, t, A, !0, r) && (m ? (d = e.result) : (h = e.result)), m || (U(e, l, p, f, d, h, o, a), (f = d = h = null)), Y(e, !0, -1), (s = e.input.charCodeAt(e.position))),
															e.lineIndent > t && 0 !== s)
														)
									  ...
									  (function (e, t) {
											...
											for (null !== e.anchor && (e.anchorMap[e.anchor] = i), m = e.input.charCodeAt(++e.position); 0 !== m; ) {
												...
												p || N(e, 'missed comma between flow collection entries'),
													(l = null),
													(o = a = !1),
													63 === m && O(e.input.charCodeAt(e.position + 1)) && ((o = a = !0), e.position++, Y(e, !0, t)),
													(n = e.line),
													P(e, t, g, !1, !0),
													(u = e.tag),
													(c = e.result),
													Y(e, !0, t),
													(m = e.input.charCodeAt(e.position)),
													(!a && e.line !== n) || 58 !== m || ((o = !0), (m = e.input.charCodeAt(++e.position)), Y(e, !0, t), P(e, t, g, !1, !0), (l = e.result)),
													s ? U(e, i, h, u, c, l) : o ? i.push(U(e, null, h, u, c, l)) : i.push(c),
													Y(e, !0, t),
													44 === (m = e.input.charCodeAt(e.position)) ? ((p = !0), (m = e.input.charCodeAt(++e.position))) : (p = !1)
											}
										...
										: ((a &&
												(function (e, t) {
													...
													for (e.kind = 'scalar', e.result = ''; 0 !== p; )
														if (43 === (p = e.input.charCodeAt(++e.position)) || 45 === p) b === o ? (o = 43 === p ? w : v) : N(e, 'repeat of a chomping mode identifier')
														else {
													...
													for (; 0 !== p; ) {
														...
														if ((!s && e.lineIndent > c && (c = e.lineIndent), S(p))) u++
														else {
															if (e.lineIndent < c) {
															...
															for (
																i
																	? I(p)
																		? ((l = !0), (e.result += h.repeat('\n', a ? 1 + u : u)))
																		: l
																		? ((l = !1), (e.result += h.repeat('\n', u + 1)))
																		: 0 === u
																		? a && (e.result += ' ')
																		: (e.result += h.repeat('\n', u))
																	: (e.result += h.repeat('\n', a ? 1 + u : u)),
										  ...
										  W(e, i)
												...
												: !(function (e) {
														...
														if (42 === n) {
															...
															return (
																...
																m.call(e.anchorMap, t) || N(e, 'unidentified alias "' + t + '"'),
												...
												? (function (e, t, n) {
														...
														if (
															...
															64 !== f &&
															96 !== f &&
															((63 !== f && 45 !== f) || !(O((i = e.input.charCodeAt(e.position + 1))) || (n && E(i))))
														) {
												  ...
												  })(e, i, g === n) && ((d = !0), null === e.tag && (e.tag = '?'))
												: ((d = !0), (null === e.tag && null === e.anchor) || N(e, 'alias node should not have any properties')),
							...
							if ('?' === e.tag) {
								for (
									null !== e.result && 'scalar' !== e.kind && N(e, 'unacceptable node kind for !<?> tag; it should be "scalar", not "' + e.kind + '"'), c = 0, u = e.implicitTypes.length;
									c < u;
									c += 1
								)
								...
								m.call(e.typeMap[e.kind || 'fallback'], e.tag)
									? ((l = e.typeMap[e.kind || 'fallback'][e.tag]),
									  null !== e.result && l.kind !== e.kind && N(e, 'unacceptable node kind for !<' + e.tag + '> tag; it should be "' + l.kind + '", not "' + e.kind + '"'),
									  l.resolve(e.result)
						...
						for (; n.position < n.length - 1; )
							!(function (e) {
								...
								for (
									...
									0 !== (r = e.input.charCodeAt(e.position)) && (Y(e, !0, -1), (r = e.input.charCodeAt(e.position)), !(0 < e.lineIndent || 37 !== r));
								...
								Y(e, !0, -1),
									0 === e.lineIndent && 45 === e.input.charCodeAt(e.position) && 45 === e.input.charCodeAt(e.position + 1) && 45 === e.input.charCodeAt(e.position + 2)
										? ((e.position += 3), Y(e, !0, -1))
										: a && N(e, 'directives end mark is expected'),
									P(e, e.lineIndent - 1, A, !1, !0),
									Y(e, !0, -1),
									e.checkLineBreaks && s.test(e.input.slice(o, e.position)) && M(e, 'non-ASCII line breaks are interpreted as content'),
					...
					;(t.exports.loadAll = H),
						...
						(t.exports.safeLoadAll = function (e, t, n) {
							return 'object' == typeof t && null !== t && void 0 === n && ((n = t), (t = null)), H(e, t, h.extend({ schema: o }, n))
						}),
				...
				function (e, t, n) {
					...
					t.exports = new i('tag:yaml.org,2002:binary', {
						...
						represent: function (e) {
							...
							return (
								0 == (t = r % 3)
									? ((n += o[(i >> 18) & 63]), (n += o[(i >> 12) & 63]), (n += o[(i >> 6) & 63]), (n += o[63 & i]))
									: 2 == t
									? ((n += o[(i >> 10) & 63]), (n += o[(i >> 4) & 63]), (n += o[(i << 2) & 63]), (n += o[64]))
									: 1 == t && ((n += o[(i >> 2) & 63]), (n += o[(i << 4) & 63]), (n += o[64]), (n += o[64])),
								n
							)
						},
					})
					...
					t.exports = new i('tag:yaml.org,2002:js/function', {
						...
						resolve: function (e) {
							...
							try {
								...
								return 'Program' !== t.type ||
									...
									('ArrowFunctionExpression' !== t.body[0].expression.type && 'FunctionExpression' !== t.body[0].expression.type)
									? !1
									: !0
							} catch (e) {
								return !1
						...
						construct: function (e) {
							...
							return (
								...
								'BlockStatement' === n.body[0].expression.body.type ? new Function(i, t.slice(e[0] + 1, e[1] - 1)) : new Function(i, 'return ' + t.slice(e[0], e[1]))
							)
						},
						predicate: function (e) {
