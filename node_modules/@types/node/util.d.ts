declare module 'util' {
	...
	namespace types {
		...
		function isMap<T>(object: T | {}): object is T extends ReadonlyMap<any, any> ? (unknown extends T ? never : ReadonlyMap<any, any>) : Map<any, any>
		...
		function isRegExp(object: any): object is RegExp
		function isSet<T>(object: T | {}): object is T extends ReadonlySet<any> ? (unknown extends T ? never : ReadonlySet<any>) : Set<any>
