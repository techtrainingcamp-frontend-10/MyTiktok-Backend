...
function getUserPkgDir(dir) {
	...
	if (userPkgDir === undefined) {
		throw new Error([`Can't find package.json in ${dir} directory or parents`, 'Please check that your project has a package.json or create one and reinstall husky.'].join('\n'))
	}
	return userPkgDir
}
function run() {
