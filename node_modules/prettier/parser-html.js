!(function (e, t) {
	'object' == typeof exports && 'undefined' != typeof module
		...
		? define(t)
		: (((e = 'undefined' != typeof globalThis ? globalThis : e || self).prettierPlugins = e.prettierPlugins || {}), (e.prettierPlugins.html = t()))
})(this, function () {
	'use strict'
	...
	var n = t(function (e, t) {
		...
		s = t(function (t, n) {
			...
			function i(e, t, n) {
				return Array.isArray(e)
					? t.visitArray(e, n)
					: 'object' == typeof (r = e) && null !== r && Object.getPrototypeOf(r) === u
		...
		i = t(function (e, t) {
			...
			function a(e) {
				...
				let n = s.stringify(t)
				return n.indexOf('(') >= 0 ? ((n = 'anonymous_'.concat(o++)), (t.__anonymousType = n)) : (n = i(n)), n
			}
			var u
			;(t.identifierName = a),
				(t.identifierModuleUrl = function (e) {
					const t = e.reference
					return t instanceof r.StaticSymbol ? t.filePath : './'.concat(s.stringify(t))
				}),
			...
			t.CompileTemplateMetadata = class {
				constructor({
					...
					;(this.interpolation = c), (this.isInline = D), (this.preserveWhitespaces = h)
				}
				toSummary() {
				...
				static create({
					...
					null != p &&
						Object.keys(p).forEach(e => {
							const t = p[e],
								r = e.match(n)
							null === r ? (b[e] = t) : null != r[1] ? (_[r[1]] = t) : null != r[2] && (S[r[2]] = t)
						})
					const F = {}
					null != u &&
						u.forEach(e => {
			...
			t.CompilePipeMetadata = class {
				...
				toSummary() {
					return { summaryKind: u.Pipe, type: this.type, name: this.name, pure: this.pure }
				}
			}
			...
			;(t.ProviderMeta = class {
				constructor(e, { useClass: t, useValue: n, useExisting: r, useFactory: s, deps: i, multi: o }) {
					;(this.token = e), (this.useClass = t || null), (this.useValue = n), (this.useExisting = r), (this.useFactory = s || null), (this.dependencies = i || null), (this.multi = !!o)
				}
			}),
				(t.flatten = p),
		...
		o = t(function (e, t) {
				...
				moveBy(e) {
					...
					for (; i > 0 && e < 0; ) {
						...
						if (t.charCodeAt(i) == n.$LF) {
							o--
							const e = t.substr(0, i - 1).lastIndexOf(String.fromCharCode(n.$LF))
							a = e > 0 ? i - e : i
						} else a--
					}
					for (; i < s && e > 0; ) {
				...
				getContext(e, t) {
					...
					if (null != r) {
						...
						let s = r,
							...
							o = 0
						for (; i < e && r > 0 && (r--, i++, '\n' != n[r] || ++o != t); );
						for (i = 0, o = 0; i < e && s < n.length - 1 && (s++, i++, '\n' != n[s] || ++o != t); );
						return { before: n.substring(r, this.offset), after: n.substring(this.offset, s + 1) }
					}
					return null
				}
			}
			...
			;(t.ParseError = class {
				...
				contextualMessage() {
					...
					return e ? ''.concat(this.msg, ' ("').concat(e.before, '[').concat(a[this.level], ' ->]').concat(e.after, '")') : this.msg
				}
				toString() {
				...
				(t.typeSourceSpan = function (e, t) {
					const n = i.identifierModuleUrl(t),
						a = null != n ? 'in '.concat(e, ' ').concat(i.identifierName(t), ' in ').concat(n) : 'in '.concat(e, ' ').concat(i.identifierName(t)),
						u = new s('', a)
	...
	const T = e => {
		...
		for (let n = 0; n < e.length; n++) {
			...
			r <= 31 || (r >= 127 && r <= 159) || (r >= 768 && r <= 879) || (r > 65535 && n++, (t += E(r) ? 2 : 1))
		}
		return t
	}
	var y = T,
	...
	var b = 'undefined' != typeof global ? global : 'undefined' != typeof self ? self : 'undefined' != typeof window ? window : {}
	function F() {
	...
	'function' == typeof b.setTimeout && (v = setTimeout), 'function' == typeof b.clearTimeout && (w = clearTimeout)
	var N,
		x = [],
		O = !1,
		R = -1
	function P() {
		O && N && ((O = !1), N.length ? (x = N.concat(x)) : (R = -1), x.length && L())
	}
	function L() {
		if (!O) {
			var e = k(P)
			...
			;(N = null),
				...
				(function (e) {
					...
					if ((w === A || !w) && clearTimeout) return (w = clearTimeout), clearTimeout(e)
					try {
						w(e)
					} catch (t) {
						try {
	...
	var W = {
		nextTick: function (e) {
			...
			x.push(new B(e, t)), 1 !== x.length || O || k(L)
		},
		title: 'browser',
		browser: !0,
		env: {},
	...
	var Q = 'object' == typeof W && W.env && W.env.NODE_DEBUG && /\bsemver\b/i.test(W.env.NODE_DEBUG) ? (...e) => console.error('SEMVER', ...e) : () => {}
	var Y = { SEMVER_SPEC_VERSION: '2.0.0', MAX_LENGTH: 256, MAX_SAFE_INTEGER: Number.MAX_SAFE_INTEGER || 9007199254740991, MAX_SAFE_COMPONENT_LENGTH: 16 },
		J = t(function (e, t) {
			...
			a('NUMERICIDENTIFIER', '0|[1-9]\\d*'),
				...
				a('MAINVERSION', '('.concat(s[i.NUMERICIDENTIFIER], ')\\.') + '('.concat(s[i.NUMERICIDENTIFIER], ')\\.') + '('.concat(s[i.NUMERICIDENTIFIER], ')')),
				a('MAINVERSIONLOOSE', '('.concat(s[i.NUMERICIDENTIFIERLOOSE], ')\\.') + '('.concat(s[i.NUMERICIDENTIFIERLOOSE], ')\\.') + '('.concat(s[i.NUMERICIDENTIFIERLOOSE], ')')),
				a('PRERELEASEIDENTIFIER', '(?:'.concat(s[i.NUMERICIDENTIFIER], '|').concat(s[i.NONNUMERICIDENTIFIER], ')')),
				a('PRERELEASEIDENTIFIERLOOSE', '(?:'.concat(s[i.NUMERICIDENTIFIERLOOSE], '|').concat(s[i.NONNUMERICIDENTIFIER], ')')),
				a('PRERELEASE', '(?:-('.concat(s[i.PRERELEASEIDENTIFIER], '(?:\\.').concat(s[i.PRERELEASEIDENTIFIER], ')*))')),
				a('PRERELEASELOOSE', '(?:-?('.concat(s[i.PRERELEASEIDENTIFIERLOOSE], '(?:\\.').concat(s[i.PRERELEASEIDENTIFIERLOOSE], ')*))')),
				a('BUILDIDENTIFIER', '[0-9A-Za-z-]+'),
				a('BUILD', '(?:\\+('.concat(s[i.BUILDIDENTIFIER], '(?:\\.').concat(s[i.BUILDIDENTIFIER], ')*))')),
				a('FULLPLAIN', 'v?'.concat(s[i.MAINVERSION]).concat(s[i.PRERELEASE], '?').concat(s[i.BUILD], '?')),
				a('FULL', '^'.concat(s[i.FULLPLAIN], '$')),
				a('LOOSEPLAIN', '[v=\\s]*'.concat(s[i.MAINVERSIONLOOSE]).concat(s[i.PRERELEASELOOSE], '?').concat(s[i.BUILD], '?')),
				a('LOOSE', '^'.concat(s[i.LOOSEPLAIN], '$')),
				a('GTLT', '((?:<|>)?=?)'),
				a('XRANGEIDENTIFIERLOOSE', ''.concat(s[i.NUMERICIDENTIFIERLOOSE], '|x|X|\\*')),
				...
				a('XRANGE', '^'.concat(s[i.GTLT], '\\s*').concat(s[i.XRANGEPLAIN], '$')),
				a('XRANGELOOSE', '^'.concat(s[i.GTLT], '\\s*').concat(s[i.XRANGEPLAINLOOSE], '$')),
				...
				a('TILDELOOSE', '^'.concat(s[i.LONETILDE]).concat(s[i.XRANGEPLAINLOOSE], '$')),
				a('LONECARET', '(?:\\^)'),
				a('CARETTRIM', '(\\s*)'.concat(s[i.LONECARET], '\\s+'), !0),
				(t.caretTrimReplace = '$1^'),
				a('CARET', '^'.concat(s[i.LONECARET]).concat(s[i.XRANGEPLAIN], '$')),
				a('CARETLOOSE', '^'.concat(s[i.LONECARET]).concat(s[i.XRANGEPLAINLOOSE], '$')),
				a('COMPARATORLOOSE', '^'.concat(s[i.GTLT], '\\s*(').concat(s[i.LOOSEPLAIN], ')$|^$')),
				a('COMPARATOR', '^'.concat(s[i.GTLT], '\\s*(').concat(s[i.FULLPLAIN], ')$|^$')),
				a('COMPARATORTRIM', '(\\s*)'.concat(s[i.GTLT], '\\s*(').concat(s[i.LOOSEPLAIN], '|').concat(s[i.XRANGEPLAIN], ')'), !0),
				(t.comparatorTrimReplace = '$1$2$3'),
				a('HYPHENRANGE', '^\\s*('.concat(s[i.XRANGEPLAIN], ')') + '\\s+-\\s+' + '('.concat(s[i.XRANGEPLAIN], ')') + '\\s*$'),
				a('HYPHENRANGELOOSE', '^\\s*('.concat(s[i.XRANGEPLAINLOOSE], ')') + '\\s+-\\s+' + '('.concat(s[i.XRANGEPLAINLOOSE], ')') + '\\s*$'),
				a('STAR', '(<|>)?=?\\s*\\*'),
				a('GTE0', '^\\s*>=\\s*0.0.0\\s*$'),
	...
	class oe {
		constructor(e, t) {
			...
			if (e.length > te) throw new TypeError('version is longer than '.concat(te, ' characters'))
			Q('SemVer', e, t), (this.options = t), (this.loose = !!t.loose), (this.includePrerelease = !!t.includePrerelease)
			const n = e.trim().match(t.loose ? re[se.LOOSE] : re[se.FULL])
			if (!n) throw new TypeError('Invalid Version: '.concat(e))
			if (((this.raw = e), (this.major = +n[1]), (this.minor = +n[2]), (this.patch = +n[3]), this.major > ne || this.major < 0)) throw new TypeError('Invalid major version')
			if (this.minor > ne || this.minor < 0) throw new TypeError('Invalid minor version')
			if (this.patch > ne || this.patch < 0) throw new TypeError('Invalid patch version')
			n[4]
		...
		compare(e) {
			if ((Q('SemVer.compare', this.version, this.options, e), !(e instanceof oe))) {
		...
		compareMain(e) {
			return e instanceof oe || (e = new oe(e, this.options)), ie(this.major, e.major) || ie(this.minor, e.minor) || ie(this.patch, e.patch)
		}
		comparePre(e) {
			if ((e instanceof oe || (e = new oe(e, this.options)), this.prerelease.length && !e.prerelease.length)) return -1
	...
	var le = (e, t, n) => ue(e, t, n) >= 0,
		...
		De = t(function (e, t) {
			...
			function h(e, t) {
				for (var n = '', r = 0, s = e.length; r < s; r++) (n += e[r]), r < s - 1 && (n += t[r])
				return n
			}
			function d(e) {
	...
	const { outdent: Ce } = De,
		...
		be = 'Special',
		Fe = {
			cursorOffset: { since: '1.4.0', category: be, type: 'int', default: -1, range: { start: -1, end: 1 / 0, step: 1 }, description: Ce(Ee()), cliCategory: ye },
			endOfLine: {
				since: '1.15.0',
				category: _e,
				type: 'choice',
			...
			insertPragma: { since: '1.8.0', category: be, type: 'boolean', default: !1, description: "Insert @format pragma into file's first docblock comment.", cliCategory: Se },
			parser: {
				since: '0.0.10',
				category: _e,
				type: 'choice',
			...
			printWidth: { since: '0.0.0', category: _e, type: 'int', default: 80, description: 'The line length where Prettier will try wrap.', range: { start: 0, end: 1 / 0, step: 1 } },
			rangeEnd: { since: '1.4.0', category: be, type: 'int', default: 1 / 0, range: { start: 0, end: 1 / 0, step: 1 }, description: Ce(fe()), cliCategory: ye },
			rangeStart: { since: '1.4.0', category: be, type: 'int', default: 0, range: { start: 0, end: 1 / 0, step: 1 }, description: Ce(de()), cliCategory: ye },
			requirePragma: { since: '1.7.0', category: be, type: 'boolean', default: !1, description: Ce(he()), cliCategory: Se },
			tabWidth: { type: 'int', category: _e, default: 2, description: 'Number of spaces per indentation level.', range: { start: 0, end: 1 / 0, step: 1 } },
			useTabs: { since: '1.0.0', category: _e, type: 'boolean', default: !1, description: 'Indent with tabs instead of spaces.' },
	...
	const Ae = { compare: ue, lt: ce, gte: le },
		ve = pe,
		we = { CATEGORY_CONFIG: Te, CATEGORY_EDITOR: ye, CATEGORY_FORMAT: 'Format', CATEGORY_OTHER: Se, CATEGORY_OUTPUT: 'Output', CATEGORY_GLOBAL: _e, CATEGORY_SPECIAL: be, options: Fe }.options
	var ke = {
		getSupportInfo: function ({ plugins: e = [], showUnreleased: t = !1, showDeprecated: n = !1, showInternal: r = !1 } = {}) {
			const s = ve.split('-', 1)[0],
				i = e.reduce((e, t) => e.concat(t.languages || []), []).filter(a),
				o = ((e, t) => Object.entries(e).map(([e, n]) => Object.assign({ [t]: e }, n)))(Object.assign({}, ...e.map(({ options: e }) => e), we), 'name')
					.filter(e => a(e) && u(e))
					...
					.map(t => {
						;(t = Object.assign({}, t)),
							Array.isArray(t.default) && (t.default = 1 === t.default.length ? t.default[0].value : t.default.filter(a).sort((e, t) => Ae.compare(t.since, e.since))[0].value),
			...
			function a(e) {
				return t || !('since' in e) || (e.since && Ae.gte(s, e.since))
			}
			function u(e) {
				return n || !('deprecated' in e) || (e.deprecated && Ae.lt(s, e.deprecated))
			}
		},
	}
	const { getSupportInfo: Ne } = ke,
		xe = /[^\x20-\x7F]/
	function Oe(e) {
		return (t, n, r) => {
	...
	function qe(e, t) {
		return !1 !== t && ('/' === e.charAt(t) && '/' === e.charAt(t + 1) ? Be(e, t) : t)
	}
	function $e(e, t, n) {
	...
	function Me(e, t, n) {
		const r = Pe(e, (n = n || {}).backwards ? t - 1 : t, n)
		return r !== $e(e, r, n)
	}
	function Ue(e, t) {
		let n = null,
			r = t
		for (; r !== n; ) (n = r), (r = Le(e, r)), (r = Ie(e, r)), (r = Pe(e, r))
		return (r = qe(e, r)), (r = $e(e, r)), !1 !== r && Me(e, r)
	}
	function Ge(e, t) {
		let n = null,
			r = t
		for (; r !== n; ) (n = r), (r = Pe(e, r)), (r = Ie(e, r)), (r = qe(e, r)), (r = $e(e, r))
		return r
	}
	function Ve(e, t, n) {
		return Ge(e, n(t))
	...
	function je(e, t, n) {
		let r = 0
		for (let s = (n = n || 0); s < e.length; ++s) '\t' === e[s] ? (r = r + t - (r % t)) : r++
		return r
	}
	function He(e, t) {
		const n = e.slice(1, -1),
		...
		if (n.includes(i.quote) || n.includes(o.quote)) {
			a = (n.match(i.regex) || []).length > (n.match(o.regex) || []).length ? o.quote : i.quote
		}
		return a
	}
	function Xe(e, t, n) {
		const r = '"' === t ? "'" : '"',
			s = e.replace(/\\([\S\s])|(["'])/g, (e, s, i) => (s === r ? s : i === t ? '\\' + i : i || (n && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/.test(s) ? s : '\\' + s)))
		return t + s + t
	}
	function ze(e, t) {
	...
	var We = {
		inferParserByLanguage: function (e, t) {
			const { languages: n } = Ne({ plugins: t.plugins }),
				r =
		...
		getStringWidth: function (e) {
			return e ? (xe.test(e) ? y(e) : e.length) : 0
		},
		...
		getNextNonSpaceNonCommentCharacterIndexWithStartIndex: Ge,
		getNextNonSpaceNonCommentCharacterIndex: Ve,
		getNextNonSpaceNonCommentCharacter: function (e, t, n) {
			return e.charAt(Ve(e, t, n))
		},
		skip: Oe,
		skipWhitespace: Re,
		skipSpaces: Pe,
		skipToLineEnd: Le,
		skipEverythingButNewLine: Be,
		skipInlineComment: Ie,
		skipTrailingComment: qe,
		skipNewline: $e,
		isNextLineEmptyAfterIndex: Ue,
		isNextLineEmpty: function (e, t, n) {
			return Ue(e, n(t))
		},
		isPreviousLineEmpty: function (e, t, n) {
			let r = n(t) - 1
			return (r = Pe(e, r, { backwards: !0 })), (r = $e(e, r, { backwards: !0 })), (r = Pe(e, r, { backwards: !0 })), r !== $e(e, r, { backwards: !0 })
		},
		hasNewline: Me,
		...
		hasSpaces: function (e, t, n) {
			return Pe(e, (n = n || {}).backwards ? t - 1 : t, n) !== t
		},
		getAlignmentSize: je,
		getIndentSize: function (e, t) {
			const n = e.lastIndexOf('\n')
			return -1 === n ? 0 : je(e.slice(n + 1).match(/^[\t ]*/)[0], t)
		},
		getPreferredQuote: He,
		printString: function (e, t, n) {
			const r = e.slice(1, -1),
				s = !r.includes('"') && !r.includes("'"),
				i = 'json' === t.parser ? '"' : t.__isInHtmlAttribute ? "'" : He(e, t.singleQuote ? "'" : '"')
			return n ? (s ? i + r + i : e) : Xe(r, i, !('css' === t.parser || 'less' === t.parser || 'scss' === t.parser || t.embeddedInHtml))
		},
		...
		addLeadingComment: function (e, t) {
			;(t.leading = !0), (t.trailing = !1), ze(e, t)
		},
		addDanglingComment: function (e, t, n) {
			;(t.leading = !1), (t.trailing = !1), n && (t.marker = n), ze(e, t)
		},
		addTrailingComment: function (e, t) {
			;(t.leading = !1), (t.trailing = !0), ze(e, t)
		},
	...
	const { getStringWidth: Ye } = We,
		{ convertEndOfLineToChars: Je } = Qe,
		{ concat: Ze, fill: Ke, cursor: et } = f
	let tt
	function nt(e, t) {
		return st(e, { type: 'indent' }, t)
	}
	function rt(e, t, n) {
		if (t === -1 / 0) return e.root || { value: '', length: 0, queue: [] }
		if (t < 0) return st(e, { type: 'dedent' }, n)
		if (!t) return e
		if ('root' === t.type) return Object.assign({}, e, { root: e })
		return st(e, { type: 'string' == typeof t ? 'stringAlign' : 'numberAlign', n: t }, n)
	}
	function st(e, t, n) {
	...
	function ot(e, t, n, r, s) {
		...
		for (; n >= 0; ) {
			...
			const [e, u, c] = o.pop()
			if ('string' == typeof c) a.push(c), (n -= Ye(c))
			else
				switch (c.type) {
					case 'concat':
						for (let t = c.parts.length - 1; t >= 0; t--) o.push([e, u, c.parts[t]])
						break
					case 'indent':
						o.push([nt(e, r), u, c.contents])
						break
					case 'align':
						o.push([rt(e, c.n, r), u, c.contents])
						break
					case 'trim':
						n += it(a)
						break
					case 'group':
						...
						o.push([e, c.break ? 1 : u, c.contents]), c.id && (tt[c.id] = o[o.length - 1][1])
						break
					case 'fill':
						for (let t = c.parts.length - 1; t >= 0; t--) o.push([e, u, c.parts[t]])
						break
					case 'if-break': {
						const t = c.groupId ? tt[c.groupId] : u
						1 === t && c.breakContents && o.push([e, u, c.breakContents]), 2 === t && c.flatContents && o.push([e, u, c.flatContents])
						break
					}
					case 'line':
						switch (u) {
		...
		printDocToString: function (e, t) {
			...
			for (; 0 !== i.length; ) {
				...
				if ('string' == typeof l) {
					...
					switch (l.type) {
						case 'cursor':
							o.push(et.placeholder)
							break
						case 'concat':
							for (let t = l.parts.length - 1; t >= 0; t--) i.push([e, c, l.parts[t]])
							break
						case 'indent':
							i.push([nt(e, t), c, l.contents])
							break
						case 'align':
							i.push([rt(e, l.n, t), c, l.contents])
							break
						case 'trim':
							s -= it(o)
							break
							...
							switch (c) {
								...
								case 1: {
									...
									const r = [e, 2, l.contents],
										o = n - s
									if (!l.break && ot(r, i, o, t)) i.push(r)
						...
						case 'fill': {
							...
							const m = [e, c, Ke(o)],
								g = o[0]
							ot([e, 2, Ze([a, u, g])], [], r, t, !0) ? (i.push(m), i.push(d), i.push(p)) : h ? (i.push(m), i.push(f), i.push(p)) : (i.push(m), i.push(f), i.push(D))
							break
						}
						case 'if-break': {
							const t = l.groupId ? tt[l.groupId] : c
						...
						case 'line':
							switch (c) {
								...
								case 1:
									...
									l.literal ? (e.root ? (o.push(r, e.root.value), (s = e.root.length)) : (o.push(r), (s = 0))) : ((s -= it(o)), o.push(r + e.value), (s = e.length))
							}
					}
				0 === i.length && u.length && (i.push(...u.reverse()), (u = []))
			}
			const c = o.indexOf(et.placeholder)
			if (-1 !== c) {
				const e = o.indexOf(et.placeholder, c + 1),
					t = o.slice(0, c).join(''),
	...
	const { literalline: ut, concat: ct } = f,
		lt = {}
	function pt(e, t, n, r) {
		const s = [e]
		for (; 0 !== s.length; ) {
			const e = s.pop()
			if (e !== lt) {
				if ((n && s.push(e, lt), !t || !1 !== t(e)))
					if ('concat' === e.type || 'fill' === e.type) for (let t = e.parts.length - 1; t >= 0; --t) s.push(e.parts[t])
					else if ('if-break' === e.type) e.flatContents && s.push(e.flatContents), e.breakContents && s.push(e.breakContents)
					else if ('group' === e.type && e.expandedStates)
						if (r) for (let t = e.expandedStates.length - 1; t >= 0; --t) s.push(e.expandedStates[t])
						else s.push(e.contents)
					else e.contents && s.push(e.contents)
			} else n(s.pop())
		}
	}
	function Dt(e, t) {
		if ('concat' === e.type || 'fill' === e.type) {
			const n = e.parts.map(e => Dt(e, t))
			return t(Object.assign({}, e, { parts: n }))
		}
		if ('if-break' === e.type) {
			const n = e.breakContents && Dt(e.breakContents, t),
				r = e.flatContents && Dt(e.flatContents, t)
			return t(Object.assign({}, e, { breakContents: n, flatContents: r }))
		}
		if (e.contents) {
			const n = Dt(e.contents, t)
	...
	function Ct(e) {
		if ('concat' === e.type) {
			...
			for (let n = 0; n < e.parts.length; ++n) {
				const r = e.parts[n]
				if ('string' != typeof r && 'concat' === r.type) t.push(...Ct(r).parts)
				else {
					const e = Ct(r)
					'' !== e && t.push(e)
				}
		...
		return 'if-break' === e.type
			? Object.assign({}, e, { breakContents: null != e.breakContents ? Ct(e.breakContents) : null, flatContents: null != e.flatContents ? Ct(e.flatContents) : null })
			: 'group' === e.type
			? Object.assign({}, e, { contents: Ct(e.contents), expandedStates: e.expandedStates ? e.expandedStates.map(Ct) : e.expandedStates })
			: e.contents
			? Object.assign({}, e, { contents: Ct(e.contents) })
			: e
	}
	function Tt(e) {
		...
		if ('concat' === e.type) return '[' + e.parts.map(Tt).join(', ') + ']'
		if ('indent' === e.type) return 'indent(' + Tt(e.contents) + ')'
		if ('align' === e.type)
			return e.n === -1 / 0
				? 'dedentToRoot(' + Tt(e.contents) + ')'
				: e.n < 0
				? 'dedent(' + Tt(e.contents) + ')'
				: 'root' === e.n.type
				? 'markAsRoot(' + Tt(e.contents) + ')'
				: 'align(' + JSON.stringify(e.n) + ', ' + Tt(e.contents) + ')'
		if ('if-break' === e.type) return 'ifBreak(' + Tt(e.breakContents) + (e.flatContents ? ', ' + Tt(e.flatContents) : '') + ')'
		if ('group' === e.type) return e.expandedStates ? 'conditionalGroup([' + e.expandedStates.map(Tt).join(',') + '])' : (e.break ? 'wrappedGroup' : 'group') + '(' + Tt(e.contents) + ')'
		if ('fill' === e.type) return 'fill(' + e.parts.map(Tt).join(', ') + ')'
		if ('line-suffix' === e.type) return 'lineSuffix(' + Tt(e.contents) + ')'
		...
		utils: {
			...
			propagateBreaks: function (e) {
				...
				pt(
					e,
					function (e) {
						if (('break-parent' === e.type && mt(n), 'group' === e.type)) {
			...
			stripTrailingHardline: function e(t, n = !1) {
				if ('concat' === t.type && 0 !== t.parts.length) {
					const r = n
						...
						s = r[r.length - 1]
					if ('concat' === s.type)
						return 2 === s.parts.length && s.parts[0].hard && 'break-parent' === s.parts[1].type
			...
			normalizeDoc: function (e) {
				return Dt(e, e => (e.parts ? Object.assign({}, e, { parts: Et(e.parts) }) : e))
			},
			replaceNewlinesWithLiterallines: function (e) {
				return Dt(e, e => ('string' == typeof e && e.includes('\n') ? ct(e.split(/(\n)/g).map((e, t) => (t % 2 == 0 ? e : ut))) : e))
			},
		},
		debug: { printDocToDebug: e => Tt(Ct(e)) },
	}
	const {
			builders: { hardline: St, concat: _t, markAsRoot: bt },
		} = yt,
		Ft = { '---': 'yaml', '+++': 'toml' }
	var At = {
		parse: function (e) {
			const t = Object.keys(Ft).map(a).join('|'),
				n = e.match(new RegExp('^('.concat(t, ')([^\\n]*)\\n(?:([\\s\\S]*?)\\n)?\\1[^\\n\\S]*(\\n|$)')))
			if (null === n) return { frontMatter: null, content: e }
			const [r, s, i, o] = n
			let u = Ft[s]
			return (
				'toml' !== u && i && i.trim() && (u = i.trim()), { frontMatter: { type: 'front-matter', lang: u, value: o, raw: r.replace(/\n$/, '') }, content: r.replace(/[^\n]/g, ' ') + e.slice(r.length) }
			)
		},
		print: function (e, t) {
			if ('yaml' === e.lang) {
	...
	const { inferParserByLanguage: kt, isFrontMatterNode: Nt } = We,
		{ CSS_DISPLAY_TAGS: xt, CSS_DISPLAY_DEFAULT: Ot, CSS_WHITE_SPACE_TAGS: Rt, CSS_WHITE_SPACE_DEFAULT: Pt } = {
			CSS_DISPLAY_TAGS: {
				area: 'none',
				base: 'none',
				basefont: 'none',
	...
	function Mt(e, t) {
		return (
			...
			!(!Zt(e) || !e.children.some(e => 'text' !== e.type && 'interpolation' !== e.type)) ||
			!(!sn(e, t) || Gt(e) || 'interpolation' === e.type)
		)
	}
	function Ut(e) {
	...
	function Gt(e) {
		return 'element' === e.type && ('script' === e.fullName || 'style' === e.fullName || 'svg:style' === e.fullName || (Kt(e) && ('script' === e.name || 'style' === e.name)))
	}
	function Vt(e) {
	...
	function Ht(e) {
		return Qt(e) || ('element' === e.type && 'br' === e.fullName) || Xt(e)
	}
	function Xt(e) {
		return zt(e) && Wt(e)
	}
	...
	function en(e) {
		return ('element' === e.type && (!e.namespace || Kt(e)) && Rt[e.name]) || Pt
	}
	const tn = new Set(['template', 'style', 'script'])
	function nn(e, t) {
		return rn(e, t) && !tn.has(e.fullName)
	}
	function rn(e, t) {
		return 'vue' === t.parser && 'element' === e.type && 'root' === e.parent.type && 'html' !== e.fullName.toLowerCase()
	}
	function sn(e, t) {
		return rn(e, t) && (nn(e, t) || (e.attrMap.lang && 'html' !== e.attrMap.lang))
	}
	var on = {
		HTML_ELEMENT_ATTRIBUTES: Bt,
		HTML_TAGS: Lt,
		...
		forceBreakContent: function (e) {
			return (
				...
				(e.firstChild && e.firstChild === e.lastChild && 'text' !== e.firstChild.type && zt(e.firstChild) && (!e.lastChild.isTrailingSpaceSensitive || Wt(e.lastChild)))
			)
		},
		forceNextEmptyLine: function (e) {
			return Nt(e) || (e.next && e.sourceSpan.end && e.sourceSpan.end.line + 1 < e.next.sourceSpan.start.line)
		},
		...
		getNodeCssStyleDisplay: function (e, t) {
			...
			switch (t.htmlWhitespaceSensitivity) {
				...
				case 'ignore':
					return 'block'
				default:
					return 'vue' === t.parser && e.parent && 'root' === e.parent.type ? 'block' : ('element' === e.type && (!e.namespace || n || Kt(e)) && xt[e.name]) || Ot
			}
		},
		getNodeCssStyleWhiteSpace: en,
		getPrettierIgnoreAttributeCommentData: function (e) {
			const t = e.trim().match(/^prettier-ignore-attribute(?:\s+([^]+))?$/)
			return !!t && (!t[1] || t[1].split(/\s+/))
		},
		hasPrettierIgnore: Ut,
		inferScriptParser: function (e, t) {
			return 'script' !== e.name || e.attrMap.src
				? 'style' === e.name
					...
					: t && sn(e, t)
					? Yt(e) || (!('src' in e.attrMap) && kt(e.attrMap.lang, t))
					: void 0
		...
		isDanglingSpaceSensitiveNode: function (e) {
			return !((t = e.cssDisplay), Jt(t) || 'inline-block' === t || Gt(e))
			var t
		},
		isIndentationSensitiveNode: Vt,
		isLeadingSpaceSensitiveNode: function (e, t) {
			const n = (function () {
				...
				if (!e.prev && ('root' === e.parent.type || (Zt(e) && e.parent) || Gt(e.parent) || nn(e.parent, t) || ((n = e.parent.cssDisplay), Jt(n) || 'inline-block' === n))) return !1
				var n
				if (
					e.prev &&
					!(function (e) {
			...
			return (
				...
				(!(('text' !== e.type && 'interpolation' !== e.type) || !e.next || ('text' !== e.next.type && 'interpolation' !== e.next.type)) ||
					(!(!e.parent || 'none' === e.parent.cssDisplay) &&
						(!!Zt(e.parent) ||
							(!(!e.next && ('root' === e.parent.type || (Zt(e) && e.parent) || Gt(e.parent) || nn(e.parent, t) || ((n = e.parent.cssDisplay), Jt(n) || 'inline-block' === n))) &&
								!(
									e.next &&
									!(function (e) {
										return !Jt(e)
		...
		isWhitespaceSensitiveNode: function (e) {
			return Gt(e) || 'interpolation' === e.type || Vt(e)
		},
		isUnknownNamespace: Kt,
		preferHardlineAsLeadingSpaces: function (e) {
			return Qt(e) || (e.prev && Ht(e.prev)) || Xt(e)
		},
		preferHardlineAsTrailingSpaces: Ht,
		shouldNotPrintClosingTag: function (e, t) {
			return !e.isSelfClosing && !e.endSourceSpan && (Ut(e) || Mt(e.parent, t))
		},
		shouldPreserveContent: Mt,
	...
	const un = { attrs: !0, children: !0 }
	class cn {
		constructor(e = {}) {
			for (const t of Object.keys(e)) {
				const n = e[t]
				t in un ? this._setNodes(t, n) : (this[t] = n)
			}
		}
		_setNodes(e, t) {
			t !== this[e] &&
				((this[e] = (function (e, t) {
					const n = e.map(e => (e instanceof cn ? e.clone() : new cn(e)))
					let r = null,
						s = n[0],
						i = n[1] || null
					for (let e = 0; e < n.length; e++) pn(s, { index: e, siblings: n, prev: r, next: i, parent: t }), (r = s), (s = i), (i = n[e + 2] || null)
					return n
				})(t, this)),
				'attrs' === e && pn(this, { attrMap: this[e].reduce((e, t) => ((e[t.fullName] = t.value), e), Object.create(null)) }))
		}
		map(e) {
			let t = null
			for (const n in un) {
				const r = this[n]
				if (r) {
					const s = ln(r, t => t.map(e))
					t !== r && (t || (t = new cn()), t._setNodes(n, s))
				}
			}
			if (t) {
				for (const e in this) e in un || (t[e] = this[e])
				const { index: e, siblings: n, prev: r, next: s, parent: i } = this
				pn(t, { index: e, siblings: n, prev: r, next: s, parent: i })
			}
			return e(t || this)
		}
		clone(e) {
			return new cn(e ? Object.assign({}, this, e) : this)
		}
		get firstChild() {
	...
	function pn(e, t) {
		const n = Object.keys(t).reduce((e, n) => ((e[n] = { value: t[n], enumerable: !1 }), e), {})
		Object.defineProperties(e, n)
	}
	var Dn = { Node: cn }
	const { ParseSourceSpan: hn } = o,
		dn = [
			[
				/^(\[if([^\]]*?)]>)([\S\s]*?)<!\s*\[endif]$/,
				function (e, t, n) {
					const [, r, s, i] = n,
						...
						[c, l] = (() => {
							try {
								...
								return [!1, [{ type: 'text', value: i, sourceSpan: new hn(a, u) }]]
							}
						})()
					return {
						...
						startSourceSpan: new hn(e.sourceSpan.start, a),
						endSourceSpan: new hn(u, e.sourceSpan.end),
					}
				},
			],
			[
				...
				function (e, t, n) {
					const [, r] = n
					return { type: 'ieConditionalStartComment', condition: r.trim().replace(/\s+/g, ' '), sourceSpan: e.sourceSpan }
				},
			],
			[
				/^<!\s*\[endif]$/,
	...
	var fn = {
		parseIeConditionalComment: function (e, t) {
			if (e.value) {
				let n
				for (const [r, s] of dn) if ((n = e.value.match(r))) return s(e, t, n)
			}
			return null
		},
	}
	var mn = {
		...
		En = t(function (e, t) {
			...
			Object.defineProperty(t, '__esModule', { value: !0 })
			class n {
				constructor({ closedByChildren: e, implicitNamespacePrefix: t, contentType: n = gn.TagContentType.PARSABLE_DATA, closedByParent: r = !1, isVoid: s = !1, ignoreFirstLf: i = !1 } = {}) {
					...
					return (
						s ||
							...
							(s = {
								...
								td: new n({ closedByChildren: ['td', 'th'], closedByParent: !0 }),
								...
								rb: new n({ closedByChildren: ['rb', 'rt', 'rtc', 'rp'], closedByParent: !0 }),
								rt: new n({ closedByChildren: ['rb', 'rt', 'rtc', 'rp'], closedByParent: !0 }),
								rtc: new n({ closedByChildren: ['rb', 'rtc', 'rp'], closedByParent: !0 }),
								rp: new n({ closedByChildren: ['rb', 'rt', 'rtc', 'rp'], closedByParent: !0 }),
								optgroup: new n({ closedByChildren: ['optgroup'], closedByParent: !0 }),
								option: new n({ closedByChildren: ['option', 'optgroup'], closedByParent: !0 }),
								pre: new n({ ignoreFirstLf: !0 }),
								listing: new n({ ignoreFirstLf: !0 }),
								style: new n({ contentType: gn.TagContentType.RAW_TEXT }),
								script: new n({ contentType: gn.TagContentType.RAW_TEXT }),
								title: new n({ contentType: gn.TagContentType.ESCAPABLE_RAW_TEXT }),
								textarea: new n({ contentType: gn.TagContentType.ESCAPABLE_RAW_TEXT, ignoreFirstLf: !0 }),
							})),
						s[e] || r
					)
				})
		...
		Tn = t(function (e, t) {
			...
			t.Expansion = class {
				constructor(e, t, n, r, s, i) {
					;(this.switchValue = e), (this.type = t), (this.cases = n), (this.sourceSpan = r), (this.switchValueSourceSpan = s), (this.i18n = i)
				}
				visit(e, t) {
			...
			t.ExpansionCase = class {
				constructor(e, t, n, r, s) {
					;(this.value = e), (this.expression = t), (this.sourceSpan = n), (this.valueSourceSpan = r), (this.expSourceSpan = s)
				}
				visit(e, t) {
			...
			t.Attribute = class {
				constructor(e, t, n, r = null, s = null, i = null) {
					;(this.name = e), (this.value = t), (this.sourceSpan = n), (this.valueSpan = r), (this.nameSpan = s), (this.i18n = i)
				}
				visit(e, t) {
			...
			class n {
				constructor(e, t, n, r, s = null, i = null, o = null, a = null) {
					;(this.name = e), (this.attrs = t), (this.children = n), (this.sourceSpan = r), (this.startSourceSpan = s), (this.endSourceSpan = i), (this.nameSpan = o), (this.i18n = a)
				}
				visit(e, t) {
			...
			function r(e, t, n = null) {
				const r = [],
					s = e.visit ? t => e.visit(t, n) || t.visit(e, n) : t => t.visit(e, n)
				return (
					t.forEach(e => {
						const t = s(e)
						t && r.push(t)
			...
			function i(e) {
				...
				return e instanceof n && (e.endSourceSpan ? (r = e.endSourceSpan.end.offset) : e.children && e.children.length && (r = i(e.children[e.children.length - 1]).end)), { start: t, end: r }
			}
			...
			Object.defineProperty(t, '__esModule', { value: !0 }),
				(t.assertArrayOfStrings = function (e, t) {
					if (null != t) {
						...
						for (let n = 0; n < t.length; n += 1) if ('string' != typeof t[n]) throw new Error("Expected '".concat(e, "' to be an array of strings."))
					}
				})
			const n = [/^\s*$/, /[<>]/, /^[{}]$/, /&(#|[a-z])/i, /^\/\//]
			t.assertInterpolationSymbols = function (e, t) {
				...
				if (null != t) {
					const e = t[0],
						r = t[1]
					n.forEach(t => {
						if (t.test(e) || t.test(r)) throw new Error("['".concat(e, "', '").concat(r, "'] contains unusable interpolation symbol."))
					})
				}
			}
		}),
		Sn = t(function (e, t) {
			...
			class n {
				...
				static fromArray(e) {
					return e ? (yn.assertInterpolationSymbols('interpolation', e), new n(e[0], e[1])) : t.DEFAULT_INTERPOLATION_CONFIG
				}
			}
		...
		_n = t(function (e, t) {
			...
			class h {
				constructor(e, t, n) {
					;(this._getTagContentType = t),
						...
						(this._interpolationConfig = n.interpolationConfig || Sn.DEFAULT_INTERPOLATION_CONFIG),
					...
					const r = n.range || { endPos: e.content.length, startPos: 0, startLine: 0, startCol: 0 }
					...
					for (; this._cursor.peek() !== r.$EOF; ) {
						...
						try {
							if (this._attemptCharCode(r.$LT))
								...
								else if (this._attemptCharCode(r.$SLASH)) this._consumeTagClose(e)
								else {
						...
						new u(
							(function (e) {
								...
								for (let r = 0; r < e.length; r++) {
									const i = e[r]
									n && n.type == s.TEXT && i.type == s.TEXT ? ((n.parts[0] += i.parts[0]), (n.sourceSpan.end = i.sourceSpan.end)) : ((n = i), t.push(n))
								}
								return t
							})(this.tokens),
							this.errors
				...
				_endToken(e, t = this._cursor.clone()) {
					if (null === this._currentTokenStart) throw new a('Programming error - attempted to end a token when there was no start to the token', this._currentTokenType, this._cursor.getSpan(t))
					if (null === this._currentTokenType) throw new a('Programming error - attempted to end a token which has no token type', null, this._cursor.getSpan(this._currentTokenStart))
					const n = new i(this._currentTokenType, e, this._cursor.getSpan(this._currentTokenStart, this._leadingTriviaCodePoints))
				...
				_createError(e, t) {
					...
					return (this._currentTokenStart = null), (this._currentTokenType = null), new D(n)
				}
				handleError(e) {
					if ((e instanceof y && (e = this._createError(e.msg, this._cursor.getSpan(e.cursor))), !(e instanceof D))) throw e
				...
				_attemptCharCodeCaseInsensitive(e) {
					return (t = this._cursor.peek()), (n = e), E(t) == E(n) && (this._cursor.advance(), !0)
					var t, n
				}
				_requireCharCode(e) {
					const t = this._cursor.clone()
					if (!this._attemptCharCode(e)) throw this._createError(l(this._cursor.peek()), this._cursor.getSpan(t))
				}
				_attemptStr(e) {
					const t = e.length
				...
				_requireStr(e) {
					const t = this._cursor.clone()
					if (!this._attemptStr(e)) throw this._createError(l(this._cursor.peek()), this._cursor.getSpan(t))
				}
				_requireStrCaseInsensitive(e) {
					const t = this._cursor.clone()
					if (!this._attemptStrCaseInsensitive(e)) throw this._createError(l(this._cursor.peek()), this._cursor.getSpan(t))
				}
				...
				_requireCharCodeUntilFn(e, t) {
					...
					if (this._cursor.clone().diff(n) < t) throw this._createError(l(this._cursor.peek()), this._cursor.getSpan(n))
				}
				_attemptUntilChar(e) {
				...
				_decodeEntity() {
					...
					if ((this._cursor.advance(), !this._attemptCharCode(r.$HASH))) {
						const t = this._cursor.clone()
						if ((this._attemptCharCodeUntilFn(g), this._cursor.peek() != r.$SEMICOLON)) return (this._cursor = t), '&'
						const n = this._cursor.getChars(t)
						this._cursor.advance()
						const s = gn.NAMED_ENTITIES[n]
					...
					}
					{
						...
						if ((this._attemptCharCodeUntilFn(m), this._cursor.peek() != r.$SEMICOLON)) throw this._createError(l(this._cursor.peek()), this._cursor.getSpan())
						...
						try {
							...
							throw this._createError(p(this._cursor.getChars(e)), this._cursor.getSpan())
						}
					}
				}
				_consumeRawText(e, t) {
				...
				_consumeCdata(e) {
					this._beginToken(s.CDATA_START, e), this._endToken([]), this._consumeRawText(!1, () => this._attemptStr(']]>')), this._beginToken(s.CDATA_END), this._requireStr(']]>'), this._endToken([])
				}
				_consumeDocType(e) {
				...
				_consumePrefixAndName() {
					...
					var n
					let s
					this._cursor.peek() === r.$COLON ? ((t = this._cursor.getChars(e)), this._cursor.advance(), (s = this._cursor.clone())) : (s = e), this._requireCharCodeUntilFn(f, '' === t ? 0 : 1)
				...
				_consumeTagOpen(e) {
					...
					const a = this._cursor.clone(),
						u = []
					try {
						if (!r.isAsciiLetter(this._cursor.peek())) throw this._createError(l(this._cursor.peek()), this._cursor.getSpan(e))
						for (i = this._consumeTagOpenStart(e), n = i.parts[0], t = i.parts[1], this._attemptCharCodeUntilFn(d); this._cursor.peek() !== r.$SLASH && this._cursor.peek() !== r.$GT; ) {
							const [e, t] = this._consumeAttributeName()
							if ((this._attemptCharCodeUntilFn(d), this._attemptCharCode(r.$EQ))) {
					...
					const c = this._getTagContentType(t, n, this._fullNameStack.length > 0, u)
					this._handleFullNameStackForTagOpen(n, t),
						c === gn.TagContentType.RAW_TEXT ? this._consumeRawTextWithTagClose(n, t, !1) : c === gn.TagContentType.ESCAPABLE_RAW_TEXT && this._consumeRawTextWithTagClose(n, t, !0)
				}
				_consumeRawTextWithTagClose(e, t, n) {
					this._consumeRawText(
						...
						() =>
							...
							(this._attemptCharCodeUntilFn(d), !!this._attemptStrCaseInsensitive(e ? ''.concat(e, ':').concat(t) : t) && (this._attemptCharCodeUntilFn(d), this._attemptCharCode(r.$GT)))
					)
					this._beginToken(s.TAG_CLOSE), this._requireCharCodeUntilFn(e => e === r.$GT, 3), this._cursor.advance(), this._endToken([e, t]), this._handleFullNameStackForTagClose(e, t)
				}
				...
				_consumeAttributeName() {
					...
					if (e === r.$SQ || e === r.$DQ) throw this._createError(l(e), this._cursor.getSpan())
				...
				_consumeAttributeValue() {
					...
					if (this._cursor.peek() === r.$SQ || this._cursor.peek() === r.$DQ) {
						...
						this._cursor.advance(), this._endToken([String.fromCodePoint(t)]), this._beginToken(s.ATTR_VALUE)
						const n = []
						for (; this._cursor.peek() !== t; ) n.push(this._readChar(!0))
						;(e = this._processCarriageReturns(n.join(''))), this._endToken([e]), this._beginToken(s.ATTR_QUOTE), this._cursor.advance(), this._endToken([String.fromCodePoint(t)])
					} else {
						this._beginToken(s.ATTR_VALUE)
						const t = this._cursor.clone()
						this._requireCharCodeUntilFn(f, 1), (e = this._processCarriageReturns(this._cursor.getChars(t))), this._endToken([e])
					}
					return e
				}
				_consumeTagOpenEnd() {
					const e = this._attemptCharCode(r.$SLASH) ? s.TAG_OPEN_END_VOID : s.TAG_OPEN_END
					this._beginToken(e), this._requireCharCode(r.$GT), this._endToken([])
				}
				_consumeTagClose(e) {
					if ((this._beginToken(s.TAG_CLOSE, e), this._attemptCharCodeUntilFn(d), this._allowHtmComponentClosingTags && this._attemptCharCode(r.$SLASH)))
						this._attemptCharCodeUntilFn(d), this._requireCharCode(r.$GT), this._endToken([])
					else {
						const [e, t] = this._consumePrefixAndName()
						this._attemptCharCodeUntilFn(d), this._requireCharCode(r.$GT), this._endToken([e, t]), this._handleFullNameStackForTagClose(e, t)
					}
				}
				_consumeExpansionFormStart() {
					...
					this._endToken([e]), this._requireCharCode(r.$COMMA), this._attemptCharCodeUntilFn(d), this._beginToken(s.RAW_TEXT)
					const t = this._readUntil(r.$COMMA)
					this._endToken([t]), this._requireCharCode(r.$COMMA), this._attemptCharCodeUntilFn(d)
				}
				...
				_consumeExpansionCaseEnd() {
					this._beginToken(s.EXPANSION_CASE_EXP_END), this._requireCharCode(r.$RBRACE), this._endToken([]), this._attemptCharCodeUntilFn(d), this._expansionCaseStack.pop()
				}
				...
				_consumeText() {
					...
					do {
						this._interpolationConfig && this._attemptStr(this._interpolationConfig.start)
							? (t.push(this._interpolationConfig.start), (this._inInterpolation = !0))
							: this._interpolationConfig && this._inInterpolation && this._attemptStr(this._interpolationConfig.end)
							? (t.push(this._interpolationConfig.end), (this._inInterpolation = !1))
			...
			class C {
				constructor(e, t) {
					if (e instanceof C) (this.file = e.file), (this.input = e.input), (this.end = e.end), (this.state = Object.assign({}, e.state))
					else {
				...
				getSpan(e, t) {
					...
					return new o.ParseSourceSpan(new o.ParseLocation(e.file, e.state.offset, e.state.line, e.state.column), new o.ParseLocation(this.file, this.state.offset, this.state.line, this.state.column))
				}
				getChars(e) {
				...
				advanceState(e) {
					if (e.offset >= this.end) throw ((this.state = e), new y('Unexpected character "EOF"', this))
			...
			class T extends C {
				...
				processEscapeSequence() {
					...
					if (e() === r.$BACKSLASH)
						if (((this.internalState = Object.assign({}, this.state)), this.advanceState(this.internalState), e() === r.$n)) this.state.peek = r.$LF
				...
				decodeHexDigits(e, t) {
					const n = this.input.substr(e.internalState.offset, t),
						r = parseInt(n, 16)
					if (isNaN(r)) throw ((e.state = e.internalState), new y('Invalid hexadecimal escape sequence', e))
					return r
				}
			}
			class y {
		...
		bn = t(function (e, t) {
			...
			class s {
				...
				build() {
					for (; this._peek.type !== _n.TokenType.EOF; )
						this._peek.type === _n.TokenType.TAG_OPEN_START
							? this._consumeStartTag(this._advance())
							: this._peek.type === _n.TokenType.TAG_CLOSE
							? (this._closeVoidElement(), this._consumeEndTag(this._advance()))
							: this._peek.type === _n.TokenType.CDATA_START
							? (this._closeVoidElement(), this._consumeCdata(this._advance()))
							: this._peek.type === _n.TokenType.COMMENT_START
							? (this._closeVoidElement(), this._consumeComment(this._advance()))
							: this._peek.type === _n.TokenType.TEXT || this._peek.type === _n.TokenType.RAW_TEXT || this._peek.type === _n.TokenType.ESCAPABLE_RAW_TEXT
							? (this._closeVoidElement(), this._consumeText(this._advance()))
							: this._peek.type === _n.TokenType.EXPANSION_FORM_START
							? this._consumeExpansion(this._advance())
							: this._peek.type === _n.TokenType.DOC_TYPE_START
				...
				_consumeCdata(e) {
					const t = this._advance(),
						n = this._getText(t),
						r = this._advanceIf(_n.TokenType.CDATA_END)
					this._addToParent(new Tn.CDATA(n, new o.ParseSourceSpan(e.sourceSpan.start, (r || t).sourceSpan.end)))
				}
				_consumeComment(e) {
					const t = this._advanceIf(_n.TokenType.RAW_TEXT),
						n = this._advanceIf(_n.TokenType.COMMENT_END),
						r = null != t ? t.parts[0].trim() : null,
						s = new o.ParseSourceSpan(e.sourceSpan.start, (n || t || e).sourceSpan.end)
					this._addToParent(new Tn.Comment(r, s))
				}
				_consumeDocType(e) {
					const t = this._advanceIf(_n.TokenType.RAW_TEXT),
						n = this._advanceIf(_n.TokenType.DOC_TYPE_END),
						r = null != t ? t.parts[0].trim() : null,
						s = new o.ParseSourceSpan(e.sourceSpan.start, (n || t || e).sourceSpan.end)
					this._addToParent(new Tn.DocType(r, s))
				}
				_consumeExpansion(e) {
					const t = this._advance(),
						r = this._advance(),
						s = []
					for (; this._peek.type === _n.TokenType.EXPANSION_CASE_VALUE; ) {
						const e = this._parseExpansionCase()
						if (!e) return
						s.push(e)
					}
					if (this._peek.type !== _n.TokenType.EXPANSION_FORM_END) return void this._errors.push(n.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '}'."))
					const i = new o.ParseSourceSpan(e.sourceSpan.start, this._peek.sourceSpan.end)
					this._addToParent(new Tn.Expansion(t.parts[0], r.parts[0], s, i, t.sourceSpan)), this._advance()
				}
				_parseExpansionCase() {
					const e = this._advance()
					if (this._peek.type !== _n.TokenType.EXPANSION_CASE_EXP_START) return this._errors.push(n.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '{'.")), null
					const t = this._advance(),
						r = this._collectExpansionExpTokens(t)
					if (!r) return null
					const i = this._advance()
					r.push(new _n.Token(_n.TokenType.EOF, [], i.sourceSpan))
					const a = new s(r, this.getTagDefinition, this.canSelfClose, this.allowHtmComponentClosingTags, this.isTagNameCaseSensitive).build()
					if (a.errors.length > 0) return (this._errors = this._errors.concat(a.errors)), null
					...
					return new Tn.ExpansionCase(e.parts[0], a.rootNodes, u, e.sourceSpan, c)
				}
				_collectExpansionExpTokens(e) {
					const t = [],
						r = [_n.TokenType.EXPANSION_CASE_EXP_START]
					for (;;) {
						if (
							((this._peek.type !== _n.TokenType.EXPANSION_FORM_START && this._peek.type !== _n.TokenType.EXPANSION_CASE_EXP_START) || r.push(this._peek.type),
							this._peek.type === _n.TokenType.EXPANSION_CASE_EXP_END)
						) {
							if (!i(r, _n.TokenType.EXPANSION_CASE_EXP_START)) return this._errors.push(n.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'.")), null
							if ((r.pop(), 0 == r.length)) return t
						}
						if (this._peek.type === _n.TokenType.EXPANSION_FORM_END) {
							if (!i(r, _n.TokenType.EXPANSION_FORM_START)) return this._errors.push(n.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'.")), null
							r.pop()
						}
						if (this._peek.type === _n.TokenType.EOF) return this._errors.push(n.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'.")), null
				...
				_consumeText(e) {
					...
					t.length > 0 && this._addToParent(new Tn.Text(t, e.sourceSpan))
				}
				_closeVoidElement() {
					const e = this._getParentElement()
				...
				_consumeStartTag(e) {
					const t = e.parts[0],
						r = e.parts[1],
						s = []
					for (; this._peek.type === _n.TokenType.ATTR_NAME; ) s.push(this._consumeAttr(this._advance()))
					const i = this._getElementFullName(t, r, this._getParentElement())
					let a = !1
					if (this._peek.type === _n.TokenType.TAG_OPEN_END_VOID) {
						this._advance(), (a = !0)
						const t = this.getTagDefinition(i)
						this.canSelfClose ||
							t.canSelfClose ||
							null !== gn.getNsPrefix(i) ||
							t.isVoid ||
							this._errors.push(n.create(i, e.sourceSpan, 'Only void and foreign elements can be self closed "'.concat(e.parts[1], '"')))
					} else this._peek.type === _n.TokenType.TAG_OPEN_END && (this._advance(), (a = !1))
					const u = this._peek.sourceSpan.start,
						c = new o.ParseSourceSpan(e.sourceSpan.start, u),
						l = new o.ParseSourceSpan(e.sourceSpan.start.moveBy(1), e.sourceSpan.end),
						p = new Tn.Element(i, s, [], c, c, void 0, l)
				...
				_consumeEndTag(e) {
					...
					if ((this._getParentElement() && (this._getParentElement().endSourceSpan = e.sourceSpan), t && this.getTagDefinition(t).isVoid))
						this._errors.push(n.create(t, e.sourceSpan, 'Void elements do not have end tags "'.concat(e.parts[1], '"')))
				...
				_popElement(e) {
					for (let t = this._elementStack.length - 1; t >= 0; t--) {
						...
						if (!e || (gn.getNsPrefix(n.name) ? n.name == e : n.name.toLowerCase() == e.toLowerCase())) return this._elementStack.splice(t, this._elementStack.length - t), !0
						if (!this.getTagDefinition(n.name).closedByParent) return !1
					}
					return !1
				}
				_consumeAttr(e) {
					const t = gn.mergeNsAndName(e.parts[0], e.parts[1])
					let n = e.sourceSpan.end,
						r = '',
						s = void 0,
						i = void 0
					if (this._peek.type === _n.TokenType.ATTR_QUOTE) {
						i = this._advance().sourceSpan.start
					}
					if (this._peek.type === _n.TokenType.ATTR_VALUE) {
						const e = this._advance()
					...
					return new Tn.Attribute(t, r, new o.ParseSourceSpan(e.sourceSpan.start, n), s, e.sourceSpan)
				}
				_getParentElement() {
				...
				_getParentElementSkippingContainers() {
					let e = null
					for (let t = this._elementStack.length - 1; t >= 0; t--) {
						if (!gn.isNgContainer(this._elementStack[t].name)) return { parent: this._elementStack[t], container: e }
				...
				_getElementFullName(e, t, n) {
					return '' === e && '' === (e = this.getTagDefinition(t).implicitNamespacePrefix || '') && null != n && (e = gn.getNsPrefix(n.name)), gn.mergeNsAndName(e, t)
				}
			}
			function i(e, t) {
		...
		Fn = t(function (e, t) {
			...
			class r extends bn.Parser {
				constructor() {
					super(En.getHtmlTagDefinition)
				}
				parse(e, t, n, r = !1, s) {
		...
		An = t(function (e, t) {
			Object.defineProperty(t, '__esModule', { value: !0 }), (t.TagContentType = gn.TagContentType)
			let n = null
			t.parse = function (e, t = {}) {
				const { canSelfClose: r = !1, allowHtmComponentClosingTags: s = !1, isTagNameCaseSensitive: i = !1, getTagContentType: o } = t
				return (n || (n = new Fn.HtmlParser()), n).parse(e, 'angular-html-parser', { tokenizeExpansionForms: !1, interpolationConfig: void 0, canSelfClose: r, allowHtmComponentClosingTags: s }, i, o)
			}
		})
	const { ParseSourceSpan: vn, ParseLocation: wn, ParseSourceFile: kn } = o,
		{ parse: Nn } = At,
		{ inferParserByLanguage: xn } = We,
		{ HTML_ELEMENT_ATTRIBUTES: On, HTML_TAGS: Rn, isUnknownNamespace: Pn } = on,
		{ hasPragma: Ln } = an,
		{ Node: Bn } = Dn,
		{ parseIeConditionalComment: In } = fn,
		{ locStart: qn, locEnd: $n } = mn
	function Mn(e, { recognizeSelfClosing: t, normalizeTagName: n, normalizeAttributeName: r, allowHtmComponentClosingTags: s, isTagNameCaseSensitive: i, getTagContentType: a }, u) {
		const c = An,
			{ RecursiveVisitor: l, visitAll: p, Attribute: D, CDATA: h, Comment: d, DocType: f, Element: m, Text: g } = Tn,
			{ ParseSourceSpan: E } = o,
			{ getHtmlTagDefinition: C } = En
		let { rootNodes: T, errors: y } = c.parse(e, { canSelfClose: t, allowHtmComponentClosingTags: s, isTagNameCaseSensitive: i, getTagContentType: a })
		const S = 'vue' === u.parser && T.some(e => (e instanceof f && 'html' === e.value) || (e instanceof m && 'html' === e.name.toLowerCase()))
		if ('vue' !== u.parser || S) {
			if (S) {
				;(t = !0), (n = !0), (r = !0), (s = !0), (i = !1)
				const o = c.parse(e, { canSelfClose: t, allowHtmComponentClosingTags: s, isTagNameCaseSensitive: i })
			...
			const n = e => {
				...
				const t = e.attrs.find(e => 'lang' === e.name),
					n = t && t.value
				return null == n || 'html' === xn(n, u)
			}
			if (T.some(n)) {
				let r
				const o = () => c.parse(e, { canSelfClose: t, allowHtmComponentClosingTags: s, isTagNameCaseSensitive: i }),
					a = () => r || (r = o()),
					u = e => a().rootNodes.find(({ startSourceSpan: t }) => t && t.start.offset === e.startSourceSpan.start.offset)
				for (let e = 0; e < T.length; e++) {
					const t = T[e],
						{ endSourceSpan: r, startSourceSpan: s } = t
					if (null === r) {
						;(y = a().errors), (T[e] = u(t) || t)
					} else if (n(t)) {
						const n = a(),
							i = s.end.offset,
							o = r.start.offset
		...
		if (0 !== y.length) {
			...
			throw vt(e, { start: { line: t.line + 1, column: t.col + 1 }, end: { line: n.line + 1, column: n.col + 1 } })
		}
		const _ = e => {
					...
					visit(e) {
						;(e => {
							if (e instanceof D) e.type = 'attribute'
								...
								if (!(e instanceof g)) throw new Error('Unexpected node '.concat(JSON.stringify(e)))
								e.type = 'text'
							}
						})(e),
							(e => {
								e instanceof m
									? (_(e),
									  e.attrs.forEach(e => {
											_(e), e.valueSpan ? ((e.value = e.valueSpan.toString()), /["']/.test(e.value[0]) && (e.value = e.value.slice(1, -1))) : (e.value = null)
									  }))
									: e instanceof d
									? (e.value = e.sourceSpan.toString().slice('\x3c!--'.length, -'--\x3e'.length))
									: e instanceof g && (e.value = e.sourceSpan.toString())
							})(e),
							(e => {
								if (e instanceof m) {
									const t = C(i ? e.name : e.name.toLowerCase())
									!e.namespace || e.namespace === t.implicitNamespacePrefix || Pn(e) ? (e.tagDefinition = t) : (e.tagDefinition = C(''))
								}
							})(e),
							(e => {
								if (e instanceof m && (!n || (e.namespace && e.namespace !== e.tagDefinition.implicitNamespacePrefix && !Pn(e)) || (e.name = b(e.name, e => e in Rn)), r)) {
									const t = On[e.name] || Object.create(null)
									e.attrs.forEach(n => {
										n.namespace || (n.name = b(n.name, n => e.name in On && (n in On['*'] || n in t)))
									})
								}
							})(e),
							(e => {
	...
	function Un(e, t, n, r = !0) {
		const { frontMatter: s, content: i } = r ? Nn(e) : { frontMatter: null, content: e },
			o = new kn(e, t.filepath),
			a = new wn(o, 0, 0, 0),
			u = a.moveBy(e.length),
			c = { type: 'root', sourceSpan: new vn(a, u), children: Mn(i, n, t) }
		if (s) {
			const e = new wn(o, 0, 0, 0),
				t = e.moveBy(s.raw.length)
			;(s.sourceSpan = new vn(e, t)), c.children.unshift(s)
		}
		const l = new Bn(c),
			p = (r, s) => {
				const { offset: i } = s,
					o = Un(e.slice(0, i).replace(/[^\n\r]/g, ' ') + r, t, n, !1)
				o.sourceSpan = new vn(s, o.children[o.children.length - 1].sourceSpan.end)
				const a = o.children[0]
				return a.length === i ? o.children.shift() : ((a.sourceSpan = new vn(a.sourceSpan.start.moveBy(i), a.sourceSpan.end)), (a.value = a.value.slice(i))), o
			}
		return l.map(e => {
			if ('comment' === e.type) {
				const t = In(e, p)
	...
	function Gn({
		...
		return {
			parse: (o, a, u) => Un(o, u, { recognizeSelfClosing: e, normalizeTagName: t, normalizeAttributeName: n, allowHtmComponentClosingTags: r, isTagNameCaseSensitive: s, getTagContentType: i }),
			hasPragma: Ln,
			astFormat: 'html',
			locStart: qn,
			locEnd: $n,
	...
	return {
		parsers: {
			html: Gn({ recognizeSelfClosing: !0, normalizeTagName: !0, normalizeAttributeName: !0, allowHtmComponentClosingTags: !0 }),
			angular: Gn(),
			vue: Gn({
				recognizeSelfClosing: !0,
				isTagNameCaseSensitive: !0,
				getTagContentType: (e, t, n, r) => {
					if ('html' !== e.toLowerCase() && !n && ('template' !== e || r.some(({ name: e, value: t }) => 'lang' === e && 'html' !== t))) return An.TagContentType.RAW_TEXT
				},
			}),
			lwc: Gn(),
		},
