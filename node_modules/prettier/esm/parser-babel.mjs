...
class K {
	...
	compareMain(t) {
		return t instanceof K || (t = new K(t, this.options)), X(this.major, t.major) || X(this.minor, t.minor) || X(this.patch, t.patch)
	}
	comparePre(t) {
...
const { outdent: ot } = tt,
	ut = {
		cursorOffset: { since: '1.4.0', category: 'Special', type: 'int', default: -1, range: { start: -1, end: 1 / 0, step: 1 }, description: ot(at()), cliCategory: 'Editor' },
		endOfLine: {
			since: '1.15.0',
			category: 'Global',
			type: 'choice',
		...
		rangeEnd: { since: '1.4.0', category: 'Special', type: 'int', default: 1 / 0, range: { start: 0, end: 1 / 0, step: 1 }, description: ot(rt()), cliCategory: 'Editor' },
		rangeStart: { since: '1.4.0', category: 'Special', type: 'int', default: 0, range: { start: 0, end: 1 / 0, step: 1 }, description: ot(st()), cliCategory: 'Editor' },
		requirePragma: { since: '1.7.0', category: 'Special', type: 'boolean', default: !1, description: ot(et()), cliCategory: 'Other' },
...
var lt = {
	getSupportInfo: function ({ plugins: t = [], showUnreleased: e = !1, showDeprecated: s = !1, showInternal: r = !1 } = {}) {
		const i = ct.split('-', 1)[0],
			...
			a = ((o = Object.assign({}, ...t.map(({ options: t }) => t), pt)), (u = 'name'), Object.entries(o).map(([t, e]) => Object.assign({ [u]: t }, e)))
				.filter(t => h(t) && c(t))
				...
				.map(e => {
					;(e = Object.assign({}, e)),
						Array.isArray(e.default) && (e.default = 1 === e.default.length ? e.default[0].value : e.default.filter(h).sort((t, e) => ht.compare(e.since, t.since))[0].value),
		...
		function c(t) {
			return s || !('deprecated' in t) || (t.deprecated && ht.lt(i, t.deprecated))
		}
	},
}
const { getSupportInfo: dt } = lt,
	Dt = /[^\x20-\x7F]/
function mt(t) {
	return (e, s, r) => {
...
function xt(t, e) {
	return !1 !== e && ('/' === t.charAt(e) && '/' === t.charAt(e + 1) ? At(t, e) : e)
}
function Ft(t, e, s) {
...
function Pt(t, e) {
	let s = null,
		r = e
	for (; r !== s; ) (s = r), (r = yt(t, r)), (r = Ct(t, r)), (r = xt(t, r)), (r = Ft(t, r))
	return r
}
function Tt(t, e, s) {
	return Pt(t, s(e))
...
var It = {
		...
		isPreviousLineEmpty: function (t, e, s) {
			let r = s(e) - 1
			return (r = yt(t, r, { backwards: !0 })), (r = Ft(t, r, { backwards: !0 })), (r = yt(t, r, { backwards: !0 })), r !== Ft(t, r, { backwards: !0 })
		},
		hasNewline: gt,
		...
		printString: function (t, e, s) {
			const r = t.slice(1, -1),
				...
				n = 'json' === e.parser ? '"' : e.__isInHtmlAttribute ? "'" : Bt(t, e.singleQuote ? "'" : '"')
			return s ? (i ? n + r + n : t) : St(r, n, !('css' === e.parser || 'less' === e.parser || 'scss' === e.parser || e.embeddedInHtml))
		},
	...
	vt = Object.freeze({ __proto__: null, default: { EOL: '\n', platform: () => 'browser', cpus: () => [{ model: 'Prettier' }] } })
const kt = t => {
	if ('string' != typeof t) throw new TypeError('Expected a string')
	const e = t.match(/(?:\r?\n)/g) || []
...
var Wt = {
	...
	insertPragma: function (t) {
		const { shebang: e, text: s, pragmas: r, comments: i } = Ht(t),
			n = jt(s),
			a = qt({ pragmas: Object.assign({ format: '' }, r), comments: i.trimStart() })
		return (e ? ''.concat(e, '\n') : '') + zt(a) + (n.startsWith('\n') ? '\n' : '\n\n') + n
	},
}
function Gt(t, e) {
...
const Zt = R(function (t, e) {
		;(e.ast = $t), (e.code = Yt), (e.keyword = Qt)
	}).keyword.isIdentifierNameES5,
	{ getLast: te, hasNewline: ee, hasNewlineInRange: se, skipWhitespace: re } = It,
...
const le = new Set(['ExportDefaultDeclaration', 'ExportDefaultSpecifier', 'DeclareExportDeclaration', 'ExportNamedDeclaration', 'ExportAllDeclaration'])
function de(t) {
...
const Fe = new Set(['BinaryExpression', 'LogicalExpression', 'NGPipeExpression'])
const ge = new Set([
	'AnyTypeAnnotation',
	'TSAnyKeyword',
...
function je(t) {
	...
	const e = []
	return t.this && e.push(t.this), Array.isArray(t.parameters) ? e.push(...t.parameters) : Array.isArray(t.params) && e.push(...t.params), t.rest && e.push(t.rest), _e.set(t, e), e
}
...
function Ve(t) {
	return t && ((t.comments && t.comments.length > 0 && t.comments.some(t => qe(t) && !t.unignore)) || t.prettierIgnore)
}
function ze(t) {
...
var He = {
	...
	hasFlowShorthandAnnotationComment: function (t) {
		return t.extra && t.extra.parenthesized && t.trailingComments && pe(t.trailingComments[0]) && oe.test(t.trailingComments[0].value)
	},
	...
	hasNewlineBetweenOrAfterDecorators: function (t, e) {
		return se(e.originalText, ie(t.decorators[0]), ne(te(t.decorators))) || ee(e.originalText, ne(te(t.decorators)))
	},
	hasNgSideEffect: function (t) {
		return he(t.getValue(), t => {
			switch (t.type) {
				case void 0:
					return !1
				case 'CallExpression':
	...
	hasPrettierIgnore: function (t) {
		return (
			...
			(function (t) {
				...
				return r && 'JSXExpressionContainer' === r.type && 'JSXEmptyExpression' === r.expression.type && r.expression.comments && r.expression.comments.some(t => qe(t))
			})(t)
		)
	},
	...
	isJSXWhitespaceExpression: function (t) {
		return 'JSXExpressionContainer' === t.type && De(t.expression) && ' ' === t.expression.value && !t.expression.comments
	},
	...
	isLongCurriedCallExpression: function (t) {
		const e = t.getValue(),
			s = t.getParentNode()
		return Pe(e) && Pe(s) && s.callee === e && e.arguments.length > s.arguments.length && s.arguments.length > 0
	},
	...
	isObjectTypePropertyAFunction: function (t) {
		return !(('ObjectTypeProperty' !== t.type && 'ObjectTypeInternalSlot' !== t.type) || 'FunctionTypeAnnotation' !== t.value.type || t.static || xe(t))
	},
	isSimpleType: function (t) {
		return !!t && (!(('GenericTypeAnnotation' !== t.type && 'TSTypeReference' !== t.type) || t.typeParameters) || !!ge.has(t.type))
	},
	isSimpleNumber: Ne,
	...
	isStringPropSafeToUnquote: function (t, e) {
		return (
			...
			((Zt(t.key.value) && !(('typescript' === e.parser || 'babel-ts' === e.parser) && 'ClassProperty' === t.type)) ||
				(Ne(t.key.value) && String(Number(t.key.value)) === t.key.value && ('babel' === e.parser || 'espree' === e.parser || 'meriyah' === e.parser)))
		)
	},
	isTemplateOnItsOwnLine: function (t, e) {
		return (('TemplateLiteral' === t.type && Ie(t)) || ('TaggedTemplateExpression' === t.type && Ie(t.quasi))) && !ee(e, ie(t), { backwards: !0 })
	},
	isTestCall: function t(e, s) {
		if ('CallExpression' !== e.type) return !1
		if (1 === e.arguments.length) {
			if (Ee(e) && s && t(s)) return ye(e.arguments[0])
			if ('Identifier' === (r = e).callee.type && /^(before|after)(Each|All)$/.test(r.callee.name) && 1 === r.arguments.length) return Ee(e.arguments[0])
		} else if (
			...
			return (
				!(e.arguments[2] && !me(e.arguments[2])) &&
	...
	isTypeAnnotationAFunction: function (t) {
		return !(('TypeAnnotation' !== t.type && 'TSTypeAnnotation' !== t.type) || 'FunctionTypeAnnotation' !== t.typeAnnotation.type || t.static || ae(t, t.typeAnnotation))
	},
	...
	returnArgumentHasLeadingComment: function (t, e) {
		...
		if (ce(e)) {
			let r,
				i = e
			for (; (r = (s = i).expressions ? s.expressions[0] : s.left || s.test || s.callee || s.object || s.tag || s.argument || s.expression); ) if (((i = r), Se(t.originalText, i))) return !0
		}
		var s
		return !1
	},
	...
	shouldFlatten: function (t, e) {
		return Re(e) === Re(t) && '**' !== t && (!ke[t] || !ke[e]) && !(('%' === e && Le[t]) || ('%' === t && Le[e])) && (e === t || !Le[e] || !Le[t]) && (!Oe[t] || !Oe[e])
	},
...
const {
	...
	{ isBlockComment: ts, getFunctionParameters: es, isPrettierIgnoreComment: ss, isJSXNode: rs, hasFlowShorthandAnnotationComment: is, hasFlowAnnotationComment: ns, hasIgnoreComment: as } = He,
...
function ls(t, e) {
	...
	return ')' === Ke(e, t, us) ? (Ye(s, t), !0) : 'BlockStatement' === i.type ? (hs(i, t), !0) : r.body === i && ($e(i, t), !0)
}
function ds(t) {
...
function Ds(t) {
	...
	if (
		...
		if (s.decorators && s.decorators.length > 0 && (!r || 'Decorator' !== r.type)) return Ye(s.decorators[s.decorators.length - 1], t), !0
		if (s.body && r === s.body) return hs(s.body, t), !0
		if (r) for (const i of ['implements', 'extends', 'mixins']) if (s[i] && r === s[i][0]) return !e || (e !== s.id && e !== s.typeParameters && e !== s.superClass) ? Qe(s, t, i) : Ye(e, t), !0
	}
	return !1
}
function ms(t, e) {
	...
	return (
		((r && s && ('Property' === r.type || 'TSDeclareMethod' === r.type || 'TSAbstractMethodDefinition' === r.type) && 'Identifier' === s.type && r.key === s && ':' !== Ke(e, s, us)) ||
			!(
				!s ||
				!r ||
				'Decorator' !== s.type ||
...
function fs(t, e) {
	const { precedingNode: s, enclosingNode: r, followingNode: i } = t
	if (s && 'FunctionTypeParam' === s.type && r && 'FunctionTypeAnnotation' === r.type && i && 'FunctionTypeParam' !== i.type) return Ye(s, t), !0
	if (s && ('Identifier' === s.type || 'AssignmentPattern' === s.type) && r && xs(r) && ')' === Ke(e, t, us)) return Ye(s, t), !0
...
function As(t, e, s) {
	...
	return e && e.body && 0 === e.body.length
		? (s ? Qe(e, t) : $e(e, t), !0)
		: !(!r || 'Program' !== r.type || 0 !== r.body.length || !r.directives || 0 !== r.directives.length) && (s ? Qe(r, t) : $e(r, t), !0)
}
function Cs(t) {
	const { enclosingNode: e, followingNode: s } = t
	if (ss(t) && e && 'TSMappedType' === e.type && s && 'TSTypeParameter' === s.type && s.constraint) return (e.prettierIgnore = !0), (t.unignore = !0), !0
}
function xs(t) {
	return (
...
var gs = {
	handleOwnLineComment: function (t, e, s, r, i) {
		return (
			...
			(function (t) {
				const { enclosingNode: e, followingNode: s } = t
				if (e && ('MemberExpression' === e.type || 'OptionalMemberExpression' === e.type) && s && 'Identifier' === s.type) return $e(e, t), !0
				return !1
			})(t) ||
			ps(t, e) ||
			ls(t, e) ||
			...
			(function (t) {
				const { enclosingNode: e } = t
				if (e && ('ForInStatement' === e.type || 'ForOfStatement' === e.type)) return $e(e, t), !0
				return !1
			})(t) ||
			(function (t) {
				const { precedingNode: e, enclosingNode: s, followingNode: r } = t
				if (s && ('UnionTypeAnnotation' === s.type || 'TSUnionType' === s.type)) return ss(t) && ((r.prettierIgnore = !0), (t.unignore = !0)), !!e && (Ye(e, t), !0)
				r && ('UnionTypeAnnotation' === r.type || 'TSUnionType' === r.type) && ss(t) && ((r.types[0].prettierIgnore = !0), (t.unignore = !0))
				return !1
			})(t) ||
			As(t, r, i) ||
			(function (t, e) {
				const { precedingNode: s, enclosingNode: r } = t
				if (s && 'ImportSpecifier' === s.type && r && 'ImportDeclaration' === r.type && Ge(e, us(t))) return Ye(s, t), !0
				return !1
			})(t, e) ||
			(function (t) {
				const { enclosingNode: e } = t
				if (e && 'AssignmentPattern' === e.type) return $e(e, t), !0
				return !1
			})(t) ||
			ms(t, e) ||
			Es(t)
	...
	handleEndOfLineComment: function (t, e, s, r, i) {
		return (
			...
			(function (t, e) {
				const { precedingNode: s, enclosingNode: r, followingNode: i } = t,
					n = s && !Je(e, us(s), os(t))
				if ((!s || !n) && r && ('ConditionalExpression' === r.type || 'TSConditionalType' === r.type) && i) return $e(i, t), !0
				return !1
			})(t, e) ||
			ys(t) ||
			ps(t, e) ||
			...
			(function (t) {
				...
				if (s && ('CallExpression' === s.type || 'OptionalCallExpression' === s.type) && e && s.callee === e && s.arguments.length > 0) return $e(s.arguments[0], t), !0
				return !1
			})(t) ||
			(function (t) {
				const { enclosingNode: e } = t
				if (e && ('Property' === e.type || 'ObjectProperty' === e.type)) return $e(e, t), !0
				return !1
			})(t) ||
			As(t, r, i) ||
			(function (t) {
			...
			(function (t) {
				...
				if (
					...
					s &&
					('ObjectExpression' === s.type || 'ArrayExpression' === s.type || 'TemplateLiteral' === s.type || 'TaggedTemplateExpression' === s.type || ts(t))
				)
					return $e(s, t), !0
				return !1
			})(t)
	...
	handleRemainingComment: function (t, e, s, r, i) {
		return !!(
			...
			(function (t) {
				const { precedingNode: e, enclosingNode: s } = t
				if (s && ('ObjectProperty' === s.type || 'Property' === s.type) && s.shorthand && s.key === e && 'AssignmentPattern' === s.value.type) return Ye(s.value.left, t), !0
				return !1
			})(t) ||
			(function (t, e) {
				if (')' !== Ke(e, t, us)) return !1
				const { enclosingNode: s } = t
				if (s && ((xs(s) && 0 === es(s).length) || (('CallExpression' === s.type || 'OptionalCallExpression' === s.type || 'NewExpression' === s.type) && 0 === s.arguments.length)))
					return Qe(s, t), !0
				if (s && 'MethodDefinition' === s.type && 0 === es(s.value).length) return Qe(s.value, t), !0
				return !1
			})(t, e) ||
			ms(t, e) ||
			As(t, r, i) ||
			...
			(function (t) {
				...
				if (e && 'TSTypeParameter' === e.type && e.constraint) return Ye(e.constraint, t), !0
				return !1
			})(t) ||
			(function (t) {
				const { enclosingNode: e } = t
				if (e && ('ContinueStatement' === e.type || 'BreakStatement' === e.type) && !e.label) return Ye(e, t), !0
				return !1
			})(t) ||
			(function (t, e) {
				const { enclosingNode: s, followingNode: r } = t
				if (!r && s && ('TSMethodSignature' === s.type || 'TSDeclareFunction' === s.type || 'TSAbstractMethodDefinition' === s.type) && ';' === Ke(e, t, us)) return Ye(s, t), !0
				return !1
			})(t, e)
		)
	},
	...
	willPrintOwnComments: function (t) {
		const e = t.getValue(),
			s = t.getParentNode()
		return (
			((e && (rs(e) || is(e) || (s && ('CallExpression' === s.type || 'OptionalCallExpression' === s.type) && (ns(e.leadingComments) || ns(e.trailingComments))))) ||
				(s &&
...
const { getLast: bs, getNextNonSpaceNonCommentCharacter: Ps, getShebang: Ts } = It,
...
function Ls(t) {
	return ks(t)
		? Ls({
				...
				operator: t.operator,
				left: Ls({ type: 'LogicalExpression', operator: t.operator, left: t.left, right: t.right.left, range: ws(t.left, t.right.left) }),
				right: t.right.right,
				range: ws(t),
		  })
		: t
		...
		return (e = vs(e, t => {
			switch (t.type) {
				...
				case 'TSTypeParameter':
					'string' == typeof t.name && (t.name = { type: 'Identifier', name: t.name, range: ws(t, t.name.length) })
					break
				case 'SequenceExpression': {
				...
				case 'ClassProperty':
					t.key && 'TSPrivateIdentifier' === t.key.type && '?' === Ps(s.originalText, t.key, Ss) && (t.optional = !0)
			}
		}))
	},
	Ms = R(function (t, e) {
		...
		class P {
			constructor(t, e, s, r) {
				;(this.token = void 0), (this.isExpr = void 0), (this.preserveSpace = void 0), (this.override = void 0), (this.token = t), (this.isExpr = !!e), (this.preserveSpace = !!s), (this.override = r)
			}
		}
		const T = {
		...
		const G = /^in(stanceof)?$/
		const X = new Set(['_', 'any', 'bool', 'boolean', 'empty', 'extends', 'false', 'interface', 'mixed', 'null', 'number', 'static', 'string', 'true', 'typeof', 'void']),
			K = Object.freeze({
				...
				jsx: t =>
					class extends t {
						...
						jsxParseIdentifier() {
							...
							return (
								this.match(c.jsxName) ? (t.name = this.state.value) : this.state.type.keyword ? (t.name = this.state.type.keyword) : this.unexpected(), this.next(), this.finishNode(t, 'JSXIdentifier')
							)
						}
				...
				flow: t =>
					class extends t {
						...
						checkReservedType(t, e, s) {
							X.has(t) && this.raise(e, s ? K.AssignReservedType : K.UnexpectedReservedType, t)
						}
							...
							for (e && this.match(c.braceBarL) ? (this.expect(c.braceBarL), (o = c.braceBarR), (u = !0)) : (this.expect(c.braceL), (o = c.braceR), (u = !1)), a.exact = u; !this.match(o); ) {
								...
								if (this.eat(c.bracketL))
									null != n && this.unexpected(n),
										this.eat(c.bracketL) ? (l && this.unexpected(l.start), a.internalSlots.push(this.flowParseObjectTypeInternalSlot(p, e))) : a.indexers.push(this.flowParseObjectTypeIndexer(p, e, l))
				...
				typescript: t =>
					class extends t {
						...
						tsNextTokenCanFollowModifier() {
							return (
								this.next(), !(this.hasPrecedingLineBreak() || this.match(c.parenL) || this.match(c.parenR) || this.match(c.colon) || this.match(c.eq) || this.match(c.question) || this.match(c.bang))
							)
						}
						tsParseModifier(t) {
						...
						tsParseBindingListForSignature() {
							return this.parseBindingList(c.parenR, 41).map(
								t => (
									'Identifier' !== t.type && 'RestElement' !== t.type && 'ObjectPattern' !== t.type && 'ArrayPattern' !== t.type && this.raise(t.start, dt.UnsupportedSignatureParameterKind, t.type), t
								)
							)
						}
						...
						tsParseEnumMember() {
							const t = this.startNode()
							return (
								(t.id = this.match(c.string) ? this.parseExprAtom() : this.parseIdentifier(!0)), this.eat(c.eq) && (t.initializer = this.parseMaybeAssignAllowIn()), this.finishNode(t, 'TSEnumMember')
							)
						}
		...
		class jt extends class extends class extends class extends class extends class extends class extends class extends class extends class {
			...
			parseSubscript(t, e, s, r, i) {
				...
				return !r && this.match(c.parenL) ? this.parseCoverCallAndAsyncArrowHead(t, e, s, i, n) : n || this.match(c.bracketL) || this.eat(c.dot) ? this.parseMember(t, e, s, i, n) : ((i.stop = !0), t)
			}
			...
			parsePropertyDefinition(t, e) {
				...
				if (!t && !a && !h && this.maybeAsyncOrAccessorProp(r)) {
					...
					'async' !== t || this.hasPrecedingLineBreak() || ((o = !0), (a = this.eat(c.star)), this.parsePropertyName(r, !1)),
						('get' !== t && 'set' !== t) || ((u = !0), (r.kind = t), this.match(c.star) && ((a = !0), this.raise(this.state.pos, g.AccessorIsGenerator, t), this.next()), this.parsePropertyName(r, !1))
				}
			...
			stmtToDirective(t) {
				...
				return this.addExtra(s, 'raw', i), this.addExtra(s, 'rawValue', n), (r.value = this.finishNodeAt(s, 'DirectiveLiteral', e.end, e.loc.end)), this.finishNodeAt(r, 'Directive', t.end, t.loc.end)
			}
...
const { getNextNonSpaceNonCommentCharacterIndexWithStartIndex: Rs, getShebang: _s } = It,
	{ hasPragma: js } = Wt,
...
const Ys = { parse: Hs, astFormat: 'estree', hasPragma: js, locStart: Us, locEnd: qs },
