...
const { outdent: Ce } = De,
	Te = {
		cursorOffset: { since: '1.4.0', category: 'Special', type: 'int', default: -1, range: { start: -1, end: 1 / 0, step: 1 }, description: Ce(Ee()), cliCategory: 'Editor' },
		endOfLine: {
			since: '1.15.0',
			category: 'Global',
			type: 'choice',
		...
		rangeEnd: { since: '1.4.0', category: 'Special', type: 'int', default: 1 / 0, range: { start: 0, end: 1 / 0, step: 1 }, description: Ce(fe()), cliCategory: 'Editor' },
		rangeStart: { since: '1.4.0', category: 'Special', type: 'int', default: 0, range: { start: 0, end: 1 / 0, step: 1 }, description: Ce(de()), cliCategory: 'Editor' },
		requirePragma: { since: '1.7.0', category: 'Special', type: 'boolean', default: !1, description: Ce(he()), cliCategory: 'Other' },
...
var be = {
	getSupportInfo: function ({ plugins: e = [], showUnreleased: t = !1, showDeprecated: n = !1, showInternal: r = !1 } = {}) {
		const s = Se.split('-', 1)[0],
			...
			o = ((e, t) => Object.entries(e).map(([e, n]) => Object.assign({ [t]: e }, n)))(Object.assign({}, ...e.map(({ options: e }) => e), _e), 'name')
				.filter(e => a(e) && u(e))
				...
				.map(t => {
					;(t = Object.assign({}, t)),
						Array.isArray(t.default) && (t.default = 1 === t.default.length ? t.default[0].value : t.default.filter(a).sort((e, t) => ye.compare(t.since, e.since))[0].value),
		...
		function u(e) {
			return n || !('deprecated' in e) || (e.deprecated && ye.lt(s, e.deprecated))
		}
	},
}
const { getSupportInfo: Fe } = be,
	Ae = /[^\x20-\x7F]/
function ve(e) {
	return (t, n, r) => {
...
function Ie(e, t) {
	let n = null,
		r = t
	for (; r !== n; ) (n = r), (r = ke(e, r)), (r = Oe(e, r)), (r = Re(e, r)), (r = Le(e, r))
	return r
}
function qe(e, t, n) {
	return Ie(e, n(t))
...
var Ve = {
	...
	isPreviousLineEmpty: function (e, t, n) {
		let r = n(t) - 1
		return (r = ke(e, r, { backwards: !0 })), (r = Le(e, r, { backwards: !0 })), (r = ke(e, r, { backwards: !0 })), r !== Le(e, r, { backwards: !0 })
	},
	hasNewline: Pe,
	...
	printString: function (e, t, n) {
		const r = e.slice(1, -1),
			...
			i = 'json' === t.parser ? '"' : t.__isInHtmlAttribute ? "'" : Me(e, t.singleQuote ? "'" : '"')
		return n ? (s ? i + r + i : e) : Ue(r, i, !('css' === t.parser || 'less' === t.parser || 'scss' === t.parser || t.embeddedInHtml))
	},
...
function Ze(e, t, n) {
	...
	return Ke(e, { type: 'string' == typeof t ? 'stringAlign' : 'numberAlign', n: t }, n)
}
function Ke(e, t, n) {
		...
		if ('string' == typeof c) a.push(c), (n -= He(c))
			...
			switch (c.type) {
				...
				case 'group':
					...
					o.push([e, c.break ? 1 : u, c.contents]), c.id && (Ye[c.id] = o[o.length - 1][1])
					break
				case 'fill':
					for (let t = c.parts.length - 1; t >= 0; t--) o.push([e, u, c.parts[t]])
					break
			...
			if ('string' == typeof l) {
				...
				switch (l.type) {
						...
						switch (c) {
							...
							case 1: {
								...
								const r = [e, 2, l.contents],
									o = n - s
								if (!l.break && tt(r, i, o, t)) i.push(r)
					...
					case 'fill': {
						...
						const m = [e, c, We(o)],
							g = o[0]
						tt([e, 2, ze([a, u, g])], [], r, t, !0) ? (i.push(m), i.push(d), i.push(p)) : h ? (i.push(m), i.push(f), i.push(p)) : (i.push(m), i.push(f), i.push(D))
						break
					}
					case 'if-break': {
					...
					case 'line':
						switch (c) {
							...
							case 1:
								...
								l.literal ? (e.root ? (o.push(r, e.root.value), (s = e.root.length)) : (o.push(r), (s = 0))) : ((s -= et(o)), o.push(r + e.value), (s = e.length))
						}
				}
...
const { literalline: rt, concat: st } = f,
	it = {}
function ot(e, t, n, r) {
	const s = [e]
	for (; 0 !== s.length; ) {
...
function dt(e) {
	...
	return 'if-break' === e.type
		? Object.assign({}, e, { breakContents: null != e.breakContents ? dt(e.breakContents) : null, flatContents: null != e.flatContents ? dt(e.flatContents) : null })
		: 'group' === e.type
		? Object.assign({}, e, { contents: dt(e.contents), expandedStates: e.expandedStates ? e.expandedStates.map(dt) : e.expandedStates })
		: e.contents
...
function ft(e) {
	...
	if ('if-break' === e.type) return 'ifBreak(' + ft(e.breakContents) + (e.flatContents ? ', ' + ft(e.flatContents) : '') + ')'
	if ('group' === e.type) return e.expandedStates ? 'conditionalGroup([' + e.expandedStates.map(ft).join(',') + '])' : (e.break ? 'wrappedGroup' : 'group') + '(' + ft(e.contents) + ')'
...
var mt = {
	...
	utils: {
		...
		normalizeDoc: function (e) {
			return at(e, e => (e.parts ? Object.assign({}, e, { parts: ht(e.parts) }) : e))
		},
		replaceNewlinesWithLiterallines: function (e) {
			return at(e, e => ('string' == typeof e && e.includes('\n') ? st(e.split(/(\n)/g).map((e, t) => (t % 2 == 0 ? e : rt))) : e))
		},
	},
	debug: { printDocToDebug: e => ft(dt(e)) },
}
const {
		builders: { hardline: gt, concat: Et, markAsRoot: Ct },
	} = mt,
	Tt = { '---': 'yaml', '+++': 'toml' }
var yt = {
	parse: function (e) {
...
const { inferParserByLanguage: bt, isFrontMatterNode: Ft } = Ve,
	{ CSS_DISPLAY_TAGS: At, CSS_DISPLAY_DEFAULT: vt, CSS_WHITE_SPACE_TAGS: wt, CSS_WHITE_SPACE_DEFAULT: kt } = {
		CSS_DISPLAY_TAGS: {
			area: 'none',
			base: 'none',
			basefont: 'none',
...
function It(e) {
	return 'element' === e.type && ('script' === e.fullName || 'style' === e.fullName || 'svg:style' === e.fullName || (Wt(e) && ('script' === e.name || 'style' === e.name)))
}
function qt(e) {
...
var en = {
	...
	forceBreakContent: function (e) {
		return (
			...
			(e.firstChild && e.firstChild === e.lastChild && 'text' !== e.firstChild.type && Gt(e.firstChild) && (!e.lastChild.isTrailingSpaceSensitive || Vt(e.lastChild)))
		)
	},
	...
	getNodeCssStyleDisplay: function (e, t) {
		...
		switch (t.htmlWhitespaceSensitivity) {
			...
			case 'ignore':
				return 'block'
			default:
				return 'vue' === t.parser && e.parent && 'root' === e.parent.type ? 'block' : ('element' === e.type && (!e.namespace || n || Wt(e)) && At[e.name]) || vt
		}
	},
	...
	isLeadingSpaceSensitiveNode: function (e, t) {
		const n = (function () {
			...
			if (!e.prev && ('root' === e.parent.type || (zt(e) && e.parent) || It(e.parent) || Jt(e.parent, t) || ((n = e.parent.cssDisplay), Xt(n) || 'inline-block' === n))) return !1
			var n
			if (
				e.prev &&
				!(function (e) {
		...
		return (
			...
			(!(('text' !== e.type && 'interpolation' !== e.type) || !e.next || ('text' !== e.next.type && 'interpolation' !== e.next.type)) ||
				(!(!e.parent || 'none' === e.parent.cssDisplay) &&
					(!!zt(e.parent) ||
						(!(!e.next && ('root' === e.parent.type || (zt(e) && e.parent) || It(e.parent) || Jt(e.parent, t) || ((n = e.parent.cssDisplay), Xt(n) || 'inline-block' === n))) &&
							!(
								e.next &&
								!(function (e) {
									return !Xt(e)
		...
		t !== this[e] &&
			((this[e] = (function (e, t) {
				...
				let r = null,
					s = n[0],
					i = n[1] || null
				for (let e = 0; e < n.length; e++) on(s, { index: e, siblings: n, prev: r, next: i, parent: t }), (r = s), (s = i), (i = n[e + 2] || null)
				return n
			})(t, this)),
			'attrs' === e && on(this, { attrMap: this[e].reduce((e, t) => ((e[t.fullName] = t.value), e), Object.create(null)) }))
	}
	map(e) {
		let t = null
		for (const n in nn) {
...
var pn = {
	...
	hn = t(function (e, t) {
		...
		Object.defineProperty(t, '__esModule', { value: !0 })
		class n {
			constructor({ closedByChildren: e, implicitNamespacePrefix: t, contentType: n = Dn.TagContentType.PARSABLE_DATA, closedByParent: r = !1, isVoid: s = !1, ignoreFirstLf: i = !1 } = {}) {
				...
				return (
					s ||
						...
						(s = {
							...
							title: new n({ contentType: Dn.TagContentType.ESCAPABLE_RAW_TEXT }),
							textarea: new n({ contentType: Dn.TagContentType.ESCAPABLE_RAW_TEXT, ignoreFirstLf: !0 }),
						})),
					s[e] || r
				)
			})
	...
	gn = t(function (e, t) {
		...
		class n {
			...
			static fromArray(e) {
				return e ? (mn.assertInterpolationSymbols('interpolation', e), new n(e[0], e[1])) : t.DEFAULT_INTERPOLATION_CONFIG
			}
		}
		...
		class h {
			constructor(e, t, n) {
				;(this._getTagContentType = t),
					...
					(this._interpolationConfig = n.interpolationConfig || gn.DEFAULT_INTERPOLATION_CONFIG),
			...
			_consumeTagOpen(e) {
				...
				this._handleFullNameStackForTagOpen(n, t),
					c === Dn.TagContentType.RAW_TEXT ? this._consumeRawTextWithTagClose(n, t, !1) : c === Dn.TagContentType.ESCAPABLE_RAW_TEXT && this._consumeRawTextWithTagClose(n, t, !0)
			}
	...
	Cn = t(function (e, t) {
		...
		class s {
			...
			build() {
				for (; this._peek.type !== En.TokenType.EOF; )
					this._peek.type === En.TokenType.TAG_OPEN_START
						...
						: this._peek.type === En.TokenType.TEXT || this._peek.type === En.TokenType.RAW_TEXT || this._peek.type === En.TokenType.ESCAPABLE_RAW_TEXT
			...
			_consumeCdata(e) {
				...
				this._addToParent(new fn.CDATA(n, new o.ParseSourceSpan(e.sourceSpan.start, (r || t).sourceSpan.end)))
			}
			_consumeComment(e) {
			...
			_consumeExpansion(e) {
				...
				if (this._peek.type !== En.TokenType.EXPANSION_FORM_END) return void this._errors.push(n.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '}'."))
				const i = new o.ParseSourceSpan(e.sourceSpan.start, this._peek.sourceSpan.end)
				this._addToParent(new fn.Expansion(t.parts[0], r.parts[0], s, i, t.sourceSpan)), this._advance()
			}
			_parseExpansionCase() {
				const e = this._advance()
				if (this._peek.type !== En.TokenType.EXPANSION_CASE_EXP_START) return this._errors.push(n.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '{'.")), null
				const t = this._advance(),
				...
				return new fn.ExpansionCase(e.parts[0], a.rootNodes, u, e.sourceSpan, c)
			}
			_collectExpansionExpTokens(e) {
				const t = [],
					r = [En.TokenType.EXPANSION_CASE_EXP_START]
				for (;;) {
					if (
						((this._peek.type !== En.TokenType.EXPANSION_FORM_START && this._peek.type !== En.TokenType.EXPANSION_CASE_EXP_START) || r.push(this._peek.type),
						this._peek.type === En.TokenType.EXPANSION_CASE_EXP_END)
					) {
						if (!i(r, En.TokenType.EXPANSION_CASE_EXP_START)) return this._errors.push(n.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'.")), null
						if ((r.pop(), 0 == r.length)) return t
					}
					if (this._peek.type === En.TokenType.EXPANSION_FORM_END) {
						if (!i(r, En.TokenType.EXPANSION_FORM_START)) return this._errors.push(n.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'.")), null
						r.pop()
					}
					if (this._peek.type === En.TokenType.EOF) return this._errors.push(n.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'.")), null
			...
			_consumeStartTag(e) {
				const t = e.parts[0],
					r = e.parts[1],
					s = []
				for (; this._peek.type === En.TokenType.ATTR_NAME; ) s.push(this._consumeAttr(this._advance()))
			...
			_popElement(e) {
				for (let t = this._elementStack.length - 1; t >= 0; t--) {
					...
					if (!e || (Dn.getNsPrefix(n.name) ? n.name == e : n.name.toLowerCase() == e.toLowerCase())) return this._elementStack.splice(t, this._elementStack.length - t), !0
			...
			_consumeAttr(e) {
				...
				return new fn.Attribute(t, r, new o.ParseSourceSpan(e.sourceSpan.start, n), s, e.sourceSpan)
			}
			_getParentElement() {
			...
			_getParentElementSkippingContainers() {
				let e = null
				for (let t = this._elementStack.length - 1; t >= 0; t--) {
					if (!Dn.isNgContainer(this._elementStack[t].name)) return { parent: this._elementStack[t], container: e }
	...
	yn = t(function (e, t) {
		Object.defineProperty(t, '__esModule', { value: !0 }), (t.TagContentType = Dn.TagContentType)
		let n = null
		t.parse = function (e, t = {}) {
			const { canSelfClose: r = !1, allowHtmComponentClosingTags: s = !1, isTagNameCaseSensitive: i = !1, getTagContentType: o } = t
			return (n || (n = new Tn.HtmlParser()), n).parse(e, 'angular-html-parser', { tokenizeExpansionForms: !1, interpolationConfig: void 0, canSelfClose: r, allowHtmComponentClosingTags: s }, i, o)
		}
	})
...
function Pn(e, { recognizeSelfClosing: t, normalizeTagName: n, normalizeAttributeName: r, allowHtmComponentClosingTags: s, isTagNameCaseSensitive: i, getTagContentType: a }, u) {
	const c = yn,
		{ RecursiveVisitor: l, visitAll: p, Attribute: D, CDATA: h, Comment: d, DocType: f, Element: m, Text: g } = fn,
		{ ParseSourceSpan: E } = o,
	...
	if (0 !== y.length) {
		...
		throw St(e, { start: { line: t.line + 1, column: t.col + 1 }, end: { line: n.line + 1, column: n.col + 1 } })
	}
	const _ = e => {
					...
					;(e => {
						...
						(e => {
							if (e instanceof m) {
								...
								!e.namespace || e.namespace === t.implicitNamespacePrefix || kn(e) ? (e.tagDefinition = t) : (e.tagDefinition = C(''))
							}
						})(e),
						(e => {
							if (e instanceof m && (!n || (e.namespace && e.namespace !== e.tagDefinition.implicitNamespacePrefix && !kn(e)) || (e.name = b(e.name, e => e in wn)), r)) {
								const t = vn[e.name] || Object.create(null)
								e.attrs.forEach(n => {
									n.namespace || (n.name = b(n.name, n => e.name in vn && (n in vn['*'] || n in t)))
								})
							}
						})(e),
						(e => {
...
function Bn(e, t, n, r = !0) {
	const { frontMatter: s, content: i } = r ? Fn(e) : { frontMatter: null, content: e },
		o = new bn(e, t.filepath),
		a = new _n(o, 0, 0, 0),
		u = a.moveBy(e.length),
		c = { type: 'root', sourceSpan: new Sn(a, u), children: Pn(i, n, t) }
	if (s) {
		const e = new _n(o, 0, 0, 0),
	...
	const l = new xn(c),
		p = (r, s) => {
			...
			o.sourceSpan = new Sn(s, o.children[o.children.length - 1].sourceSpan.end)
			const a = o.children[0]
			return a.length === i ? o.children.shift() : ((a.sourceSpan = new Sn(a.sourceSpan.start.moveBy(i), a.sourceSpan.end)), (a.value = a.value.slice(i))), o
		}
	return l.map(e => {
		if ('comment' === e.type) {
			const t = On(e, p)
...
function In({
	...
	return {
		parse: (o, a, u) => Bn(o, u, { recognizeSelfClosing: e, normalizeTagName: t, normalizeAttributeName: n, allowHtmComponentClosingTags: r, isTagNameCaseSensitive: s, getTagContentType: i }),
		hasPragma: Nn,
		astFormat: 'html',
		locStart: Rn,
		locEnd: Ln,
...
var qn = {
	parsers: {
		html: In({ recognizeSelfClosing: !0, normalizeTagName: !0, normalizeAttributeName: !0, allowHtmComponentClosingTags: !0 }),
		angular: In(),
		vue: In({
			recognizeSelfClosing: !0,
			isTagNameCaseSensitive: !0,
			getTagContentType: (e, t, n, r) => {
				if ('html' !== e.toLowerCase() && !n && ('template' !== e || r.some(({ name: e, value: t }) => 'lang' === e && 'html' !== t))) return yn.TagContentType.RAW_TEXT
			},
		}),
		lwc: In(),
	},
