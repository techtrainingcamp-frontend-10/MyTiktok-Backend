!(function (e, t) {
	'object' == typeof exports && 'undefined' != typeof module
		...
		? define(t)
		: ((e = 'undefined' != typeof globalThis ? globalThis : e || self).prettier = t())
})(this, function () {
	'use strict'
	function e(e, t) {
		if (null == e) return {}
					...
					if (((t.lines = o), t.added || t.removed)) {
						...
						if (l)
							if (o.length <= 2 * i.context && e < a.length - 2) {
								...
								var C = { oldStart: l, oldLines: h - l + E, newStart: p, newLines: m - p + E, lines: f }
	...
	var J = Object.freeze({
		...
		diffWords: function (e, t, n) {
			return (n = a(n, { ignoreWhitespace: !0 })), l.diff(e, t, n)
		},
		...
		merge: function (e, t, n) {
			...
			for (var o = 0, u = 0, i = 0, a = 0; o < e.hunks.length || u < t.hunks.length; ) {
				...
				if (P(s, c)) r.hunks.push(O(s, i)), o++, (a += s.newLines - s.oldLines)
				else if (P(c, s)) r.hunks.push(O(c, a)), u++, (i += c.newLines - c.oldLines)
				else {
	...
	const { outdent: it } = Ze,
		...
		pt = 'Special',
		dt = {
			cursorOffset: { since: '1.4.0', category: pt, type: 'int', default: -1, range: { start: -1, end: 1 / 0, step: 1 }, description: it(ut()), cliCategory: st },
			endOfLine: {
				since: '1.15.0',
				category: lt,
				type: 'choice',
			...
			insertPragma: { since: '1.8.0', category: pt, type: 'boolean', default: !1, description: "Insert @format pragma into file's first docblock comment.", cliCategory: ct },
			parser: {
				since: '0.0.10',
				category: lt,
				type: 'choice',
			...
			printWidth: { since: '0.0.0', category: lt, type: 'int', default: 80, description: 'The line length where Prettier will try wrap.', range: { start: 0, end: 1 / 0, step: 1 } },
			rangeEnd: { since: '1.4.0', category: pt, type: 'int', default: 1 / 0, range: { start: 0, end: 1 / 0, step: 1 }, description: it(nt()), cliCategory: st },
			rangeStart: { since: '1.4.0', category: pt, type: 'int', default: 0, range: { start: 0, end: 1 / 0, step: 1 }, description: it(tt()), cliCategory: st },
			requirePragma: { since: '1.7.0', category: pt, type: 'boolean', default: !1, description: it(et()), cliCategory: ct },
			tabWidth: { type: 'int', category: lt, default: 2, description: 'Number of spaces per indentation level.', range: { start: 0, end: 1 / 0, step: 1 } },
			useTabs: { since: '1.0.0', category: lt, type: 'boolean', default: !1, description: 'Indent with tabs instead of spaces.' },
	...
	const ft = { compare: Ye, lt: Ke, gte: Qe },
		ht = n.version,
		mt = { CATEGORY_CONFIG: at, CATEGORY_EDITOR: st, CATEGORY_FORMAT: 'Format', CATEGORY_OTHER: ct, CATEGORY_OUTPUT: 'Output', CATEGORY_GLOBAL: lt, CATEGORY_SPECIAL: pt, options: dt }.options
	var gt = {
		getSupportInfo: function ({ plugins: t = [], showUnreleased: n = !1, showDeprecated: r = !1, showInternal: o = !1 } = {}) {
			const u = ht.split('-', 1)[0],
				...
				a = ((e, t) => Object.entries(e).map(([e, n]) => Object.assign({ [t]: e }, n)))(Object.assign({}, ...t.map(({ options: e }) => e), mt), 'name')
					.filter(e => s(e) && c(e))
					...
					.map(e => {
						;(e = Object.assign({}, e)),
							Array.isArray(e.default) && (e.default = 1 === e.default.length ? e.default[0].value : e.default.filter(s).sort((e, t) => ft.compare(t.since, e.since))[0].value),
							Array.isArray(e.choices) &&
								((e.choices = e.choices.filter(e => s(e) && c(e))),
								'parser' === e.name &&
									(function (e, t, n) {
	...
	var Lt = {
		inferParserByLanguage: function (e, t) {
			const { languages: n } = Dt({ plugins: t.plugins }),
				r =
					...
					n.find(({ extensions: t }) => Array.isArray(t) && t.includes('.'.concat(e)))
		...
		isPreviousLineEmpty: function (e, t, n) {
			let r = n(t) - 1
			return (r = bt(e, r, { backwards: !0 })), (r = St(e, r, { backwards: !0 })), (r = bt(e, r, { backwards: !0 })), r !== St(e, r, { backwards: !0 })
		},
		hasNewline: wt,
	...
	const { getStringWidth: jt } = Lt,
		{ convertEndOfLineToChars: _t } = Mt,
		{ concat: Rt, fill: Vt, cursor: $t } = Z
	let qt
	function Wt(e, t) {
		return Jt(e, { type: 'indent' }, t)
	}
	function Ut(e, t, n) {
		if (t === -1 / 0) return e.root || { value: '', length: 0, queue: [] }
		if (t < 0) return Jt(e, { type: 'dedent' }, n)
		if (!t) return e
		if ('root' === t.type) return Object.assign({}, e, { root: e })
		return Jt(e, { type: 'string' == typeof t ? 'stringAlign' : 'numberAlign', n: t }, n)
	}
	function Jt(e, t, n) {
	...
	function Ht(e, t, n, r, o) {
		...
		for (; n >= 0; ) {
			...
			const [e, s, c] = i.pop()
			if ('string' == typeof c) a.push(c), (n -= jt(c))
			else
				switch (c.type) {
					case 'concat':
	...
	const { literalline: Xt, concat: Yt } = Z,
		Kt = {}
	function Qt(e, t, n, r) {
		const o = [e]
		for (; 0 !== o.length; ) {
	...
	function an(e) {
		...
		return 'if-break' === e.type
			? Object.assign({}, e, { breakContents: null != e.breakContents ? an(e.breakContents) : null, flatContents: null != e.flatContents ? an(e.flatContents) : null })
			: 'group' === e.type
			? Object.assign({}, e, { contents: an(e.contents), expandedStates: e.expandedStates ? e.expandedStates.map(an) : e.expandedStates })
			: e.contents
			? Object.assign({}, e, { contents: an(e.contents) })
			: e
	}
	function sn(e) {
		...
		if ('align' === e.type)
			return e.n === -1 / 0
				? 'dedentToRoot(' + sn(e.contents) + ')'
				: e.n < 0
				? 'dedent(' + sn(e.contents) + ')'
				: 'root' === e.n.type
				? 'markAsRoot(' + sn(e.contents) + ')'
				: 'align(' + JSON.stringify(e.n) + ', ' + sn(e.contents) + ')'
	...
	var cn = {
		...
		utils: {
			...
			normalizeDoc: function (e) {
				return Zt(e, e => (e.parts ? Object.assign({}, e, { parts: un(e.parts) }) : e))
			},
	...
	function xn(e) {
		...
		return (
			1 === r
				? ((t = e[n - 1]), (o += En[t >> 2]), (o += En[(t << 4) & 63]), (o += '=='))
				: 2 === r && ((t = (e[n - 2] << 8) + e[n - 1]), (o += En[t >> 10]), (o += En[(t >> 4) & 63]), (o += En[(t << 2) & 63]), (o += '=')),
			u.push(o),
			u.join('')
		)
	}
			...
			t = Math.abs(t),
				isNaN(t) || t === 1 / 0
					...
					: ((i = Math.floor(Math.log(t) / Math.LN2)),
					  ...
					  i + p >= l ? ((a = 0), (i = l)) : i + p >= 1 ? ((a = (t * s - 1) * Math.pow(2, o)), (i += p)) : ((a = t * Math.pow(2, p - 1) * Math.pow(2, o)), (i = 0)));
			o >= 8;
	...
	function qn(e, t, n, r, o) {
		...
		if ('number' == typeof t)
			return (
				(t &= 255),
				Pn.TYPED_ARRAY_SUPPORT && 'function' == typeof Uint8Array.prototype.indexOf
					? o
				...
				switch (p) {
					...
					case 4:
						;(u = e[o + 1]),
							(i = e[o + 2]),
							(a = e[o + 3]),
							128 == (192 & u) && 128 == (192 & i) && 128 == (192 & a) && (s = ((15 & c) << 18) | ((63 & u) << 12) | ((63 & i) << 6) | (63 & a)) > 65535 && s < 1114112 && (l = s)
				}
	...
	;(Pn.TYPED_ARRAY_SUPPORT = void 0 === ce.TYPED_ARRAY_SUPPORT || ce.TYPED_ARRAY_SUPPORT),
		(Pn.poolSize = 8192),
		(Pn._augment = function (e) {
			return (e.__proto__ = Pn.prototype), e
		}),
		(Pn.from = function (e, t, n) {
			return On(null, e, t, n)
		}),
		Pn.TYPED_ARRAY_SUPPORT && ((Pn.prototype.__proto__ = Uint8Array.prototype), (Pn.__proto__ = Uint8Array)),
		(Pn.alloc = function (e, t, n) {
		...
		(Pn.byteLength = Rn),
		(Pn.prototype._isBuffer = !0),
		(Pn.prototype.swap16 = function () {
			var e = this.length
	...
	;(Pn.prototype.slice = function (e, t) {
		var n,
			r = this.length
		if (((e = ~~e) < 0 ? (e += r) < 0 && (e = 0) : e > r && (e = r), (t = void 0 === t ? r : ~~t) < 0 ? (t += r) < 0 && (t = 0) : t > r && (t = r), t < e && (t = e), Pn.TYPED_ARRAY_SUPPORT))
			(n = this.subarray(e, t)).__proto__ = Pn.prototype
		else {
			var o = t - e
			n = new Pn(o, void 0)
		...
		(Pn.prototype.writeUInt32LE = function (e, t, n) {
			return (
				(e = +e),
				(t |= 0),
				n || or(this, e, t, 4, 4294967295, 0),
				Pn.TYPED_ARRAY_SUPPORT ? ((this[t + 3] = e >>> 24), (this[t + 2] = e >>> 16), (this[t + 1] = e >>> 8), (this[t] = 255 & e)) : ir(this, e, t, !0),
				t + 4
			)
		}),
		(Pn.prototype.writeUInt32BE = function (e, t, n) {
			return (
				...
				(t |= 0),
				n || or(this, e, t, 4, 4294967295, 0),
				Pn.TYPED_ARRAY_SUPPORT ? ((this[t] = e >>> 24), (this[t + 1] = e >>> 16), (this[t + 2] = e >>> 8), (this[t + 3] = 255 & e)) : ir(this, e, t, !1),
				t + 4
			)
		}),
		...
		(Pn.prototype.writeInt32LE = function (e, t, n) {
			return (
				(e = +e),
				(t |= 0),
				n || or(this, e, t, 4, 2147483647, -2147483648),
				Pn.TYPED_ARRAY_SUPPORT ? ((this[t] = 255 & e), (this[t + 1] = e >>> 8), (this[t + 2] = e >>> 16), (this[t + 3] = e >>> 24)) : ir(this, e, t, !0),
				t + 4
			)
		}),
		...
		(Pn.prototype.copy = function (e, t, n, r) {
			...
			else if (u < 1e3 || !Pn.TYPED_ARRAY_SUPPORT) for (o = 0; o < u; ++o) e[o + t] = this[o + n]
	...
	function fr(e) {
		return (function (e) {
			...
			for (t = 0, n = 0; t < r; t += 4, n += 3)
				(o = (Cn[e.charCodeAt(t)] << 18) | (Cn[e.charCodeAt(t + 1)] << 12) | (Cn[e.charCodeAt(t + 2)] << 6) | Cn[e.charCodeAt(t + 3)]),
					(i[s++] = (o >> 16) & 255),
					(i[s++] = (o >> 8) & 255),
					(i[s++] = 255 & o)
			return (
				2 === u
					? ((o = (Cn[e.charCodeAt(t)] << 2) | (Cn[e.charCodeAt(t + 1)] >> 4)), (i[s++] = 255 & o))
					: 1 === u && ((o = (Cn[e.charCodeAt(t)] << 10) | (Cn[e.charCodeAt(t + 1)] << 4) | (Cn[e.charCodeAt(t + 2)] >> 2)), (i[s++] = (o >> 8) & 255), (i[s++] = 255 & o)),
				i
			)
		})(
			(function (e) {
	...
	var Dr = class {
		constructor(e, t) {
			;(t = t || {}).readChunk || (t.readChunk = 1024),
				...
				(this.fd = 'number' == typeof e ? e : gr.openSync(e, 'r')),
				(this.options = t),
		...
		_readChunk(e) {
			...
			let o = Pn.concat(r)
			return (
				t < this.options.readChunk && ((this.eofReached = !0), (o = o.slice(0, n))), n && ((this.linesCache = this._extractLines(o)), e && (this.linesCache[0] = Pn.concat([e, this.linesCache[0]]))), n
			)
		}
		next() {
			if (!this.fd) return !1
	...
	var vr = { ConfigError: Er, DebugError: Cr, UndefinedParserError: br },
		Ar = function (e, t) {
			return (Ar =
  ...
  ***************************************************************************** */ var Fr = function () {
	...
	var Tr = Object.freeze({
			...
			__asyncDelegator: function (e) {
				...
				function r(r, o) {
					t[r] = e[r]
						? function (t) {
								return (n = !n) ? { value: wr(e[r](t)), done: 'return' === r } : o ? o(t) : t
						  }
						: o
				}
			},
		...
		Nr = je(function (e, t) {
			Object.defineProperty(t, '__esModule', { value: !0 }), Tr.__exportStar(Br, t)
		}),
		kr = /[|\\{}()[\]^$+*?.]/g,
		Pr = function (e) {
			if ('string' != typeof e) throw new TypeError('Expected a string')
			...
			;(r.rgb.hsl = function (e) {
				...
				(r.rgb.hsv = function (e) {
					...
					return (
						0 === l
							? (o = u = 0)
							: ((u = l / c), (t = p(i)), (n = p(a)), (r = p(s)), i === c ? (o = r - n) : a === c ? (o = 1 / 3 + t - r) : s === c && (o = 2 / 3 + n - t), o < 0 ? (o += 1) : o > 1 && (o -= 1)),
						[360 * o, 100 * u, 100 * c]
					)
				}),
	...
	function Lr(e) {
		var t = (function () {
				for (var e = {}, t = Object.keys(Ir), n = t.length, r = 0; r < n; r++) e[t[r]] = { distance: -1, parent: null }
				return e
			})(),
			n = [e]
	...
	Object.keys(Ir).forEach(function (e) {
		;(_r[e] = {}), Object.defineProperty(_r[e], 'channels', { value: Ir[e].channels }), Object.defineProperty(_r[e], 'labels', { value: Ir[e].labels })
		var t = (function (e) {
	...
	$r('no-color') || $r('no-colors') || $r('color=false') ? (Ur = !1) : ($r('color') || $r('colors') || $r('color=true') || $r('color=always')) && (Ur = !0),
		'FORCE_COLOR' in Wr && (Ur = 0 === Wr.FORCE_COLOR.length || 0 !== parseInt(Wr.FORCE_COLOR, 10))
	...
	var no = (e, t) => {
			...
			let o = []
			if (
				(t.replace(Hr, (t, u, i, a, s, c) => {
					if (u) o.push(Qr(u))
					else if (a) {
						const t = o.join('')
						;(o = []), r.push(0 === n.length ? t : to(e, n)(t)), n.push({ inverse: i, styles: eo(a) })
					} else if (s) {
		...
		ro = je(function (e) {
			...
			for (const e of Object.keys(Vr))
				(Vr[e].closeRe = new RegExp(Pr(Vr[e].close), 'g')),
					(u[e] = {
						get() {
							const t = Vr[e]
			...
			for (const e of Object.keys(Vr.color.ansi))
				o.has(e) ||
					(u[e] = {
						get() {
							const t = this.level
							return function () {
								const n = Vr.color[r[t]][e].apply(null, arguments),
									o = { open: n, close: Vr.color.close, closeRe: Vr.color.closeRe }
					...
					get() {
						...
						return function () {
							const n = Vr.bgColor[r[t]][e].apply(null, arguments),
								o = { open: n, close: Vr.bgColor.close, closeRe: Vr.bgColor.closeRe }
							return c.call(this, this._styles ? this._styles.concat(o) : [o], this._empty, e)
						}
					},
				}
		...
		uo = je(function (e, t) {
			Object.defineProperty(t, '__esModule', { value: !0 }), Tr.__exportStar(oo, t)
		}),
		io = je(function (e, t) {
			Object.defineProperty(t, '__esModule', { value: !0 }),
				(t.commonInvalidHandler = (e, t, n) =>
					[
						'Invalid '.concat(ro.default.red(n.descriptor.key(e)), ' value.'),
						'Expected '.concat(ro.default.blue(n.schemas[e].expected(n)), ','),
						'but received '.concat(ro.default.red(n.descriptor.value(t)), '.'),
					].join(' '))
		}),
		ao = je(function (e, t) {
			Object.defineProperty(t, '__esModule', { value: !0 }), Tr.__exportStar(io, t)
		}),
		so = [],
		co = [],
		lo = je(function (e, t) {
			Object.defineProperty(t, '__esModule', { value: !0 }),
				(t.levenUnknownHandler = (e, t, { descriptor: n, logger: r, schemas: o }) => {
					const u = ['Ignored unknown option '.concat(ro.default.yellow(n.pair({ key: e, value: t })), '.')],
						i = Object.keys(o)
							.sort()
							.find(
								t =>
									(function (e, t) {
										...
										for (; p < o; )
											for (u = t.charCodeAt(c + p), a = p++, i = p, l = 0; l < r; l++) (s = u === co[c + l] ? a : a + 1), (a = so[l]), (i = so[l] = a > i ? (s > i ? i + 1 : s) : s > a ? a + 1 : s)
										return i
									})(e, t) < 3
							)
		...
		po = je(function (e, t) {
			Object.defineProperty(t, '__esModule', { value: !0 }), Tr.__exportStar(lo, t)
		}),
		fo = je(function (e, t) {
			Object.defineProperty(t, '__esModule', { value: !0 }), Tr.__exportStar(uo, t), Tr.__exportStar(ao, t), Tr.__exportStar(po, t)
		}),
		ho = je(function (e, t) {
			Object.defineProperty(t, '__esModule', { value: !0 })
		...
		Fo = je(function (e, t) {
			Object.defineProperty(t, '__esModule', { value: !0 }),
				Tr.__exportStar(mo, t),
				Tr.__exportStar(go, t),
				Tr.__exportStar(Do, t),
				Tr.__exportStar(yo, t),
				Tr.__exportStar(Co, t),
				Tr.__exportStar(vo, t),
				Tr.__exportStar(bo, t),
				Tr.__exportStar(Ao, t)
		}),
		xo = je(function (e, t) {
			Object.defineProperty(t, '__esModule', { value: !0 }),
				(t.defaultDescriptor = Br.apiDescriptor),
				(t.defaultUnknownHandler = lo.levenUnknownHandler),
				(t.defaultInvalidHandler = ao.commonInvalidHandler),
				(t.defaultDeprecatedHandler = oo.commonDeprecatedHandler)
		}),
		So = je(function (e, t) {
			...
			class n {
				...
				_applyNormalization(e, t) {
					...
					for (const o of r) {
						...
						for (const { from: e, to: t } of c.redirect) s({ value: e, redirectTo: t })
					}
					for (const r of o) {
						const o = e[r],
		...
		wo = je(function (e, t) {
			Object.defineProperty(t, '__esModule', { value: !0 }), Tr.__exportStar(Nr, t), Tr.__exportStar(fo, t), Tr.__exportStar(Fo, t), Tr.__exportStar(So, t), Tr.__exportStar(ho, t)
		})
	const To = [],
		Bo = [],
		No = (e, t) => {
	...
	for (const e of Object.keys(Lo)) {
		...
		delete Lo[e].channels, delete Lo[e].labels, Object.defineProperty(Lo[e], 'channels', { value: t }), Object.defineProperty(Lo[e], 'labels', { value: n })
	}
	function jo(e) {
		const t = (function () {
				const e = {},
	...
	;(Lo.rgb.hsl = function (e) {
		...
		const c = (o + u) / 2
		return (s = u === o ? 0 : c <= 0.5 ? i / (u + o) : i / (2 - u - o)), [a, 100 * s, 100 * c]
	}),
		...
		(Lo.gray.hsv = Lo.gray.hsl),
		(Lo.gray.hwb = function (e) {
			return [0, 100, e[0]]
		}),
	...
	Object.keys(Mo).forEach(e => {
		;(Vo[e] = {}), Object.defineProperty(Vo[e], 'channels', { value: Mo[e].channels }), Object.defineProperty(Vo[e], 'labels', { value: Mo[e].labels })
		const t = (function (e) {
			const t = jo(e),
				n = {},
				r = Object.keys(t)
	...
	Uo('no-color') || Uo('no-colors') || Uo('color=false') || Uo('color=never') ? (Ho = 0) : (Uo('color') || Uo('colors') || Uo('color=true') || Uo('color=always')) && (Ho = 1),
		'FORCE_COLOR' in zo && (Ho = 'true' === zo.FORCE_COLOR ? 1 : 'false' === zo.FORCE_COLOR ? 0 : 0 === zo.FORCE_COLOR.length ? 1 : Math.min(parseInt(zo.FORCE_COLOR, 10), 3))
	var Yo = {
	...
	var au = (e, t) => {
		...
		let o = []
		if (
			(t.replace(Qo, (t, u, i, a, s, c) => {
				if (u) o.push(ru(u))
				else if (a) {
					const t = o.join('')
					;(o = []), r.push(0 === n.length ? t : iu(e, n)(t)), n.push({ inverse: i, styles: uu(a) })
				} else if (s) {
					if (0 === n.length) throw new Error('Found extraneous } in Chalk template literal')
	...
	const { stdout: su, stderr: cu } = Yo,
		{ stringReplaceAll: lu, stringEncaseCRLFWithFirstIndex: pu } = Ko,
		{ isArray: du } = Array,
	...
	const gu = e => {
		...
		return (
			...
			(t.template = (...e) => Fu(t.template, ...e)),
			Object.setPrototypeOf(t, Du.prototype),
			Object.setPrototypeOf(t.template, t),
			(t.template.constructor = () => {
				throw new Error('`chalk.constructor()` is deprecated. Use `new chalk.Instance()` instead.')
			}),
			(t.template.Instance = mu),
			t.template
		)
	}
	function Du(e) {
	...
	for (const [e, t] of Object.entries(qo))
		hu[e] = {
			get() {
	...
	function ei(t, n, { logger: r, isCLI: o = !1, passThrough: u = !1 } = {}) {
		const i = u
				...
				: (t, n, r) => {
						...
						return wo.levenUnknownHandler(t, n, Object.assign({}, r, { schemas: o }))
				  },
			a = o ? Ku : wo.apiDescriptor,
			s = (function (e, { isCLI: t }) {
				const n = []
				t && n.push(wo.AnySchema.create({ name: '_' }))
				for (const r of e) n.push(ti(r, { isCLI: t, optionInfos: e })), r.alias && t && n.push(wo.AliasSchema.create({ name: r.alias, sourceName: r.name }))
				return n
			})(n, { isCLI: o }),
			c = new wo.Normalizer(s, { logger: r, unknown: i, descriptor: a }),
			l = !1 !== r
	...
	function ti(e, { isCLI: t, optionInfos: n }) {
		...
		switch (e.type) {
			...
			case 'string':
				...
				break
			case 'choice':
				;(r = wo.ChoiceSchema), (o.choices = e.choices.map(t => ('object' == typeof t && t.redirect ? Object.assign({}, t, { redirect: { to: { key: e.name, value: t.redirect } } }) : t)))
				break
			case 'boolean':
				r = wo.BooleanSchema
				break
		...
		return e.array ? wo.ArraySchema.create(Object.assign({}, t ? { preprocess: e => [].concat(e) } : {}, u, { valueSchema: r.create(o) })) : r.create(Object.assign({}, o, u))
	}
	var ni = {
		...
		normalizeCliOptions: function (e, t, n) {
			return ei(e, t, Object.assign({ isCLI: !0 }, n))
		},
	}
	function ri(e, t) {
	...
	var ii = {
		...
		ci = je(function (e, t) {
			Object.defineProperty(t, '__esModule', { value: !0 }),
				...
				(t.isStrictBindOnlyReservedWord = c),
	...
	function mi(e) {
		var t = (function () {
				for (var e = {}, t = Object.keys(hi), n = t.length, r = 0; r < n; r++) e[t[r]] = { distance: -1, parent: null }
				return e
			})(),
			n = [e]
		for (t[e].distance = 0; n.length; )
	...
	Object.keys(hi).forEach(function (e) {
		;(yi[e] = {}), Object.defineProperty(yi[e], 'channels', { value: hi[e].channels }), Object.defineProperty(yi[e], 'labels', { value: hi[e].labels })
		var t = (function (e) {
	...
	$r('no-color') || $r('no-colors') || $r('color=false') ? (vi = !1) : ($r('color') || $r('colors') || $r('color=true') || $r('color=always')) && (vi = !0),
		'FORCE_COLOR' in bi && (vi = 0 === bi.FORCE_COLOR.length || 0 !== parseInt(bi.FORCE_COLOR, 10))
	...
	var Ii = (e, t) => {
			...
			let o = []
			if (
				(t.replace(xi, (t, u, i, a, s, c) => {
					if (u) o.push(Ni(u))
					else if (a) {
						const t = o.join('')
						;(o = []), r.push(0 === n.length ? t : Oi(e, n)(t)), n.push({ inverse: i, styles: Pi(a) })
					} else if (s) {
						if (0 === n.length) throw new Error('Found extraneous } in Chalk template literal')
		...
		Li = je(function (e) {
			...
			for (const e of Object.keys(Ci))
				(Ci[e].closeRe = new RegExp(di(Ci[e].close), 'g')),
					(u[e] = {
						get() {
							const t = Ci[e]
							return c.call(this, this._styles ? this._styles.concat(t) : [t], this._empty, e)
			...
			for (const e of Object.keys(Ci.color.ansi))
				o.has(e) ||
					(u[e] = {
						get() {
							const t = this.level
							return function () {
								const n = Ci.color[r[t]][e].apply(null, arguments),
									o = { open: n, close: Ci.color.close, closeRe: Ci.color.closeRe }
								return c.call(this, this._styles ? this._styles.concat(o) : [o], this._empty, e)
							}
						},
					})
					...
					get() {
						...
						return function () {
							const n = Ci.bgColor[r[t]][e].apply(null, arguments),
								o = { open: n, close: Ci.bgColor.close, closeRe: Ci.bgColor.closeRe }
							return c.call(this, this._styles ? this._styles.concat(o) : [o], this._empty, e)
						}
					},
				}
		...
		Mi = je(function (e, t) {
			...
			var n,
				...
				o = (n = Li) && n.__esModule ? n : { default: n }
			function u() {
		...
		_i = _e(yn)
	const { ConfigError: Ri } = vr,
		{ locStart: Vi, locEnd: $i } = ii,
	...
	function Ji(e, t) {
		if (((t = t || Ui(e)), 'function' == typeof e.parser)) return { parse: e.parser, astFormat: 'estree', locStart: Vi, locEnd: $i }
	...
	const { UndefinedParserError: Hi } = vr,
		{ getSupportInfo: Gi } = gt,
		{ resolveParser: Xi } = zi,
		Yi = { astFormat: 'estree', printer: {}, originalText: void 0, locStart: null, locEnd: null }
	function Ki(e, t) {
		const n = _i.basename(e).toLowerCase(),
			r = Gi({ plugins: t }).languages.filter(e => null !== e.since)
	...
	var Qi = {
		normalize: function (e, t) {
			...
			const n = Object.assign({}, e),
				r = Gi({ plugins: e.plugins, showUnreleased: !0, showDeprecated: !0 }).options,
			...
			const u = Xi(ni.normalizeApiOptions(n, [r.find(e => 'parser' === e.name)], { passThrough: !0, logger: !1 }))
			...
			return (
				...
				ni.normalizeApiOptions(n, r, Object.assign({ passThrough: Object.keys(Yi) }, t))
			)
		},
		hiddenDefaults: Yi,
		inferParser: Ki,
	...
	const {
			builders: { concat: na, line: ra, hardline: oa, breakParent: ua, indent: ia, lineSuffix: aa, join: sa, cursor: ca },
		} = cn,
		{ hasNewline: la, skipNewline: pa, skipSpaces: da, isPreviousLineEmpty: fa, addLeadingComment: ha, addDanglingComment: ma, addTrailingComment: ga } = Lt,
		...
		const i =
			...
			('object' == typeof e &&
				Object.keys(e)
					...
					.map(t => e[t]))
		return i
			? (n || Object.defineProperty(e, Da, { value: (n = []), enumerable: !1 }),
			  i.forEach(e => {
					ya(e, t, n)
			  }),
			  n)
	...
	var Fa = {
		attach: function (e, t, n, r) {
			...
			e.forEach((a, s) => {
				...
				Ea(t, a, r)
				const { precedingNode: c, enclosingNode: l, followingNode: p } = a,
					...
					m = e.length - 1 === s
				if (la(n, u(a), { backwards: !0 })) d(a, n, r, t, m) || (p ? ha(p, a) : c ? ga(c, a) : ma(l || t, a))
				else if (la(n, i(a))) f(a, n, r, t, m) || (c ? ga(c, a) : p ? ha(p, a) : ma(l || t, a))
				else if (h(a, n, r, t, m));
				else if (c && p) {
					const e = o.length
					if (e > 0) {
					...
					if (r) {
						const r = (function (e, t) {
							...
							if (t.printer.isBlockComment && t.printer.isBlockComment(n)) {
								const e = la(t.originalText, t.locEnd(n)) ? (la(t.originalText, t.locStart(n), { backwards: !0 }) ? oa : ra) : ' '
								return na([r, e])
							}
							return na([r, oa])
						})(e, n)
		...
		printDanglingComments: function (e, t, n, r) {
			...
			return u && u.comments
				? (e.each(e => {
				  ...
				  0 === o.length ? '' : n ? sa(oa, o) : ia(na([oa, sa(oa, o)])))
				: ''
		},
	...
	const {
			utils: { stripTrailingHardline: Ta },
		} = cn,
		{ normalize: Ba } = Qi
	var Na = {
	...
	const ka = cn,
		Pa = ka.builders,
		{ concat: Oa, hardline: Ia, addAlignmentToDoc: La } = Pa,
		Ma = ka.utils
	function ja(e, t, n = 0) {
		const { printer: r } = t
	...
	const {
			printer: { printDocToString: Ja },
			debug: { printDocToDebug: za },
		} = cn,
		{ getAlignmentSize: Ha } = Lt,
		{ guessEndOfLine: Ga, convertEndOfLineToChars: Xa, countEndOfLineChars: Ya, normalizeEndOfLine: Ka } = Mt,
		Qa = Qi.normalize,
		Za = Symbol('cursor')
	function es(e, t, n) {
		const r = t.comments
	...
	function rs(e, t) {
		...
		return (n = ns(e, n, -1)), (r = ns(e, r, 0)), (o = ns(e, o, e.length)), Object.assign({}, t, { cursorOffset: n, rangeStart: r, rangeEnd: o })
	}
	function os(e, t) {
		...
		return { hasBOM: i, text: e, options: rs(e, Object.assign({}, t, { cursorOffset: n, rangeStart: r, rangeEnd: o, endOfLine: u })) }
	}
	function us(e, t) {
			...
			o.rangeStart > 0 || o.rangeEnd < r.length
				? (a = (function (e, t) {
						const { ast: n, text: r } = zi.parse(e, t),
							{ rangeStart: o, rangeEnd: u } = Ua.calculateRange(r, t, n),
							i = r.slice(o, u),
							a = Math.min(o, r.lastIndexOf('\n', o) + 1),
							s = r.slice(a, o).match(/^\s*/)[0],
							c = Ha(s, t.tabWidth),
							l = ts(i, Object.assign({}, t, { rangeStart: 0, rangeEnd: 1 / 0, cursorOffset: t.cursorOffset > o && t.cursorOffset < u ? t.cursorOffset - o : -1, endOfLine: 'lf' }), c),
				...
				: (!i && o.insertPragma && o.printer.insertPragma && (r = o.printer.insertPragma(r)), (a = ts(r, o))),
	...
	var is = {
		formatWithCursor: us,
		parse(e, t, n) {
			const { text: r, options: o } = os(e, Qa(t)),
				u = zi.parse(r, o)
		...
		formatDoc: (e, t) => us(za(e), Object.assign({}, t, { parser: 'babel' })).formatted,
		printToDoc(e, t) {
			t = Qa(t)
			const { ast: n, text: r } = zi.parse(e, t)
	...
	const Ls = je(function (e, t) {
		...
		{ getLast: Ms, hasNewline: js, hasNewlineInRange: _s, skipWhitespace: Rs } = Lt,
		{ locStart: Vs, locEnd: $s, hasSameLocStart: qs } = ii,
		Ws = '(?:(?=.)\\s)',
	...
	var wc = {
		...
		isStringPropSafeToUnquote: function (e, t) {
			return (
				'json' !== t.parser &&
				Zs(e.key) &&
				mc(e.key).slice(1, -1) === e.key.value &&
				((Ls(e.key.value) && !(('typescript' === t.parser || 'babel-ts' === t.parser) && 'ClassProperty' === e.type)) ||
					(fc(e.key.value) && String(Number(e.key.value)) === e.key.value && ('babel' === t.parser || 'espree' === t.parser || 'meriyah' === t.parser)))
			)
		},
		isTemplateOnItsOwnLine: function (e, t) {
			return (('TemplateLiteral' === e.type && hc(e)) || ('TaggedTemplateExpression' === e.type && hc(e.quasi))) && !js(t, Vs(e), { backwards: !0 })
		},
		isTestCall: function e(t, n) {
			...
			if (1 === t.arguments.length) {
				...
				(('Identifier' === t.callee.type && ac.test(t.callee.name)) ||
					(function (e) {
						return (
	...
	const {
		...
		{ isBlockComment: jc, getFunctionParameters: _c, isPrettierIgnoreComment: Rc, isJSXNode: Vc, hasFlowShorthandAnnotationComment: $c, hasFlowAnnotationComment: qc, hasIgnoreComment: Wc } = wc,
		{ locStart: Uc, locEnd: Jc } = ii
	function zc(e, t) {
	...
	function Gc(e, t) {
		...
		return ')' === kc(t, e, Jc)
			...
			? ('BlockStatement' === n.type ? Ic(n, e) : Lc(r, e), !0)
			: 'BlockStatement' === o.type
			? (zc(o, e), !0)
			: 'IfStatement' === o.type
			? (Hc(o.consequent, e), !0)
			: r.consequent === o && (Oc(o, e), !0)
	}
	function Xc(e, t) {
		const { precedingNode: n, enclosingNode: r, followingNode: o } = e
	...
	function Yc(e) {
		...
		return (
			...
			('CatchClause' === n.type && t
				...
				: 'TryStatement' === r.type
				? (Hc(r.finalizer, e), !0)
				: 'CatchClause' === r.type && (Hc(r.body, e), !0))
		)
	}
	function Kc(e) {
		const { precedingNode: t, enclosingNode: n, followingNode: r } = e
	...
	function Qc(e, t) {
		...
		return (
			((r && n && ('Property' === r.type || 'TSDeclareMethod' === r.type || 'TSAbstractMethodDefinition' === r.type) && 'Identifier' === n.type && r.key === n && ':' !== kc(t, n, Jc)) ||
				!(
					!n ||
					!r ||
					'Decorator' !== n.type ||
	...
	function nl(e, t, n) {
		...
		return t && t.body && 0 === t.body.length
			? (n ? Lc(t, e) : Oc(t, e), !0)
			: !(!r || 'Program' !== r.type || 0 !== r.body.length || !r.directives || 0 !== r.directives.length) && (n ? Lc(r, e) : Oc(r, e), !0)
	}
	function rl(e) {
	...
	var il = {
			...
			return (
				...
				(function (e) {
					...
					if (
						...
						n &&
						('ObjectExpression' === n.type || 'ArrayExpression' === n.type || 'TemplateLiteral' === n.type || 'TaggedTemplateExpression' === n.type || jc(e))
					)
						return Oc(n, e), !0
					return !1
				})(e)
		...
		handleRemainingComment: function (e, t, n, r, o) {
			return !!(
				...
				(function (e, t) {
					...
					if (n && ((ol(n) && 0 === _c(n).length) || (('CallExpression' === n.type || 'OptionalCallExpression' === n.type || 'NewExpression' === n.type) && 0 === n.arguments.length)))
						return Lc(n, e), !0
		...
		willPrintOwnComments: function (e) {
			const t = e.getValue(),
				n = e.getParentNode()
			return (
				((t && (Vc(t) || $c(t) || (n && ('CallExpression' === n.type || 'OptionalCallExpression' === n.type) && (qc(t.leadingComments) || qc(t.trailingComments))))) ||
					(n &&
				...
				(!Wc(e) || 'UnionTypeAnnotation' === n.type || 'TSUnionType' === n.type)
			)
		},
	}
	const { getStringWidth: al, getIndentSize: sl } = Lt,
		{
			builders: { concat: cl, join: ll, hardline: pl, softline: dl, group: fl, indent: hl, align: ml, lineSuffixBoundary: gl, addAlignmentToDoc: Dl },
			printer: { printDocToString: yl },
			utils: { mapDoc: El },
		} = cn,
		{ isBinaryish: Cl, isJestEachTemplateLiteral: bl, isSimpleTemplateLiteral: vl } = wc
	function Al(e) {
	...
	var Fl = {
		printTemplateLiteral: function (e, t, n) {
			...
			if ('TemplateLiteral' === r.type && bl(r, e.getParentNode())) {
				const r = (function (e, t, n) {
					...
					if (o.length > 1 || o.some(e => 0 !== e.length)) {
						...
						t.__inJestEach = !1
						const i = [],
							a = u.map(e => '${' + yl(e, Object.assign({}, t, { printWidth: 1 / 0, endOfLine: 'lf' })).formatted + '}'),
									...
									cl([
										...
										ll(
											...
											p.map(e =>
												ll(
													' | ',
													e.cells.map((t, n) => (e.hasLineBreak ? t : t + ' '.repeat(l[n] - al(t))))
												)
											)
										),
									])
			...
			const a = vl(r)
			return (
				a && (i = i.map(e => yl(e, Object.assign({}, n, { printWidth: 1 / 0 })).formatted)),
				u.push(gl, '`'),
				e.each(e => {
					const s = e.getName()
	...
	const {
			builders: { indent: xl, softline: Sl, literalline: wl, concat: Tl, dedentToRoot: Bl },
		} = cn,
		{ escapeTemplateCharacters: Nl } = Fl
	var kl = function (e, t, n) {
		...
		const i = Nl(n(r, { parser: 'markdown', __inJsTemplate: !0 }, { stripTrailingHardline: !0 }), !0)
		return Tl(['`', u ? xl(Tl([Sl, i])) : Tl([wl, Bl(i)]), Sl, '`'])
	}
	const {
			builders: { indent: Pl, hardline: Ol, softline: Il, concat: Ll },
			utils: { mapDoc: Ml, replaceNewlinesWithLiterallines: jl },
		} = cn,
		{ printTemplateExpressions: _l } = Fl
	...
	const {
			builders: { indent: Vl, join: $l, hardline: ql, concat: Wl },
		} = cn,
		{ escapeTemplateCharacters: Ul, printTemplateExpressions: Jl } = Fl
	function zl(e) {
		const t = []
		let n = !1
		return (
	...
	var Hl = function (e, t, n) {
		...
		for (let e = 0; e < o; e++) {
			...
			let m = null
			;(m = h ? zl(c) : n(s, { parser: 'graphql' }, { stripTrailingHardline: !0 })),
				m ? ((m = Ul(m, !1)), !t && d && i.push(''), i.push(m), !a && f && i.push('')) : t || a || !d || i.push(''),
				p && i.push(p)
		}
		return Wl(['`', Vl(Wl([ql, $l(ql, i)])), ql, '`'])
	}
	const {
			builders: { indent: Gl, line: Xl, hardline: Yl, concat: Kl, group: Ql },
			utils: { mapDoc: Zl },
		} = cn,
		{ printTemplateExpressions: ep, uncookTemplateElementValue: tp } = Fl
	let np = 0
	...
	const { isBlockComment: op } = wc,
		{ hasLeadingComment: up } = il
	function ip(e) {
		return (function (e) {
			const t = e.getValue(),
				n = e.getParentNode(),
					...
					case 'CallExpression':
						return (
							...
							('MemberExpression' === n.callee.type &&
								(('MemberExpression' === n.callee.object.type && (sp(n.callee.object.object) || cp(n.callee.object))) || ('CallExpression' === n.callee.object.type && sp(n.callee.object.callee))))
						)
					case 'Identifier':
						return 'css' === n.name
					default:
	...
	var pp = function (e, t, n, r) {
		...
		if (
			...
			return
		const u = ip(e)
		return u ? ('markdown' === u ? kl(e, t, n) : 'css' === u ? Rl(e, t, n) : 'graphql' === u ? Hl(e, t, n) : 'html' === u || 'angular' === u ? rp(e, t, n, r, { parser: u }) : void 0) : void 0
	}
	const { isBlockComment: dp } = wc,
	...
	function hp(e, t, n) {
		...
		if (
			...
			;((e.leadingComments && e.leadingComments.some(e => dp(e) && ['GraphQL', 'HTML'].some(t => e.value === ' '.concat(t, ' ')))) || ('CallExpression' === n.type && 'graphql' === n.callee.name)) &&
	...
	var yp = je(function (e, t) {
		...
		function r() {
			const e = (t = Dp) && t.__esModule ? t : { default: t }
			var t
			return (
				(r = function () {
					return e
	...
	const { parseWithComments: Ep, strip: Cp, extract: bp, print: vp } = yp,
		{ getShebang: Ap } = Lt,
		{ normalizeEndOfLine: Fp } = Mt
	function xp(e) {
		const t = Ap(e)
		t && (e = e.slice(t.length + 1))
		const n = bp(e),
			{ pragmas: r, comments: o } = Ep(n)
	...
	var Sp = {
		...
		insertPragma: function (e) {
			const { shebang: t, text: n, pragmas: r, comments: o } = xp(e),
				u = Cp(n),
				i = vp({ pragmas: Object.assign({ format: '' }, r), comments: o.trimStart() })
			return (t ? ''.concat(t, '\n') : '') + Fp(i) + (u.startsWith('\n') ? '\n' : '\n\n') + u
		},
	}
	const {
		...
		switch (o.type) {
			...
			case 'FunctionTypeAnnotation': {
				...
				return (
					...
					('FunctionTypeParam' === n.type && null === n.name && wp(o).some(e => e.typeAnnotation && 'NullableTypeAnnotation' === e.typeAnnotation.type))
				)
			}
			case 'StringLiteral':
			case 'NumericLiteral':
	...
	function _p(e, t) {
		...
		return 'FunctionExpression' === n.type || 'ClassExpression' === n.type
			? 'ExportDefaultDeclaration' === r.type || !Mp(e, t)
			: !(!Np(n) || ('ExportDefaultDeclaration' !== r.type && Mp(e, t))) && e.call(e => _p(e, t), ...Tp(e, n))
	}
	var Rp = Mp
	const {
		builders: { concat: Vp, join: $p, line: qp, group: Wp, softline: Up, indent: Jp },
	} = cn
	var zp = {
		...
		printHtmlBinding: function (e, t, n) {
			...
			if ((t.__onHtmlBindingRoot && null === e.getName() && t.__onHtmlBindingRoot(r, t), 'File' === r.type))
				return t.__isVueForBindingLeft
					...
					: t.__isVueBindings
					? e.call(e => $p(Vp([',', qp]), e.map(n, 'params')), 'program', 'body', 0)
					: void 0
		},
	}
	var Hp = function (e, t) {
	...
	const {
			builders: { concat: Gp, group: Xp, indent: Yp, join: Kp, line: Qp, hardline: Zp },
		} = cn,
		{ hasNewlineBetweenOrAfterDecorators: ed, getParentExportDeclaration: td } = wc
	var nd = {
	...
	const {
			builders: { concat: rd, softline: od, group: ud, indent: id, join: ad, line: sd, ifBreak: cd, hardline: ld },
		} = cn,
		{ printDanglingComments: pd } = Fa,
		{ hasDanglingComments: dd, shouldPrintComma: fd, needsHardlineAfterDanglingComment: hd } = wc,
		{ locStart: md, hasSameLoc: gd } = ii
	function Dd(e, t, n) {
		const r = e.getValue()
		if (!r.source) return ''
		const o = []
		...
		if (r.specifiers && r.specifiers.length > 0) {
			...
			if (
				...
				i.length > 1 || u.length > 0 || r.specifiers.some(e => e.comments)
					? o.push(ud(rd(['{', id(rd([t.bracketSpacing ? sd : od, ad(rd([',', sd]), i)])), cd(fd(t) ? ',' : ''), t.bracketSpacing ? sd : od, '}'])))
					: o.push(rd(['{', t.bracketSpacing ? ' ' : '', rd(i), t.bracketSpacing ? ' ' : '', '}']))
			}
		} else o.push('{}')
		return rd(o)
	}
	...
	var bd = {
		...
		printExportDeclaration: function (e, t, n) {
			...
			return (
				...
				dd(r) && (o.push(' ', pd(e, t, !0)), hd(r) && o.push(ld)),
				a ? o.push(' ', e.call(n, 'declaration')) : o.push('type' === i ? ' type' : '', yd(e, t, n), Dd(e, t, n), Cd(e, t, n)),
				(function (e, t) {
					if (!t.semi) return !1
		...
		printModuleSpecifier: function (e, t, n) {
			...
			let l = '',
				p = ''
			return (
				'ExportNamespaceSpecifier' === o || 'ImportNamespaceSpecifier' === o ? (l = '*') : r[s] && (l = e.call(n, s)),
				!r[c] || (r[s] && gd(r[s], r[c])) || (p = e.call(n, c)),
				i.push(l, l && p ? ' as ' : '', p),
				rd(i)
			)
		},
	}
	const { hasNewlineInRange: vd } = Lt,
		{ isJSXNode: Ad, isBlockComment: Fd } = wc,
		{ locStart: xd, locEnd: Sd } = ii,
		{
			builders: { concat: wd, line: Td, softline: Bd, group: Nd, indent: kd, align: Pd, ifBreak: Od, dedent: Id, breakParent: Ld },
		} = cn
	var Md = function (e, t, n, r) {
		...
		if (
			r.shouldCheckJsx &&
			(Ad(o[r.testNodePropertyNames[0]]) ||
				Ad(u) ||
				Ad(i) ||
				(function (e) {
					return (function (e) {
			...
			const s = wd([
				Td,
				'? ',
				u.type === r.conditionalNodeType ? Od('', '(') : '',
				Pd(2, e.call(n, r.consequentNodePropertyName)),
				u.type === r.conditionalNodeType ? Od('', ')') : '',
				Td,
				': ',
				i.type === r.conditionalNodeType ? e.call(n, r.alternateNodePropertyName) : Pd(2, e.call(n, r.alternateNodePropertyName)),
			])
			a.push(c.type !== r.conditionalNodeType || c[r.alternateNodePropertyName] === o || l ? s : t.useTabs ? Id(kd(s)) : Pd(Math.max(0, t.tabWidth - 2), s))
		}
		const D = Yu([...r.testNodePropertyNames.map(e => o[e].comments), u.comments, i.comments])
				.filter(Boolean)
				.some(e => Fd(e) && vd(t.originalText, xd(e), Sd(e))),
			y = !s && ('MemberExpression' === c.type || 'OptionalMemberExpression' === c.type || ('NGPipeExpression' === c.type && c.left === o)) && !c.computed,
			E = (e => (c === m ? Nd(e, { shouldBreak: D }) : D ? wd([e, Ld]) : e))(
	...
	const { getNextNonSpaceNonCommentCharacter: jd, isNextLineEmpty: _d } = Lt,
		{ printDanglingComments: Rd } = Fa,
		{
			builders: { concat: Vd, line: $d, hardline: qd, softline: Wd, group: Ud, indent: Jd, ifBreak: zd },
			utils: { removeLines: Hd },
		} = cn,
		{
		...
		{ locEnd: rf } = ii,
		{ printFunctionTypeParameters: of } = nd
	function uf(e) {
		if (!e) return !1
		const t = Gd(e)
		...
		printFunctionParameters: function (e, t, n, r, o) {
			...
			return (l && f) || c
				...
				: (ef(s) ||
				  ...
				  Yd(i[0].typeAnnotation) &&
				  !u.rest
				? 'always' === n.arrowParens
					? Vd(['(', Vd(d), ')'])
					: Vd(d)
				: Vd([a, '(', Jd(Vd([Wd, Vd(d)])), zd(!tf(u) && nf(n, 'all') ? ',' : ''), Wd, ')'])
		},
	...
	const {
		...
		{ isFlowAnnotationComment: cf, isSimpleType: lf, isObjectType: pf } = wc
	var df = {
	...
	const { printDanglingComments: ff } = Fa,
		{
			builders: { concat: hf, line: mf, softline: gf, group: Df, indent: yf, ifBreak: Ef },
		} = cn,
		{ getLast: Cf, isNextLineEmpty: bf } = Lt,
		{ hasDanglingComments: vf, shouldPrintComma: Af } = wc,
		{ locEnd: Ff } = ii,
		{ printOptionalToken: xf } = nd,
		{ printTypeAnnotation: Sf } = df
	function wf(e, t, n, r) {
		const o = []
		let u = []
		return (
	...
	var Tf = {
		printArray: function (e, t, n) {
			...
			if (0 === r.elements.length) vf(r) ? o.push(Df(hf([u, ff(e, t), gf, ']']))) : o.push(u, ']')
			else {
				...
				o.push(Df(hf([u, yf(hf([gf, wf(e, t, 'elements', n)])), s ? ',' : '', Ef(a && !s && Af(t) ? ',' : ''), ff(e, t, !0), gf, ']']), { shouldBreak: c }))
			}
			return o.push(xf(e), Sf(e, t, n)), hf(o)
		},
		printArrayItems: wf,
	}
	const { printDanglingComments: Bf } = Fa,
		{
			builders: { concat: Nf, line: kf, softline: Pf, group: Of, indent: If, ifBreak: Lf, hardline: Mf },
		} = cn,
		{ getLast: jf, isNextLineEmpty: _f, hasNewlineInRange: Rf, hasNewline: Vf } = Lt,
		{ hasDanglingComments: $f, shouldPrintComma: qf, hasNodeIgnoreComment: Wf, isBlockComment: Uf } = wc,
		{ locStart: Jf, locEnd: zf } = ii,
		{ printOptionalToken: Hf } = nd,
		{ shouldHugFunctionParameters: Gf } = af,
		{ printTypeAnnotation: Xf, shouldHugType: Yf } = df
	var Kf = {
		printObject: function (e, t, n) {
			...
			a.forEach(t => {
				e.each(e => {
					const t = e.getValue()
					m.push({ node: t, printed: n(e), loc: Jf(t) })
				}, t)
			})
			let g = []
			const D = m
				...
				.map(e => {
					...
					return (
						(g = [d, kf]),
						('TSPropertySignature' !== e.node.type && 'TSMethodSignature' !== e.node.type && 'TSConstructSignatureDeclaration' !== e.node.type) || !Wf(e.node) || g.shift(),
						_f(t.originalText, e.node, zf) && g.push(Mf),
						n
					)
				})
			if (o.inexact) {
			...
			const y = jf(o[u]),
				E = !(
					...
					(y && ('TSPropertySignature' === y.type || 'TSCallSignatureDeclaration' === y.type || 'TSMethodSignature' === y.type || 'TSConstructSignatureDeclaration' === y.type) && Wf(y))
				)
			let C
			if (0 === D.length) {
			...
			return e.match(
				...
				(e, t, n) => Gf(e) && ('params' === t || 'parameters' === t || 'this' === t || 'rest' === t) && 0 === n
			) ||
				e.match(
					Yf,
	...
	const { printComments: Qf, printDanglingComments: Zf } = Fa,
		{
			builders: { concat: eh, line: th, hardline: nh, softline: rh, group: oh, indent: uh, conditionalGroup: ih, fill: ah, ifBreak: sh, lineSuffixBoundary: ch },
			utils: { willBreak: lh, isLineNext: ph, isEmpty: dh },
		} = cn,
		{ getLast: fh, getPreferredQuote: hh } = Lt,
		{
	...
	function Th(e, t, n) {
		...
		if (
			...
			return eh([o, eh(e.map(n, 'children')), u])
		r.children = r.children.map(e => (Dh(e) ? { type: 'JSXText', value: ' ', raw: ' ' } : e))
		...
		const D = m ? ah(g) : oh(eh(g), { shouldBreak: !0 })
		if (l) return D
	...
	var Ph = {
		printJsxElement: function (e, t, n) {
			...
			return (function (e, t, n) {
				...
				const o = e.match(
					...
					u = Rp(e, n)
				return oh(eh([u ? '' : sh('('), uh(eh([rh, t])), rh, u ? '' : sh(')')]), { shouldBreak: o })
			})(e, r, t)
		},
		...
		printJsxOpeningElement: function (e, t, n) {
			...
			if (
				...
				Fh(r.attributes[0].value) &&
				!r.attributes[0].value.value.includes('\n') &&
				!o &&
				(!r.attributes[0].comments || !r.attributes[0].comments.length)
			)
				return oh(eh(['<', e.call(n, 'name'), e.call(n, 'typeParameters'), ' ', eh(e.map(n, 'attributes')), r.selfClosing ? ' />' : '>']))
			...
			return oh(
				eh(['<', e.call(n, 'name'), e.call(n, 'typeParameters'), eh([uh(eh(e.map(e => eh([th, n(e)]), 'attributes'))), r.selfClosing ? th : i ? '>' : rh]), r.selfClosing ? '/>' : i ? '' : '>']),
				{ shouldBreak: a }
			)
		},
				...
				i =
					...
					(!u &&
						('ArrayExpression' === r.expression.type ||
							...
							(yh(o) && ('ConditionalExpression' === r.expression.type || xh(r.expression)))))
	...
	const { printDanglingComments: Oh } = Fa,
		{
			builders: { concat: Ih, join: Lh, line: Mh, hardline: jh, softline: _h, group: Rh, indent: Vh, ifBreak: $h },
		} = cn,
		{ hasDanglingComments: qh, isTestCall: Wh, isBlockComment: Uh, shouldPrintComma: Jh } = wc,
		{ shouldHugType: zh } = df,
		Hh = new WeakMap()
	function Gh(e) {
	...
	var Yh = {
		printTypeParameters: function (e, t, n, r) {
			...
			return (null != u && Wh(u)) ||
				0 === o[r].length ||
				(1 === o[r].length &&
					(zh(o[r][0]) || ('GenericTypeAnnotation' === o[r][0].type && zh(o[r][0].id)) || ('TSTypeReference' === o[r][0].type && zh(o[r][0].typeName)) || 'NullableTypeAnnotation' === o[r][0].type))
				? Ih(['<', Lh(', ', e.map(n, r)), Xh(e, t), '>'])
				: Rh(Ih(['<', Vh(Ih([_h, Lh(Ih([',', Mh]), e.map(n, r))])), $h('typescript' !== t.parser && 'babel-ts' !== t.parser && Jh(t, 'all') ? ',' : ''), _h, '>']), { id: Gh(o) })
		},
		getTypeParametersGroupId: Gh,
	}
	const { printComments: Kh } = Fa,
		{ printString: Qh, printNumber: Zh } = Lt,
		{
			builders: { concat: em },
		} = cn,
		{ isNumericLiteral: tm, isSimpleNumber: nm, isStringLiteral: rm, isStringPropSafeToUnquote: om, rawText: um } = wc,
		im = new WeakMap()
	var am = {
		printPropertyKey: function (e, t, n) {
			...
			if (
				('Identifier' === u.type || (tm(u) && nm(Zh(um(u))) && String(u.value) === Zh(um(u)) && 'typescript' !== t.parser && 'babel-ts' !== t.parser)) &&
				('json' === t.parser || ('consistent' === t.quoteProps && im.get(o)))
			) {
				const n = Qh(JSON.stringify('Identifier' === u.type ? u.name : u.value.toString()), t)
				return e.call(e => Kh(e, () => n, t), 'key')
			}
			return om(r, t) && ('as-needed' === t.quoteProps || ('consistent' === t.quoteProps && !im.get(o)))
				? e.call(e => Kh(e, () => (/^\d/.test(u.value) ? Zh(u.value) : u.value), t), 'key')
				: e.call(n, 'key')
		},
	}
	const { printDanglingComments: sm } = Fa,
		{ getNextNonSpaceNonCommentCharacterIndex: cm } = Lt,
		{
			builders: { concat: lm, line: pm, softline: dm, group: fm, indent: hm, ifBreak: mm, hardline: gm },
		} = cn,
		{
		...
		{ locEnd: Tm } = ii,
		{ printFunctionParameters: Bm } = af,
		{ printPropertyKey: Nm } = am,
		{ printFunctionTypeParameters: km } = nd
	function Pm(e, t, n) {
	...
	var Lm = {
		printFunctionDeclaration: function (e, t, n, r) {
			...
			return (
				...
				u.push(km(e, n, t), fm(lm([Bm(e, t, n, r), Im(e, t, n)])), o.body ? ' ' : '', e.call(t, 'body')),
				lm(u)
			)
		},
		...
		printMethod: function (e, t, n) {
			const r = e.getNode(),
				...
				i = []
			return (
				o && 'init' !== o && 'method' !== o && 'constructor' !== o ? (ta.ok('get' === o || 'set' === o), i.push(o, ' ')) : u.async && i.push('async '),
				u.generator && i.push('*'),
				i.push(Nm(e, t, n), r.optional || r.key.optional ? '?' : '', r === u ? Pm(e, t, n) : e.call(e => Pm(e, t, n), 'value')),
				lm(i)
			)
		},
		printReturnAndThrowArgument: function (e, t, n) {
			...
			r.argument &&
				(xm(t, r.argument)
					? u.push(lm([' (', hm(lm([gm, e.call(n, 'argument')])), gm, ')']))
					: Sm(r.argument) || 'SequenceExpression' === r.argument.type
					? u.push(fm(lm([mm(' (', ' '), hm(lm([dm, e.call(n, 'argument')])), dm, mm(')')])))
	...
	const { printComments: Mm, printDanglingComments: jm } = Fa,
		{
			builders: { concat: _m, join: Rm, line: Vm, hardline: $m, softline: qm, group: Wm, indent: Um, ifBreak: Jm },
		} = cn,
		{ hasTrailingComment: zm, hasTrailingLineComment: Hm } = wc,
		{ getTypeParametersGroupId: Gm } = Yh,
		{ printMethod: Xm } = Lm,
		{ printDecorators: Ym } = nd
	function Km(e) {
		return (
			e.typeParameters &&
			!Hm(e.typeParameters) &&
	...
	function Qm(e, t, n, r) {
		...
		return _m([Km(o) ? Jm(' ', Vm, { groupId: Gm(o.typeParameters) }) : Vm, u, u && $m, r, Wm(Um(_m([Vm, Rm(_m([',', Vm]), e.map(n, r))])))])
	}
	function Zm(e, t, n) {
	...
	var eg = {
		...
		printClassMethod: function (e, t, n) {
			const r = e.getValue(),
				o = []
			return (
				r.decorators && 0 !== r.decorators.length && o.push(Ym(e, t, n)),
	...
	const { getLast: tg, getPenultimate: ng, isNextLineEmpty: rg } = Lt,
		{
		...
		{ locEnd: hg } = ii,
		{
			builders: { concat: mg, line: gg, hardline: Dg, softline: yg, group: Eg, indent: Cg, conditionalGroup: bg, ifBreak: vg, breakParent: Ag },
			utils: { willBreak: Fg },
		} = cn
	function xg(e) {
		return (
			...
			('TSTypeAssertion' === e.type && xg(e.expression)) ||
			('TSAsExpression' === e.type && xg(e.expression)) ||
			'FunctionExpression' === e.type ||
			('ArrowFunctionExpression' === e.type &&
	...
	var Sg = function (e, t, n) {
		...
		if (2 === u.length && 'ArrowFunctionExpression' === u[0].type && 0 === og(u[0]).length && 'BlockStatement' === u[0].body.type && 'ArrayExpression' === u[1].type && !u.some(e => e.comments))
		...
		fg(e, (e, r) => {
			const o = e.getNode(),
				u = [n(e)]
			r === c || (rg(t.originalText, o, hg) ? (0 === r && (s = !0), (i = !0), u.push(',', Dg, Dg)) : u.push(',', gg)),
				(a = (function (e, t) {
		...
		function d() {
			return Eg(mg(['(', Cg(mg([gg, mg(l)])), p, gg, ')']), { shouldBreak: !0 })
		}
		...
		if (f || h) {
			...
			let o = []
			fg(e, (e, t) => {
				f && 0 === t && (o = [mg([e.call(e => n(e, { expandFirstArg: !0 })), l.length > 1 ? ',' : '', s ? Dg : gg, s ? Dg : ''])].concat(l.slice(1))),
					h && t === u.length - 1 && (o = l.slice(0, -1).concat(e.call(e => n(e, { expandLastArg: !0 }))))
			})
			const c = l.some(Fg),
				p = mg(['(', mg(o), ')'])
			return mg([
				...
				bg(
					[
						c || r.typeArguments || r.typeParameters ? vg(d(), p) : p,
						mg(f ? ['(', Eg(o[0], { shouldBreak: !0 }), mg(o.slice(1)), ')'] : ['(', mg(l.slice(0, -1)), Eg(tg(o), { shouldBreak: !0 }), ')']),
						d(),
					],
					{ shouldBreak: t }
				),
		...
		return lg(e) ? m : Eg(m, { shouldBreak: l.some(Fg) || i })
	}
	const {
			builders: { concat: wg, softline: Tg, group: Bg, indent: Ng },
		} = cn,
		{ isNumericLiteral: kg } = wc,
		{ printOptionalToken: Pg } = nd
	function Og(e, t, n) {
	...
	const { getLast: Lg, isNextLineEmpty: Mg, isNextLineEmptyAfterIndex: jg, getNextNonSpaceNonCommentCharacterIndex: _g } = Lt,
		{
		...
		{ locEnd: Hg } = ii,
		{
			builders: { concat: Gg, join: Xg, hardline: Yg, group: Kg, indent: Qg, conditionalGroup: Zg, breakParent: eD },
			utils: { willBreak: tD },
		} = cn,
		{ printMemberLookup: nD } = Ig,
		{ printOptionalToken: rD, printFunctionTypeParameters: oD, printBindExpressionCallee: uD } = nd
	var iD = function (e, t, n) {
		...
		function a(e) {
			const r = e.getValue()
			$g(r) && (Ug(r.callee) || $g(r.callee))
				? (u.unshift({ node: r, printed: Gg([Fa.printComments(e, () => Gg([rD(e), oD(e, t, n), Sg(e, t, n)]), t), i(r) ? Yg : '']) }), e.call(e => a(e), 'callee'))
				: Ug(r)
				? (u.unshift({ node: r, needsParens: Rp(e, t), printed: Fa.printComments(e, () => ('OptionalMemberExpression' === r.type || 'MemberExpression' === r.type ? nD(e, t, n) : uD(e, t, n)), t) }),
				  e.call(e => a(e), 'object'))
				: 'TSNonNullExpression' === r.type
				? (u.unshift({ node: r, printed: Fa.printComments(e, () => '!', t) }), e.call(e => a(e), 'expression'))
				: u.unshift({ node: r, printed: e.call(n) })
		}
		const s = e.getValue()
		u.unshift({ node: s, printed: Gg([rD(e), oD(e, t, n), Sg(e, t, n)]) }), s.callee && e.call(e => a(e), 'callee')
		const c = []
		let l = [u[0]],
			p = 1
		for (
			...
			('TSNonNullExpression' === u[p].node.type ||
				$g(u[p].node) ||
				(('MemberExpression' === u[p].node.type || 'OptionalMemberExpression' === u[p].node.type) && u[p].node.computed && Jg(u[p].node.property)));
			++p
		)
			l.push(u[p])
		...
		const b = Lg(c[h ? 1 : 0]).node,
			...
			A = Gg([
				m(c[0]),
				h ? Gg(c.slice(1, 2).map(m)) : '',
				v ? Yg : '',
				(function (e) {
					return 0 === e.length ? '' : Qg(Kg(Gg([Yg, Xg(Yg, e.map(m))])))
				})(c.slice(h ? 2 : 1)),
			]),
			F = u.map(({ node: e }) => e).filter($g)
		return C ||
			(F.length > 2 && F.some(e => !e.arguments.every(e => zg(e, 0)))) ||
			g.slice(0, -1).some(tD) ||
			(function () {
	...
	const {
			builders: { concat: aD, join: sD, group: cD },
		} = cn,
		{ getCallArguments: lD, hasFlowAnnotationComment: pD, isCallOrOptionalCallExpression: dD, isMemberish: fD, isTemplateOnItsOwnLine: hD, isTestCall: mD, iterateCallArgumentsPath: gD } = wc,
		{ printOptionalToken: DD, printFunctionTypeParameters: yD } = nd
	var ED = {
		printCallExpression: function (e, t, n) {
			...
			if (
				a.length > 0 &&
				((!u && !o && 'Identifier' === r.callee.type && ('require' === r.callee.name || 'define' === r.callee.name)) ||
					(1 === a.length && hD(a[0], t.originalText)) ||
					(!o && mD(r, e.getParentNode())))
			) {
				const r = []
				return (
					gD(e, e => {
	...
	const {
			builders: { concat: CD, join: bD, line: vD, group: AD, indent: FD, ifBreak: xD },
		} = cn,
		{ hasTrailingComment: SD, hasTrailingLineComment: wD, identity: TD } = wc,
		{ getTypeParametersGroupId: BD } = Yh,
		{ printTypeScriptModifiers: ND } = nd
	var kD = {
		printInterface: function (e, t, n) {
			...
			if (
				(r.extends && 0 !== r.extends.length && i.push(a ? xD(' ', vD, { groupId: BD(r.typeParameters) }) : vD, 'extends ', (1 === r.extends.length ? TD : FD)(bD(CD([',', vD]), e.map(n, 'extends')))),
				(r.id && SD(r.id)) || (r.extends && 0 !== r.extends.length))
			) {
				const e = CD(i)
	...
	const { printComments: PD } = Fa,
		{ getLast: OD } = Lt,
		{
			builders: { concat: ID, join: LD, line: MD, softline: jD, group: _D, indent: RD, align: VD, ifBreak: $D },
			utils: { normalizeParts: qD },
		} = cn,
		{ hasLeadingOwnLineComment: WD, hasTrailingLineComment: UD, isBinaryish: JD, isJSXNode: zD, shouldFlatten: HD } = wc
	let GD = 0
	function XD(e, t, n, r, o) {
		...
		if (JD(i)) {
						...
						? _D(
								RD(
									ID([
										...
										LD(
											ID([jD, ':', $D(' ')]),
											e.map(t, 'arguments').map(e => VD(2, _D(e)))
										),
									])
								)
						  )
			...
			u.push(s ? '' : ' ', h ? _D(p, { shouldBreak: f }) : p), r && i.comments && (u = qD(PD(e, () => ID(u), n).parts))
	...
	function YD(e) {
		return (
			'LogicalExpression' === e.type &&
			(('ObjectExpression' === e.right.type && 0 !== e.right.properties.length) || ('ArrayExpression' === e.right.type && 0 !== e.right.elements.length) || !!zD(e.right))
		)
	}
	var KD = {
		printBinaryishExpression: function (e, t, n) {
			...
			if (!p) return g
			const D = OD(a)
			return _D(ID([g, $D(RD(D), D, { groupId: m })]))
		},
		shouldInlineLogicalExpression: YD,
	}
	const {
			builders: { concat: QD, line: ZD, group: ey, indent: ty },
		} = cn,
		{ hasLeadingOwnLineComment: ny, isBinaryish: ry, isMemberExpressionChain: oy, isStringLiteral: uy } = wc,
		{ shouldInlineLogicalExpression: iy } = KD
	...
	function sy(e, t, n, r) {
		...
		return (ry(t) && !iy(t)) ||
			('ConditionalExpression' === t.type && ry(t.test) && !iy(t.test)) ||
			'StringLiteralTypeAnnotation' === t.type ||
			('ClassExpression' === t.type && t.decorators && t.decorators.length) ||
			(('Identifier' === e.type || uy(e) || 'MemberExpression' === e.type) && (uy(t) || oy(t)) && 'json' !== r.parser && 'json5' !== r.parser) ||
	...
	const { isNextLineEmpty: ly } = Lt,
		{
			builders: { concat: py, join: dy, hardline: fy },
		} = cn,
		{ classChildNeedsASIProtection: hy, classPropMayCauseASIProblems: my, getLeftSidePathName: gy, hasNakedLeftSide: Dy, isJSXNode: yy, isLastStatement: Ey, isTheOnlyJSXElementInMarkdown: Cy } = wc,
		{ locEnd: by } = ii,
		{ shouldPrintParamsWithoutParens: vy } = Lm
	...
	function Fy(e, t) {
		...
		return (
			!!(
				...
				'TypeCastExpression' === n.type ||
				('ArrowFunctionExpression' === n.type && !vy(e, t)) ||
				'ArrayExpression' === n.type ||
				'ArrayPattern' === n.type ||
	...
	const { printDanglingComments: Sy } = Fa,
		{ isNextLineEmpty: wy } = Lt,
		{
			builders: { concat: Ty, hardline: By, indent: Ny },
		} = cn,
		{ hasDanglingComments: ky } = wc,
		{ locEnd: Py } = ii,
		{ printStatementSequence: Oy } = xy
	var Iy = {
		printBlock: function (e, t, n) {
			...
			return a ||
				...
				('ArrowFunctionExpression' !== c.type &&
					...
					'ClassPrivateMethod' !== c.type &&
					'ForStatement' !== c.type &&
					'WhileStatement' !== c.type &&
					'DoWhileStatement' !== c.type &&
					'DoExpression' !== c.type &&
					('CatchClause' !== c.type || l.finalizer) &&
					'TSModuleDeclaration' !== c.type &&
					'TSDeclareFunction' !== c.type &&
					'StaticBlock' !== r.type)
				? (o.push('{'),
				  s &&
						e.each(e => {
	...
	const { hasNewline: Ly } = Lt,
		{
			builders: { concat: My, join: jy, hardline: _y },
		} = cn,
		{ isLineComment: Ry, isBlockComment: Vy } = wc,
		{ locStart: $y, locEnd: qy } = ii
	var Wy = {
		printComment: function (e, t) {
			...
			if (Vy(n)) {
				if (
					...
					return n.trailing && !Ly(t.originalText, $y(n), { backwards: !0 }) ? My([_y, e]) : e
				}
				const e = qy(n),
	...
	const { hasNewline: Uy, hasNewlineInRange: Jy, getLast: zy, printString: Hy, printNumber: Gy, isNextLineEmpty: Xy } = Lt,
		{
			builders: { concat: Yy, join: Ky, line: Qy, hardline: Zy, softline: eE, literalline: tE, group: nE, indent: rE, align: oE, conditionalGroup: uE, ifBreak: iE },
			utils: { isEmpty: aE },
		} = cn,
		{ insertPragma: sE } = Sp,
		{ printHtmlBinding: cE, isVueEventBindingExpression: lE } = zp,
		{
		...
		{ locStart: LE, locEnd: ME } = ii,
		{ printOptionalToken: jE, printBindExpressionCallee: _E, printTypeScriptModifiers: RE, printDecorators: VE, printFlowDeclaration: $E, adjustClause: qE } = nd,
		{ printImportDeclaration: WE, printExportDeclaration: UE, printExportAllDeclaration: JE, printModuleSpecifier: zE } = bd,
		{ printFunctionParameters: HE } = af,
		{ printTemplateLiteral: GE } = Fl,
		{ printArray: XE, printArrayItems: YE } = Tf,
		{ printObject: KE } = Kf,
		{ printTypeAnnotation: QE, shouldHugType: ZE } = df,
		{
			printJsxElement: eC,
		...
		{ printClass: cC, printClassMethod: lC } = eg,
		{ printTypeParameters: pC } = Yh,
		{ printPropertyKey: dC } = am,
		{ printFunctionDeclaration: fC, printArrowFunctionExpression: hC, printMethod: mC, printReturnAndThrowArgument: gC } = Lm,
		{ printCallExpression: DC } = ED,
		{ printInterface: yC } = kD,
		{ printVariableDeclarator: EC, printAssignmentExpression: CC, printAssignment: bC, printAssignmentRight: vC } = cy,
		{ printBinaryishExpression: AC } = KD,
		{ printStatementSequence: FC } = xy,
		{ printMemberExpression: xC } = Ig,
		{ printBlock: SC } = Iy,
		{ printComment: wC } = Wy
	function TC(e, t, n) {
		const r = OE(e),
	...
	var NC = {
		...
		print: function (e, t, n, r) {
			...
			const i = (function (e, t, n, r) {
				...
				switch (o.type) {
					...
					case 'TSTypeAssertion': {
						...
						return t ? uE([Yy([r, e.call(n, 'expression')]), Yy([r, nE(u, { shouldBreak: !0 })]), Yy([r, e.call(n, 'expression')])]) : nE(Yy([r, e.call(n, 'expression')]))
					}
					case 'OptionalMemberExpression':
					case 'MemberExpression':
						return xC(e, t, n)
					...
					case 'Property':
						return o.method || 'get' === o.kind || 'set' === o.kind
							? mC(e, t, n)
							: (o.shorthand ? a.push(e.call(n, 'value')) : a.push(bC(o.key, dC(e, t, n), ':', o.value, e.call(n, 'value'), t)), Yy(a))
					case 'ClassMethod':
					case 'ClassPrivateMethod':
					case 'MethodDefinition':
					case 'TSAbstractMethodDefinition':
					...
					case 'UnaryExpression':
						return (
							...
							o.argument.comments && o.argument.comments.length > 0 ? a.push(nE(Yy(['(', rE(Yy([eE, e.call(n, 'argument')])), eE, ')']))) : a.push(e.call(n, 'argument')),
							Yy(a)
						)
					case 'UpdateExpression':
					...
					case 'VariableDeclaration': {
						...
						let c
						return (
							1 !== t.length || o.declarations[0].comments ? t.length > 0 && (c = rE(t[0])) : (c = t[0]),
							(a = [o.declare ? 'declare ' : '', o.kind, c ? Yy([' ', c]) : '', rE(Yy(t.slice(1).map(e => Yy([',', s && !i ? Zy : Qy, e]))))]),
							(i && r.body !== o) || a.push(u),
							nE(Yy(a))
						)
					}
					...
					case 'ForStatement': {
						...
						return o.init || o.test || o.update
							? Yy([i, nE(Yy(['for (', nE(Yy([rE(Yy([eE, e.call(n, 'init'), ';', Qy, e.call(n, 'test'), ';', Qy, e.call(n, 'update')])), eE])), ')', r]))])
							: Yy([i, nE(Yy(['for (;;)', r]))])
					}
					case 'WhileStatement':
					...
					case 'CatchClause':
						if (o.param) {
							const r = o.param.comments && o.param.comments.some(e => !kE(e) || (e.leading && Uy(t.originalText, ME(e))) || (e.trailing && Uy(t.originalText, LE(e), { backwards: !0 }))),
								u = e.call(n, 'param')
					...
					case 'SwitchStatement':
						return Yy([
							nE(Yy(['switch (', rE(Yy([eE, e.call(n, 'discriminant')])), eE, ')'])),
							' {',
							o.cases.length > 0
								? rE(
										Yy([
					...
					case 'ClassPrivateProperty':
						return (
							o.decorators && 0 !== o.decorators.length && a.push(VE(e, t, n)),
							...
							a.push(dC(e, t, n), jE(e), QE(e, t, n)),
							o.value && a.push(' =', vC(o.key, o.value, e.call(n, 'value'), t)),
							a.push(u),
							nE(Yy(a))
						)
					case 'ClassDeclaration':
					...
					case 'OpaqueType':
						return (
							...
							a.push(u),
							'DeclareOpaqueType' === o.type ? $E(e, Yy(a)) : Yy(a)
						)
					...
					case 'TSFunctionType': {
						...
						let s =
								...
								!(
									(('ObjectTypeProperty' === r.type || 'ObjectTypeInternalSlot' === r.type) && !r.variance && !r.optional && LE(r) === LE(o)) ||
					...
					case 'IntersectionTypeAnnotation': {
						...
						for (let e = 0; e < t.length; ++e)
							0 === e
								? r.push(t[e])
								: wE(o.types[e - 1]) && wE(o.types[e])
								? r.push(Yy([' & ', u ? rE(t[e]) : t[e]]))
								: wE(o.types[e - 1]) || wE(o.types[e])
								? (e > 1 && (u = !0), r.push(' & ', e > 1 ? rE(t[e]) : t[e]))
								: r.push(rE(Yy([' &', Qy, t[e]])))
						return nE(Yy(r))
					}
					case 'TSUnionType':
					case 'UnionTypeAnnotation': {
						const r = e.getParentNode(),
							u = !(
								...
								(('TypeAlias' === r.type || 'VariableDeclarator' === r.type || 'TSTypeAliasDeclaration' === r.type) && DE(t.originalText, o))
							),
							i = ZE(o),
							a = e.map(e => {
								let r = e.call(n)
					...
					case 'ObjectTypeProperty': {
						...
						return (
							...
							Yy([r, FE(o) ? o.kind + ' ' : '', o.variance ? e.call(n, 'variance') : '', dC(e, t, n), jE(e), AE(o) ? '' : ': ', e.call(n, 'value')])
						)
					}
					...
					case 'TSParameterProperty':
						return (
							o.accessibility && a.push(o.accessibility + ' '), o.export && a.push('export '), o.static && a.push('static '), o.readonly && a.push('readonly '), a.push(e.call(n, 'parameter')), Yy(a)
						)
					...
					case 'TSIndexSignature': {
						...
						return Yy([
							o.export ? 'export ' : '',
							o.accessibility ? Yy([o.accessibility, ' ']) : '',
							o.static ? 'static ' : '',
							o.readonly ? 'readonly ' : '',
							o.declare ? 'declare ' : '',
							'[',
					...
					case 'TSImportType':
						return Yy([
							...
							')',
							o.qualifier ? Yy(['.', e.call(n, 'qualifier')]) : '',
							pC(e, t, n, 'typeParameters'),
						])
					case 'TSLiteralType':
					...
					case 'TSMappedType': {
						...
						return nE(
							Yy([
								...
								rE(
									Yy([
										t.bracketSpacing ? Qy : eE,
										o.readonly ? Yy([hE(o.readonly, 'readonly'), ' ']) : '',
										RE(e, t, n),
										e.call(n, 'typeParameter'),
										o.optional ? hE(o.optional, '?') : '',
										o.typeAnnotation ? ': ' : '',
										e.call(n, 'typeAnnotation'),
										iE(u, ''),
									])
								),
								Fa.printDanglingComments(e, t, !0),
								t.bracketSpacing ? Qy : eE,
								'}',
							]),
							{ shouldBreak: r }
					...
					case 'TSEnumDeclaration':
						return (
							o.declare && a.push('declare '),
							o.modifiers && a.push(RE(e, t, n)),
							o.const && a.push('const '),
							a.push('enum ', e.call(n, 'id'), ' '),
							0 === o.members.length
								? a.push(nE(Yy(['{', Fa.printDanglingComments(e, t), eE, '}'])))
								: a.push(nE(Yy(['{', rE(Yy([Zy, YE(e, t, 'members', n), IE(t, 'es5') ? ',' : ''])), Fa.printDanglingComments(e, t, !0), Zy, '}']))),
							Yy(a)
						)
					case 'TSEnumMember':
					...
					case 'NGChainedExpression':
						return nE(
							Ky(
								Yy([';', Qy]),
								e.map(e => (EE(e) ? n(e) : Yy(['(', n(e), ')'])), 'expressions')
							)
						)
			...
			if (
			...
			else if (o.decorators && o.decorators.length > 0 && !(a && LE(a, { ignoreDecorators: !0 }) > LE(o.decorators[0]))) {
				...
				vE(o) && o.declaration && o.declaration.decorators && o.declaration.decorators.length > 0 && LE(o, { ignoreDecorators: !0 }) > LE(o.declaration.decorators[0])
					? e.each(
							e => {
		...
		printComment: wC,
		isBlockComment: kE,
		handleComments: { ownLine: il.handleOwnLineComment, endOfLine: il.handleEndOfLineComment, remaining: il.handleRemainingComment },
		getGapRegex: il.getGapRegex,
		getCommentChildNodes: il.getCommentChildNodes,
	}
	const {
		builders: { concat: kC, hardline: PC, indent: OC, join: IC },
	} = cn
	...
	const _C = 'Common'
	var RC = {
		bracketSpacing: { since: '0.0.0', category: _C, type: 'boolean', default: !0, description: 'Print spaces between brackets.', oppositeDescription: 'Do not print spaces between brackets.' },
		singleQuote: { since: '0.0.0', category: _C, type: 'boolean', default: !1, description: 'Use single quotes instead of double quotes.' },
		proseWrap: {
			since: '1.8.2',
			category: _C,
			type: 'choice',
	...
	var $C = {
			...
			jsxBracketSameLine: { since: '0.17.0', category: VC, type: 'boolean', default: !1, description: 'Put > on the last line instead of at a new line.' },
			semi: {
				since: '1.0.0',
				category: VC,
				type: 'boolean',
			...
			jsxSingleQuote: { since: '1.15.0', category: VC, type: 'boolean', default: !1, description: 'Use single quotes in JSX.' },
			quoteProps: {
				since: '1.17.0',
				category: VC,
				type: 'choice',
		...
		GC = { name: 'JSON5', type: 'data', extensions: ['.json5'], tmScope: 'source.js', aceMode: 'javascript', codemirrorMode: 'javascript', codemirrorMimeType: 'application/json', languageId: 175 }
	var XC = {
		languages: [
			ks(qC, e => ({
				since: '0.0.0',
			...
			ks(qC, () => ({ name: 'Flow', since: '0.0.0', parsers: ['flow', 'babel-flow'], vscodeLanguageIds: ['javascript'], aliases: [], filenames: [], extensions: ['.js.flow'] })),
			ks(WC, () => ({ since: '0.0.0', parsers: ['babel', 'babel-flow', 'babel-ts', 'flow', 'typescript', 'espree', 'meriyah'], vscodeLanguageIds: ['javascriptreact'] })),
			ks(UC, () => ({ since: '1.4.0', parsers: ['typescript', 'babel-ts'], vscodeLanguageIds: ['typescript'] })),
			ks(JC, () => ({ since: '1.4.0', parsers: ['typescript', 'babel-ts'], vscodeLanguageIds: ['typescriptreact'] })),
			ks(zC, () => ({
				name: 'JSON.stringify',
				since: '1.13.0',
			...
			ks(zC, e => ({ since: '1.5.0', parsers: ['json'], vscodeLanguageIds: ['json'], filenames: [...e.filenames, '.prettierrc'], extensions: e.extensions.filter(e => '.jsonl' !== e) })),
			ks(HC, e => ({ since: '1.5.0', parsers: ['json'], vscodeLanguageIds: ['jsonc'], filenames: [...e.filenames, '.eslintrc'] })),
			ks(GC, () => ({ since: '1.13.0', parsers: ['json5'], vscodeLanguageIds: ['json5'] })),
		],
		options: $C,
		printers: { estree: NC, 'estree-json': jC },
		parsers: {
			get babel() {
	...
	var ZC = QC
	const {
			builders: { hardline: eb, concat: tb, markAsRoot: nb },
		} = cn,
		rb = { '---': 'yaml', '+++': 'toml' }
	var ob = {
		parse: function (e) {
	...
	const {
			builders: { hardline: ub, concat: ib },
		} = cn,
		{ print: ab } = ob
	...
	const { printNumber: Nb, printString: kb, hasNewline: Pb, isFrontMatterNode: Ob, isNextLineEmpty: Ib } = Lt,
		{
			builders: { concat: Lb, join: Mb, line: jb, hardline: _b, softline: Rb, group: Vb, fill: $b, indent: qb, dedent: Wb, ifBreak: Ub, breakParent: Jb },
			utils: { removeLines: zb },
		} = cn,
		{ insertPragma: Hb } = lb,
		{
			getAncestorNode: Gb,
	...
	function $v(e, t, n) {
		...
		return (
			e.each((e, u) => {
				...
				u !== r.nodes.length - 1 &&
					(('css-comment' === r.nodes[u + 1].type && !Pb(t.originalText, _v(r.nodes[u + 1]), { backwards: !0 }) && !Ob(r.nodes[u])) ||
					('css-atrule' === r.nodes[u + 1].type && 'else' === r.nodes[u + 1].name && 'css-comment' !== r.nodes[u].type)
						? o.push(' ')
						: (o.push(t.__isHTMLStyleAttribute ? jb : _b), Ib(t.originalText, e.getValue(), Rv) && !Ob(r.nodes[u]) && o.push(_b)))
			}, 'nodes'),
			Lb(o)
		)
	}
	...
	var Gv = {
				...
				switch (r.type) {
					...
					case 'css-rule':
						return Lb([
							...
							r.nodes
								? Lb([r.selector && 'selector-unknown' === r.selector.type && Mv(r.selector.value) ? jb : ' ', '{', r.nodes.length > 0 ? qb(Lb([_b, $v(e, t, n)])) : '', _b, '}', av(r) ? ';' : ''])
								: ';',
						])
					case 'css-decl': {
						const o = e.getParentNode(),
						...
						return (
							!a && Mv(i) && (s = qb(Lb([_b, Wb(s)]))),
							Lb([
								r.raws.before.replace(/[\s;]/g, ''),
								Qb(e) ? r.prop : Yb(r.prop),
								i.startsWith('//') ? ' ' : '',
								i,
								r.extend ? '' : ' ',
								uv(t) && r.extend && r.selector ? Lb(['extend(', e.call(n, 'selector'), ')']) : '',
								s,
								...
								r.nodes
									? Lb([' {', qb(Lb([Rb, $v(e, t, n)])), Rb, '}'])
									: xv(r) && !o.raws.semicolon && ';' !== t.originalText[Rv(r) - 1]
									? ''
									: t.__isHTMLStyleAttribute && ov(e, r)
									? Ub(';', '')
									: ';',
							])
						)
						...
						if (uv(t)) {
							...
							if (r.variable)
								return Lb([
									...
									r.name,
									': ',
									r.value ? Lb([e.call(n, 'value')]) : '',
									r.raws.between.trim() ? r.raws.between.trim() + ' ' : '',
									r.nodes ? Lb(['{', qb(Lb([r.nodes.length > 0 ? Rb : '', $v(e, t, n)])), Rb, '}']) : '',
									u ? '' : ';',
								])
						}
						return Lb([
							'@',
							Av(r) || r.name.endsWith(':') ? r.name : Yb(r.name),
							r.params
								? Lb([
										Av(r)
											? ''
								...
								: '',
							r.selector ? qb(Lb([' ', e.call(n, 'selector')])) : '',
							r.value ? Vb(Lb([' ', e.call(n, 'value'), iv(r) ? (Cv(r) ? ' ' : jb) : ''])) : 'else' === r.name ? ' ' : '',
							r.nodes
								? Lb([
										iv(r)
											? ''
											: (r.selector && !r.selector.nodes && 'string' == typeof r.selector.value && Mv(r.selector.value)) || (!r.selector && 'string' == typeof r.params && Mv(r.params))
											? jb
											: ' ',
										'{',
										qb(Lb([r.nodes.length > 0 ? Rb : '', $v(e, t, n)])),
										Rb,
										'}',
								  ])
								: u
					...
					case 'selector-attribute':
						return Lb([
							'[',
							r.namespace ? Lb([!0 === r.namespace ? '' : r.namespace.trim(), '|']) : '',
							r.attribute.trim(),
							r.operator ? r.operator : '',
							r.value ? Jv(Uv(r.value.trim(), t), t) : '',
							r.insensitive ? ' i' : '',
							']',
						])
					...
					case 'value-comma_group': {
						...
						for (let n = 0; n < r.groups.length; ++n) {
							...
							if (lv(m) || lv(h) || Kb(e, 'calc') || b || !((pv(m) && !v) || (pv(h) && !A) || (dv(m) && !v) || (dv(h) && !A) || fv(m) || fv(h)) || !(bv(m) || (E && (!u || (u && hv(u))))))
								if (Tv(h)) {
									...
									(s && (cv(m) || sv(m) || yv(m) || mv(h) || gv(h))) || (a && 'namespace' === a.name.toLowerCase())
										? l.push(' ')
										: i
										...
										: C
										? l.push(' ')
										: (m && '...' === m.value) || (jv(h) && jv(m) && Rv(h) === _v(m)) || l.push(jb)
						}
					...
					case 'value-paren_group': {
						...
						if (
							...
							return Lb([r.open ? e.call(n, 'open') : '', Mb(',', e.map(n, 'groups')), r.close ? e.call(n, 'close') : ''])
						if (!r.open) {
									...
									Lb([
										...
										Mb(
											...
											e.map(e => {
												const t = e.getValue(),
													r = n(e)
												return vv(t) && 'value-comma_group' === t.type && t.groups && t.groups[2] && 'value-paren_group' === t.groups[2].type
													? ((r.contents.contents.parts[1] = Vb(r.contents.contents.parts[1])), Vb(Wb(r)))
													: r
											}, 'groups')
										),
									])
								),
								Ub(!a && rv(t.parser, t.originalText) && u && Vv(t) ? ',' : ''),
								Rb,
		...
		Xv = { singleQuote: RC.singleQuote },
		Yv = { name: 'PostCSS', type: 'markup', tmScope: 'source.postcss', group: 'CSS', extensions: ['.pcss', '.postcss'], aceMode: 'text', languageId: 262764437 },
		Kv = { name: 'Less', type: 'markup', color: '#1d365d', extensions: ['.less'], tmScope: 'source.css.less', aceMode: 'less', codemirrorMode: 'css', codemirrorMimeType: 'text/css', languageId: 198 },
		Qv = {
			name: 'SCSS',
			type: 'markup',
			color: '#c6538c',
	...
	var Zv = {
		languages: [
			ks({ name: 'CSS', type: 'markup', tmScope: 'source.css', aceMode: 'css', codemirrorMode: 'css', codemirrorMimeType: 'text/css', color: '#563d7c', extensions: ['.css'], languageId: 50 }, e => ({
				since: '1.4.0',
				parsers: ['css'],
				vscodeLanguageIds: ['css'],
				extensions: [...e.extensions, '.wxss'],
			})),
			ks(Yv, () => ({ since: '1.4.0', parsers: ['css'], vscodeLanguageIds: ['postcss'] })),
			ks(Kv, () => ({ since: '1.4.0', parsers: ['less'], vscodeLanguageIds: ['less'] })),
			ks(Qv, () => ({ since: '1.4.0', parsers: ['scss'], vscodeLanguageIds: ['scss'] })),
		],
		options: Xv,
		printers: { postcss: Gv },
		parsers: {
	...
	const {
			builders: { concat: pA, group: dA, hardline: fA, ifBreak: hA, indent: mA, join: gA, line: DA, softline: yA },
		} = cn,
		{ locStart: EA, locEnd: CA } = eA,
		{
			getNextNode: bA,
			getPreviousNode: vA,
	...
	function kA(e, t) {
		const n = e.getValue()
		return mA(
			pA([n.attributes.length ? DA : '', gA(DA, e.map(t, 'attributes')), n.modifiers.length ? DA : '', gA(DA, e.map(t, 'modifiers')), n.comments.length ? DA : '', gA(DA, e.map(t, 'comments'))])
		)
	}
	function PA(e, t, n) {
				...
				case 'TextNode': {
					...
					if (e.stack.includes('attributes')) {
						...
						let n = '',
							o = ''
						return (
							SA(e, ['ConcatStatement']) && (wA(e, ['MustacheStatement']) && (n = ' '), FA(e, ['MustacheStatement']) && (o = ' ')),
							pA([...KA(a, t), r.chars.replace(/^\s+/g, n).replace(/\s+$/, o), ...KA(s, t)])
						)
					}
					let c = '',
						l = ''
	...
	const {
			builders: { concat: sF, join: cF, hardline: lF, line: pF, softline: dF, group: fF, indent: hF, ifBreak: mF },
		} = cn,
		{ isNextLineEmpty: gF } = Lt,
		{ insertPragma: DF } = iF,
		{ locStart: yF, locEnd: EF } = aF
	function CF(e, t, n) {
			...
			print: function (e, t, n) {
				...
				switch (r.kind) {
					...
					case 'OperationDefinition': {
						...
						return sF([
							o ? r.operation : '',
							o && u ? sF([' ', e.call(n, 'name')]) : '',
							r.variableDefinitions && r.variableDefinitions.length ? fF(sF(['(', hF(sF([dF, cF(sF([mF('', ', '), dF]), e.map(n, 'variableDefinitions'))])), dF, ')'])) : '',
							CF(e, n, r),
							r.selectionSet && (o || u) ? ' ' : '',
					...
					case 'ObjectValue':
						return fF(
							sF([
								...
								hF(sF([dF, cF(sF([mF('', ', '), dF]), e.map(n, 'fields'))])),
								dF,
								mF('', t.bracketSpacing && r.fields.length > 0 ? ' ' : ''),
								'}',
							])
						)
					case 'ObjectField':
					...
					case 'ObjectTypeDefinition':
						return sF([
							...
							'type ',
							e.call(n, 'name'),
							r.interfaces.length > 0 ? sF([' implements ', sF(vF(e, t, n))]) : '',
							CF(e, n, r),
							r.fields.length > 0
								? sF([
										' {',
					...
					case 'InputValueDefinition':
						return sF([
							e.call(n, 'description'),
							r.description ? (r.description.block ? lF : pF) : '',
							e.call(n, 'name'),
							': ',
							e.call(n, 'type'),
							r.defaultValue ? sF([' = ', e.call(n, 'defaultValue')]) : '',
							CF(e, n, r),
						])
							...
							r.operationTypes.length > 0
								? hF(
										sF([
											...
											cF(
												lF,
												e.call(e => bF(e, t, n), 'operationTypes')
											),
										])
								  )
								: '',
							...
							sF([
								...
								fF(
									sF([
										...
										e.call(n, 'name'),
										CF(e, n, r),
										r.types.length > 0 ? sF([' =', mF('', ' '), hF(sF([mF(sF([pF, '  '])), cF(sF([pF, '| ']), e.map(n, 'types'))]))]) : '',
									])
								),
							])
						)
	...
	var SF = {
		languages: [
			ks({ name: 'GraphQL', type: 'data', color: '#e10098', extensions: ['.graphql', '.gql', '.graphqls'], tmScope: 'source.graphql', aceMode: 'text', languageId: 139 }, () => ({
				since: '1.5.0',
				parsers: ['graphql'],
	...
	const { getLast: TF } = Lt,
		{ locStart: BF, locEnd: NF } = wF,
		{ cjkPattern: kF, kPattern: PF, punctuationPattern: OF } = {
			cjkPattern:
	...
	var RF = {
		...
		splitText: function (e, t) {
			const n = 'non-cjk',
				...
				u = []
			return (
				('preserve' === t.proseWrap ? e : e.replace(new RegExp('('.concat(kF, ')\n(').concat(kF, ')'), 'g'), '$1$2')).split(/([\t\n ]+)/).forEach((e, t, a) => {
					t % 2 != 1
						? ((0 !== t && t !== a.length - 1) || '' !== e) &&
						  e.split(new RegExp('('.concat(kF, ')'))).forEach((e, t, u) => {
								;((0 !== t && t !== u.length - 1) || '' !== e) &&
									(t % 2 != 0
										? i(
												jF.test(e)
													? { type: 'word', value: e, kind: o, hasLeadingPunctuation: !0, hasTrailingPunctuation: !0 }
													: { type: 'word', value: e, kind: MF.test(e) ? 'k-letter' : r, hasLeadingPunctuation: !1, hasTrailingPunctuation: !1 }
										  )
										: '' !== e && i({ type: 'word', value: e, kind: n, hasLeadingPunctuation: jF.test(e[0]), hasTrailingPunctuation: jF.test(TF(e)) }))
						  })
	...
	const { inferParserByLanguage: VF, getMaxContinuousCount: $F } = Lt,
		{
			builders: { hardline: qF, concat: WF, markAsRoot: UF },
			utils: { replaceNewlinesWithLiterallines: JF },
		} = cn,
		{ print: zF } = ob,
		{ getFencedCodeBlockValue: HF } = RF
	var GF = function (e, t, n, r) {
		...
		if ('code' === o.type && null !== o.lang) {
			...
			if (e) {
				const t = r.__inJsTemplate ? '~' : '`',
					...
					i = n(HF(o, r.originalText), { parser: e }, { stripTrailingHardline: !0 })
		...
		switch (o.type) {
			case 'front-matter':
				return zF(o, n)
			case 'importExport':
				return WF([n(o.value, { parser: 'babel' }, { stripTrailingHardline: !0 }), qF])
			case 'jsx':
	...
	const { getOrderedListItemInfo: ZF, mapAst: ex, splitText: tx } = RF,
		nx = /^([\u0000-\uffff]|[\ud800-\udbff][\udc00-\udfff])$/
	function rx(e, t, n) {
		return ex(e, e => {
	...
	var ox = function (e, t) {
		return (e = (function (e) {
			...
			(e = (function (e) {
				return ex(e, e => ('import' !== e.type && 'export' !== e.type ? e : Object.assign({}, e, { type: 'importExport' })))
			})(
				(e = (function (e, t) {
					return ex(e, (e, n, [r]) => {
						if ('text' !== e.type) return e
						let { value: o } = e
						return 'paragraph' === r.type && (0 === n && (o = o.trimStart()), n === r.children.length - 1 && (o = o.trimEnd())), { type: 'sentence', position: e.position, children: tx(o, t) }
					})
				})(
					(e = (function (e, t) {
						return ex(e, (e, t, n) => {
						...
						(e = (function (e, t) {
							...
							(e = (function (e) {
								return ex(e, e => ('inlineCode' !== e.type ? e : Object.assign({}, e, { value: e.value.replace(/\s+/g, ' ') })))
							})(
								(e = (function (e) {
									return rx(
										e,
									...
									(e = (function (e, t) {
										return ex(e, e =>
											'text' === e.type && '*' !== e.value && '_' !== e.value && nx.test(e.value) && e.position.end.offset - e.position.start.offset !== e.value.length
	...
	const { isFrontMatterNode: ux } = Lt,
		{ startWithPragma: ix } = QF,
		...
		return (
			...
			'text' === e.type
				...
				: ('inlineCode' === e.type && (t.value = e.value.replace(/[\t\n ]+/g, ' ')),
				  ...
				  n && 'root' === n.type && n.children.length > 0 && (n.children[0] === e || (ux(n.children[0]) && n.children[1] === e)) && 'html' === e.type && ix(e.value) ? null : void 0)
		)
	}
	sx.ignoredProperties = ax
	var cx = sx
	const { getLast: lx, getMinNotPresentContinuousCount: px, getMaxContinuousCount: dx, getStringWidth: fx } = Lt,
		{
			builders: { breakParent: hx, concat: mx, join: gx, line: Dx, literalline: yx, markAsRoot: Ex, hardline: Cx, softline: bx, ifBreak: vx, fill: Ax, align: Fx, indent: xx, group: Sx },
			utils: { normalizeDoc: wx },
			printer: { printDocToString: Tx },
		} = cn,
		{ replaceEndOfLineWith: Bx } = Lt,
		{ insertPragma: Nx } = QF,
		{ locStart: kx, locEnd: Px } = wF,
		{ getFencedCodeBlockValue: Ox, hasGitDiffFriendlyOrderedList: Ix, splitText: Lx, punctuationPattern: Mx, INLINE_NODE_TYPES: jx, INLINE_NODE_WRAPPER_TYPES: _x, isAutolink: Rx } = RF,
	...
	var tS = {
			...
			print: function (e, t, n) {
				...
				if (
					...
					return mx(Lx(t.originalText.slice(r.position.start.offset, r.position.end.offset), t).map(n => ('word' === n.type ? n.value : '' === n.value ? '' : Hx(e, n.value, t))))
				switch (r.type) {
					case 'front-matter':
					...
					case 'paragraph':
						return Xx(e, t, n, { postprocessor: Ax })
					case 'sentence':
						return Xx(e, t, n)
					case 'word': {
						let t = r.value
							.replace(/\*/g, '\\$&')
							.replace(new RegExp(['(^|'.concat(Mx, ')(_+)'), '(_+)('.concat(Mx, '|$)')].join('|'), 'g'), (e, t, n, r, o) => (n ? ''.concat(t).concat(n) : ''.concat(r).concat(o)).replace(/_/g, '\\_'))
					...
					case 'whitespace': {
						...
						return Hx(e, r.value, { proseWrap: i })
					}
					case 'emphasis': {
						let o
						if (Rx(r.children[0])) o = t.originalText[r.position.start.offset]
						else {
							const t = e.getParentNode(),
								...
								i = t.children[n + 1]
							o =
								(u && 'sentence' === u.type && u.children.length > 0 && 'word' === lx(u.children).type && !lx(u.children).hasTrailingPunctuation) ||
						...
						return Xx(e, t, n, {
							processor: (e, i) => {
								...
								return 2 === s.children.length && 'html' === s.children[1].type && s.children[0].position.start.column !== s.children[1].position.start.column
									? mx([a, Wx(e, t, n, a)])
									: mx([a, Fx(' '.repeat(a.length), Wx(e, t, n, a))])
							},
						})
					}
					case 'thematicBreak': {
					...
					case 'footnoteDefinition': {
						...
						return mx([
							...
							r.identifier,
							']: ',
							u ? Xx(e, t, n) : Sx(mx([Fx(' '.repeat(4), Xx(e, t, n, { processor: (e, t) => (0 === t ? Sx(mx([bx, e.call(n)])) : e.call(n)) })), o && 'footnoteDefinition' === o.type ? bx : ''])),
						])
					}
					case 'table':
						return (function (e, t, n) {
		...
		nS = { proseWrap: RC.proseWrap, singleQuote: RC.singleQuote },
		rS = {
			name: 'Markdown',
			type: 'prose',
			color: '#083fa1',
	...
	var oS = {
		languages: [
			ks(rS, e => ({ since: '1.8.0', parsers: ['markdown'], vscodeLanguageIds: ['markdown'], filenames: e.filenames.concat(['README']), extensions: e.extensions.filter(e => '.mdx' !== e) })),
			ks(rS, () => ({ name: 'MDX', since: '1.15.0', parsers: ['mdx'], vscodeLanguageIds: ['mdx'], filenames: [], extensions: ['.mdx'] })),
		],
		options: nS,
		printers: { mdast: tS },
		parsers: {
	...
	const { isFrontMatterNode: uS } = Lt,
		iS = new Set(['sourceSpan', 'startSourceSpan', 'endSourceSpan', 'nameSpan', 'valueSpan'])
	function aS(e, t) {
		return 'text' === e.type || 'comment' === e.type || uS(e) || 'yaml' === e.type || 'toml' === e.type
			? null
			: ('attribute' === e.type && delete t.value, void ('docType' === e.type && delete t.value))
	}
	...
	const { inferParserByLanguage: lS, isFrontMatterNode: pS } = Lt,
		{ CSS_DISPLAY_TAGS: dS, CSS_DISPLAY_DEFAULT: fS, CSS_WHITE_SPACE_TAGS: hS, CSS_WHITE_SPACE_DEFAULT: mS } = {
			CSS_DISPLAY_TAGS: {
				area: 'none',
				base: 'none',
				basefont: 'none',
	...
	function vS(e, t) {
		return (
			...
			!(!IS(e) || !e.children.some(e => 'text' !== e.type && 'interpolation' !== e.type)) ||
			...
			inferScriptParser: function (e, t) {
				return 'script' !== e.name || e.attrMap.src
					? 'style' === e.name
						...
						: t && VS(e, t)
						? PS(e) || (!('src' in e.attrMap) && lS(e.attrMap.lang, t))
						: void 0
				...
				return (
					...
					(!(('text' !== e.type && 'interpolation' !== e.type) || !e.next || ('text' !== e.next.type && 'interpolation' !== e.next.type)) ||
						(!(!e.parent || 'none' === e.parent.cssDisplay) &&
							(!!IS(e.parent) ||
								(!(!e.next && ('root' === e.parent.type || (IS(e) && e.parent) || FS(e.parent) || _S(e.parent, t) || ((n = e.parent.cssDisplay), OS(n) || 'inline-block' === n))) &&
									!(
										e.next &&
										!(function (e) {
											return !OS(e)
			...
			t.CompileNgModuleMetadata = class {
				constructor({
					...
					;(this.type = e || null),
						...
						(this.importedModules = s(c)),
						(this.exportedModules = s(l)),
						(this.schemas = s(p)),
						(this.id = f || null),
	...
	const { ParseSourceSpan: HS } = zS,
		...
		ow = [
						...
						if (e.children) {
							...
							if (r.some(Boolean)) {
								...
								for (let o = 0; o < e.children.length; o++) {
									...
									const a = t.pop()
									t.push(a.clone({ value: a.value + i.value, sourceSpan: new HS(a.sourceSpan.start, i.sourceSpan.end) }))
								}
								return e.clone({ children: t })
							}
						}
						...
						for (let n = 0; n < u.length; n++, e = o) {
							...
							n % 2 != 0
								? ((o = e.moveBy(r.length + 4)),
								  t.push({ type: 'interpolation', sourceSpan: new HS(e, o), children: 0 === r.length ? [] : [{ type: 'text', value: r, sourceSpan: new HS(e.moveBy(2), o.moveBy(-2)) }] }))
								: ((o = e.moveBy(r.length)), 0 !== r.length && t.push({ type: 'text', value: r, sourceSpan: new HS(e, o) }))
						}
					}
					return e.clone({ children: t })
				})
			...
			function (e) {
				...
				return e.map(e => {
					if (!e.children) return e
					if (0 === e.children.length || (1 === e.children.length && 'text' === e.children[0].type && 0 === GS(e.children[0].value).length))
					...
					return e.clone({
						...
						children: e.children
							.reduce((e, r) => {
								...
								const o = [],
									{ leadingWhitespace: u, text: i, trailingWhitespace: a } = XS(r.value)
								return (
									u && o.push({ type: t }),
									i && o.push({ type: 'text', value: i, sourceSpan: new HS(r.sourceSpan.start.moveBy(u.length), r.sourceSpan.end.moveBy(-a.length)) }),
									a && o.push({ type: t }),
									e.concat(o)
								)
							}, [])
			...
			function (e, t) {
				return e.map(e => Object.assign(e, { cssDisplay: QS(e, t) }))
			},
			function (e) {
			...
			function (e, t) {
				return e.map(e =>
					e.children
						? 0 === e.children.length
							? e.clone({ isDanglingSpaceSensitive: ZS(e) })
							: e.clone({
									children: e.children
										.map(e => Object.assign({}, e, { isLeadingSpaceSensitive: tw(e, t), isTrailingSpaceSensitive: nw(e, t) }))
										.map((e, t, n) =>
											Object.assign({}, e, {
	...
	var lw = {
			...
			printVueFor: function (e, t) {
				...
				return sw([cw(t('function _('.concat(n, ') {}'), { parser: 'babel', __isVueForBindingLeft: !0 })), ' ', r, ' ', t(o, { parser: '__js_expression' }, { stripTrailingHardline: !0 })])
			},
	...
	const {
		builders: { concat: dw, ifBreak: fw, join: hw, line: mw },
	} = cn
	var gw = {
	...
	const {
			builders: Dw,
			utils: { mapDoc: yw, normalizeParts: Ew },
		} = cn,
		{ replaceEndOfLineWith: Cw } = Lt,
		{ print: bw } = ob,
		{ breakParent: vw, dedentToRoot: Aw, fill: Fw, group: xw, hardline: Sw, ifBreak: ww, indent: Tw, join: Bw, line: Nw, literalline: kw, softline: Pw } = Dw,
		{
		...
		{ insertPragma: nT } = iw,
		{ locStart: rT, locEnd: oT } = aw,
		{ printVueFor: uT, printVueBindings: iT, isVueEventBindingExpression: aT } = lw,
		{ printImgSrcset: sT, printClassNames: cT } = gw
	function lT(e) {
		const t = Ew(e)
		...
		return lT(
			e.map((e, t) => {
				...
				const r = [],
					...
					p = n.next ? i(n, n.next) : ''
				return (
					l && (Vw(n.prev) ? r.push(Sw, Sw) : l === Sw ? r.push(Sw) : Yw(n.prev) ? a.push(l) : a.push(ww('', Pw, { groupId: o[t - 1] }))),
					p && (Vw(n) ? Yw(n.next) && c.push(Sw, Sw) : p === Sw ? Yw(n.next) && c.push(Sw) : s.push(p)),
					lT([].concat(r, xw(lT([lT(a), xw(lT([u(e), lT(s)]), { id: o[t] })])), c))
				)
			}, 'children')
		)
		function u(e) {
		...
		function i(e, t) {
			return Yw(e) && Yw(t)
				? e.isTrailingSpaceSensitive
					...
					? Sw
					: Pw
				: (CT(e) && (Ww(t) || t.firstChild || t.isSelfClosing || ('element' === t.type && 0 !== t.attrs.length))) || ('element' === e.type && e.isSelfClosing && vT(t))
				? ''
				: !t.isLeadingSpaceSensitive || Kw(t) || (vT(t) && e.lastChild && FT(e.lastChild) && e.lastChild.lastChild && FT(e.lastChild.lastChild))
				? Sw
				: t.hasLeadingSpaces
				? Nw
				: Pw
							...
							lT([
								...
								0 === r.children.length
									...
									: lT([
											...
											u ? ww(Tw(o), o, { groupId: i }) : (!Xw(r) && !Jw(r, t)) || 'root' !== r.parent.type || 'vue' !== t.parser || t.vueIndentScriptAndStyle ? Tw(o) : o),
											(r.next ? vT(r.next) : AT(r.parent))
												...
												: ('comment' === r.lastChild.type || ('text' === r.lastChild.type && r.isWhitespaceSensitive && r.isIndentationSensitive)) &&
												  new RegExp('\\n[\\t ]{'.concat(t.tabWidth * Mw(e, e => e.parent && 'root' !== e.parent.type), '}$')).test(r.lastChild.value)
												? ''
												: Pw,
									  ]),
							])
			...
			switch (o.type) {
				case 'element':
					...
					if (!o.isSelfClosing && zw(o, r)) {
						...
						let a = /^\s*$/.test(i),
							s = ''
						return a || ((s = n(Ow(i), { parser: u }, { stripTrailingHardline: !0 })), (a = '' === s)), lT([xT(o, r), xw(hT(e, r, t)), a ? '' : Sw, s, a ? '' : Sw, DT(o, r), wT(o, r)])
					}
					break
				case 'text':
					if (Xw(o.parent)) {
						...
						if (e) {
							...
							return Dw.concat([lT([vw, xT(o, r), n(t, u, { stripTrailingHardline: !0 }), wT(o, r)])])
						}
				...
				case 'attribute': {
					...
					const e = (function (e, t, n) {
						...
						const i = (e, t) => {
							...
							c = e => (u ? a(e) : s(e)),
							l = (e, n) => t(e, Object.assign({ __onHtmlBindingRoot: i }, n), { stripTrailingHardline: !0 })
						...
						if ('style' === e.fullName && !n.parentParser) {
							const e = o()
							if (!e.includes('{{')) return s(l(e, { parser: 'css', __isHTMLStyleAttribute: !0 }))
						}
						if ('vue' === n.parser) {
							...
							if (r(['^@', '^v-on:'])) {
								const e = o()
								return c(l(e, { parser: aT(e) ? '__js_expression' : '__vue_event_binding' }))
							}
							if (r(t)) return c(l(o(), { parser: '__vue_expression' }))
							if (r(u)) return c(l(o(), { parser: '__js_expression' }))
						}
						if ('angular' === n.parser) {
							const t = (e, t) => l(e, Object.assign({}, t, { trailingComma: 'none' })),
								n = ['^\\*'],
								u = ['^\\[.+\\]$', '^bind(on)?-', '^ng-(if|show|hide|class|style)$'],
								i = ['^i18n(-.+)?$']
							if (r(['^\\(.+\\)$', '^on-'])) return c(t(o(), { parser: '__ng_action' }))
							if (r(u)) return c(t(o(), { parser: '__ng_binding' }))
							if (r(i)) {
								const t = o().trim()
								return s(Fw(PT(e, t)), !t.includes('@@'))
							}
							if (r(n)) return c(t(o(), { parser: '__ng_directive' }))
							const a = /{{([\S\s]+?)}}/g,
								p = o()
							if (a.test(p)) {
								const e = []
								return (
									p.split(a).forEach((n, r) => {
										if (r % 2 == 0) e.push(lT(Cw(n, kw)))
										else
											try {
												e.push(xw(lT(['{{', Tw(lT([Nw, t(n, { parser: '__ng_interpolation', __isInHtmlInterpolation: !0 })])), Nw, '}}'])))
											} catch (t) {
												e.push('{{', lT(Cw(n, kw)), '}}')
											}
									}),
	...
	var LT = {
			...
			vueIndentScriptAndStyle: { since: '1.19.0', category: IT, type: 'boolean', default: !1, description: 'Indent script and style tags in Vue files.' },
		},
		MT = {
			name: 'HTML',
			type: 'markup',
		...
		jT = { name: 'Vue', type: 'markup', color: '#2c3e50', extensions: ['.vue'], tmScope: 'text.html.vue', aceMode: 'html', languageId: 391 }
	var _T = {
		languages: [
			ks(MT, () => ({ name: 'Angular', since: '1.15.0', parsers: ['angular'], vscodeLanguageIds: ['html'], extensions: ['.component.html'], filenames: [] })),
			ks(MT, e => ({ since: '1.15.0', parsers: ['html'], vscodeLanguageIds: ['html'], extensions: e.extensions.concat(['.mjml']) })),
			ks(MT, () => ({ name: 'Lightning Web Components', since: '1.17.0', parsers: ['lwc'], vscodeLanguageIds: ['html'], extensions: [], filenames: [] })),
			ks(jT, () => ({ since: '1.10.0', parsers: ['vue'], vscodeLanguageIds: ['vue'] })),
		],
		printers: { html: OT },
		options: LT,
		parsers: {
	...
	var YT = {
		...
		getBlockValueLineContents: function (e, { parentIndent: t, isLastDescendant: n, options: r }) {
			...
			return 'preserve' === r.proseWrap || 'blockLiteral' === e.type
				...
				: s(
						a
							.map(e => (0 === e.length ? [] : XT(e)))
							.reduce((e, t, n) => (0 === n || 0 === a[n - 1].length || 0 === t.length || /^\s/.test(t[0]) || /^\s|\s$/.test($T(e)) ? e.concat([t]) : e.concat([e.pop().concat(t)])), [])
							.map(e => e.reduce((e, t) => (0 !== e.length && /\s$/.test($T(e)) ? e.concat(e.pop() + ' ' + t) : e.concat(t)), []))
		...
		getFlowScalarLineContents: function (e, t, n) {
			...
			return 'preserve' === n.proseWrap
				...
				: r
						.map(e => (0 === e.length ? [] : XT(e)))
						.reduce((t, n, o) => (0 === o || 0 === r[o - 1].length || 0 === n.length || ('quoteDouble' === e && $T($T(t)).endsWith('\\')) ? t.concat([n]) : t.concat([t.pop().concat(n)])), [])
	...
	const KT = cn.builders,
		...
		{ replaceEndOfLineWith: fB, isPreviousLineEmpty: hB } = Lt,
		{ insertPragma: mB, isPragma: gB } = RT,
		{ locStart: DB } = VT,
		{
			getAncestorCount: yB,
		...
		switch (e.type) {
			case 'root':
				return eB([
					...
					0 === e.children.length || ((i = vB(e)), kB(i, ['blockLiteral', 'blockFolded']) && 'keep' === i.chomping) ? '' : uB,
				])
			case 'document': {
				...
				return aB(
					...
					[
						'head' === $B(e, u, t, r)
							? aB(
									uB,
									[0 === e.head.children.length && 0 === e.head.endComments.length ? '' : n.call(o, 'head'), eB(['---', SB(e.head) ? eB([' ', n.call(o, 'head', 'trailingComment')]) : ''])].filter(
										Boolean
									)
							  )
							: '',
			...
			case 'blockLiteral': {
				...
				return eB([
					...
					xB(e) ? eB([' ', n.call(o, 'indicatorComment')]) : '',
					(null === e.indent ? tB : nB)(
						jB(
							null === e.indent ? r.tabWidth : e.indent - 1 + t,
							eB(
								EB(e, { parentIndent: t, isLastDescendant: u, options: r }).reduce(
									(t, n, r, o) =>
										t.concat(0 === r ? uB : '', rB(aB(sB, n).parts), r !== o.length - 1 ? (0 === n.length ? uB : pB(lB)) : 'keep' === e.chomping && u ? (0 === n.length ? nB(uB) : nB(lB)) : ''),
									[]
								)
							)
						)
			...
			case 'flowMappingItem': {
				...
				if (i)
					return 'flowMappingItem' === e.type && 'flowMapping' === t.type
						? s
						: 'mappingItem' !== e.type || !qB(e.key.content, r) || SB(e.key.content) || (t.tag && 'tag:yaml.org,2002:set' === t.tag.value)
						? eB(['? ', jB(2, s)])
						: eB([s, WB(e) ? ' ' : '', ':'])
				if (u) return eB([': ', jB(2, c)])
				const l = Symbol('mappingKey')
				return AB(e.value) || !_B(e.key.content)
					? eB([
							'? ',
							jB(2, s),
							uB,
							aB(
								'',
								n.map(o, 'value', 'leadingComments').map(e => eB([e, uB]))
							),
							': ',
							jB(2, c),
					  ])
					: !(function (e) {
					  ...
					  FB(e.value.content) ||
					  wB(e.value) ||
					  !qB(e.value.content, r)
					? QT([
							eB([
								oB(eB([iB('? '), oB(jB(2, s), { id: l })])),
								iB(
									eB([uB, ': ', jB(2, c)]),
									a(
										eB([
											...
											':',
											AB(e.value.content) ||
											(wB(e.value) && e.value.content && !kB(e.value.content, ['mapping', 'sequence'])) ||
											('mapping' === t.type && SB(e.key.content) && _B(e.value.content)) ||
											(kB(e.value.content, ['mapping', 'sequence']) && null === e.value.content.tag && null === e.value.content.anchor)
												? uB
												: e.value.content
												? sB
												: '',
				...
				return eB([
					...
					a(
						eB([
							...
							eB(
								n.map(
									(t, n) => eB([o(t), n === e.children.length - 1 ? '' : eB([',', sB, e.children[n].position.start.line !== e.children[n + 1].position.start.line ? zB(t, r.originalText) : ''])]),
									'children'
								)
							),
							l,
							wB(e) ? eB([uB, aB(uB, n.map(o, 'endComments'))]) : '',
						])
					),
					c ? '' : s,
					i,
	...
	var GB = {
			...
			print: function (e, t, n) {
				...
				return eB([
					'mappingValue' !== r.type && AB(r) ? eB([aB(uB, e.map(n, 'leadingComments')), uB]) : '',
					u,
					u && i ? ' ' : '',
					i,
					u || i ? (kB(r, ['sequence', 'mapping']) && !FB(r) ? uB : ' ') : '',
					FB(r) ? eB([1 === r.middleComments.length ? '' : uB, aB(uB, e.map(n, 'middleComments')), uB]) : '',
					TB(e) ? eB(fB(t.originalText.slice(r.position.start.offset, r.position.end.offset).trimEnd(), lB)) : oB(MB(r, o, e, t, n)),
					SB(r) && !kB(r, ['document', 'documentHead'])
						? cB(eB(['mappingValue' !== r.type || r.content ? ' ' : '', 'mappingKey' === o.type && 'mapping' === e.getParentNode(2).type && _B(r) ? '' : ZT, e.call(n, 'trailingComment')]))
						: '',
					UB(r)
						? jB(
								...
								eB([
									...
									aB(
										uB,
										e.map(e => eB([hB(t.originalText, e.getValue(), DB) ? uB : '', n(e)]), 'endComments')
									),
								])
						  )
						: '',
		...
		XB = { bracketSpacing: RC.bracketSpacing, singleQuote: RC.singleQuote, proseWrap: RC.proseWrap }
	var YB = [
		XC,
		Zv,
		uF,
	...
	const { version: KB } = n,
		{ getSupportInfo: QB } = gt,
		ZB = YB.map(t => e(t, ['parsers']))
	function eN(e, t = 1) {
		return (...n) => {
			const r = n[t] || {},
				o = r.plugins || []
			return (n[t] = Object.assign({}, r, { plugins: [...ZB, ...(Array.isArray(o) ? o : Object.values(o))] })), e(...n)
		}
	}
	...
	return {
		...
		version: KB,
		util: Ns,
		__debug: { parse: eN(is.parse), formatAST: eN(is.formatAST), formatDoc: eN(is.formatDoc), printToDoc: eN(is.printToDoc), printDocToString: eN(is.printDocToString) },
	}
})
