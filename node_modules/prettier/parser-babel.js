!(function (t, e) {
	'object' == typeof exports && 'undefined' != typeof module
		...
		? define(e)
		: (((t = 'undefined' != typeof globalThis ? globalThis : t || self).prettierPlugins = t.prettierPlugins || {}), (t.prettierPlugins.babel = e()))
})(this, function () {
	'use strict'
	var t = function (t, e) {
	...
	const n = t => {
		...
		for (let e = 0; e < t.length; e++) {
			...
			i <= 31 || (i >= 127 && i <= 159) || (i >= 768 && i <= 879) || (i > 65535 && e++, (s += r(i) ? 2 : 1))
		}
		return s
	}
	var a = n,
	...
	'function' == typeof c.setTimeout && (d = setTimeout), 'function' == typeof c.clearTimeout && (D = clearTimeout)
	var f,
		y = [],
		E = !1,
		A = -1
		...
		if (!E) {
			...
			;(f = null),
				...
				(function (t) {
					...
					if ((D === l || !D) && clearTimeout) return (D = clearTimeout), clearTimeout(t)
					try {
						D(t)
					} catch (e) {
						try {
	...
	var O = 'object' == typeof L && L.env && L.env.NODE_DEBUG && /\bsemver\b/i.test(L.env.NODE_DEBUG) ? (...t) => console.error('SEMVER', ...t) : () => {}
	var M = { SEMVER_SPEC_VERSION: '2.0.0', MAX_LENGTH: 256, MAX_SAFE_INTEGER: Number.MAX_SAFE_INTEGER || 9007199254740991, MAX_SAFE_COMPONENT_LENGTH: 16 }
	function R(t, e, s) {
		return (
			t(
				(s = {
	...
	var j = R(function (t, e) {
		...
		o('NUMERICIDENTIFIER', '0|[1-9]\\d*'),
			...
			o('MAINVERSION', '('.concat(i[n.NUMERICIDENTIFIER], ')\\.') + '('.concat(i[n.NUMERICIDENTIFIER], ')\\.') + '('.concat(i[n.NUMERICIDENTIFIER], ')')),
			o('MAINVERSIONLOOSE', '('.concat(i[n.NUMERICIDENTIFIERLOOSE], ')\\.') + '('.concat(i[n.NUMERICIDENTIFIERLOOSE], ')\\.') + '('.concat(i[n.NUMERICIDENTIFIERLOOSE], ')')),
			o('PRERELEASEIDENTIFIER', '(?:'.concat(i[n.NUMERICIDENTIFIER], '|').concat(i[n.NONNUMERICIDENTIFIER], ')')),
			o('PRERELEASEIDENTIFIERLOOSE', '(?:'.concat(i[n.NUMERICIDENTIFIERLOOSE], '|').concat(i[n.NONNUMERICIDENTIFIER], ')')),
			o('PRERELEASE', '(?:-('.concat(i[n.PRERELEASEIDENTIFIER], '(?:\\.').concat(i[n.PRERELEASEIDENTIFIER], ')*))')),
			o('PRERELEASELOOSE', '(?:-?('.concat(i[n.PRERELEASEIDENTIFIERLOOSE], '(?:\\.').concat(i[n.PRERELEASEIDENTIFIERLOOSE], ')*))')),
			o('BUILDIDENTIFIER', '[0-9A-Za-z-]+'),
			o('BUILD', '(?:\\+('.concat(i[n.BUILDIDENTIFIER], '(?:\\.').concat(i[n.BUILDIDENTIFIER], ')*))')),
			o('FULLPLAIN', 'v?'.concat(i[n.MAINVERSION]).concat(i[n.PRERELEASE], '?').concat(i[n.BUILD], '?')),
			o('FULL', '^'.concat(i[n.FULLPLAIN], '$')),
			o('LOOSEPLAIN', '[v=\\s]*'.concat(i[n.MAINVERSIONLOOSE]).concat(i[n.PRERELEASELOOSE], '?').concat(i[n.BUILD], '?')),
			o('LOOSE', '^'.concat(i[n.LOOSEPLAIN], '$')),
			o('GTLT', '((?:<|>)?=?)'),
			o('XRANGEIDENTIFIERLOOSE', ''.concat(i[n.NUMERICIDENTIFIERLOOSE], '|x|X|\\*')),
			...
			o('XRANGELOOSE', '^'.concat(i[n.GTLT], '\\s*').concat(i[n.XRANGEPLAINLOOSE], '$')),
			o('COERCE', ''.concat('(^|[^\\d])(\\d{1,').concat(s, '})') + '(?:\\.(\\d{1,'.concat(s, '}))?') + '(?:\\.(\\d{1,'.concat(s, '}))?') + '(?:$|[^\\d])'),
			...
			o('TILDELOOSE', '^'.concat(i[n.LONETILDE]).concat(i[n.XRANGEPLAINLOOSE], '$')),
			o('LONECARET', '(?:\\^)'),
			o('CARETTRIM', '(\\s*)'.concat(i[n.LONECARET], '\\s+'), !0),
			(e.caretTrimReplace = '$1^'),
			o('CARET', '^'.concat(i[n.LONECARET]).concat(i[n.XRANGEPLAIN], '$')),
			o('CARETLOOSE', '^'.concat(i[n.LONECARET]).concat(i[n.XRANGEPLAINLOOSE], '$')),
			o('COMPARATORLOOSE', '^'.concat(i[n.GTLT], '\\s*(').concat(i[n.LOOSEPLAIN], ')$|^$')),
			o('COMPARATOR', '^'.concat(i[n.GTLT], '\\s*(').concat(i[n.FULLPLAIN], ')$|^$')),
			o('COMPARATORTRIM', '(\\s*)'.concat(i[n.GTLT], '\\s*(').concat(i[n.LOOSEPLAIN], '|').concat(i[n.XRANGEPLAIN], ')'), !0),
			(e.comparatorTrimReplace = '$1$2$3'),
			o('HYPHENRANGE', '^\\s*('.concat(i[n.XRANGEPLAIN], ')') + '\\s+-\\s+' + '('.concat(i[n.XRANGEPLAIN], ')') + '\\s*$'),
			o('HYPHENRANGELOOSE', '^\\s*('.concat(i[n.XRANGEPLAINLOOSE], ')') + '\\s+-\\s+' + '('.concat(i[n.XRANGEPLAINLOOSE], ')') + '\\s*$'),
			o('STAR', '(<|>)?=?\\s*\\*'),
			o('GTE0', '^\\s*>=\\s*0.0.0\\s*$'),
	...
	const U = /^[0-9]+$/,
		q = (t, e) => {
			const s = U.test(t),
				r = U.test(e)
			return s && r && ((t = +t), (e = +e)), t === e ? 0 : s && !r ? -1 : r && !s ? 1 : t < e ? -1 : 1
		}
	var V = { compareIdentifiers: q, rcompareIdentifiers: (t, e) => q(e, t) }
	const { MAX_LENGTH: z, MAX_SAFE_INTEGER: H } = M,
		{ re: W, t: X } = j,
		{ compareIdentifiers: G } = V
	class K {
		constructor(t, e) {
			if (((e && 'object' == typeof e) || (e = { loose: !!e, includePrerelease: !1 }), t instanceof K)) {
			...
			if (t.length > z) throw new TypeError('version is longer than '.concat(z, ' characters'))
			O('SemVer', t, e), (this.options = e), (this.loose = !!e.loose), (this.includePrerelease = !!e.includePrerelease)
			const s = t.trim().match(e.loose ? W[X.LOOSE] : W[X.FULL])
			if (!s) throw new TypeError('Invalid Version: '.concat(t))
			if (((this.raw = t), (this.major = +s[1]), (this.minor = +s[2]), (this.patch = +s[3]), this.major > H || this.major < 0)) throw new TypeError('Invalid major version')
		...
		compareMain(t) {
			return t instanceof K || (t = new K(t, this.options)), G(this.major, t.major) || G(this.minor, t.minor) || G(this.patch, t.patch)
		}
		comparePre(t) {
			if ((t instanceof K || (t = new K(t, this.options)), this.prerelease.length && !t.prerelease.length)) return -1
			...
			do {
				const s = this.prerelease[e],
					r = t.prerelease[e]
				if ((O('prerelease compare', e, s, r), void 0 === s && void 0 === r)) return 0
			...
			switch (t) {
				...
				case 'pre':
					if (0 === this.prerelease.length) this.prerelease = [0]
						...
						for (; --t >= 0; ) 'number' == typeof this.prerelease[t] && (this.prerelease[t]++, (t = -2))
	...
	var Q = (t, e, s) => $(t, e, s) >= 0,
		...
		tt = R(function (t, e) {
			...
			function d(t, e) {
				for (var s = '', r = 0, i = t.length; r < i; r++) (s += t[r]), r < i - 1 && (s += e[r])
				return s
			}
			function D(t) {
					...
					function r(n) {
						...
						if (D(n)) {
							var c = n,
								...
								y = f ? i : s,
								E = y.get(c)
							if ((E || ((E = l(c, f, e)), y.set(c, E)), 0 === o.length)) return E[0]
			...
			try {
				;(t.exports = m), Object.defineProperty(m, '__esModule', { value: !0 }), (m.default = m), (m.outdent = m)
			} catch (t) {}
		})
	function et() {
	...
	const { outdent: ot } = tt,
		...
		lt = 'Special',
		dt = {
			cursorOffset: { since: '1.4.0', category: lt, type: 'int', default: -1, range: { start: -1, end: 1 / 0, step: 1 }, description: ot(at()), cliCategory: ht },
			endOfLine: {
				since: '1.15.0',
				category: pt,
				type: 'choice',
			...
			insertPragma: { since: '1.8.0', category: lt, type: 'boolean', default: !1, description: "Insert @format pragma into file's first docblock comment.", cliCategory: ct },
			parser: {
				since: '0.0.10',
				category: pt,
				type: 'choice',
			...
			printWidth: { since: '0.0.0', category: pt, type: 'int', default: 80, description: 'The line length where Prettier will try wrap.', range: { start: 0, end: 1 / 0, step: 1 } },
			rangeEnd: { since: '1.4.0', category: lt, type: 'int', default: 1 / 0, range: { start: 0, end: 1 / 0, step: 1 }, description: ot(rt()), cliCategory: ht },
			rangeStart: { since: '1.4.0', category: lt, type: 'int', default: 0, range: { start: 0, end: 1 / 0, step: 1 }, description: ot(st()), cliCategory: ht },
			requirePragma: { since: '1.7.0', category: lt, type: 'boolean', default: !1, description: ot(et()), cliCategory: ct },
			tabWidth: { type: 'int', category: pt, default: 2, description: 'Number of spaces per indentation level.', range: { start: 0, end: 1 / 0, step: 1 } },
			useTabs: { since: '1.0.0', category: pt, type: 'boolean', default: !1, description: 'Indent with tabs instead of spaces.' },
	...
	const Dt = { compare: $, lt: Y, gte: Q },
		mt = Z,
		ft = { CATEGORY_CONFIG: ut, CATEGORY_EDITOR: ht, CATEGORY_FORMAT: 'Format', CATEGORY_OTHER: ct, CATEGORY_OUTPUT: 'Output', CATEGORY_GLOBAL: pt, CATEGORY_SPECIAL: lt, options: dt }.options
	var yt = {
		getSupportInfo: function ({ plugins: t = [], showUnreleased: e = !1, showDeprecated: s = !1, showInternal: r = !1 } = {}) {
			const i = mt.split('-', 1)[0],
				n = t.reduce((t, e) => t.concat(e.languages || []), []).filter(h),
				a = ((o = Object.assign({}, ...t.map(({ options: t }) => t), ft)), (u = 'name'), Object.entries(o).map(([t, e]) => Object.assign({ [u]: t }, e)))
					.filter(t => h(t) && c(t))
					...
					.map(function (t) {
						...
						return (function (t, e) {
							...
							var s,
								...
								i = {},
								n = Object.keys(t)
							for (r = 0; r < n.length; r++) (s = n[r]), e.indexOf(s) >= 0 || (i[s] = t[s])
							return i
						})(t, ['cliName', 'cliCategory', 'cliDescription'])
					})
					.map(e => {
						;(e = Object.assign({}, e)),
							Array.isArray(e.default) && (e.default = 1 === e.default.length ? e.default[0].value : e.default.filter(h).sort((t, e) => Dt.compare(e.since, t.since))[0].value),
											...
											if (i.parsers)
												for (const e of i.parsers)
													if (!r.has(e)) {
														...
														let a = i.name
														n && n.name && (a += ' (plugin: '.concat(n.name, ')')), t.choices.push({ value: e, description: a })
													}
									})(e, n, t))
						const s = t.filter(t => t.defaultOptions && void 0 !== t.defaultOptions[e.name]).reduce((t, s) => ((t[s.name] = s.defaultOptions[e.name]), t), {})
						return Object.assign({}, e, { pluginDefaults: s })
					})
			var o, u
			return { languages: n, options: a }
			function h(t) {
				return e || !('since' in t) || (t.since && Dt.gte(i, t.since))
			}
			function c(t) {
				return s || !('deprecated' in t) || (t.deprecated && Dt.lt(i, t.deprecated))
			}
		},
	}
	const { getSupportInfo: Et } = yt,
		At = /[^\x20-\x7F]/
	function Ct(t) {
		return (e, s, r) => {
	...
	function Tt(t, e) {
		return !1 !== e && ('/' === t.charAt(e) && '/' === t.charAt(e + 1) ? bt(t, e) : e)
	}
	function wt(t, e, s) {
	...
	function Bt(t, e, s) {
		const r = Ft(t, (s = s || {}).backwards ? e - 1 : e, s)
		return r !== wt(t, r, s)
	}
	function St(t, e) {
		let s = null,
			r = e
		for (; r !== s; ) (s = r), (r = gt(t, r)), (r = Pt(t, r)), (r = Ft(t, r))
		return (r = Tt(t, r)), (r = wt(t, r)), !1 !== r && Bt(t, r)
	}
	function Nt(t, e) {
		let s = null,
			r = e
		for (; r !== s; ) (s = r), (r = Ft(t, r)), (r = Pt(t, r)), (r = Tt(t, r)), (r = wt(t, r))
		return r
	}
	function It(t, e, s) {
		return Nt(t, s(e))
	...
	function vt(t, e, s) {
		let r = 0
		for (let i = (s = s || 0); i < t.length; ++i) '\t' === t[i] ? (r = r + e - (r % e)) : r++
		return r
	}
	function kt(t, e) {
		const s = t.slice(1, -1),
		...
		if (s.includes(n.quote) || s.includes(a.quote)) {
			o = (s.match(n.regex) || []).length > (s.match(a.regex) || []).length ? a.quote : n.quote
		}
		return o
	}
	function Lt(t, e, s) {
		const r = '"' === e ? "'" : '"',
			i = t.replace(/\\([\S\s])|(["'])/g, (t, i, n) => (i === r ? i : n === e ? '\\' + n : n || (s && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/.test(i) ? i : '\\' + i)))
		return e + i + e
	}
	function Ot(t, e) {
	...
	var Mt = {
			inferParserByLanguage: function (t, e) {
				const { languages: s } = Et({ plugins: e.plugins }),
					r =
						s.find(({ name: e }) => e.toLowerCase() === t) ||
						s.find(({ aliases: e }) => Array.isArray(e) && e.includes(t)) ||
						s.find(({ extensions: e }) => Array.isArray(e) && e.includes('.'.concat(t)))
			...
			getStringWidth: function (t) {
				return t ? (At.test(t) ? a(t) : t.length) : 0
			},
			...
			getNextNonSpaceNonCommentCharacterIndexWithStartIndex: Nt,
			getNextNonSpaceNonCommentCharacterIndex: It,
			getNextNonSpaceNonCommentCharacter: function (t, e, s) {
				return t.charAt(It(t, e, s))
			},
			skip: Ct,
			skipWhitespace: xt,
			skipSpaces: Ft,
			skipToLineEnd: gt,
			skipEverythingButNewLine: bt,
			skipInlineComment: Pt,
			skipTrailingComment: Tt,
			skipNewline: wt,
			isNextLineEmptyAfterIndex: St,
			isNextLineEmpty: function (t, e, s) {
				return St(t, s(e))
			},
			isPreviousLineEmpty: function (t, e, s) {
				let r = s(e) - 1
				return (r = Ft(t, r, { backwards: !0 })), (r = wt(t, r, { backwards: !0 })), (r = Ft(t, r, { backwards: !0 })), r !== wt(t, r, { backwards: !0 })
			},
			hasNewline: Bt,
			...
			hasSpaces: function (t, e, s) {
				return Ft(t, (s = s || {}).backwards ? e - 1 : e, s) !== e
			},
			getAlignmentSize: vt,
			getIndentSize: function (t, e) {
				const s = t.lastIndexOf('\n')
				return -1 === s ? 0 : vt(t.slice(s + 1).match(/^[\t ]*/)[0], e)
			},
			getPreferredQuote: kt,
			printString: function (t, e, s) {
				const r = t.slice(1, -1),
					i = !r.includes('"') && !r.includes("'"),
					n = 'json' === e.parser ? '"' : e.__isInHtmlAttribute ? "'" : kt(t, e.singleQuote ? "'" : '"')
				return s ? (i ? n + r + n : t) : Lt(r, n, !('css' === e.parser || 'less' === e.parser || 'scss' === e.parser || e.embeddedInHtml))
			},
			...
			addLeadingComment: function (t, e) {
				;(e.leading = !0), (e.trailing = !1), Ot(t, e)
			},
			addDanglingComment: function (t, e, s) {
				;(e.leading = !1), (e.trailing = !1), s && (e.marker = s), Ot(t, e)
			},
			addTrailingComment: function (t, e) {
				;(e.leading = !1), (e.trailing = !0), Ot(t, e)
			},
		...
		Rt = Object.freeze({ __proto__: null, default: { EOL: '\n', platform: () => 'browser', cpus: () => [{ model: 'Prettier' }] } })
	const _t = t => {
		if ('string' != typeof t) throw new TypeError('Expected a string')
		const e = t.match(/(?:\r?\n)/g) || []
	...
	var jt = _t
	jt.graceful = t => ('string' == typeof t && _t(t)) || '\n'
	var Ut = _(Rt),
		qt = R(function (t, e) {
			function s() {
				const t = Ut
			...
			function r() {
				const t = (e = jt) && e.__esModule ? e : { default: e }
				var e
				return (
					(r = function () {
						return t
			...
			function d(t) {
				...
				let a = ''
				for (; a !== t; ) (a = t), (t = t.replace(h, ''.concat(e, '$1 $2').concat(e)))
				...
				for (; (m = c.exec(t)); ) {
					...
					'string' == typeof d[m[1]] || Array.isArray(d[m[1]]) ? (d[m[1]] = l.concat(d[m[1]], t)) : (d[m[1]] = t)
				}
	...
	var Vt = {
		...
		countEndOfLineChars: function (t, e) {
			...
			if ('\n' === e) s = /\n/g
				...
				if ('\r\n' !== e) throw new Error('Unexpected "eol" '.concat(JSON.stringify(e), '.'))
				s = /\r\n/g
			}
			const r = t.match(s)
			return r ? r.length : 0
	...
	const { parseWithComments: zt, strip: Ht, extract: Wt, print: Xt } = qt,
		{ getShebang: Gt } = Mt,
		{ normalizeEndOfLine: Kt } = Vt
	function Jt(t) {
		const e = Gt(t)
		e && (t = t.slice(e.length + 1))
		const s = Wt(t),
			{ pragmas: r, comments: i } = zt(s)
		return { shebang: e, text: t, pragmas: r, comments: i }
	}
	var $t = {
		hasPragma: function (t) {
			const e = Object.keys(Jt(t).pragmas)
			return e.includes('prettier') || e.includes('format')
		},
		insertPragma: function (t) {
			const { shebang: e, text: s, pragmas: r, comments: i } = Jt(t),
				n = Ht(s),
				a = Xt({ pragmas: Object.assign({ format: '' }, r), comments: i.trimStart() })
			return (e ? ''.concat(e, '\n') : '') + Kt(a) + (n.startsWith('\n') ? '\n' : '\n\n') + n
		},
	}
	function Yt(t, e) {
		...
		if (!s) {
			...
			if (e && e.length > 0) return Yt(e[0])
		}
		return t.range ? t.range[0] : t.start
	}
	function Qt(t) {
		const e = t.range ? t.range[1] : t.end
		return t.typeAnnotation ? Math.max(e, Qt(t.typeAnnotation)) : e
	}
	function Zt(t, e) {
		return Yt(t) === Yt(e)
	}
	var te = {
			...
			composeLoc: function (t, e = t) {
				const s = Yt(t)
				return [s, 'number' == typeof e ? s + e : Qt(e)]
			},
			hasSameLocStart: Zt,
		...
		se = R(function (t) {
			!(function () {
				...
				for (
					...
					i[a] = (a >= 97 && a <= 122) || (a >= 65 && a <= 90) || 36 === a || 95 === a
				for (n = new Array(128), a = 0; a < 128; ++a) n[a] = (a >= 97 && a <= 122) || (a >= 65 && a <= 90) || (a >= 48 && a <= 57) || 36 === a || 95 === a
				t.exports = {
					...
					isWhiteSpace: function (t) {
						return 32 === t || 9 === t || 11 === t || 12 === t || 160 === t || (t >= 5760 && r.indexOf(t) >= 0)
					},
		...
		re = R(function (t) {
			!(function () {
				...
				function a(t) {
					...
					for (s = 1, r = t.length; s < r; ++s) if (((i = t.charCodeAt(s)), !e.isIdentifierPartES5(i))) return !1
					return !0
				}
				function o(t) {
					var s, r, i, n, a
	...
	const ie = R(function (t, e) {
			;(e.ast = ee), (e.code = se), (e.keyword = re)
		}).keyword.isIdentifierNameES5,
		{ getLast: ne, hasNewline: ae, hasNewlineInRange: oe, skipWhitespace: ue } = Mt,
		{ locStart: he, locEnd: ce, hasSameLocStart: pe } = te,
		le = '(?:(?=.)\\s)',
		de = new RegExp('^'.concat(le, '*:')),
		De = new RegExp('^'.concat(le, '*::'))
	function me(t, e) {
		if (!t || 'object' != typeof t) return !1
		if (Array.isArray(t)) return t.some(t => me(t, e))
		const s = e(t)
		return 'boolean' == typeof s ? s : Object.keys(t).some(s => me(t[s], e))
	}
	function fe(t) {
		return (
	...
	function ye(t) {
		return 'Block' === t.type || 'CommentBlock' === t.type || 'MultiLine' === t.type
	}
	const Ee = new Set(['ExportDefaultDeclaration', 'ExportDefaultSpecifier', 'DeclareExportDeclaration', 'ExportNamedDeclaration', 'ExportAllDeclaration'])
	function Ae(t) {
		return t && Ee.has(t.type)
	}
	function Ce(t) {
		return (
	...
	function xe(t) {
		return 'NumericLiteral' === t.type || ('Literal' === t.type && 'number' == typeof t.value)
	}
	function Fe(t) {
		return 'StringLiteral' === t.type || ('Literal' === t.type && 'string' == typeof t.value)
	}
	function ge(t) {
	...
	function be(t) {
		return !(
			...
			('async' !== t.callee.name && 'inject' !== t.callee.name && 'fakeAsync' !== t.callee.name)
		)
	}
	function Pe(t) {
	...
	function we(t) {
		return Te(t) || pe(t, t.value)
	}
	const Be = new Set(['BinaryExpression', 'LogicalExpression', 'NGPipeExpression'])
	const Se = new Set([
		'AnyTypeAnnotation',
		'TSAnyKeyword',
	...
	const Ne = /^(skip|[fx]?(it|describe|test))$/
	function Ie(t) {
	...
	const ve = new RegExp('([ \n\r\t]+)'),
		ke = new RegExp('[^ \n\r\t]')
	function Le(t) {
		return Ce(t) && (ke.test(_e(t)) || !/\n/.test(_e(t)))
	}
	function Oe(t, e) {
		if (Pe(e)) return Ke(e)
		return e.comments && e.comments.some(e => e.leading && ae(t, ce(e)))
	}
	function Me(t) {
		return /^(\d+|\d+\.\d+)$/.test(t)
	}
	...
	function We(t) {
		...
		const e = []
		return t.this && e.push(t.this), Array.isArray(t.parameters) ? e.push(...t.parameters) : Array.isArray(t.params) && e.push(...t.params), t.rest && e.push(t.rest), He.set(t, e), e
	}
	...
	function Ke(t) {
		return t && ((t.comments && t.comments.length > 0 && t.comments.some(t => Ge(t) && !t.unignore)) || t.prettierIgnore)
	}
	function Je(t) {
		return Ke(t.getValue())
	}
	var $e = {
			...
			if (t) {
				...
				switch (t.type) {
					...
					case 'ClassPrivateMethod': {
						...
						return !e && 'get' !== t.kind && 'set' !== t.kind && !(!t.computed && !s)
					}
		...
		classPropMayCauseASIProblems: function (t) {
			...
			return !(('static' !== s && 'get' !== s && 'set' !== s) || e.value || e.typeAnnotation) || void 0
		},
		getFunctionParameters: We,
		iterateFunctionParametersPath: function (t, e) {
			const s = t.getValue()
			let r = 0
			const i = t => e(t, r++)
			s.this && t.call(i, 'this'), Array.isArray(s.parameters) ? t.each(i, 'parameters') : Array.isArray(s.params) && t.each(i, 'params'), s.rest && t.call(i, 'rest')
		},
		...
		iterateCallArgumentsPath: function (t, e) {
			'ImportExpression' === t.getValue().type ? t.call(t => e(t, 0), 'source') : t.each(e, 'arguments')
		},
		hasRestParameter: function (t) {
			if (t.rest) return !0
			const e = We(t)
			return e.length > 0 && 'RestElement' === ne(e).type
		},
		...
		getParentExportDeclaration: function (t) {
			...
			return 'declaration' === t.getName() && Ae(e) ? e : null
		},
		...
		hasFlowAnnotationComment: function (t) {
			return t && ye(t[0]) && De.test(t[0].value)
		},
		hasFlowShorthandAnnotationComment: function (t) {
			return t.extra && t.extra.parenthesized && t.trailingComments && ye(t.trailingComments[0]) && de.test(t.trailingComments[0].value)
		},
		hasLeadingComment: function (t) {
			return t.comments && t.comments.some(t => t.leading)
		},
		hasLeadingOwnLineComment: Oe,
		hasNakedLeftSide: fe,
		hasNewlineBetweenOrAfterDecorators: function (t, e) {
			return oe(e.originalText, he(t.decorators[0]), ce(ne(t.decorators))) || ae(e.originalText, ce(ne(t.decorators)))
		},
		hasNgSideEffect: function (t) {
			return me(t.getValue(), t => {
				switch (t.type) {
					case void 0:
						return !1
					case 'CallExpression':
		...
		hasPrettierIgnore: function (t) {
			return (
				...
				(function (t) {
					const e = t.getValue(),
						s = t.getParentNode()
					if (!(s && e && Pe(e) && Pe(s))) return !1
					let r = null
					for (let t = s.children.indexOf(e); t > 0; t--) {
						const e = s.children[t - 1]
						if ('JSXText' !== e.type || Le(e)) {
							r = e
							break
						}
					}
					return r && 'JSXExpressionContainer' === r.type && 'JSXEmptyExpression' === r.expression.type && r.expression.comments && r.expression.comments.some(t => Ge(t))
				})(t)
			)
		},
		...
		hasTrailingLineComment: function (t) {
			return t.comments && t.comments.some(t => t.trailing && !ye(t))
		},
		hasIgnoreComment: Je,
		hasNodeIgnoreComment: Ke,
		identity: function (t) {
			return t
		},
		isBinaryish: function (t) {
			return Be.has(t.type)
		},
		isBlockComment: ye,
		isLineComment: function (t) {
			return 'Line' === t.type || 'CommentLine' === t.type || 'SingleLine' === t.type || 'HashbangComment' === t.type || 'HTMLOpen' === t.type || 'HTMLClose' === t.type
		},
		isPrettierIgnoreComment: Ge,
		isCallOrOptionalCallExpression: Ie,
		...
		isFunctionCompositionArgs: function (t) {
			...
			for (const s of t)
				if (ge(s)) {
					if (((e += 1), e > 1)) return !0
				} else if (Ie(s)) for (const t of s.arguments) if (ge(t)) return !0
			return !1
		},
		isFunctionNotation: we,
		isFunctionOrArrowExpression: ge,
		isGetterOrSetter: Te,
			...
			return (
				...
				(('Identifier' === e.tag.object.type && s.test(e.tag.object.name)) ||
					('MemberExpression' === e.tag.object.type &&
						...
						('only' === e.tag.object.property.name || 'skip' === e.tag.object.property.name) &&
		...
		isJSXWhitespaceExpression: function (t) {
			return 'JSXExpressionContainer' === t.type && Ce(t.expression) && ' ' === t.expression.value && !t.expression.comments
		},
		...
		isLongCurriedCallExpression: function (t) {
			const e = t.getValue(),
				s = t.getParentNode()
			return Ie(e) && Ie(s) && s.callee === e && e.arguments.length > s.arguments.length && s.arguments.length > 0
		},
		isSimpleCallArgument: function t(e, s) {
			if (s >= 2) return !1
			const r = e => t(e, s + 1),
				i = ('Literal' === e.type && 'regex' in e && e.regex.pattern) || ('RegExpLiteral' === e.type && e.pattern)
			return (
				!(i && i.length > 5) &&
				('Literal' === e.type ||
					...
					('TemplateLiteral' === e.type
						...
						? e.properties.every(t => !t.computed && (t.shorthand || (t.value && r(t.value))))
						: 'ArrayExpression' === e.type
						? e.elements.every(t => null === t || r(t))
						: 'ImportExpression' === e.type
						? r(e.source)
						: 'CallExpression' === e.type || 'OptionalCallExpression' === e.type || 'NewExpression' === e.type
						? t(e.callee, s) && e.arguments.every(r)
						: 'MemberExpression' === e.type || 'OptionalMemberExpression' === e.type
						? t(e.object, s) && t(e.property, s)
						: 'UnaryExpression' !== e.type || ('!' !== e.operator && '-' !== e.operator)
						? 'TSNonNullExpression' === e.type && t(e.expression, s)
						: t(e.argument, s)))
			)
		},
		isMeaningfulJSXText: Le,
		isMemberExpressionChain: function t(e) {
			return ('MemberExpression' === e.type || 'OptionalMemberExpression' === e.type) && ('Identifier' === e.object.type || t(e.object))
		},
		isMemberish: function (t) {
			return 'MemberExpression' === t.type || 'OptionalMemberExpression' === t.type || ('BindExpression' === t.type && Boolean(t.object))
		},
		isNgForOf: function (t, e, s) {
			return 'NGMicrosyntaxKeyedExpression' === t.type && 'of' === t.key.name && 1 === e && 'NGMicrosyntaxLet' === s.body[0].type && null === s.body[0].value
		},
		isNumericLiteral: xe,
		...
		isObjectTypePropertyAFunction: function (t) {
			return !(('ObjectTypeProperty' !== t.type && 'ObjectTypeInternalSlot' !== t.type) || 'FunctionTypeAnnotation' !== t.value.type || t.static || we(t))
		},
		isSimpleType: function (t) {
			return !!t && (!(('GenericTypeAnnotation' !== t.type && 'TSTypeReference' !== t.type) || t.typeParameters) || !!Se.has(t.type))
		},
		isSimpleNumber: Me,
		isSimpleTemplateLiteral: function (t) {
			...
			return (
				...
				s.every(t => {
					...
					if ('MemberExpression' === t.type || 'OptionalMemberExpression' === t.type) {
						let e = t
						for (; 'MemberExpression' === e.type || 'OptionalMemberExpression' === e.type; ) {
							if ('Identifier' !== e.property.type && 'Literal' !== e.property.type && 'StringLiteral' !== e.property.type && 'NumericLiteral' !== e.property.type) return !1
		...
		isStringPropSafeToUnquote: function (t, e) {
			return (
				'json' !== e.parser &&
				Fe(t.key) &&
				_e(t.key).slice(1, -1) === t.key.value &&
				((ie(t.key.value) && !(('typescript' === e.parser || 'babel-ts' === e.parser) && 'ClassProperty' === t.type)) ||
					(Me(t.key.value) && String(Number(t.key.value)) === t.key.value && ('babel' === e.parser || 'espree' === e.parser || 'meriyah' === e.parser)))
			)
		},
		isTemplateOnItsOwnLine: function (t, e) {
			return (('TemplateLiteral' === t.type && Re(t)) || ('TaggedTemplateExpression' === t.type && Re(t.quasi))) && !ae(e, he(t), { backwards: !0 })
		},
		isTestCall: function t(e, s) {
			if ('CallExpression' !== e.type) return !1
			if (1 === e.arguments.length) {
				if (be(e) && s && t(s)) return ge(e.arguments[0])
				if ('Identifier' === (r = e).callee.type && /^(before|after)(Each|All)$/.test(r.callee.name) && 1 === r.arguments.length) return be(e.arguments[0])
			} else if (
				(2 === e.arguments.length || 3 === e.arguments.length) &&
				(('Identifier' === e.callee.type && Ne.test(e.callee.name)) ||
					(function (t) {
						return (
							('MemberExpression' === t.callee.type || 'OptionalMemberExpression' === t.callee.type) &&
							'Identifier' === t.callee.object.type &&
							'Identifier' === t.callee.property.type &&
							Ne.test(t.callee.object.name) &&
							('only' === t.callee.property.name || 'skip' === t.callee.property.name)
						)
					})(e)) &&
				((function (t) {
				...
				return (
					!(e.arguments[2] && !xe(e.arguments[2])) &&
					((2 === e.arguments.length
						? ge(e.arguments[1])
						: (function (t) {
								return 'FunctionExpression' === t.type || ('ArrowFunctionExpression' === t.type && 'BlockStatement' === t.body.type)
						  })(e.arguments[1]) && We(e.arguments[1]).length <= 1) ||
						be(e.arguments[1]))
				)
			var r
			return !1
		...
		isTheOnlyJSXElementInMarkdown: function (t, e) {
			...
			const s = e.getNode()
			if (!s.expression || !Pe(s.expression)) return !1
		...
		isTypeAnnotationAFunction: function (t) {
			return !(('TypeAnnotation' !== t.type && 'TSTypeAnnotation' !== t.type) || 'FunctionTypeAnnotation' !== t.typeAnnotation.type || t.static || pe(t, t.typeAnnotation))
		},
		matchJsxWhitespaceRegex: ve,
		needsHardlineAfterDanglingComment: function (t) {
			if (!t.comments) return !1
			const e = ne(t.comments.filter(t => !t.leading && !t.trailing))
			return e && !ye(e)
		},
		rawText: _e,
		returnArgumentHasLeadingComment: function (t, e) {
			if (Oe(t.originalText, e)) return !0
			if (fe(e)) {
				let r,
					i = e
				for (; (r = (s = i).expressions ? s.expressions[0] : s.left || s.test || s.callee || s.object || s.tag || s.argument || s.expression); ) if (((i = r), Oe(t.originalText, i))) return !0
			}
			var s
			return !1
		},
		shouldPrintComma: function (t, e = 'es5') {
			return ('es5' === t.trailingComma && 'es5' === e) || ('all' === t.trailingComma && ('all' === e || 'es5' === e))
		},
		isBitwiseOperator: function (t) {
			return !!qe[t] || '|' === t || '^' === t || '&' === t
		},
		shouldFlatten: function (t, e) {
			return ze(e) === ze(t) && '**' !== t && (!je[t] || !je[e]) && !(('%' === e && Ue[t]) || ('%' === t && Ue[e])) && (e === t || !Ue[e] || !Ue[t]) && (!qe[t] || !qe[e])
		},
	...
	const {
			getLast: Ye,
			hasNewline: Qe,
			getNextNonSpaceNonCommentCharacterIndexWithStartIndex: Ze,
			getNextNonSpaceNonCommentCharacter: ts,
			hasNewlineInRange: es,
			addLeadingComment: ss,
			addTrailingComment: rs,
			addDanglingComment: is,
			getNextNonSpaceNonCommentCharacterIndex: ns,
		} = Mt,
		{ isBlockComment: as, getFunctionParameters: os, isPrettierIgnoreComment: us, isJSXNode: hs, hasFlowShorthandAnnotationComment: cs, hasFlowAnnotationComment: ps, hasIgnoreComment: ls } = $e,
		{ locStart: ds, locEnd: Ds } = te
	function ms(t, e) {
		const s = (t.body || t.properties).find(({ type: t }) => 'EmptyStatement' !== t)
		s ? ss(s, e) : is(t, e)
	}
	function fs(t, e) {
		'BlockStatement' === t.type ? ms(t, e) : ss(t, e)
	}
	function ys(t, e) {
		...
		return ')' === ts(e, t, Ds)
			...
			? ('BlockStatement' === s.type ? rs(s, t) : is(r, t), !0)
			: 'BlockStatement' === i.type
			? (ms(i, t), !0)
			: 'IfStatement' === i.type
			? (fs(i.consequent, t), !0)
			: r.consequent === i && (ss(i, t), !0)
	}
	function Es(t, e) {
		const { precedingNode: s, enclosingNode: r, followingNode: i } = t
		if (!r || 'WhileStatement' !== r.type || !i) return !1
		return ')' === ts(e, t, Ds) ? (rs(s, t), !0) : 'BlockStatement' === i.type ? (ms(i, t), !0) : r.body === i && (ss(i, t), !0)
	}
	function As(t) {
		...
		return (
			...
			('CatchClause' === s.type && e
				...
				: 'TryStatement' === r.type
				? (fs(r.finalizer, t), !0)
				: 'CatchClause' === r.type && (fs(r.body, t), !0))
		)
	}
	function Cs(t) {
		const { precedingNode: e, enclosingNode: s, followingNode: r } = t
		if (
			...
			if (s.decorators && s.decorators.length > 0 && (!r || 'Decorator' !== r.type)) return rs(s.decorators[s.decorators.length - 1], t), !0
			if (s.body && r === s.body) return ms(s.body, t), !0
			if (r) for (const i of ['implements', 'extends', 'mixins']) if (s[i] && r === s[i][0]) return !e || (e !== s.id && e !== s.typeParameters && e !== s.superClass) ? is(s, t, i) : rs(e, t), !0
		}
		return !1
	}
	function xs(t, e) {
		...
		return (
			((r && s && ('Property' === r.type || 'TSDeclareMethod' === r.type || 'TSAbstractMethodDefinition' === r.type) && 'Identifier' === s.type && r.key === s && ':' !== ts(e, s, Ds)) ||
				!(
					!s ||
					!r ||
					'Decorator' !== s.type ||
	...
	function Fs(t, e) {
		const { precedingNode: s, enclosingNode: r, followingNode: i } = t
		if (s && 'FunctionTypeParam' === s.type && r && 'FunctionTypeAnnotation' === r.type && i && 'FunctionTypeParam' !== i.type) return rs(s, t), !0
		if (s && ('Identifier' === s.type || 'AssignmentPattern' === s.type) && r && ws(r) && ')' === ts(e, t, Ds)) return rs(s, t), !0
		if (r && 'FunctionDeclaration' === r.type && i && 'BlockStatement' === i.type) {
			const s = (() => {
				const t = os(r)
				if (0 !== t.length) return Ze(e, Ds(Ye(t)))
				const s = Ze(e, Ds(r.id))
				return !1 !== s && Ze(e, s + 1)
			})()
			if (ds(t) > s) return ms(i, t), !0
		}
		return !1
	}
	function gs(t) {
	...
	function Ps(t, e, s) {
		...
		return e && e.body && 0 === e.body.length
			? (s ? is(e, t) : ss(e, t), !0)
			: !(!r || 'Program' !== r.type || 0 !== r.body.length || !r.directives || 0 !== r.directives.length) && (s ? is(r, t) : ss(r, t), !0)
	}
	function Ts(t) {
		const { enclosingNode: e, followingNode: s } = t
		if (us(t) && e && 'TSMappedType' === e.type && s && 'TSTypeParameter' === s.type && s.constraint) return (e.prettierIgnore = !0), (t.unignore = !0), !0
	}
	function ws(t) {
		return (
	...
	function Bs(t) {
		return as(t) && '*' === t.value[0] && /@type\b/.test(t.value)
	}
	var Ss = {
		handleOwnLineComment: function (t, e, s, r, i) {
			return (
				...
				(function (t) {
					const { enclosingNode: e, followingNode: s } = t
					if (e && ('MemberExpression' === e.type || 'OptionalMemberExpression' === e.type) && s && 'Identifier' === s.type) return ss(e, t), !0
					return !1
				})(t) ||
				ys(t, e) ||
				Es(t, e) ||
				...
				(function (t) {
					const { enclosingNode: e } = t
					if (e && ('ForInStatement' === e.type || 'ForOfStatement' === e.type)) return ss(e, t), !0
					return !1
				})(t) ||
				(function (t) {
					const { precedingNode: e, enclosingNode: s, followingNode: r } = t
					if (s && ('UnionTypeAnnotation' === s.type || 'TSUnionType' === s.type)) return us(t) && ((r.prettierIgnore = !0), (t.unignore = !0)), !!e && (rs(e, t), !0)
					r && ('UnionTypeAnnotation' === r.type || 'TSUnionType' === r.type) && us(t) && ((r.types[0].prettierIgnore = !0), (t.unignore = !0))
					return !1
				})(t) ||
				Ps(t, r, i) ||
				(function (t, e) {
					const { precedingNode: s, enclosingNode: r } = t
					if (s && 'ImportSpecifier' === s.type && r && 'ImportDeclaration' === r.type && Qe(e, Ds(t))) return rs(s, t), !0
					return !1
				})(t, e) ||
				(function (t) {
					const { enclosingNode: e } = t
		...
		handleEndOfLineComment: function (t, e, s, r, i) {
			return (
				...
				(function (t, e) {
					const { precedingNode: s, enclosingNode: r, followingNode: i } = t,
						n = s && !es(e, Ds(s), ds(t))
					if ((!s || !n) && r && ('ConditionalExpression' === r.type || 'TSConditionalType' === r.type) && i) return ss(i, t), !0
					return !1
				})(t, e) ||
				gs(t) ||
				ys(t, e) ||
				...
				(function (t) {
					...
					if (s && ('CallExpression' === s.type || 'OptionalCallExpression' === s.type) && e && s.callee === e && s.arguments.length > 0) return ss(s.arguments[0], t), !0
					return !1
				})(t) ||
				(function (t) {
					const { enclosingNode: e } = t
				...
				(function (t) {
					const { enclosingNode: e } = t
					if (e && 'TypeAlias' === e.type) return ss(e, t), !0
					return !1
				})(t) ||
				(function (t) {
					const { enclosingNode: e, followingNode: s } = t
					if (
						...
						s &&
						('ObjectExpression' === s.type || 'ArrayExpression' === s.type || 'TemplateLiteral' === s.type || 'TaggedTemplateExpression' === s.type || as(t))
					)
						return ss(s, t), !0
					return !1
				})(t)
		...
		handleRemainingComment: function (t, e, s, r, i) {
			return !!(
				...
				(function (t) {
					const { precedingNode: e, enclosingNode: s } = t
					if (s && ('ObjectProperty' === s.type || 'Property' === s.type) && s.shorthand && s.key === e && 'AssignmentPattern' === s.value.type) return rs(s.value.left, t), !0
					return !1
				})(t) ||
				(function (t, e) {
					if (')' !== ts(e, t, Ds)) return !1
					const { enclosingNode: s } = t
					if (s && ((ws(s) && 0 === os(s).length) || (('CallExpression' === s.type || 'OptionalCallExpression' === s.type || 'NewExpression' === s.type) && 0 === s.arguments.length)))
						return is(s, t), !0
					if (s && 'MethodDefinition' === s.type && 0 === os(s.value).length) return is(s.value, t), !0
					return !1
				})(t, e) ||
				xs(t, e) ||
				Ps(t, r, i) ||
				(function (t, e) {
					...
					const r = ns(e, t, Ds)
					if (!1 !== r && '=>' === e.slice(r, r + 2)) return is(s, t), !0
					return !1
				})(t, e) ||
				(function (t, e) {
					if ('(' !== ts(e, t, Ds)) return !1
					const { precedingNode: s, enclosingNode: r } = t
					if (s && r && ('FunctionDeclaration' === r.type || 'FunctionExpression' === r.type || 'ClassMethod' === r.type || 'MethodDefinition' === r.type || 'ObjectMethod' === r.type))
						return rs(s, t), !0
					return !1
				})(t, e) ||
				(function (t) {
					...
					if (r && 'TSTypeParameter' === r.type && r.name) return ss(r.name, t), !0
					if (e && 'TSTypeParameter' === e.type && e.constraint) return rs(e.constraint, t), !0
					return !1
				})(t) ||
				(function (t) {
					const { enclosingNode: e } = t
					if (e && ('ContinueStatement' === e.type || 'BreakStatement' === e.type) && !e.label) return rs(e, t), !0
					return !1
				})(t) ||
				(function (t, e) {
					const { enclosingNode: s, followingNode: r } = t
					if (!r && s && ('TSMethodSignature' === s.type || 'TSDeclareFunction' === s.type || 'TSAbstractMethodDefinition' === s.type) && ';' === ts(e, t, Ds)) return rs(s, t), !0
					return !1
				})(t, e)
			)
		},
		...
		willPrintOwnComments: function (t) {
			const e = t.getValue(),
				s = t.getParentNode()
			return (
				((e && (hs(e) || cs(e) || (s && ('CallExpression' === s.type || 'OptionalCallExpression' === s.type) && (ps(e.leadingComments) || ps(e.trailingComments))))) ||
					(s &&
						('JSXSpreadAttribute' === s.type ||
							'JSXSpreadChild' === s.type ||
							'UnionTypeAnnotation' === s.type ||
							'TSUnionType' === s.type ||
							(('ClassDeclaration' === s.type || 'ClassExpression' === s.type) && s.superClass === e)))) &&
				(!ls(t) || 'UnionTypeAnnotation' === s.type || 'TSUnionType' === s.type)
			)
		},
	}
	const { getLast: Ns, getNextNonSpaceNonCommentCharacter: Is, getShebang: vs } = Mt,
		{ composeLoc: ks, locStart: Ls, locEnd: Os } = te,
		{ isTypeCastComment: Ms } = Ss
	function Rs(t) {
		return (
			'CallExpression' === t.type
				? ((t.type = 'OptionalCallExpression'), (t.callee = Rs(t.callee)))
				: 'MemberExpression' === t.type
				? ((t.type = 'OptionalMemberExpression'), (t.object = Rs(t.object)))
				: 'TSNonNullExpression' === t.type && (t.expression = Rs(t.expression)),
			t
		)
	}
	function _s(t, e) {
	...
	function Us(t) {
		return js(t)
			? Us({
					...
					operator: t.operator,
					left: Us({ type: 'LogicalExpression', operator: t.operator, left: t.left, right: t.right.left, range: ks(t.left, t.right.left) }),
					right: t.right.right,
					range: ks(t),
			  })
			: t
	...
	var qs = function (e, s) {
			if (
				(('typescript' !== s.parser && 'flow' !== s.parser && 'espree' !== s.parser) ||
					(function (t, e) {
						const s = vs(e.originalText)
						s && t.comments.unshift({ type: 'Line', value: s.slice(2), range: [0, s.length] })
					})(e, s),
				'typescript' === s.parser && s.originalText.includes('@'))
			) {
				const { esTreeNodeToTSNodeMap: r, tsNodeToESTreeNodeMap: i } = s.tsParseResult
				e = _s(e, e => {
					const s = r.get(e)
					if (!s) return
					...
					if (
						...
						throw t('Leading decorators must be attached to a class declaration', { start: { line: e.line, column: e.column + 1 }, end: { line: s.line, column: s.column + 1 } })
					}
				})
			}
			if ('typescript' !== s.parser && 'flow' !== s.parser && 'espree' !== s.parser && 'meriyah' !== s.parser) {
				const t = new Set()
				;(e = _s(e, e => {
					e.leadingComments && e.leadingComments.some(Ms) && t.add(Ls(e))
				})),
					(e = _s(e, e => {
						if ('ParenthesizedExpression' === e.type) {
							...
							const r = Ls(e)
							if (!t.has(r)) return (s.extra = Object.assign({}, s.extra, { parenthesized: !0 })), s
						}
					}))
			}
			return (e = _s(e, t => {
				switch (t.type) {
					case 'ChainExpression':
						return Rs(t.expression)
					case 'LogicalExpression':
						if (js(t)) return Us(t)
						break
					case 'VariableDeclaration': {
						const e = Ns(t.declarations)
						e &&
							e.init &&
							(function (t, e) {
								if (';' === s.originalText[Os(e)]) return
								t.range = ks(t, e)
							})(t, e)
						break
					}
					case 'TSParenthesizedType':
						return (t.typeAnnotation.range = ks(t)), t.typeAnnotation
					case 'TSUnionType':
					case 'TSIntersectionType':
						if (1 === t.types.length) {
							const [e] = t.types
							return (e.range = ks(t)), e
						}
						break
					case 'TSTypeParameter':
						'string' == typeof t.name && (t.name = { type: 'Identifier', name: t.name, range: ks(t, t.name.length) })
						break
					case 'SequenceExpression': {
						const e = Ns(t.expressions)
						Os(t) > Os(e) && (t.range = ks(t, e))
						break
					}
					case 'ClassProperty':
						t.key && 'TSPrivateIdentifier' === t.key.type && '?' === Is(s.originalText, t.key, Os) && (t.optional = !0)
				}
			}))
		},
		Vs = R(function (t, e) {
			...
			const c = {
					...
					relational: h('</>/<=/>=', 7),
					bitShift: h('<</>>/>>>', 8),
					plusMin: new a('+/-', { beforeExpr: s, binop: 9, prefix: n, startsExpr: r }),
					modulo: new a('%', { beforeExpr: s, binop: 10, startsExpr: r }),
					star: new a('*', { binop: 10 }),
					slash: h('/', 10),
					exponent: new a('**', { beforeExpr: s, binop: 11, rightAssociative: !0 }),
					_break: u('break'),
			...
			;(c.parenR.updateContext = c.braceR.updateContext = function () {
				...
				(c.name.updateContext = function (t) {
					let e = !1
					t !== c.dot && ('of' !== this.state.value || this.state.exprAllowed || t === c._function || t === c._class || (e = !0)),
				...
				(c._function.updateContext = c._class.updateContext = function (t) {
					!t.beforeExpr || t === c.semi || t === c._else || (t === c._return && this.hasPrecedingLineBreak()) || ((t === c.colon || t === c.braceL) && this.curContext() === T.b_stat)
			...
			function L(t) {
				return t < 65 ? 36 === t : t <= 90 || (t < 97 ? 95 === t : t <= 122 || (t <= 65535 ? t >= 170 && S.test(String.fromCharCode(t)) : k(t, I)))
			}
			function O(t) {
				return t < 48 ? 36 === t : t < 58 || (!(t < 65) && (t <= 90 || (t < 97 ? 95 === t : t <= 122 || (t <= 65535 ? t >= 170 && N.test(String.fromCharCode(t)) : k(t, I) || k(t, v)))))
			}
			const M = ['implements', 'interface', 'let', 'package', 'private', 'protected', 'public', 'static', 'yield'],
				R = ['eval', 'arguments'],
				_ = new Set([
					'break',
					'case',
			...
			const X = /^in(stanceof)?$/
			const G = new Set(['_', 'any', 'bool', 'boolean', 'empty', 'extends', 'false', 'interface', 'mixed', 'null', 'number', 'static', 'string', 'true', 'typeof', 'void']),
				K = Object.freeze({
			...
			const Y = { const: 'declare export var', let: 'declare export var', type: 'export type', interface: 'export interface' }
			const Q = /\*?\s*@((?:no)?flow)\b/
			const Z = {
					quot: '"',
					amp: '&',
			...
			function it(t) {
				...
				if ('JSXMemberExpression' === t.type) return it(t.object) + '.' + it(t.property)
			...
			class at {
				...
				declareName(t, e, s) {
					...
					if (8 & e || 16 & e) this.checkRedeclarationInScope(r, t, e, s), 16 & e ? r.functions.push(t) : r.lexical.push(t), 8 & e && this.maybeExportDefined(r, t)
					else if (4 & e)
						for (
							let i = this.scopeStack.length - 1;
							i >= 0 && ((r = this.scopeStack[i]), this.checkRedeclarationInScope(r, t, e, s), r.var.push(t), this.maybeExportDefined(r, t), !(131 & r.flags));
							--i
						);
				...
				checkRedeclarationInScope(t, e, s, r) {
					this.isRedeclaredInScope(t, e, s) && this.raise(r, g.VarRedeclaration, e)
				}
				isRedeclaredInScope(t, e, s) {
					return (
						!!(1 & s) &&
						(8 & s
							? t.lexical.indexOf(e) > -1 || t.functions.indexOf(e) > -1 || t.var.indexOf(e) > -1
							: 16 & s
							? t.lexical.indexOf(e) > -1 || (!this.treatFunctionsAsVarInScope(t) && t.var.indexOf(e) > -1)
							: (t.lexical.indexOf(e) > -1 && !(8 & t.flags && t.lexical[0] === e)) || (!this.treatFunctionsAsVarInScope(t) && t.functions.indexOf(e) > -1))
					)
				}
				checkLocalExport(t) {
			...
			class ut extends at {
				...
				declareName(t, e, s) {
					...
					if (e & d) return this.maybeExportDefined(r, t), void r.exportOnlyBindings.push(t)
					super.declareName(...arguments),
						2 & e && (1 & e || (this.checkRedeclarationInScope(r, t, e, s), this.maybeExportDefined(r, t)), r.types.push(t)),
				...
				isRedeclaredInScope(t, e, s) {
					...
					return s & l && t.classes.indexOf(e) > -1 ? t.lexical.indexOf(e) > -1 && !!(1 & s) : !!(2 & s && t.types.indexOf(e) > -1) || super.isRedeclaredInScope(...arguments)
				}
				checkLocalExport(t) {
			...
			const Et = {
					estree: t =>
						class extends t {
							...
							checkDeclaration(t) {
								b(t) ? this.checkDeclaration(t.value) : super.checkDeclaration(t)
							}
								...
								switch (t.type) {
									case 'ObjectPattern':
										t.properties.forEach(t => {
											this.checkLVal('Property' === t.type ? t.value : t, e, s, 'object destructuring pattern', i)
										})
										break
									default:
							...
							toAssignable(t) {
								return b(t) ? (this.toAssignable(t.value), t) : super.toAssignable(t)
							}
							toAssignableObjectExpressionProp(t, e) {
								if ('get' === t.kind || 'set' === t.kind) throw this.raise(t.key.start, g.PatternHasAccessor)
								...
								switch ((super.parseExport(t), t.type)) {
									...
									case 'ExportNamedDeclaration':
										1 === t.specifiers.length &&
											...
											((t.type = 'ExportAllDeclaration'), (t.exported = t.specifiers[0].exported), delete t.specifiers)
								}
								return t
							}
							parseSubscript(t, e, s, r, i) {
								...
								if (i.optionalChainMember) {
									if ((('OptionalMemberExpression' !== n.type && 'OptionalCallExpression' !== n.type) || (n.type = n.type.substring(8)), i.stop)) {
						...
						class extends t {
							jsxReadToken() {
								let t = '',
									e = this.state.pos
								for (;;) {
									if (this.state.pos >= this.length) throw this.raise(this.state.start, st.UnterminatedJsxContent)
									...
									switch (s) {
										...
										case 123:
											return this.state.pos === this.state.start
												...
												: ((t += this.input.slice(e, this.state.pos)), this.finishToken(c.jsxText, t))
										case 38:
							...
							jsxReadNewLine(t) {
								...
								return (
									++this.state.pos,
									13 === e && 10 === this.input.charCodeAt(this.state.pos) ? (++this.state.pos, (s = t ? '\n' : '\r\n')) : (s = String.fromCharCode(e)),
									++this.state.curLine,
							...
							jsxReadString(t) {
								...
								for (;;) {
									...
									38 === r
										...
										: y(r)
										? ((e += this.input.slice(s, this.state.pos)), (e += this.jsxReadNewLine(!1)), (s = this.state.pos))
										: ++this.state.pos
								}
							...
							jsxReadEntity() {
								...
								for (; this.state.pos < this.length && s++ < 10; ) {
									if (((r = this.input[this.state.pos++]), ';' === r)) {
										'#' === e[0]
											? 'x' === e[1]
												? ((e = e.substr(2)), tt.test(e) && (t = String.fromCodePoint(parseInt(e, 16))))
												: ((e = e.substr(1)), et.test(e) && (t = String.fromCodePoint(parseInt(e, 10))))
											: (t = Z[e])
										break
									}
									e += r
							...
							jsxParseIdentifier() {
								...
								return (
									this.match(c.jsxName) ? (t.name = this.state.value) : this.state.type.keyword ? (t.name = this.state.type.keyword) : this.unexpected(),
									this.next(),
							...
							jsxParseAttributeValue() {
								...
								switch (this.state.type) {
									case c.braceL:
										return (t = this.startNode()), this.next(), (t = this.jsxParseExpressionContainer(t)), 'JSXEmptyExpression' === t.expression.type && this.raise(t.start, st.AttributeIsEmpty), t
									case c.jsxTagStart:
									case c.string:
							...
							jsxParseExpressionContainer(t) {
								return (
									this.match(c.braceR) ? (t.expression = this.jsxParseEmptyExpression()) : (t.expression = this.parseExpression()), this.expect(c.braceR), this.finishNode(t, 'JSXExpressionContainer')
								)
							}
							jsxParseAttribute() {
								const t = this.startNode()
								return this.eat(c.braceL)
									? (this.expect(c.ellipsis), (t.argument = this.parseMaybeAssignAllowIn()), this.expect(c.braceR), this.finishNode(t, 'JSXSpreadAttribute'))
									: ((t.name = this.jsxParseNamespacedName()), (t.value = this.eat(c.eq) ? this.jsxParseAttributeValue() : null), this.finishNode(t, 'JSXAttribute'))
							}
							...
							jsxParseClosingElementAt(t, e) {
								...
								return this.match(c.jsxTagEnd)
									? (this.expect(c.jsxTagEnd), this.finishNode(s, 'JSXClosingFragment'))
									: ((s.name = this.jsxParseElementName()), this.expect(c.jsxTagEnd), this.finishNode(s, 'JSXClosingElement'))
							}
								...
								if (!i.selfClosing) {
									t: for (;;)
										switch (this.state.type) {
											...
											case c.braceL: {
												const t = this.startNode()
												this.next(), this.match(c.ellipsis) ? r.push(this.jsxParseSpreadChild(t)) : r.push(this.jsxParseExpressionContainer(t))
												break
											}
											default:
									...
									rt(i) && !rt(n)
										...
										: !rt(i) && rt(n)
										? this.raise(n.start, st.MissingClosingTagElement, it(i.name))
										: rt(i) || rt(n) || (it(n.name) !== it(i.name) && this.raise(n.start, st.MissingClosingTagElement, it(i.name)))
								}
								if ((rt(i) ? ((s.openingFragment = i), (s.closingFragment = n)) : ((s.openingElement = i), (s.closingElement = n)), (s.children = r), this.isRelational('<')))
									throw this.raise(this.state.start, st.UnwrappedAdjacentJSXElements)
								return rt(i) ? this.finishNode(s, 'JSXFragment') : this.finishNode(s, 'JSXElement')
							}
							jsxParseElement() {
								const t = this.state.start,
									e = this.state.startLoc
							...
							parseExprAtom(t) {
								return this.match(c.jsxText)
									...
									: this.isRelational('<') && 33 !== this.input.charCodeAt(this.state.pos)
						...
						class extends t {
							...
							flowParsePredicate() {
								...
								return (
									...
									(e.line === r.line && e.column === r.column - 1) || this.raise(s, K.UnexpectedSpaceBetweenModuloChecks),
									this.eat(c.parenL) ? ((t.value = this.parseExpression()), this.expect(c.parenR), this.finishNode(t, 'DeclaredPredicate')) : this.finishNode(t, 'InferredPredicate')
								)
							}
							...
							flowParseDeclareFunction(t) {
								...
								return (
									...
									([s.returnType, t.predicate] = this.flowParseTypeAndPredicateInitialiser()),
							...
							flowParseDeclare(t, e) {
								...
								if (this.eatContextual('module'))
									return this.match(c.dot) ? this.flowParseDeclareModuleExports(t) : (e && this.raise(this.state.lastTokStart, K.NestedDeclareModule), this.flowParseDeclareModule(t))
							...
							flowParseDeclareModule(t) {
								...
								for (this.expect(c.braceL); !this.match(c.braceR); ) {
									...
									this.match(c._import)
										? (this.next(), this.isContextual('type') || this.match(c._typeof) || this.raise(this.state.lastTokStart, K.InvalidNonTypeImportInDeclareModule), this.parseImport(t))
										: (this.expectContextual('declare', K.UnsupportedStatementInDeclareModule), (t = this.flowParseDeclare(t, !0))),
										s.push(t)
								}
									...
									s.forEach(t => {
										!(function (t) {
											return (
												...
												('DeclareExportDeclaration' === t.type && (!t.declaration || ('TypeAlias' !== t.declaration.type && 'InterfaceDeclaration' !== t.declaration.type)))
											)
										})(t)
											? 'DeclareModuleExports' === t.type &&
											  (i && this.raise(t.start, K.DuplicateDeclareModuleExports), 'ES' === r && this.raise(t.start, K.AmbiguousDeclareModuleKind), (r = 'CommonJS'), (i = !0))
											: ('CommonJS' === r && this.raise(t.start, K.AmbiguousDeclareModuleKind), (r = 'ES'))
									}),
									(t.kind = r || 'CommonJS'),
							...
							flowParseDeclareExportDeclaration(t, e) {
								if ((this.expect(c._export), this.eat(c._default)))
									return (
										this.match(c._function) || this.match(c._class) ? (t.declaration = this.flowParseDeclare(this.startNode())) : ((t.declaration = this.flowParseType()), this.semicolon()),
										(t.default = !0),
								...
								if (this.match(c._const) || this.isLet() || ((this.isContextual('type') || this.isContextual('interface')) && !e)) {
									const t = this.state.value,
										e = Y[t]
									throw this.raise(this.state.start, K.UnsupportedDeclareExportKind, t, e)
								}
								if (this.match(c._var) || this.match(c._function) || this.match(c._class) || this.isContextual('opaque'))
									return (t.declaration = this.flowParseDeclare(this.startNode())), (t.default = !1), this.finishNode(t, 'DeclareExportDeclaration')
								if (this.match(c.star) || this.match(c.braceL) || this.isContextual('interface') || this.isContextual('type') || this.isContextual('opaque'))
									return 'ExportNamedDeclaration' === (t = this.parseExport(t)).type && ((t.type = 'ExportDeclaration'), (t.default = !1), delete t.exportKind), (t.type = 'Declare' + t.type), t
								throw this.unexpected()
							}
							...
							flowParseInterfaceish(t, e = !1) {
								...
								t.body = this.flowParseObjectType({ allowStatic: e, allowExact: !1, allowSpread: !1, allowProto: e, allowInexact: !1 })
							}
							...
							checkNotUnderscore(t) {
								'_' === t && this.raise(this.state.start, K.UnexpectedReservedUnderscore)
							}
							checkReservedType(t, e, s) {
								G.has(t) && this.raise(e, s ? K.AssignReservedType : K.UnexpectedReservedType, t)
							}
							...
							flowParseOpaqueType(t, e) {
								return (
									...
									this.isRelational('<') ? (t.typeParameters = this.flowParseTypeParameterDeclaration()) : (t.typeParameters = null),
									(t.supertype = null),
									this.match(c.colon) && (t.supertype = this.flowParseTypeInitialiser(c.colon)),
									(t.impltype = null),
							...
							flowParseTypeParameter(t = !1) {
								...
								return (
									...
									this.match(c.eq) ? (this.eat(c.eq), (s.default = this.flowParseType())) : t && this.raise(e, K.MissingTypeParamDefault),
							...
							flowParseTypeParameterInstantiationCallOrNew() {
								...
								for (t.params = [], this.state.inType = !0, this.expectRelational('<'); !this.isRelational('>'); )
									t.params.push(this.flowParseTypeOrImplicitInstantiation()), this.isRelational('>') || this.expect(c.comma)
							...
							flowParseInterfaceType() {
								...
								return (t.body = this.flowParseObjectType({ allowStatic: !1, allowExact: !1, allowSpread: !1, allowProto: !1, allowInexact: !1 })), this.finishNode(t, 'InterfaceTypeAnnotation')
							}
							...
							flowParseObjectTypeIndexer(t, e, s) {
								return (
									(t.static = e),
									this.lookahead().type === c.colon ? ((t.id = this.flowParseObjectPropertyKey()), (t.key = this.flowParseTypeInitialiser())) : ((t.id = null), (t.key = this.flowParseType())),
							...
							flowParseObjectTypeInternalSlot(t, e) {
								return (
									...
									this.isRelational('<') || this.match(c.parenL)
										? ((t.method = !0), (t.optional = !1), (t.value = this.flowParseObjectTypeMethodish(this.startNodeAt(t.start, t.loc.start))))
										: ((t.method = !1), this.eat(c.question) && (t.optional = !0), (t.value = this.flowParseTypeInitialiser())),
									this.finishNode(t, 'ObjectTypeInternalSlot')
								)
							}
							flowParseObjectTypeMethodish(t) {
								for (
									t.params = [], t.rest = null, t.typeParameters = null, this.isRelational('<') && (t.typeParameters = this.flowParseTypeParameterDeclaration()), this.expect(c.parenL);
								...
								return (
									this.eat(c.ellipsis) && (t.rest = this.flowParseFunctionTypeParam()),
									this.expect(c.parenR),
							...
							flowParseObjectType({ allowStatic: t, allowExact: e, allowSpread: s, allowProto: r, allowInexact: i }) {
								...
								let h = !1
								for (e && this.match(c.braceBarL) ? (this.expect(c.braceBarL), (o = c.braceBarR), (u = !0)) : (this.expect(c.braceL), (o = c.braceR), (u = !1)), a.exact = u; !this.match(o); ) {
									let e = !1,
										n = null,
										o = null
									...
									if (r && this.isContextual('proto')) {
										...
										e.type !== c.colon && e.type !== c.question && (this.next(), (n = this.state.start), (t = !1))
									}
									...
									if (this.eat(c.bracketL))
										null != n && this.unexpected(n),
											this.eat(c.bracketL)
												? (l && this.unexpected(l.start), a.internalSlots.push(this.flowParseObjectTypeInternalSlot(p, e)))
												: a.indexers.push(this.flowParseObjectTypeIndexer(p, e, l))
									else if (this.match(c.parenL) || this.isRelational('<'))
										null != n && this.unexpected(n), l && this.unexpected(l.start), a.callProperties.push(this.flowParseObjectTypeCallProperty(p, e))
									else {
										let t = 'init'
										...
										const r = this.flowParseObjectTypeProperty(p, e, n, l, t, s, null != i ? i : !u)
										null === r ? ((h = !0), (o = this.state.lastTokStart)) : a.properties.push(r)
									}
									this.flowObjectTypeSemicolon(), !o || this.match(c.braceR) || this.match(c.braceBarR) || this.raise(o, K.UnexpectedExplicitInexactInObject)
								}
							...
							flowParseObjectTypeProperty(t, e, s, r, i, n, a) {
								if (this.eat(c.ellipsis)) {
									return this.match(c.comma) || this.match(c.semi) || this.match(c.braceR) || this.match(c.braceBarR)
										? (n ? a || this.raise(this.state.lastTokStart, K.InexactInsideExact) : this.raise(this.state.lastTokStart, K.InexactInsideNonObject),
										  r && this.raise(r.start, K.InexactVariance),
										  null)
										: (n || this.raise(this.state.lastTokStart, K.UnexpectedSpreadType),
									...
									return (
										this.isRelational('<') || this.match(c.parenL)
											? ((t.method = !0),
											  ...
											  ('get' !== i && 'set' !== i) || this.flowCheckGetterSetterParams(t))
											: ('init' !== i && this.unexpected(), (t.method = !1), this.eat(c.question) && (n = !0), (t.value = this.flowParseTypeInitialiser()), (t.variance = r)),
										(t.optional = n),
							...
							flowCheckGetterSetterParams(t) {
								const e = 'get' === t.kind ? 0 : 1,
									s = t.start
								t.value.params.length + (t.value.rest ? 1 : 0) !== e && ('get' === t.kind ? this.raise(s, g.BadGetterArity) : this.raise(s, g.BadSetterArity)),
									'set' === t.kind && t.value.rest && this.raise(s, g.BadSetterRestParameter)
							}
							...
							flowParseTupleType() {
								const t = this.startNode()
								for (t.types = [], this.expect(c.bracketL); this.state.pos < this.length && !this.match(c.bracketR) && (t.types.push(this.flowParseType()), !this.match(c.bracketR)); )
									this.expect(c.comma)
							...
							flowParseFunctionTypeParam() {
								...
								const r = this.startNode(),
									i = this.lookahead()
								return (
									i.type === c.colon || i.type === c.question ? ((t = this.parseIdentifier()), this.eat(c.question) && (e = !0), (s = this.flowParseTypeInitialiser())) : (s = this.flowParseType()),
									(r.name = t),
									(r.optional = e),
									(r.typeAnnotation = s),
							...
							flowParsePrimaryType() {
								...
								switch (this.state.type) {
									...
									case c.bracketL:
										return (this.state.noAnonFunctionType = !1), (i = this.flowParseTupleType()), (this.state.noAnonFunctionType = a), i
									case c.relational:
										if ('<' === this.state.value)
											return (
									...
									case c.parenL:
										...
										if (n) {
											if (
												...
												this.state.noAnonFunctionType || !(this.match(c.comma) || (this.match(c.parenR) && this.lookahead().type === c.arrow)))
											)
									...
									case c.plusMin:
										if ('-' === this.state.value) {
											...
											throw this.raise(this.state.start, K.UnexpectedSubtractionOperand)
										}
										throw this.unexpected()
									case c.num:
							...
							flowParsePostfixType() {
								...
								for (; this.match(c.bracketL) && !this.canInsertSemicolon(); ) {
									const r = this.startNodeAt(t, e)
									;(r.elementType = s), this.expect(c.bracketL), this.expect(c.bracketR), (s = this.finishNode(r, 'ArrayTypeAnnotation'))
								}
								return s
							}
							flowParsePrefixType() {
							...
							isExportDefaultSpecifier() {
								return (
									(!this.match(c.name) ||
										!('type' === this.state.value || 'interface' === this.state.value || 'opaque' === this.state.value || (this.shouldParseEnums() && 'enum' === this.state.value))) &&
							...
							parseConditional(t, e, s, r) {
								...
								if (r) {
									...
									return i.node ? (i.error && (this.state = i.failState), i.node) : ((r.start = i.error.pos || this.state.start), t)
								}
								this.expect(c.question)
								const i = this.state.clone(),
									n = this.state.noArrowAt,
									a = this.startNodeAt(e, s)
								let { consequent: o, failed: u } = this.tryParseConditionalConsequent(),
								...
								if (u || p.length > 0) {
									...
									if (p.length > 0) {
										...
										;({ consequent: o, failed: u } = this.tryParseConditionalConsequent()), ([h, p] = this.getArrowLikeExpressions(o))
									}
									u && h.length > 1 && this.raise(i.start, K.AmbiguousConditionalArrow),
										u && 1 === h.length && ((this.state = i), (this.state.noArrowAt = t.concat(h[0].start)), ({ consequent: o, failed: u } = this.tryParseConditionalConsequent()))
								}
								return (
									...
									(a.test = t),
									(a.consequent = o),
									(a.alternate = this.forwardNoArrowParamsConversionAt(a, () => this.parseMaybeAssign(void 0, void 0, void 0))),
							...
							getArrowLikeExpressions(t, e) {
								...
								for (; 0 !== s.length; ) {
									const t = s.pop()
									'ArrowFunctionExpression' === t.type
										? (t.typeParameters || !t.returnType ? this.finishArrowValidation(t) : r.push(t), s.push(t.body))
										: 'ConditionalExpression' === t.type && (s.push(t.consequent), s.push(t.alternate))
								}
								return e
							...
							forwardNoArrowParamsConversionAt(t, e) {
								...
								return (
									-1 !== this.state.noArrowParamsConversionAt.indexOf(t.start)
										? (this.state.noArrowParamsConversionAt.push(this.state.start), (s = e()), this.state.noArrowParamsConversionAt.pop())
										: (s = e()),
									s
								)
							}
							...
							assertModuleNodeAllowed(t) {
								;('ImportDeclaration' === t.type && ('type' === t.importKind || 'typeof' === t.importKind)) ||
							...
							parseClassMember(t, e, s) {
								...
								super.parseClassMember(t, e, s),
									e.declare &&
										('ClassProperty' !== e.type && 'ClassPrivateProperty' !== e.type ? this.raise(r, K.DeclareClassElement) : e.value && this.raise(e.value.start, K.DeclareClassFieldInitializer))
							}
							getTokenFromCode(t) {
							...
							toReferencedList(t, e) {
								for (let r = 0; r < t.length; r++) {
									var s
									const i = t[r]
									i && 'TypeCastExpression' === i.type && !(null == (s = i.extra) ? void 0 : s.parenthesized) && (t.length > 1 || !e) && this.raise(i.typeAnnotation.start, K.TypeCastInPattern)
								}
								return t
							}
							parseArrayLike(t, e, s, r) {
								const i = super.parseArrayLike(t, e, s, r)
								return e && !this.state.maybeInArrowParameters && this.toReferencedList(i.elements), i
							}
							...
							parseObjPropValue(t, e, s, r, i, n, a, o) {
								...
								t.variance && this.unexpected(t.variance.start),
									delete t.variance,
									this.isRelational('<') && !a && ((u = this.flowParseTypeParameterDeclaration()), this.match(c.parenL) || this.unexpected()),
									super.parseObjPropValue(t, e, s, r, i, n, a, o),
									u && ((t.value || t).typeParameters = u)
							}
							parseAssignableListItemTypes(t) {
								return (
									this.eat(c.question) && ('Identifier' !== t.type && this.raise(t.start, K.OptionalBindingPattern), (t.optional = !0)),
							...
							parseMaybeDefault(t, e, s) {
								...
								return 'AssignmentPattern' === r.type && r.typeAnnotation && r.right.start < r.typeAnnotation.start && this.raise(r.typeAnnotation.start, K.TypeBeforeInitializer), r
							}
							shouldParseDefaultImport(t) {
								return J(t) ? $(this.state) : super.shouldParseDefaultImport(t)
							}
							parseImportSpecifierLocal(t, e, s, r) {
								;(e.local = J(t) ? this.flowParseRestrictedIdentifier(!0, !0) : this.parseIdentifier()), this.checkLVal(e.local, 9, void 0, r), t.specifiers.push(this.finishNode(e, s))
							}
							maybeParseDefaultImportSpecifier(t) {
								...
								if ((this.match(c._typeof) ? (e = 'typeof') : this.isContextual('type') && (e = 'type'), e)) {
									...
									'type' === e && s.type === c.star && this.unexpected(s.start), ($(s) || s.type === c.braceL || s.type === c.star) && (this.next(), (t.importKind = e))
								}
							...
							parseImportSpecifier(t) {
								...
								if (this.isContextual('as') && !this.isLookaheadContextual('as')) {
									...
									null === i || this.match(c.name) || this.state.type.keyword
										? ((e.imported = r), (e.importKind = null), (e.local = this.parseIdentifier()))
										: ((e.imported = t), (e.importKind = i), (e.local = t.__clone()))
								} else if (null !== i && (this.match(c.name) || this.state.type.keyword))
									(e.imported = this.parseIdentifier(!0)), (e.importKind = i), this.eatContextual('as') ? (e.local = this.parseIdentifier()) : ((n = !0), (e.local = e.imported.__clone()))
								else {
									if ('StringLiteral' === r.type) throw this.raise(e.start, g.ImportBindingIsString, r.value)
									;(n = !0), (e.imported = r), (e.importKind = null), (e.local = e.imported.__clone())
								}
								const a = J(t),
									o = J(e)
								a && o && this.raise(s, K.ImportTypeShorthandOnlyInPureImport),
									(a || o) && this.checkReservedType(e.local.name, e.local.start, !0),
									!n || a || o || this.checkReservedWord(e.local.name, e.start, !0, !0),
							...
							parseMaybeAssign(t, e, s) {
								...
								if (this.hasPlugin('jsx') && (this.match(c.jsxTagStart) || this.isRelational('<'))) {
									if (((n = this.state.clone()), (i = this.tryParse(() => super.parseMaybeAssign(t, e, s), n)), !i.error)) return i.node
									const { context: r } = this.state
									r[r.length - 1] === T.j_oTag ? (r.length -= 2) : r[r.length - 1] === T.j_expr && (r.length -= 1)
								}
								if ((null == (r = i) ? void 0 : r.error) || this.isRelational('<')) {
									var a, o
									let r
									...
									const u = this.tryParse(i => {
										...
										'ArrowFunctionExpression' !== a.type && (null == (n = a.extra) ? void 0 : n.parenthesized) && i()
										const o = this.maybeUnwrapTypeCastExpression(a)
										return (o.typeParameters = r), this.resetStartLocationFromNode(o, r), a
									}, n)
									let h = null
									if (u.node && 'ArrowFunctionExpression' === this.maybeUnwrapTypeCastExpression(u.node).type) {
										if (!u.error && !u.aborted) return u.node.async && this.raise(r.start, K.UnexpectedTypeParameterBeforeAsyncArrowFunction), u.node
										h = u.node
									}
									if (null == (a = i) ? void 0 : a.node) return (this.state = i.failState), i.node
									if (h) return (this.state = u.failState), h
									if (null == (o = i) ? void 0 : o.thrown) throw i.error
									if (u.thrown) throw u.error
									throw this.raise(r.start, K.UnexpectedTokenAfterTypeParameter)
								}
							...
							parseArrow(t) {
								if (this.match(c.colon)) {
									const e = this.tryParse(() => {
										...
										const s = this.startNode()
										return (
											([s.typeAnnotation, t.predicate] = this.flowParseTypeAndPredicateInitialiser()),
							...
							parseSubscripts(t, e, s, r) {
								if ('Identifier' === t.type && 'async' === t.name && -1 !== this.state.noArrowAt.indexOf(e)) {
									this.next()
									const r = this.startNodeAt(e, s)
									;(r.callee = t), (r.arguments = this.parseCallExpressionArguments(c.parenR, !1)), (t = this.finishNode(r, 'CallExpression'))
								} else if ('Identifier' === t.type && 'async' === t.name && this.isRelational('<')) {
									const i = this.state.clone(),
										n = this.tryParse(t => this.parseAsyncArrowWithTypeParameters(e, s) || t(), i)
							...
							parseSubscript(t, e, s, r, i) {
								if (this.match(c.questionDot) && this.isLookaheadToken_lt()) {
									...
									return (
										...
										this.expect(c.parenL),
										(n.arguments = this.parseCallExpressionArguments(c.parenR, !1)),
										(n.optional = !0),
								...
								if (!r && this.shouldParseTypes() && this.isRelational('<')) {
									...
									const n = this.tryParse(
										() => (
											...
											this.expect(c.parenL),
											(r.arguments = this.parseCallExpressionArguments(c.parenR, !1)),
							...
							parseTopLevel(t, e) {
								...
								return this.state.hasFlowComment && this.raise(this.state.pos, K.UnterminatedFlowComment), s
							}
							skipBlockComment() {
								if (this.hasPlugin('flowComments') && this.skipFlowComment())
									return (
										this.state.hasFlowComment && this.unexpected(null, K.NestedFlowComment),
							...
							skipFlowComment() {
								...
								return 58 === s && 58 === r ? e + 2 : 'flow-include' === this.input.slice(e + t, e + t + 12) ? e + 12 : 58 === s && 58 !== r && e
							}
							...
							flowEnumErrorInvalidExplicitType(t, { enumName: e, suppliedType: s }) {
								return this.raise(t, null === s ? K.EnumInvalidExplicitTypeUnknownSupplied : K.EnumInvalidExplicitType, e, s)
							}
							...
							flowEnumMemberInit() {
								...
								switch (this.state.type) {
									case c.num: {
										...
										return e() ? { type: 'number', pos: s.start, value: s } : { type: 'invalid', pos: t }
									}
									case c.string: {
										const s = this.parseLiteral(this.state.value, 'StringLiteral')
										return e() ? { type: 'string', pos: s.start, value: s } : { type: 'invalid', pos: t }
									}
									case c._true:
									case c._false: {
										const s = this.parseBooleanLiteral()
										return e() ? { type: 'boolean', pos: s.start, value: s } : { type: 'invalid', pos: t }
									}
									default:
							...
							flowEnumMemberRaw() {
								const t = this.state.start
								return { id: this.parseIdentifier(!0), init: this.eat(c.eq) ? this.flowEnumMemberInit() : { type: 'none', pos: t } }
							}
							flowEnumCheckExplicitTypeMismatch(t, e, s) {
								const { explicitType: r } = e
								null !== r && r !== s && this.flowEnumErrorInvalidMemberInitializer(t, e)
							}
							flowEnumMembers({ enumName: t, explicitType: e }) {
								...
								for (; !this.match(c.braceR); ) {
									const i = this.startNode(),
										...
										o = n.name
									if ('' === o) continue
									;/^[a-z]/.test(o) && this.flowEnumErrorInvalidMemberName(n.start, { enumName: t, memberName: o }),
										s.has(o) && this.flowEnumErrorDuplicateMemberName(n.start, { enumName: t, memberName: o }),
										s.add(o)
									const u = { enumName: t, explicitType: e, memberName: o }
									switch (((i.id = n), a.type)) {
										case 'boolean':
											this.flowEnumCheckExplicitTypeMismatch(a.pos, u, 'boolean'), (i.init = a.value), r.booleanMembers.push(this.finishNode(i, 'EnumBooleanMember'))
											break
										case 'number':
											this.flowEnumCheckExplicitTypeMismatch(a.pos, u, 'number'), (i.init = a.value), r.numberMembers.push(this.finishNode(i, 'EnumNumberMember'))
											break
										case 'string':
											this.flowEnumCheckExplicitTypeMismatch(a.pos, u, 'string'), (i.init = a.value), r.stringMembers.push(this.finishNode(i, 'EnumStringMember'))
											break
										case 'invalid':
											throw this.flowEnumErrorInvalidMemberInitializer(a.pos, u)
										case 'none':
											switch (e) {
												case 'boolean':
													this.flowEnumErrorBooleanMemberNotInitialized(a.pos, u)
													break
												case 'number':
													this.flowEnumErrorNumberMemberNotInitialized(a.pos, u)
													break
												default:
													r.defaultedMembers.push(this.finishNode(i, 'EnumDefaultedMember'))
											}
									}
							...
							flowEnumStringMembers(t, e, { enumName: s }) {
								...
								if (e.length > t.length) {
									for (let e = 0; e < t.length; e++) {
										const r = t[e]
										this.flowEnumErrorStringMemberInconsistentlyInitailized(r.start, { enumName: s })
									}
									return e
								}
							...
							flowEnumParseExplicitType({ enumName: t }) {
								if (this.eatContextual('of')) {
									if (!this.match(c.name)) throw this.flowEnumErrorInvalidExplicitType(this.state.start, { enumName: t, suppliedType: null })
									const { value: e } = this.state
									return (
										this.next(), 'boolean' !== e && 'number' !== e && 'string' !== e && 'symbol' !== e && this.flowEnumErrorInvalidExplicitType(this.state.start, { enumName: t, suppliedType: e }), e
									)
								}
								return null
							}
							flowEnumBody(t, { enumName: e, nameLoc: s }) {
								...
								const i = this.flowEnumMembers({ enumName: e, explicitType: r })
								switch (r) {
									case 'boolean':
										return (t.explicitType = !0), (t.members = i.booleanMembers), this.expect(c.braceR), this.finishNode(t, 'EnumBooleanBody')
									case 'number':
										return (t.explicitType = !0), (t.members = i.numberMembers), this.expect(c.braceR), this.finishNode(t, 'EnumNumberBody')
									case 'string':
										return (
											(t.explicitType = !0), (t.members = this.flowEnumStringMembers(i.stringMembers, i.defaultedMembers, { enumName: e })), this.expect(c.braceR), this.finishNode(t, 'EnumStringBody')
										)
									case 'symbol':
										return (t.members = i.defaultedMembers), this.expect(c.braceR), this.finishNode(t, 'EnumSymbolBody')
									default: {
										const r = () => ((t.members = []), this.expect(c.braceR), this.finishNode(t, 'EnumStringBody'))
										t.explicitType = !1
										...
										if (n || a || o || u) {
											if (n || a) {
												if (!a && !o && n >= u) {
													for (let t = 0, s = i.defaultedMembers; t < s.length; t++) {
														const r = s[t]
														this.flowEnumErrorBooleanMemberNotInitialized(r.start, { enumName: e, memberName: r.id.name })
													}
													return (t.members = i.booleanMembers), this.expect(c.braceR), this.finishNode(t, 'EnumBooleanBody')
												}
												if (!n && !o && a >= u) {
													for (let t = 0, s = i.defaultedMembers; t < s.length; t++) {
														const r = s[t]
														this.flowEnumErrorNumberMemberNotInitialized(r.start, { enumName: e, memberName: r.id.name })
													}
													return (t.members = i.numberMembers), this.expect(c.braceR), this.finishNode(t, 'EnumNumberBody')
												}
												return this.flowEnumErrorInconsistentMemberValues(s, { enumName: e }), r()
											}
											return (t.members = this.flowEnumStringMembers(i.stringMembers, i.defaultedMembers, { enumName: e })), this.expect(c.braceR), this.finishNode(t, 'EnumStringBody')
										}
										return r()
									}
								}
							...
							flowParseEnumDeclaration(t) {
								...
								return (t.id = e), (t.body = this.flowEnumBody(this.startNode(), { enumName: e.name, nameLoc: e.start })), this.finishNode(t, 'EnumDeclaration')
							}
							updateContext(t) {
								this.match(c.name) && 'of' === this.state.value && t === c.name && 'interface' === this.input.slice(this.state.lastTokStart, this.state.lastTokEnd)
									? (this.state.exprAllowed = !1)
					...
					typescript: t =>
						class extends t {
							...
							tsNextTokenCanFollowModifier() {
								return (
									this.next(),
									!(this.hasPrecedingLineBreak() || this.match(c.parenL) || this.match(c.parenR) || this.match(c.colon) || this.match(c.eq) || this.match(c.question) || this.match(c.bang))
								)
							}
							tsParseModifier(t) {
							...
							tsParseModifiers(t, e) {
								for (;;) {
									...
									if (!r) break
									Object.hasOwnProperty.call(t, r) && this.raise(s, dt.DuplicateModifier, r), (t[r] = !0)
								}
							}
							...
							tsParseBracketedList(t, e, s, r) {
								...
								return s ? this.expect(c.bracketR) : this.expectRelational('>'), i
							}
							tsParseImportType() {
								const t = this.startNode()
								return (
									this.expect(c._import),
									this.expect(c.parenL),
									this.match(c.string) || this.raise(this.state.start, dt.UnsupportedImportTypeArgument),
							...
							tsParseTypeReference() {
								...
								return (
									...
									!this.hasPrecedingLineBreak() && this.isRelational('<') && (t.typeParameters = this.tsParseTypeArguments()),
							...
							tsParseTypeParameter() {
								const t = this.startNode()
								return (
									(t.name = this.parseIdentifierName(t.start)), (t.constraint = this.tsEatThenParseType(c._extends)), (t.default = this.tsEatThenParseType(c.eq)), this.finishNode(t, 'TSTypeParameter')
								)
							}
							...
							tsParseTypeParameters() {
								...
								return (
									...
									0 === t.params.length && this.raise(t.start, dt.EmptyTypeParameters),
							...
							tsFillSignature(t, e) {
								...
								;(e.typeParameters = this.tsTryParseTypeParameters()),
									...
									(s || this.match(t)) && (e.typeAnnotation = this.tsParseTypeOrTypePredicateAnnotation(t))
							}
							tsParseBindingListForSignature() {
								return this.parseBindingList(c.parenR, 41).map(
									t => (
										'Identifier' !== t.type && 'RestElement' !== t.type && 'ObjectPattern' !== t.type && 'ArrayPattern' !== t.type && this.raise(t.start, dt.UnsupportedSignatureParameterKind, t.type),
										t
									)
								)
							}
							...
							tsParsePropertyOrMethodSignature(t, e) {
								...
								if (e || (!this.match(c.parenL) && !this.isRelational('<'))) {
									...
									return r && (t.typeAnnotation = r), this.tsParseTypeMemberSemicolon(), this.finishNode(t, 'TSPropertySignature')
								}
								{
									const t = s
								...
								if (this.match(c._new)) {
									...
									return (
										...
										this.match(c.parenL) || this.isRelational('<')
											? this.tsParseSignatureMember('TSConstructSignatureDeclaration', t)
											: ((t.key = this.createIdentifier(e, 'new')), this.tsParsePropertyOrMethodSignature(t, !1))
									)
								}
							...
							tsIsStartOfMappedType() {
								return (
									...
									this.eat(c.plusMin)
										...
										: (this.isContextual('readonly') && this.next(), !!this.match(c.bracketL) && (this.next(), !!this.tsIsIdentifier() && (this.next(), this.match(c._in))))
								)
							}
							...
							tsParseMappedType() {
								...
								return (
									this.expect(c.braceL),
									this.match(c.plusMin) ? ((t.readonly = this.state.value), this.next(), this.expectContextual('readonly')) : this.eatContextual('readonly') && (t.readonly = !0),
									this.expect(c.bracketL),
									(t.typeParameter = this.tsParseMappedTypeParameter()),
									(t.nameType = this.eatContextual('as') ? this.tsParseType() : null),
									this.expect(c.bracketR),
									this.match(c.plusMin) ? ((t.optional = this.state.value), this.next(), this.expect(c.question)) : this.eat(c.question) && (t.optional = !0),
							...
							tsParseTupleType() {
								...
								return (
									t.elementTypes.forEach(t => {
										var r
										let { type: i } = t
										!e || 'TSRestType' === i || 'TSOptionalType' === i || ('TSNamedTupleMember' === i && t.optional) || this.raise(t.start, dt.OptionalTypeBeforeRequired),
											(e = e || ('TSNamedTupleMember' === i && t.optional) || 'TSOptionalType' === i),
											'TSRestType' === i && (i = (t = t.typeAnnotation).type)
										const n = 'TSNamedTupleMember' === i
										;(s = null != (r = s) ? r : n), s !== n && this.raise(t.start, dt.MixedLabeledAndUnlabeledElements)
									}),
							...
							tsParseTupleElementType() {
								...
								if (this.eat(c.colon)) {
									...
									;(t.optional = i),
										'TSTypeReference' !== r.type || r.typeParameters || 'Identifier' !== r.typeName.type ? (this.raise(r.start, dt.InvalidTupleMemberLabel), (t.label = r)) : (t.label = r.typeName),
							...
							tsParseTypeOrTypePredicateAnnotation(t) {
								return this.tsInType(() => {
									...
									const r = this.tsIsIdentifier() && this.tsTryParse(this.tsParseTypePredicatePrefix.bind(this))
									if (!r) {
									...
									return (n.parameterName = r), (n.typeAnnotation = i), (n.asserts = s), (e.typeAnnotation = this.finishNode(n, 'TSTypePredicate')), this.finishNode(e, 'TSTypeAnnotation')
								})
							}
							...
							tsParseHeritageClause(t) {
								...
								return s.length || this.raise(e, dt.EmptyHeritageClauseType, t), s
							}
							...
							tsParseInterfaceDeclaration(t) {
								;(t.id = this.parseIdentifier()),
									...
									this.eat(c._extends) && (t.extends = this.tsParseHeritageClause('extends'))
								const e = this.startNode()
							...
							tsParseEnumMember() {
								const t = this.startNode()
								return (
									(t.id = this.match(c.string) ? this.parseExprAtom() : this.parseIdentifier(!0)),
									this.eat(c.eq) && (t.initializer = this.parseMaybeAssignAllowIn()),
							...
							tsParseModuleOrNamespaceDeclaration(t, e = !1) {
								if (((t.id = this.parseIdentifier()), e || this.checkLVal(t.id, 1024, null, 'module or namespace declaration'), this.eat(c.dot))) {
									const e = this.startNode()
									this.tsParseModuleOrNamespaceDeclaration(e, !0), (t.body = e)
								} else this.scope.enter(p), this.prodParam.enter(0), (t.body = this.tsParseModuleBlock()), this.prodParam.exit(), this.scope.exit()
								return this.finishNode(t, 'TSModuleDeclaration')
							}
							tsParseAmbientExternalModuleDeclaration(t) {
								return (
									this.isContextual('global') ? ((t.global = !0), (t.id = this.parseIdentifier())) : this.match(c.string) ? (t.id = this.parseExprAtom()) : this.unexpected(),
									this.match(c.braceL) ? (this.scope.enter(p), this.prodParam.enter(0), (t.body = this.tsParseModuleBlock()), this.prodParam.exit(), this.scope.exit()) : this.semicolon(),
							...
							tsTryParseDeclare(t) {
								...
								let e,
									s = this.state.type
								return (
									this.isContextual('let') && ((s = c._var), (e = 'let')),
							...
							tsParseTypeArguments() {
								const t = this.startNode()
								return (
									(t.params = this.tsInType(() => this.tsInNoContext(() => (this.expectRelational('<'), this.tsParseDelimitedList('TypeParametersOrArguments', this.tsParseType.bind(this)))))),
									0 === t.params.length && this.raise(t.start, dt.EmptyTypeArguments),
									(this.state.exprAllowed = !1),
							...
							parseAssignableListItem(t, e) {
								...
								let i,
									n = !1
								void 0 !== t && ((i = this.parseAccessModifier()), (n = !!this.tsParseModifier(['readonly'])), !1 === t && (i || n) && this.raise(s, dt.UnexpectedParameterModifier))
								...
								if (i || n) {
									...
									return (
										...
										i && (t.accessibility = i),
										n && (t.readonly = n),
										'Identifier' !== o.type && 'AssignmentPattern' !== o.type && this.raise(t.start, dt.UnsupportedParameterPropertyKind),
										(t.parameter = o),
							...
							parseFunctionBodyAndFinish(t, e, s = !1) {
								...
								const r = 'FunctionDeclaration' === e ? 'TSDeclareFunction' : 'ClassMethod' === e ? 'TSDeclareMethod' : void 0
								r && !this.match(c.braceL) && this.isLineTerminator()
									? this.finishNode(t, r)
									: 'TSDeclareFunction' === r && this.state.isDeclareContext && (this.raise(t.start, dt.DeclareFunctionHasImplementation), t.declare)
							...
							tsCheckForInvalidTypeCasts(t) {
								t.forEach(t => {
									'TSTypeCastExpression' === (null == t ? void 0 : t.type) && this.raise(t.typeAnnotation.start, dt.UnexpectedTypeAnnotation)
								})
							}
							toReferencedList(t, e) {
							...
							parseExprOp(t, e, s, r) {
								if (pt(c._in.binop) > r && !this.hasPrecedingLineBreak() && this.isContextual('as')) {
									const i = this.startNodeAt(e, s)
									i.expression = t
									const n = this.tsTryNextParseConstantContext()
									return (i.typeAnnotation = n || this.tsNextThenParseType()), this.finishNode(i, 'TSAsExpression'), this.reScan_lt_gt(), this.parseExprOp(i, e, s, r)
								}
							...
							parseImport(t) {
								...
								return (
									'type' === e.importKind &&
										...
										this.raise(e.start, 'A type-only import can specify a default import or named bindings, but not both.'),
									e
								)
							}
							parseExport(t) {
							...
							parseClassMember(t, e, s) {
								...
								r && (e.accessibility = r), this.tsParseModifiers(e, ['declare'])
								const i = () => {
									super.parseClassMember(t, e, s)
								}
							...
							parseClassMemberWithIsStatic(t, e, s, r) {
								...
								if (i)
									return (
										t.body.push(i),
										e.abstract && this.raise(e.start, dt.IndexSignatureHasAbstract),
										r && this.raise(e.start, dt.IndexSignatureHasStatic),
										e.accessibility && this.raise(e.start, dt.IndexSignatureHasAccessibility, e.accessibility),
										void (e.declare && this.raise(e.start, dt.IndexSignatureHasDeclare))
									)
								super.parseClassMemberWithIsStatic(t, e, s, r)
							}
							parsePostMemberNameModifiers(t) {
								this.eat(c.question) && (t.optional = !0),
									t.readonly && this.match(c.parenL) && this.raise(t.start, dt.ClassMethodHasReadonly),
									t.declare && this.match(c.parenL) && this.raise(t.start, dt.ClassMethodHasDeclare)
							}
							parseExpressionStatement(t, e) {
							...
							parseConditional(t, e, s, r) {
								if (!r || !this.match(c.question)) return super.parseConditional(t, e, s, r)
								const i = this.tryParse(() => super.parseConditional(t, e, s))
								return i.node ? (i.error && (this.state = i.failState), i.node) : ((r.start = i.error.pos || this.state.start), t)
							}
							parseParenItem(t, e, s) {
							...
							parseExportDeclaration(t) {
								...
								let i
								return (
									this.match(c.name) && (i = this.tsTryParseExportDeclaration()),
									i || (i = super.parseExportDeclaration(t)),
									i && ('TSInterfaceDeclaration' === i.type || 'TSTypeAliasDeclaration' === i.type || r) && (t.exportKind = 'type'),
							...
							parseClassProperty(t) {
								return (
									this.parseClassPropertyAnnotation(t), this.state.isDeclareContext && this.match(c.eq) && this.raise(this.state.start, dt.DeclareClassFieldHasInitializer), super.parseClassProperty(t)
								)
							}
							parseClassPrivateProperty(t) {
								return (
									t.abstract && this.raise(t.start, dt.PrivateElementHasAbstract),
									t.accessibility && this.raise(t.start, dt.PrivateElementHasAccessibility, t.accessibility),
							...
							pushClassMethod(t, e, s, r, i, n) {
								...
								a && i && this.raise(a.start, dt.ConstructorHasTypeParameters), a && (e.typeParameters = a), super.pushClassMethod(t, e, s, r, i, n)
							}
							pushClassPrivateMethod(t, e, s, r) {
							...
							parseMaybeAssign(...t) {
								...
								if (this.match(c.jsxTagStart)) {
									if (((u = this.state.clone()), (h = this.tryParse(() => super.parseMaybeAssign(...t), u)), !h.error)) return h.node
									const { context: e } = this.state
									e[e.length - 1] === T.j_oTag ? (e.length -= 2) : e[e.length - 1] === T.j_expr && (e.length -= 1)
								}
								if (!(null == (e = h) ? void 0 : e.error) && !this.isRelational('<')) return super.parseMaybeAssign(...t)
								...
								const d = this.tryParse(e => {
									...
									return (
										('ArrowFunctionExpression' !== r.type || (r.extra && r.extra.parenthesized)) && e(),
										0 !== (null == (s = l) ? void 0 : s.params.length) && this.resetStartLocationFromNode(r, l),
										(r.typeParameters = l),
										r
									)
								}, u)
								if (!d.error && !d.aborted) return d.node
								if (!h && (lt(!this.hasPlugin('jsx')), (p = this.tryParse(() => super.parseMaybeAssign(...t), u)), !p.error)) return p.node
								if (null == (s = h) ? void 0 : s.node) return (this.state = h.failState), h.node
								if (d.node) return (this.state = d.failState), d.node
								if (null == (r = p) ? void 0 : r.node) return (this.state = p.failState), p.node
								if (null == (i = h) ? void 0 : i.thrown) throw h.error
								if (d.thrown) throw d.error
								if (null == (n = p) ? void 0 : n.thrown) throw p.error
								throw (null == (a = h) ? void 0 : a.error) || d.error || (null == (o = p) ? void 0 : o.error)
							}
							parseMaybeUnary(t) {
							...
							parseAssignableListItemTypes(t) {
								this.eat(c.question) && ('Identifier' === t.type || this.state.isDeclareContext || this.state.inType || this.raise(t.start, dt.PatternIsOptional), (t.optional = !0))
								const e = this.tsTryParseTypeAnnotation()
							...
							parseMaybeDefault(...t) {
								...
								return 'AssignmentPattern' === e.type && e.typeAnnotation && e.right.start < e.typeAnnotation.start && this.raise(e.typeAnnotation.start, dt.TypeAnnotationAfterAssign), e
							}
							getTokenFromCode(t) {
								...
								for (let e = 0; e < t.length; e++) {
									...
									if (s)
										switch (s.type) {
											...
											case 'TSAsExpression':
											case 'TSTypeAssertion':
												this.state.maybeInArrowParameters ? this.raise(s.start, dt.UnexpectedTypeCastInParameter) : (t[e] = this.typeCastToParameter(s))
										}
								}
					...
					placeholders: t =>
						class extends t {
							...
							parseClass(t, e, s) {
								...
								if (n)
									if (this.match(c._extends) || this.match(c.placeholder) || this.match(c.braceL)) t.id = n
									else {
										if (s || !e) return (t.id = null), (t.body = this.finishPlaceholder(n, 'ClassBody')), this.finishNode(t, r)
										this.unexpected(null, 'A class name is required')
									}
								else this.parseClassId(t, e, s)
								return this.parseClassSuper(t), (t.body = this.parsePlaceholder('ClassBody') || this.parseClassBody(!!t.superClass, i)), this.finishNode(t, r)
							}
							parseExport(t) {
								...
								if (!this.isContextual('from') && !this.match(c.comma))
									return (t.specifiers = []), (t.source = null), (t.declaration = this.finishPlaceholder(e, 'Declaration')), this.finishNode(t, 'ExportNamedDeclaration')
							...
							parseImport(t) {
								...
								if (((t.specifiers = []), !this.isContextual('from') && !this.match(c.comma)))
									return (t.source = this.finishPlaceholder(e, 'StringLiteral')), this.semicolon(), this.finishNode(t, 'ImportDeclaration')
								const s = this.startNodeAtNode(e)
								if (((s.local = e), this.finishNode(s, 'ImportDefaultSpecifier'), t.specifiers.push(s), this.eat(c.comma))) {
			...
			const gt = new Set(['g', 'm', 's', 'i', 'y', 'u']),
				bt = { decBinOct: [46, 66, 69, 79, 95, 98, 101, 111], hex: [46, 88, 95, 120] },
				Pt = { bin: [48, 49] }
			...
			class Bt {
				constructor(t, e, s) {
					;(this.type = void 0),
						...
						(null == t ? void 0 : t.filename) && (this.loc.filename = t.filename)
				}
				__clone() {
					const t = new Bt(),
						e = Object.keys(this)
					for (let s = 0, r = e.length; s < r; s++) {
						const r = e[s]
						'leadingComments' !== r && 'trailingComments' !== r && 'innerComments' !== r && (t[r] = this[r])
					}
					return t
				}
			}
			const St = t => ('ParenthesizedExpression' === t.type ? St(t.expression) : t)
			class Nt {
				constructor(t = 0) {
			...
			class vt {
				...
				recordAsyncArrowParametersError(t, e) {
					...
					let r = s.length - 1,
						i = s[r]
					for (; i.canBeArrowParameterDeclaration(); ) 2 === i.type && i.recordDeclarationError(t, e), (i = s[--r])
				}
				validateAsPattern() {
					const { stack: t } = this,
						e = t[t.length - 1]
					e.canBeArrowParameterDeclaration() &&
						e.iterateErrors((e, s) => {
							...
							let r = t.length - 2,
								i = t[r]
							for (; i.canBeArrowParameterDeclaration(); ) i.clearDeclarationError(s), (i = t[--r])
						})
				}
			}
			function kt() {
			...
			class _t {
				...
				exit() {
					const t = this.stack.pop(),
						e = this.current()
					for (let s = 0, r = Array.from(t.undefinedPrivateNames); s < r.length; s++) {
						const [t, i] = r[s]
						e ? e.undefinedPrivateNames.has(t) || e.undefinedPrivateNames.set(t, i) : this.raise(i, g.InvalidPrivateFieldResolution, t)
					}
				}
				declarePrivateName(t, e, s) {
					...
					i && this.raise(s, g.PrivateNameRedeclaration, t), r.privateNames.add(t), r.undefinedPrivateNames.delete(t)
				}
				usePrivateName(t, e) {
					let s
					for (let e = 0, r = this.stack; e < r.length; e++) if (((s = r[e]), s.privateNames.has(t))) return
					s ? s.undefinedPrivateNames.set(t, e) : this.raise(e, g.InvalidPrivateFieldResolution, t)
				}
			}
			class jt extends class extends class extends class extends class extends class extends class extends class extends class extends class {
				constructor() {
				...
				adjustCommentsAfterTrailingComma(t, e, s) {
					...
					for (let e = 0; e < this.state.leadingComments.length; e++) {
						...
						r.end < t.end ? (n.push(r), s || (this.state.leadingComments.splice(e, 1), e--)) : (void 0 === t.trailingComments && (t.trailingComments = []), t.trailingComments.push(r))
					}
					s && (this.state.leadingComments = []), n.length > 0 ? (r.trailingComments = n) : void 0 !== r.trailingComments && (r.trailingComments = [])
				}
				processComment(t) {
					...
					if (this.state.trailingComments.length > 0)
						this.state.trailingComments[0].start >= t.end ? ((i = this.state.trailingComments), (this.state.trailingComments = [])) : (this.state.trailingComments.length = 0)
					else if (e.length > 0) {
						const s = F(e)
						s.trailingComments && s.trailingComments[0].start >= t.end && ((i = s.trailingComments), delete s.trailingComments)
					}
					for (e.length > 0 && F(e).start >= t.start && (s = e.pop()); e.length > 0 && F(e).start >= t.start; ) r = e.pop()
					if ((!r && s && (r = s), s))
						switch (t.type) {
							case 'ObjectExpression':
						...
						this.state.commentPreviousNode &&
							(('ImportSpecifier' === this.state.commentPreviousNode.type && 'ImportSpecifier' !== t.type) ||
								('ExportSpecifier' === this.state.commentPreviousNode.type && 'ExportSpecifier' !== t.type)) &&
							this.adjustCommentsAfterTrailingComma(t, [this.state.commentPreviousNode])
					if (r) {
						if (r.leadingComments)
							if (r !== t && r.leadingComments.length > 0 && F(r.leadingComments).end <= t.start) (t.leadingComments = r.leadingComments), delete r.leadingComments
							else
								for (n = r.leadingComments.length - 2; n >= 0; --n)
									if (r.leadingComments[n].end <= t.start) {
										t.leadingComments = r.leadingComments.splice(0, n + 1)
										break
									}
						...
						if (F(this.state.leadingComments).end <= t.start) {
							...
							e.length && (t.leadingComments = e), (i = this.state.leadingComments.slice(n)), 0 === i.length && (i = null)
						}
					if (((this.state.commentPreviousNode = t), i))
						if (i.length && i[0].start >= t.start && F(i).end <= t.end) t.innerComments = i
						else {
							const e = i.findIndex(e => e.end >= t.end)
							e > 0 ? ((t.innerComments = i.slice(0, e)), (t.trailingComments = i.slice(e))) : (t.trailingComments = i)
						}
					e.push(t)
				}
			} {
							...
							t === this.state.start
								...
								: (function (t, e) {
										let s,
											r = 1,
											i = 0
										for (f.lastIndex = 0; (s = f.exec(t)) && s.index < e; ) r++, (i = f.lastIndex)
										return new C(r, e - i)
								  })(this.input, t)),
						e
					)
				...
				raiseWithData(t, e, s, ...r) {
					const i = this.getLocationForPosition(t),
						n = s.replace(/%(\d+)/g, (t, e) => r[e]) + ' ('.concat(i.line, ':').concat(i.column, ')')
					return this._raise(Object.assign({ loc: i, pos: t }, e), n)
				}
				_raise(t, e) {
				...
				constructor(t, e) {
					super(), (this.isLookahead = void 0), (this.tokens = []), (this.state = new xt()), this.state.init(t), (this.input = e), (this.length = e.length), (this.isLookahead = !1)
				}
				pushToken(t) {
					;(this.tokens.length = this.state.tokensLength), this.tokens.push(t), ++this.state.tokensLength
				}
				next() {
					this.isLookahead || (this.checkKeywordEscapes(), this.options.tokens && this.pushToken(new Tt(this.state))),
				...
				pushComment(t, e, s, r, i, n) {
					const a = { type: t ? 'CommentBlock' : 'CommentLine', value: e, start: s, end: r, loc: new x(i, n) }
					this.options.tokens && this.pushToken(a), this.state.comments.push(a), this.addComment(a)
				}
				skipBlockComment() {
					...
					let r
					for (this.state.pos = s + 2, f.lastIndex = e; (r = f.exec(this.input)) && r.index < this.state.pos; ) ++this.state.curLine, (this.state.lineStart = r.index + r[0].length)
				...
				skipLineComment(t) {
					...
					if (this.state.pos < this.length) for (; !y(r) && ++this.state.pos < this.length; ) r = this.input.charCodeAt(this.state.pos)
				...
				readToken_numberSign() {
					...
					if (123 === e || (91 === e && this.hasPlugin('recordAndTuple'))) {
						if ((this.expectPlugin('recordAndTuple'), 'hash' !== this.getPluginOption('recordAndTuple', 'syntaxType')))
							throw this.raise(this.state.pos, 123 === e ? g.RecordExpressionHashIncorrectStartSyntaxType : g.TupleExpressionHashIncorrectStartSyntaxType)
				...
				readToken_mult_modulo(t) {
					...
					42 === t && 42 === r && (s++, (r = this.input.charCodeAt(this.state.pos + 2)), (e = c.exponent)), 61 !== r || i || (s++, (e = c.assign)), this.finishOp(e, s)
				}
				readToken_pipe_amp(t) {
					const e = this.input.charCodeAt(this.state.pos + 1)
					if (e !== t) {
				...
				readToken_plus_min(t) {
					const e = this.input.charCodeAt(this.state.pos + 1)
					if (e === t)
						return 45 !== e || this.inModule || 62 !== this.input.charCodeAt(this.state.pos + 2) || (0 !== this.state.lastTokEnd && !this.hasPrecedingLineBreak())
				...
				readToken_lt_gt(t) {
					...
					return e === t
						? ((s = 62 === t && 62 === this.input.charCodeAt(this.state.pos + 2) ? 3 : 2),
						  61 === this.input.charCodeAt(this.state.pos + s) ? void this.finishOp(c.assign, s + 1) : void this.finishOp(c.bitShift, s))
						: 33 !== e || 60 !== t || this.inModule || 45 !== this.input.charCodeAt(this.state.pos + 2) || 45 !== this.input.charCodeAt(this.state.pos + 3)
						? (61 === e && (s = 2), void this.finishOp(c.relational, s))
				...
				readRegexp() {
					...
					for (; this.state.pos < this.length; ) {
						...
						if (gt.has(t)) i.indexOf(t) > -1 && this.raise(this.state.pos + 1, g.DuplicateRegExpFlags)
						else {
							if (!O(e) && 92 !== e) break
				...
				readInt(t, e, s, r = !0) {
					const i = this.state.pos,
						...
						a = 16 === t ? Pt.hex : 10 === t ? Pt.dec : 8 === t ? Pt.oct : Pt.bin
					let o = !1,
						u = 0
					for (let i = 0, h = null == e ? 1 / 0 : e; i < h; ++i) {
						...
						let h
						if (95 !== e) {
							if (((h = e >= 97 ? e - 97 + 10 : e >= 65 ? e - 65 + 10 : Ft(e) ? e - 48 : 1 / 0), h >= t))
								if (this.options.errorRecovery && h <= 9) (h = 0), this.raise(this.state.start + i + 2, g.InvalidDigit, t)
								else {
									if (!s) break
									;(h = 0), (o = !0)
								}
							...
							;(-1 === a.indexOf(e) || n.indexOf(t) > -1 || n.indexOf(e) > -1 || Number.isNaN(e)) && this.raise(this.state.pos, g.UnexpectedNumericSeparator),
								r || this.raise(this.state.pos, g.NumericSeparatorInEscapeSequence),
								++this.state.pos
						}
					}
					return this.state.pos === i || (null != e && this.state.pos - i !== e) || o ? null : u
				}
				readRadixNumber(t) {
					const e = this.state.pos
					let s = !1
					...
					null == r && this.raise(this.state.start + 2, g.InvalidDigit, t)
					const i = this.input.charCodeAt(this.state.pos)
					if (110 === i) ++this.state.pos, (s = !0)
					else if (109 === i) throw this.raise(e, g.InvalidDecimal)
					if (L(this.input.codePointAt(this.state.pos))) throw this.raise(this.state.pos, g.NumberIdentifier)
					if (s) {
				...
				readNumber(t) {
					...
					if (o) {
						...
						if (this.state.strict) this.raise(e, g.StrictOctalLiteral)
						else {
							const s = t.indexOf('_')
					...
					if (
						(46 !== u || a || (++this.state.pos, this.readInt(10), (s = !0), (u = this.input.charCodeAt(this.state.pos))),
						(69 !== u && 101 !== u) ||
							a ||
							((u = this.input.charCodeAt(++this.state.pos)),
							(43 !== u && 45 !== u) || ++this.state.pos,
							null === this.readInt(10) && this.raise(e, g.InvalidOrMissingExponent),
							(s = !0),
							(n = !0),
							(u = this.input.charCodeAt(this.state.pos))),
						110 === u && ((s || o) && this.raise(e, g.InvalidBigIntLiteral), ++this.state.pos, (r = !0)),
						109 === u && (this.expectPlugin('decimal', this.state.pos), (n || o) && this.raise(e, g.InvalidDecimal), ++this.state.pos, (i = !0)),
				...
				readString(t) {
					...
					for (;;) {
						...
						const r = this.input.charCodeAt(this.state.pos)
						if (r === t) break
						if (92 === r) (e += this.input.slice(s, this.state.pos)), (e += this.readEscapedChar(!1)), (s = this.state.pos)
						else if (8232 === r || 8233 === r) ++this.state.pos, ++this.state.curLine, (this.state.lineStart = this.state.pos)
						else {
							if (y(r)) throw this.raise(this.state.start, g.UnterminatedString)
							++this.state.pos
						}
					}
				...
				readTmplToken() {
					...
					for (;;) {
						...
						if (96 === r || (36 === r && 123 === this.input.charCodeAt(this.state.pos + 1)))
							return this.state.pos === this.state.start && this.match(c.template)
								? 36 === r
									? ((this.state.pos += 2), void this.finishToken(c.dollarBraceL))
									: (++this.state.pos, void this.finishToken(c.backQuote))
								: ((t += this.input.slice(e, this.state.pos)), void this.finishToken(c.template, s ? null : t))
						if (92 === r) {
					...
					switch ((++this.state.pos, s)) {
						...
						default:
							if (s >= 48 && s <= 55) {
								...
								if ('0' !== s || 56 === i || 57 === i) {
									if (t) return null
									this.state.strict ? this.raise(e, g.StrictNumericEscape) : this.state.octalPositions.push(e)
								}
				...
				readHexChar(t, e, s) {
					...
					return null === i && (s ? this.raise(r, g.InvalidEscapeSequence) : (this.state.pos = r - 1)), i
				}
				readWord1() {
					let t = ''
					...
					for (; this.state.pos < this.length; ) {
						...
						if (O(r)) this.state.pos += r <= 65535 ? 1 : 2
							...
							if (92 !== r) break
							{
								...
								null !== n && (i(n) || this.raise(r, g.EscapedCharNotAnIdentifier), (t += String.fromCodePoint(n))), (s = this.state.pos)
							}
						}
					}
				...
				braceIsBlock(t) {
					const e = this.curContext()
					return (
						e === T.functionExpression ||
						e === T.functionStatement ||
						(t !== c.colon || (e !== T.braceStatement && e !== T.braceExpression)
							? t === c._return || (t === c.name && this.state.exprAllowed)
								...
								: t === c._else ||
								  ...
								  t === c.parenR ||
								  t === c.arrow ||
								  (t === c.braceL ? e === T.braceStatement : t !== c._var && t !== c._const && t !== c.name && (t === c.relational || !this.state.exprAllowed))
							: !e.isExpr)
					)
				}
				updateContext(t) {
				...
				isUnparsedContextual(t, e) {
					const s = t + e.length
					return this.input.slice(t, s) === e && (s === this.input.length || !O(this.input.charCodeAt(s)))
				}
				...
				hasPrecedingLineBreak() {
					return m.test(this.input.slice(this.state.lastTokEnd, this.state.start))
				}
				isLineTerminator() {
				...
				expectPlugin(t, e) {
					if (!this.hasPlugin(t)) throw this.raiseWithData(null != e ? e : this.state.start, { missingPlugin: [t] }, "This experimental syntax requires enabling the parser plugin: '".concat(t, "'"))
					return !0
				}
				expectOnePlugin(t, e) {
				...
				tryParse(t, e = this.state.clone()) {
					...
					try {
						...
						if (this.state.errors.length > e.errors.length) {
							const t = this.state
							return (this.state = e), { node: r, error: t.errors[e.errors.length], thrown: !1, aborted: !1, failState: t }
						}
						return { node: r, error: null, thrown: !1, aborted: !1, failState: null }
					} catch (t) {
						const r = this.state
						if (((this.state = e), t instanceof SyntaxError)) return { node: null, error: t, thrown: !0, aborted: !1, failState: r }
						if (t === s) return { node: s.node, error: null, thrown: !1, aborted: !0, failState: r }
						throw t
					}
				}
				checkExpressionErrors(t, e) {
					...
					if (!e) return s >= 0 || r >= 0
					s >= 0 && this.unexpected(s), r >= 0 && this.raise(r, g.DuplicateProto)
				}
				...
				toAssignable(t) {
					...
					let r = void 0
					switch (
						(('ParenthesizedExpression' === t.type || (null == (e = t.extra) ? void 0 : e.parenthesized)) &&
							((r = St(t)), 'Identifier' !== r.type && 'MemberExpression' !== r.type && this.raise(t.start, g.InvalidParenthesizedAssignment)),
						t.type)
					) {
						case 'Identifier':
						case 'ObjectPattern':
						...
						case 'ObjectExpression':
							...
							for (let e = 0, s = t.properties.length, r = s - 1; e < s; e++) {
								var i
								const s = t.properties[e],
									n = e === r
								this.toAssignableObjectExpressionProp(s, n), n && 'RestElement' === s.type && (null == (i = t.extra) ? void 0 : i.trailingComma) && this.raiseRestNotLast(t.extra.trailingComma)
							}
							break
						case 'ObjectProperty':
						...
						case 'ArrayExpression':
							...
							break
						case 'AssignmentExpression':
							'=' !== t.operator && this.raise(t.left.end, g.MissingEqInAssignment), (t.type = 'AssignmentPattern'), delete t.operator, this.toAssignable(t.left)
							break
						case 'ParenthesizedExpression':
							this.toAssignable(r)
					}
				...
				parseBindingList(t, e, s, r) {
					...
					let n = !0
					for (; !this.eat(t); )
						if ((n ? (n = !1) : this.expect(c.comma), s && this.match(c.comma))) i.push(null)
						else {
							if (this.eat(t)) break
							if (this.match(c.ellipsis)) {
								i.push(this.parseAssignableListItemTypes(this.parseRestBinding())), this.checkCommaAfterRest(e), this.expect(t)
								break
							}
							{
								const t = []
				...
				parseMaybeDefault(t, e, s) {
					var r, i, n
					if (((e = null != (r = e) ? r : this.state.startLoc), (t = null != (i = t) ? i : this.state.start), (s = null != (n = s) ? n : this.parseBindingAtom()), !this.eat(c.eq))) return s
					const a = this.startNodeAt(t, e)
					return (a.left = s), (a.right = this.parseMaybeAssignAllowIn()), this.finishNode(a, 'AssignmentPattern')
				}
				checkLVal(t, e = 64, s, r, i, n = !1) {
					switch (t.type) {
						case 'Identifier':
							if ((this.state.strict && (n ? H(t.name, this.inModule) : z(t.name)) && this.raise(t.start, e === D ? g.StrictEvalArguments : g.StrictEvalArgumentsBinding, t.name), s)) {
								const e = '_'.concat(t.name)
								s[e] ? this.raise(t.start, g.ParamDupe) : (s[e] = !0)
							}
							i && 'let' === t.name && this.raise(t.start, g.LetInLexicalBinding), e & D || this.scope.declareName(t.name, e, t.start)
							break
						case 'MemberExpression':
							e !== D && this.raise(t.start, g.InvalidPropertyBindingPattern)
							break
						case 'ObjectPattern':
							for (let r = 0, n = t.properties; r < n.length; r++) {
								...
								this.checkLVal(t, e, s, 'object destructuring pattern', i)
							}
							break
						case 'ArrayPattern':
							for (let r = 0, n = t.elements; r < n.length; r++) {
								const t = n[r]
								t && this.checkLVal(t, e, s, 'array destructuring pattern', i)
							}
							break
						case 'AssignmentPattern':
						...
						case 'ParenthesizedExpression':
							...
							break
						default:
							this.raise(t.start, e === D ? g.InvalidLhs : g.InvalidLhsBinding, r)
					}
				}
				...
				checkProto(t, e, s, r) {
					...
					if ('__proto__' === ('Identifier' === i.type ? i.name : i.value)) {
						...
						s.used && (r ? -1 === r.doubleProto && (r.doubleProto = i.start) : this.raise(i.start, g.DuplicateProto)), (s.used = !0)
					}
				}
				...
				parseExpressionBase(t) {
					...
					if (this.match(c.comma)) {
						const i = this.startNodeAt(e, s)
						for (i.expressions = [r]; this.eat(c.comma); ) i.expressions.push(this.parseMaybeAssign(t))
				...
				parseMaybeAssign(t, e, s) {
					...
					let n
					t ? (n = !1) : ((t = new wt()), (n = !0)), (this.match(c.parenL) || this.match(c.name)) && (this.state.potentialArrowAt = this.state.start)
					...
					if ((e && (a = e.call(this, a, r, i)), this.state.type.isAssign)) {
						...
						return (
							(e.operator = s),
							this.match(c.eq) ? ((e.left = this.toAssignable(a)), (t.doubleProto = -1)) : (e.left = a),
				...
				parseMaybeConditional(t, e) {
					...
					return this.shouldExitDescending(n, i) ? n : this.parseConditional(n, s, r, e)
				}
				parseConditional(t, e, s, r) {
					if (this.eat(c.question)) {
						const r = this.startNodeAt(e, s)
						return (r.test = t), (r.consequent = this.parseMaybeAssignAllowIn()), this.expect(c.colon), (r.alternate = this.parseMaybeAssign()), this.finishNode(r, 'ConditionalExpression')
					}
					return t
				}
				parseExprOps(t) {
				...
				parseExprOp(t, e, s, r) {
					...
					if (null != i && (this.prodParam.hasIn || !this.match(c._in)) && i > r) {
						...
						;(a.left = t),
							...
							n !== c.exponent ||
								...
								(!this.options.createParenthesizedExpressions && t.extra && t.extra.parenthesized) ||
								this.raise(t.argument.start, g.UnexpectedTokenUnaryExponentiation)
						const o = n === c.logicalOR || n === c.logicalAND,
							u = n === c.nullishCoalescing
						if (
							(u && (i = c.logicalAND.binop),
							this.next(),
							n === c.pipeline && 'minimal' === this.getPluginOption('pipelineOperator', 'proposal') && this.match(c.name) && 'await' === this.state.value && this.prodParam.hasAwait)
						)
							throw this.raise(this.state.start, g.UnexpectedAwaitAfterPipelineBody)
						;(a.right = this.parseExprOpRightExpr(n, i)), this.finishNode(a, o || u ? 'LogicalExpression' : 'BinaryExpression')
						const h = this.state.type
						if ((u && (h === c.logicalOR || h === c.logicalAND)) || (o && h === c.nullishCoalescing)) throw this.raise(this.state.start, g.MixingCoalesceWithLogical)
					...
					switch (t) {
						case c.pipeline:
							switch (this.getPluginOption('pipelineOperator', 'proposal')) {
								case 'smart':
									return this.withTopicPermittingContext(() => this.parseSmartPipelineBody(this.parseExprOpBaseRightExpr(t, e), s, r))
								case 'fsharp':
				...
				parseExprOpBaseRightExpr(t, e) {
					const s = this.state.start,
						r = this.state.startLoc
					return this.parseExprOp(this.parseMaybeUnary(), s, r, t.rightAssociative ? e - 1 : e)
				}
				parseMaybeUnary(t) {
					...
					if (this.state.type.prefix) {
						...
						if ((this.next(), (s.argument = this.parseMaybeUnary()), this.checkExpressionErrors(t, !0), this.state.strict && r)) {
							const t = s.argument
							'Identifier' === t.type
								? this.raise(s.start, g.StrictDelete)
								: ('MemberExpression' !== t.type && 'OptionalMemberExpression' !== t.type) || 'PrivateName' !== t.property.type || this.raise(s.start, g.DeletePrivateField)
						}
				...
				parseUpdate(t, e, s) {
					...
					for (; this.state.type.postfix && !this.canInsertSemicolon(); ) {
						...
						;(t.operator = this.state.value), (t.prefix = !1), (t.argument = n), this.checkLVal(n, void 0, void 0, 'postfix operation'), this.next(), (n = this.finishNode(t, 'UpdateExpression'))
					}
					return n
				}
				...
				parseSubscripts(t, e, s, r) {
					const i = { optionalChainMember: !1, maybeAsyncArrow: this.atPossibleAsyncArrow(t), stop: !1 }
					do {
				...
				parseSubscript(t, e, s, r, i) {
					if (!r && this.eat(c.doubleColon)) return this.parseBind(t, e, s, r, i)
					if (this.match(c.backQuote)) return this.parseTaggedTemplateExpression(t, e, s, i)
					let n = !1
					if (this.match(c.questionDot)) {
						if (((i.optionalChainMember = n = !0), r && 40 === this.lookaheadCharCode())) return (i.stop = !0), t
						this.next()
					}
				...
				parseMember(t, e, s, r, i) {
					const n = this.startNodeAt(e, s),
						a = this.eat(c.bracketL)
					;(n.object = t), (n.computed = a)
					const o = a ? this.parseExpression() : this.parseMaybePrivateName(!0)
					return (
						'PrivateName' === o.type && ('Super' === n.object.type && this.raise(e, g.SuperPrivateField), this.classScope.usePrivateName(o.id.name, o.start)),
						(n.property = o),
						a && this.expect(c.bracketR),
						r.optionalChainMember ? ((n.optional = i), this.finishNode(n, 'OptionalMemberExpression')) : this.finishNode(n, 'MemberExpression')
					)
				}
				parseBind(t, e, s, r, i) {
					const n = this.startNodeAt(e, s)
					return (n.object = t), (n.callee = this.parseNoCallExpr()), (i.stop = !0), this.parseSubscripts(this.finishNode(n, 'BindExpression'), e, s, r)
				}
				parseCoverCallAndAsyncArrowHead(t, e, s, r, i) {
					...
					return (
						...
						(a.arguments = i ? this.parseCallExpressionArguments(c.parenR, !1) : this.parseCallExpressionArguments(c.parenR, r.maybeAsyncArrow, 'Import' === t.type, 'Super' !== t.type, a)),
						this.finishCallExpression(a, r.optionalChainMember),
						r.maybeAsyncArrow && this.shouldParseAsyncArrow() && !i
							? ((r.stop = !0), this.expressionScope.validateAsPattern(), this.expressionScope.exit(), (a = this.parseAsyncArrowFromCallExpression(this.startNodeAt(e, s), a)))
							: (r.maybeAsyncArrow && this.expressionScope.exit(), this.toReferencedArguments(a)),
				...
				parseTaggedTemplateExpression(t, e, s, r) {
					const i = this.startNodeAt(e, s)
					return (i.tag = t), (i.quasi = this.parseTemplate(!0)), r.optionalChainMember && this.raise(e, g.OptionalChainingNoTemplate), this.finishNode(i, 'TaggedTemplateExpression')
				}
				...
				finishCallExpression(t, e) {
					if ('Import' === t.callee.type)
						if ((2 === t.arguments.length && (this.hasPlugin('moduleAttributes') || this.expectPlugin('importAssertions')), 0 === t.arguments.length || t.arguments.length > 2))
							this.raise(t.start, g.ImportCallArity, this.hasPlugin('importAssertions') || this.hasPlugin('moduleAttributes') ? 'one or two arguments' : 'one argument')
						else
				...
				parseCallExpressionArguments(t, e, s, r, i) {
					...
					for (this.state.inFSharpPipelineDirectBody = !1; !this.eat(t); ) {
						if (o) o = !1
							...
							!s || this.hasPlugin('importAssertions') || this.hasPlugin('moduleAttributes') || this.raise(this.state.lastTokStart, g.ImportCallArgumentTrailingComma),
								i && this.addExtra(i, 'trailingComma', this.state.lastTokStart),
								this.next()
							break
						}
						this.match(c.parenL) && !a && (a = this.state.start), n.push(this.parseExprListItem(!1, e ? new wt() : void 0, e ? { start: 0 } : void 0, r))
					}
					return e && a && this.shouldParseAsyncArrow() && this.unexpected(), (this.state.inFSharpPipelineDirectBody = u), n
				}
				shouldParseAsyncArrow() {
					...
					switch (this.state.type) {
						...
						case c._import:
							return (
								(s = this.startNode()),
								this.next(),
								this.match(c.dot) ? this.parseImportMetaProperty(s) : (this.match(c.parenL) || this.raise(this.state.lastTokStart, g.UnsupportedImport), this.finishNode(s, 'Import'))
							)
						case c._this:
						...
						case c.hash: {
							if (this.state.inPipeline)
								return (
									(s = this.startNode()),
									'smart' !== this.getPluginOption('pipelineOperator', 'proposal') && this.raise(s.start, g.PrimaryTopicRequiresSmartPipeline),
									this.next(),
									this.primaryTopicReferenceIsAllowedInCurrentTopicContext() || this.raise(s.start, g.PrimaryTopicNotAllowed),
						...
						case c.relational:
							if ('<' === this.state.value) {
								...
								;(L(t) || 62 === t) && this.expectOnePlugin(['jsx', 'flow', 'typescript'])
							}
						default:
							throw this.unexpected()
					}
				...
				parseSuper() {
					...
					return (
						this.next(),
						!this.match(c.parenL) || this.scope.allowDirectSuper || this.options.allowSuperOutsideMethod
							? this.scope.allowSuper || this.options.allowSuperOutsideMethod || this.raise(t.start, g.UnexpectedSuper)
							: this.raise(t.start, g.SuperNotAllowed),
						this.match(c.parenL) || this.match(c.bracketL) || this.match(c.dot) || this.raise(t.start, g.UnsupportedSuper),
				...
				parseMetaProperty(t, e, s) {
					...
					return (t.property = this.parseIdentifier(!0)), (t.property.name !== s || r) && this.raise(t.property.start, g.UnsupportedMetaProperty, e.name, s), this.finishNode(t, 'MetaProperty')
				}
				parseImportMetaProperty(t) {
					const e = this.createIdentifier(this.startNodeAtNode(t), 'import')
					return (
						this.next(),
						this.isContextual('meta') && (this.inModule || this.raiseWithData(e.start, { code: 'BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED' }, g.ImportMetaOutsideModule), (this.sawUnambiguousESM = !0)),
				...
				parseLiteral(t, e, s, r) {
					...
					return this.addExtra(i, 'rawValue', t), this.addExtra(i, 'raw', this.input.slice(s, this.state.end)), (i.value = t), this.next(), this.finishNode(i, e)
				}
				parseParenAndDistinguishExpression(t) {
					const e = this.state.start,
						s = this.state.startLoc
					...
					for (; !this.match(c.parenR); ) {
						if (D) D = !1
						else if ((this.expect(c.comma, p.start || null), this.match(c.parenR))) {
							d = this.state.start
							break
						}
						if (this.match(c.ellipsis)) {
							const t = this.state.start,
								e = this.state.startLoc
							;(l = this.state.start), u.push(this.parseParenItem(this.parseRestBinding(), t, e)), this.checkCommaAfterRest(41)
							break
						}
						u.push(this.parseMaybeAssignAllowIn(h, this.parseParenItem, p))
					}
					const m = this.state.lastTokEnd,
						f = this.state.lastTokEndLoc
					this.expect(c.parenR), (this.state.maybeInArrowParameters = i), (this.state.inFSharpPipelineDirectBody = n)
					...
					if (
						...
						u.length > 1 ? ((r = this.startNodeAt(a, o)), (r.expressions = u), this.finishNodeAt(r, 'SequenceExpression', m, f)) : (r = u[0]),
						!this.options.createParenthesizedExpressions)
					)
						return this.addExtra(r, 'parenthesized', !0), this.addExtra(r, 'parenStart', e), r
					const E = this.startNodeAt(e, s)
					return (E.expression = r), this.finishNode(E, 'ParenthesizedExpression'), E
				}
				shouldParseArrow() {
				...
				parseNew(t) {
					return (
						...
						'Import' === t.callee.type
							...
							: 'OptionalMemberExpression' === t.callee.type || 'OptionalCallExpression' === t.callee.type
							? this.raise(this.state.lastTokEnd, g.OptionalChainingNoNew)
							: this.eat(c.questionDot) && this.raise(this.state.start, g.OptionalChainingNoNew),
				...
				parseTemplateElement(t) {
					const e = this.startNode()
					return (
						null === this.state.value && (t || this.raise(this.state.start + 1, g.InvalidEscapeSequenceTemplate)),
						(e.value = { raw: this.input.slice(this.state.start, this.state.end).replace(/\r\n?/g, '\n'), cooked: this.state.value }),
						this.next(),
				...
				parseObjectLike(t, e, s, r) {
					...
					for (o.properties = [], this.next(); !this.match(t); ) {
						...
						e || this.checkProto(i, s, n, r),
							s && 'ObjectProperty' !== i.type && 'SpreadElement' !== i.type && this.raise(i.start, g.InvalidRecordProperty),
							i.shorthand && this.addExtra(i, 'shorthand', !0),
							o.properties.push(i)
					}
					;(this.state.exprAllowed = !1), this.next(), (this.state.inFSharpPipelineDirectBody = i)
					let u = 'ObjectExpression'
					return e ? (u = 'ObjectPattern') : s && (u = 'RecordExpression'), this.finishNode(o, u)
				}
				...
				parsePropertyDefinition(t, e) {
					let s = []
					if (this.match(c.at)) for (this.hasPlugin('decorators') && this.raise(this.state.start, g.UnsupportedPropertyDecorator); this.match(c.at); ) s.push(this.parseDecorator())
					const r = this.startNode()
					let i,
						n,
						a = !1,
						...
						u = !1
					if (this.match(c.ellipsis))
						return s.length && this.unexpected(), t ? (this.next(), (r.argument = this.parseIdentifier()), this.checkCommaAfterRest(125), this.finishNode(r, 'RestElement')) : this.parseSpread()
					s.length && ((r.decorators = s), (s = [])), (r.method = !1), (t || e) && ((i = this.state.start), (n = this.state.startLoc)), t || (a = this.eat(c.star))
					const h = this.state.containsEsc,
						p = this.parsePropertyName(r, !1)
					if (!t && !a && !h && this.maybeAsyncOrAccessorProp(r)) {
						const t = p.name
						'async' !== t || this.hasPrecedingLineBreak() || ((o = !0), (a = this.eat(c.star)), this.parsePropertyName(r, !1)),
							('get' !== t && 'set' !== t) ||
								((u = !0), (r.kind = t), this.match(c.star) && ((a = !0), this.raise(this.state.pos, g.AccessorIsGenerator, t), this.next()), this.parsePropertyName(r, !1))
					}
				...
				checkGetterSetterParams(t) {
					...
					const s = this.getGetterSetterExpectedParamCount(t),
						...
						i = t.start
					r.length !== s && ('get' === t.kind ? this.raise(i, g.BadGetterArity) : this.raise(i, g.BadSetterArity)),
						'set' === t.kind && 'RestElement' === (null == (e = r[r.length - 1]) ? void 0 : e.type) && this.raise(i, g.BadSetterRestParameter)
				}
				parseObjectMethod(t, e, s, r, i) {
					return i
						? (this.parseMethod(t, e, !1, !1, !1, 'ObjectMethod'), this.checkGetterSetterParams(t), t)
						: s || e || this.match(c.parenL)
						? (r && this.unexpected(), (t.kind = 'method'), (t.method = !0), this.parseMethod(t, e, s, !1, !1, 'ObjectMethod'))
						: void 0
				}
				parseObjectProperty(t, e, s, r, i) {
					return (
						(t.shorthand = !1),
						this.eat(c.colon)
							? ((t.value = r ? this.parseMaybeDefault(this.state.start, this.state.startLoc) : this.parseMaybeAssignAllowIn(i)), this.finishNode(t, 'ObjectProperty'))
							...
							: (this.checkReservedWord(t.key.name, t.key.start, !0, !1),
							  r
									...
									: this.match(c.eq) && i
									? (-1 === i.shorthandAssign && (i.shorthandAssign = this.state.start), (t.value = this.parseMaybeDefault(e, s, t.key.__clone())))
				...
				parseObjPropValue(t, e, s, r, i, n, a, o) {
					const u = this.parseObjectMethod(t, r, i, n, a) || this.parseObjectProperty(t, e, s, n, o)
				...
				parsePropertyName(t, e) {
					if (this.eat(c.bracketL)) (t.computed = !0), (t.key = this.parseMaybeAssignAllowIn()), this.expect(c.bracketR)
						...
						;(this.state.inPropertyName = !0),
							(t.key = this.match(c.num) || this.match(c.string) || this.match(c.bigint) || this.match(c.decimal) ? this.parseExprAtom() : this.parseMaybePrivateName(e)),
				...
				parseMethod(t, e, s, r, i, n, a = !1) {
					...
					const o = r
					return (
						this.scope.enter(18 | (a ? 64 : 0) | (i ? 32 : 0)),
				...
				parseArrayLike(t, e, s, r) {
					...
					return this.next(), (n.elements = this.parseExprList(t, !s, r, n)), (this.state.inFSharpPipelineDirectBody = i), this.finishNode(n, s ? 'TupleExpression' : 'ArrayExpression')
				}
				parseArrowExpression(t, e, s, r) {
					this.scope.enter(6)
					let i = ct(s, !1)
					!this.match(c.bracketL) && this.prodParam.hasIn && (i |= 8), this.prodParam.enter(i), this.initFunction(t, s)
					const n = this.state.maybeInArrowParameters
					return (
					...
					if ((this.expressionScope.enter(kt()), r)) (t.body = this.parseMaybeAssign()), this.checkParams(t, !1, e, !1)
						...
						;(this.state.labels = []),
							...
							(t.body = this.parseBlock(!0, !1, i => {
								...
								this.checkParams(t, !(this.state.strict || e || s || n), e, a), this.state.strict && t.id && this.checkLVal(t.id, 65, void 0, 'function name', void 0, a)
							})),
							this.prodParam.exit(),
							this.expressionScope.exit(),
							(this.state.labels = i)
				...
				checkParams(t, e, s, r = !0) {
					...
					for (let s = 0; s < t.params.length; s++) this.checkLVal(t.params[s], 5, e ? null : i, 'function parameter list', void 0, r)
				}
				...
				parseExprListItem(t, e, s, r) {
					let i
					if (this.match(c.comma)) t || this.raise(this.state.pos, g.UnexpectedToken, ','), (i = null)
					else if (this.match(c.ellipsis)) {
						const t = this.state.start,
							r = this.state.startLoc
						i = this.parseParenItem(this.parseSpread(e, s), t, r)
					} else if (this.match(c.question)) {
						this.expectPlugin('partialApplication'), r || this.raise(this.state.start, g.UnexpectedArgumentPlaceholder)
						const t = this.startNode()
				...
				parseIdentifierName(t, e) {
					...
					if (i === c.name) s = this.state.value
						...
						if (!i.keyword) throw this.unexpected()
						{
							s = i.keyword
							const t = this.curContext()
							;(i !== c._class && i !== c._function) || (t !== T.functionStatement && t !== T.functionExpression) || this.state.context.pop()
						}
					}
					return e ? (this.state.type = c.name) : this.checkReservedWord(s, r, !!i.keyword, !1), this.next(), s
				}
				checkReservedWord(t, e, s, r) {
					if (this.prodParam.hasYield && 'yield' === t) return void this.raise(e, g.YieldBindingIdentifier)
					if ('await' === t) {
					...
					if (this.scope.inClass && !this.scope.inNonArrowFunction && 'arguments' === t) return void this.raise(e, g.ArgumentsInClass)
					if (s && W(t)) return void this.raise(e, g.UnexpectedKeyword, t)
					;(this.state.strict ? (r ? H : V) : q)(t, this.inModule) &&
						(this.prodParam.hasAwait || 'await' !== t
							? this.raise(e, g.UnexpectedReservedWord, t)
							: this.raise(e, this.hasPlugin('topLevelAwait') ? g.AwaitNotInAsyncContext : g.AwaitNotInAsyncFunction))
				}
				isAwaitAllowed() {
				...
				parseAwait() {
					...
					return (
						this.next(),
						this.expressionScope.recordParameterInitializerError(t.start, g.AwaitExpressionFormalParameter),
				...
				parseYield() {
					const t = this.startNode()
					return (
						this.expressionScope.recordParameterInitializerError(t.start, g.YieldInParameter),
						this.next(),
						this.match(c.semi) || (!this.match(c.star) && !this.state.type.startsExpr) || this.hasPrecedingLineBreak()
							? ((t.delegate = !1), (t.argument = null))
							: ((t.delegate = this.eat(c.star)), (t.argument = this.parseMaybeAssign())),
				...
				parseSmartPipelineBodyInStyle(t, e, s) {
					...
					return (
						i ? (r.callee = t) : (this.topicReferenceWasUsedInCurrentTopicContext() || this.raise(e, g.PipelineTopicUnused), (r.expression = t)),
				...
				parseTopLevel(t, e) {
					if (
						...
						for (let t = 0, e = Array.from(this.scope.undefinedExports); t < e.length; t++) {
							const [s] = e[t],
								r = this.scope.undefinedExports.get(s)
				...
				stmtToDirective(t) {
					...
					return (
						this.addExtra(s, 'raw', i), this.addExtra(s, 'rawValue', n), (r.value = this.finishNodeAt(s, 'DirectiveLiteral', e.end, e.loc.end)), this.finishNodeAt(r, 'Directive', t.end, t.loc.end)
					)
				}
				...
				parseStatementContent(t, e) {
					...
					switch ((this.isLet(t) && ((s = c._var), (i = 'let')), s)) {
						...
						case c._function:
							...
							return (
								t && (this.state.strict ? this.raise(this.state.start, g.StrictFunction) : 'if' !== t && 'label' !== t && this.raise(this.state.start, g.SloppyFunction)),
						...
						case c._const:
						case c._var:
							return (i = i || this.state.value), t && 'var' !== i && this.raise(this.state.start, g.UnexpectedLexicalDeclaration), this.parseVarStatement(r, i)
						case c._while:
						...
						case c._export: {
							let t
							return (
								this.options.allowImportExportEverywhere || e || this.raise(this.state.start, g.UnexpectedImportExport),
								this.next(),
								s === c._import
									? ((t = this.parseImport(r)), 'ImportDeclaration' !== t.type || (t.importKind && 'value' !== t.importKind) || (this.sawUnambiguousESM = !0))
									: ((t = this.parseExport(r)),
									  (('ExportNamedDeclaration' !== t.type || (t.exportKind && 'value' !== t.exportKind)) &&
											('ExportAllDeclaration' !== t.type || (t.exportKind && 'value' !== t.exportKind)) &&
						...
						default:
							if (this.isAsyncFunction()) return t && this.raise(this.state.start, g.AsyncFunctionInSingleStatementContext), this.next(), this.parseFunctionStatement(r, !0, !t)
					}
					const n = this.state.value,
						a = this.parseExpression()
					return s === c.name && 'Identifier' === a.type && this.eat(c.colon) ? this.parseLabeledStatement(r, n, a, t) : this.parseExpressionStatement(r, a)
				}
				assertModuleNodeAllowed(t) {
					this.options.allowImportExportEverywhere || this.inModule || this.raiseWithData(t.start, { code: 'BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED' }, g.ImportOutsideModule)
				}
				takeDecorators(t) {
				...
				parseDecorators(t) {
					...
					if (this.match(c._export))
						t || this.unexpected(), this.hasPlugin('decorators') && !this.getPluginOption('decorators', 'decoratorsBeforeExport') && this.raise(this.state.start, g.DecoratorExportClass)
				...
				parseDecorator() {
					...
					if ((this.next(), this.hasPlugin('decorators'))) {
						...
						const e = this.state.start,
							s = this.state.startLoc
						let r
						if (this.eat(c.parenL)) (r = this.parseExpression()), this.expect(c.parenR)
						else
							for (r = this.parseIdentifier(!1); this.eat(c.dot); ) {
								const t = this.startNodeAt(e, s)
								;(t.object = r), (t.property = this.parseIdentifier(!0)), (t.computed = !1), (r = this.finishNode(t, 'MemberExpression'))
							}
				...
				verifyBreakContinue(t, e) {
					...
					r === this.state.labels.length && this.raise(t.start, g.IllegalBreakContinue, e)
				}
				...
				parseForStatement(t) {
					...
					let e = -1
					if ((this.isAwaitAllowed() && this.eatContextual('await') && (e = this.state.lastTokStart), this.scope.enter(0), this.expect(c.parenL), this.match(c.semi)))
						return e > -1 && this.unexpected(e), this.parseFor(t, null)
					const s = this.isLet()
					if (this.match(c._var) || this.match(c._const) || s) {
						const r = this.startNode(),
							i = s ? 'let' : this.state.value
						return (
							this.next(),
							this.parseVar(r, !0, i),
							this.finishNode(r, 'VariableDeclaration'),
							(this.match(c._in) || this.isContextual('of')) && 1 === r.declarations.length ? this.parseForIn(t, r, e) : (e > -1 && this.unexpected(e), this.parseFor(t, r))
						)
					}
					const r = new wt(),
					...
					if (this.match(c._in) || this.isContextual('of')) {
						...
						return this.checkLVal(i, void 0, void 0, s), this.parseForIn(t, i, e)
					}
					return this.checkExpressionErrors(r, !0), e > -1 && this.unexpected(e), this.parseFor(t, i)
				}
				...
				parseIfStatement(t) {
					return (
						...
						(t.alternate = this.eat(c._else) ? this.parseStatement('if') : null),
						this.finishNode(t, 'IfStatement')
					)
				}
				parseReturnStatement(t) {
					return (
						this.prodParam.hasReturn || this.options.allowReturnOutsideFunction || this.raise(this.state.start, g.IllegalReturn),
						this.next(),
				...
				parseSwitchStatement(t) {
					...
					const e = (t.cases = [])
					let s, r
					for (this.expect(c.braceL), this.state.labels.push(Ot), this.scope.enter(0); !this.match(c.braceR); )
						if (this.match(c._case) || this.match(c._default)) {
							...
							s && this.finishNode(s, 'SwitchCase'),
								...
								(s.consequent = []),
								this.next(),
								t ? (s.test = this.parseExpression()) : (r && this.raise(this.state.lastTokStart, g.MultipleDefaultsInSwitch), (r = !0), (s.test = null)),
								this.expect(c.colon)
				...
				parseThrowStatement(t) {
					return (
						this.next(),
						this.hasPrecedingLineBreak() && this.raise(this.state.lastTokEnd, g.NewlineAfterThrow),
				...
				parseCatchClauseParam() {
					const t = this.parseBindingAtom(),
						e = 'Identifier' === t.type
					return this.scope.enter(e ? 8 : 0), this.checkLVal(t, 9, null, 'catch clause'), t
				}
				parseTryStatement(t) {
					if ((this.next(), (t.block = this.parseBlock()), (t.handler = null), this.match(c._catch))) {
						const e = this.startNode()
						this.next(),
							this.match(c.parenL) ? (this.expect(c.parenL), (e.param = this.parseCatchClauseParam()), this.expect(c.parenR)) : ((e.param = null), this.scope.enter(0)),
				...
				parseWithStatement(t) {
					return (
						this.state.strict && this.raise(this.state.start, g.StrictWith),
						this.next(),
				...
				parseLabeledStatement(t, e, s, r) {
					...
					const i = this.state.type.isLoop ? 'loop' : this.match(c._switch) ? 'switch' : null
					...
					return (
						...
						(t.body = this.parseStatement(r ? (-1 === r.indexOf('label') ? r + 'label' : r) : 'label')),
						this.state.labels.pop(),
						(t.label = s),
				...
				parseBlock(t = !1, e = !0, s) {
					const r = this.startNode()
					return this.expect(c.braceL), e && this.scope.enter(0), this.parseBlockBody(r, t, !1, c.braceR, s), e && this.scope.exit(), this.finishNode(r, 'BlockStatement')
				}
				isValidDirective(t) {
				...
				parseBlockOrModuleBlockBody(t, e, s, r, i) {
					...
					let o = !1,
						u = !1
					for (; !this.match(r); ) {
						!u && this.state.octalPositions.length && n.push(...this.state.octalPositions)
				...
				parseForIn(t, e, s) {
					...
					return (
						...
						'VariableDeclaration' !== e.type || null == e.declarations[0].init || (r && !this.state.strict && 'var' === e.kind && 'Identifier' === e.declarations[0].id.type)
							? 'AssignmentPattern' === e.type && this.raise(e.start, g.InvalidLhs, 'for-loop')
							: this.raise(e.start, g.ForInOfLoopInitializer, r ? 'for-in' : 'for-of'),
						(t.left = e),
				...
				parseVar(t, e, s) {
					...
					for (t.kind = s; ; ) {
						...
						if (
							(this.parseVarId(t, s),
							this.eat(c.eq)
								? (t.init = e ? this.parseMaybeAssignDisallowIn() : this.parseMaybeAssignAllowIn())
								: ('const' !== s || this.match(c._in) || this.isContextual('of')
										? 'Identifier' === t.id.type ||
										  (e && (this.match(c._in) || this.isContextual('of'))) ||
										  this.raise(this.state.lastTokEnd, g.DeclarationMissingInitializer, 'Complex binding patterns')
										: i || this.raise(this.state.lastTokEnd, g.DeclarationMissingInitializer, 'Const declarations'),
								  (t.init = null)),
				...
				parseFunction(t, e = 0, s = !1) {
					const r = 1 & e,
						i = 2 & e,
						n = !(!r || 4 & e)
					this.initFunction(t, s), this.match(c.star) && i && this.raise(this.state.start, g.GeneratorInSingleStatementContext), (t.generator = this.eat(c.star)), r && (t.id = this.parseFunctionId(n))
				...
				parseFunctionParams(t, e) {
					this.expect(c.parenL), this.expressionScope.enter(new Nt(3)), (t.params = this.parseBindingList(c.parenR, 41, !1, e)), this.expressionScope.exit()
				}
				registerFunctionStatementId(t) {
				...
				parseClassBody(t, e) {
					...
					const s = { constructorAllowsSuper: t, hadConstructor: !1, hadStaticBlock: !1 }
					let r = []
					const i = this.startNode()
					if (
						((i.body = []),
						...
						this.withTopicForbiddingContext(() => {
							for (; !this.match(c.braceR); ) {
								if (this.eat(c.semi)) {
									if (r.length > 0) throw this.raise(this.state.lastTokEnd, g.DecoratorSemicolon)
									continue
								}
								if (this.match(c.at)) {
								...
								const t = this.startNode()
								r.length && ((t.decorators = r), this.resetStartLocationFromNode(t, r[0]), (r = [])),
									this.parseClassMember(i, t, s),
									'constructor' === t.kind && t.decorators && t.decorators.length > 0 && this.raise(t.start, g.DecoratorConstructor)
							}
						}),
						(this.state.strict = e),
						this.next(),
				...
				parseClassMemberWithIsStatic(t, e, s, r) {
					...
					if (((e.static = r), this.eat(c.star)))
						return (
							...
							'PrivateName' === u.key.type
								...
								: (this.isNonstaticConstructor(i) && this.raise(i.key.start, g.ConstructorIsGenerator), void this.pushClassMethod(t, i, !0, !1, !1, !1))
						)
					...
					if ((this.parsePostMemberNameModifiers(h), this.isClassMethod())) {
						if (((u.kind = 'method'), d)) return void this.pushClassPrivateMethod(t, n, !1, !1)
						const e = this.isNonstaticConstructor(i)
						let r = !1
						e && ((i.kind = 'constructor'), s.hadConstructor && !this.hasPlugin('typescript') && this.raise(l.start, g.DuplicateConstructor), (s.hadConstructor = !0), (r = s.constructorAllowsSuper)),
							this.pushClassMethod(t, i, !1, !1, e, r)
					} else if (this.isClassProperty()) d ? this.pushClassPrivateProperty(t, o) : this.pushClassProperty(t, a)
					else if (!D || 'async' !== l.name || p || this.isLineTerminator())
						!D || ('get' !== l.name && 'set' !== l.name) || p || (this.match(c.star) && this.isLineTerminator())
							...
							: ((u.kind = l.name),
							  ...
							  'PrivateName' === u.key.type
									...
									: (this.isNonstaticConstructor(i) && this.raise(i.key.start, g.ConstructorIsAccessor), this.pushClassMethod(t, i, !1, !1, !1, !1)),
						...
						h.optional && this.unexpected(m),
							...
							'PrivateName' === u.key.type
								...
								: (this.isNonstaticConstructor(i) && this.raise(i.key.start, g.ConstructorIsAsync), this.pushClassMethod(t, i, e, !0, !1, !1))
					}
				}
				parseClassElementName(t) {
					const e = this.parsePropertyName(t, !0)
					return (
						t.computed || !t.static || ('prototype' !== e.name && 'prototype' !== e.value) || this.raise(e.start, g.StaticPrototype),
						'PrivateName' === e.type && 'constructor' === e.id.name && this.raise(e.start, g.ConstructorClassPrivateField),
						e
					)
				}
				parseClassStaticBlock(t, e, s) {
					var r
					this.expectPlugin('classStaticBlock', e.start), this.scope.enter(80), this.expressionScope.enter(kt())
					...
					this.parseBlockOrModuleBlockBody(n, void 0, !1, c.braceR),
						...
						(null == (r = e.decorators) ? void 0 : r.length) && this.raise(e.start, g.DecoratorStaticBlock),
						(s.hadStaticBlock = !0)
				}
				...
				pushClassPrivateMethod(t, e, s, r) {
					...
					t.body.push(i)
					const n = 'get' === i.kind ? (i.static ? 6 : 2) : 'set' === i.kind ? (i.static ? 5 : 1) : 0
				...
				parseClassId(t, e, s, r = 139) {
					this.match(c.name) ? ((t.id = this.parseIdentifier()), e && this.checkLVal(t.id, r, void 0, 'class name')) : s || !e ? (t.id = null) : this.unexpected(null, g.MissingClassName)
				}
				parseClassSuper(t) {
				...
				parseExport(t) {
					const e = this.maybeParseExportDefaultSpecifier(t),
						...
						a = e || r
					if (r && !i) return e && this.unexpected(), this.parseExportFrom(t, !0), this.finishNode(t, 'ExportAllDeclaration')
					const o = this.maybeParseExportNamedSpecifiers(t)
					if ((e && s && !r && !o) || (i && n && !o)) throw this.unexpected(null, c.braceL)
					let u
					if ((a || o ? ((u = !1), this.parseExportFrom(t, a)) : (u = this.maybeParseExportDeclaration(t)), a || o || u))
				...
				isAsyncFunction() {
					...
					const t = this.nextTokenStart()
					return !m.test(this.input.slice(this.state.pos, t)) && this.isUnparsedContextual(t, 'function')
				}
				parseExportDefaultExpression() {
					const t = this.startNode(),
					...
					if (this.match(c.at))
						return (
							this.hasPlugin('decorators') && this.getPluginOption('decorators', 'decoratorsBeforeExport') && this.raise(this.state.start, g.DecoratorBeforeExport),
					...
					if (e)
						if (s) {
							if ((this.checkDuplicateExports(t, 'default'), this.hasPlugin('exportDefaultFrom'))) {
								...
								'Identifier' !== e.type || 'from' !== e.name || e.end - e.start != 4 || (null == (i = e.extra) ? void 0 : i.parenthesized) || this.raise(e.start, g.ExportDefaultFromAsIdentifier)
							}
							...
							for (let e = 0, s = t.specifiers; e < s.length; e++) {
								...
								if ((this.checkDuplicateExports(t, n), !r && t.local)) {
									const { local: e } = t
									'StringLiteral' === e.type ? this.raise(t.start, g.ExportBindingIsString, e.extra.raw, n) : (this.checkReservedWord(e.name, e.start, !0, !1), this.scope.checkLocalExport(e))
								}
							}
				...
				parseAssertEntries() {
					...
					do {
						...
						const s = this.startNode(),
							r = this.state.value
						if (
							(this.match(c.string) ? (s.key = this.parseLiteral(r, 'StringLiteral')) : (s.key = this.parseIdentifier(!0)),
							this.expect(c.colon),
							'type' !== r && this.raise(s.key.start, g.ModuleAttributeDifferentFromType, r),
							e.has(r) && this.raise(s.key.start, g.ModuleAttributesWithDuplicateKeys, r),
							e.add(r),
							!this.match(c.string))
						)
							throw this.unexpected(this.state.start, g.ModuleAttributeInvalidValue)
				...
				maybeParseModuleAttributes() {
					...
					do {
						...
						if (
							...
							'type' !== s.key.name && this.raise(s.key.start, g.ModuleAttributeDifferentFromType, s.key.name),
							e.has(s.key.name) && this.raise(s.key.start, g.ModuleAttributesWithDuplicateKeys, s.key.name),
							e.add(s.key.name),
							this.expect(c.colon),
							!this.match(c.string))
						)
				...
				parseImportSpecifier(t) {
					...
					this.checkLVal(e.local, 9, void 0, 'import specifier'), t.specifiers.push(this.finishNode(e, 'ImportSpecifier'))
				}
			} {
				constructor(t, e) {
					super(
			...
			function Ut(t, e) {
				...
				return (
					(null == t ? void 0 : t.plugins) &&
						(!(function (t) {
							if (Dt(t, 'decorators')) {
								if (Dt(t, 'decorators-legacy')) throw new Error('Cannot use the decorators and decorators-legacy plugin together')
							...
							if (Dt(t, 'flow') && Dt(t, 'typescript')) throw new Error('Cannot combine flow and typescript plugins.')
							if (Dt(t, 'placeholders') && Dt(t, 'v8intrinsic')) throw new Error('Cannot combine placeholders and v8intrinsic plugins.')
							if (Dt(t, 'pipelineOperator') && !ft.includes(mt(t, 'pipelineOperator', 'proposal')))
								throw new Error("'pipelineOperator' requires 'proposal' option whose value should be one of: " + ft.map(t => "'".concat(t, "'")).join(', '))
							if (Dt(t, 'moduleAttributes')) {
								if (Dt(t, 'importAssertions')) throw new Error('Cannot combine importAssertions and moduleAttributes plugins.')
								if ('may-2020' !== mt(t, 'moduleAttributes', 'version'))
									throw new Error("The 'moduleAttributes' plugin requires a 'version' option, representing the last proposal update. Currently, the only supported value is 'may-2020'.")
							}
							if (Dt(t, 'recordAndTuple') && !yt.includes(mt(t, 'recordAndTuple', 'syntaxType')))
								throw new Error("'recordAndTuple' requires 'syntaxType' option whose value should be one of: " + yt.map(t => "'".concat(t, "'")).join(', '))
						})(t.plugins),
						(s = (function (t) {
							const e = At.filter(e => Dt(t, e)),
								s = e.join('/')
							let r = qt[s]
							if (!r) {
								r = jt
			...
			;(e.parse = function (t, e) {
				var s
				if ('unambiguous' !== (null == (s = e) ? void 0 : s.sourceType)) return Ut(e, t).parse()
				e = Object.assign({}, e)
				try {
					e.sourceType = 'module'
					const s = Ut(e, t),
	...
	const { getNextNonSpaceNonCommentCharacterIndexWithStartIndex: zs, getShebang: Hs } = Mt,
		{ hasPragma: Ws } = $t,
		{ locStart: Xs, locEnd: Gs } = te
	const Ks = /@(?:no)?flow\b/
	function Js(e, ...s) {
		return (r, i, n = {}) => {
			if (
				...
				(function (t, e) {
					...
					const r = zs(t, 0)
					return !1 !== r && (t = t.slice(0, r)), Ks.test(t)
				})(r, n)
			)
				return (n.parser = 'babel-flow'), Ys(r, i, n)
			const a = Vs,
				o = 'script' === n.__babelSourceType ? 'script' : 'module'
			let u
			try {
				u = (function (t, e) {
					let s
				...
				throw t(s.replace(/ \(.*\)/, ''), { start: { line: r ? r.line : 0, column: r ? r.column + 1 : 0 } })
			}
			return qs(u, Object.assign({}, n, { originalText: r }))
		}
	}
	const $s = Js('parse', ['jsx', 'flow']),
		Ys = Js('parse', ['jsx', ['flow', { all: !0, enums: !0 }]]),
		Qs = Js('parse', ['jsx', 'typescript'], ['typescript']),
		Zs = Js('parseExpression', ['jsx'])
	const tr = new Set([
	...
	function sr(e, s) {
		...
		function i(s) {
			const r = s ? ''.concat(e.type, ' with ').concat(s, '=').concat(JSON.stringify(e[s])) : e.type
			return t(''.concat(r, ' is not allowed in JSON.'), { start: { line: e.loc.start.line, column: e.loc.start.column + 1 } })
		}
	}
	const rr = { parse: $s, astFormat: 'estree', hasPragma: Ws, locStart: Xs, locEnd: Gs },
		ir = Object.assign({}, rr, { parse: Ys }),
		nr = Object.assign({}, rr, { parse: Qs }),
		ar = Object.assign({}, rr, { parse: Zs })
	return {
		parsers: {
			babel: rr,
			'babel-flow': ir,
			'babel-ts': nr,
			json: Object.assign({}, ar, { hasPragma: () => !0 }),
			json5: ar,
			'json-stringify': {
				parse: function (t, e, s) {
					const r = Zs(t, e, s)
					return r.comments.forEach(sr), sr(r), r
				},
