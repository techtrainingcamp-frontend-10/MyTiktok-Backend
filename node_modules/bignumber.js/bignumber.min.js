/* bignumber.js v9.0.0 https://github.com/MikeMcl/bignumber.js/LICENCE */ !(function (e) {
	...
	;((r = (function e(r) {
		...
		function D(e, r, n, t) {
			...
			if (a) {
				e: {
					...
					if ((o = r - i) < 0) (o += M), (s = r), (c = ((u = a[(l = 0)]) / h[i - s - 1]) % 10 | 0)
					...
					if (
						...
						(t =
							n < 4
								? (c || t) && (0 == n || n == (e.s < 0 ? 3 : 2))
								: 5 < c || (5 == c && (4 == n || t || (6 == n && (0 < o ? (0 < s ? u / h[i - s] : 0) : a[l - 1]) % 10 & 1) || n == (e.s < 0 ? 8 : 7)))),
						r < 1 || !a[0])
					)
		...
		return (
			...
			(B.config = B.set = function (e) {
				...
				if (null != e) {
					...
					if (
						(e.hasOwnProperty((r = 'DECIMAL_PLACES')) && (H((n = e[r]), 0, q, r), (N = n)),
						e.hasOwnProperty((r = 'ROUNDING_MODE')) && (H((n = e[r]), 0, 8, r), (O = n)),
						e.hasOwnProperty((r = 'EXPONENTIAL_AT')) && ((n = e[r]) && n.pop ? (H(n[0], -q, 0, r), H(n[1], 0, q, r), (p = n[0]), (d = n[1])) : (H(n, -q, q, r), (p = -(d = n < 0 ? -n : n)))),
					...
					if (
						(e.hasOwnProperty((r = 'MODULO_MODE')) && (H((n = e[r]), 0, 9, r), (o = n)), e.hasOwnProperty((r = 'POW_PRECISION')) && (H((n = e[r]), 0, q, r), (E = n)), e.hasOwnProperty((r = 'FORMAT')))
					) {
			...
			(a = (function () {
				...
				return function (e, r, n, t, i) {
					var o,
						...
						w = O
					for (
						0 <= g && ((u = E), (E = 0), (e = e.replace('.', '')), (c = (h = new B(r)).pow(e.length - g)), (E = u), (h.c = m(X($(c.c), c.e, '0'), 10, n, d)), (h.e = h.c.length)),
					...
					if (
						(g < 0 ? --f : ((c.c = a), (c.e = f), (c.s = t), (a = (c = v(c, h, p, w, n)).c), (l = c.r), (f = c.e)),
						(g = a[(s = f + p + 1)]),
						(u = n / 2),
						(l = l || s < 0 || null != a[s + 1]),
			...
			(v = (function () {
				...
				return function (e, r, n, t, i) {
					...
					if ((A[f] > (E[f] || 0) && s--, b < 0)) g.push(1), (u = !0)
						...
						for (
							v = E.length, O = A.length, b += 2, 1 < (l = U(i / (A[(f = 0)] + 1))) && ((A = S(A, l, i)), (E = S(E, l, i)), (O = A.length), (v = E.length)), m = O, w = (p = E.slice(0, O)).length;
							w < O;
							p[w++] = 0
						);
			...
			(t.modulo = t.mod = function (e, r) {
				...
				return (
					...
					!i.c || !e.s || (e.c && !e.c[0])
						...
						: !e.c || (i.c && !i.c[0])
						? new B(i)
						: (9 == o ? ((t = e.s), (e.s = 1), (n = v(i, e, 0, 3)), (e.s = t), (n.s *= t)) : (n = v(i, e, 0, o)), (e = i.minus(n.times(e))).c[0] || 1 != o || (e.s = i.s), e)
				)
			}),
					...
					(n =
						0 == (f = Math.sqrt(+P(o))) || f == 1 / 0
							? (((r = $(s)).length + u) % 2 == 0 && (r += '0'),
							  (f = Math.sqrt(+r)),
							  (u = j((u + 1) / 2) - (u < 0 || u % 2)),
							  new B((r = f == 1 / 0 ? '1e' + u : (r = f.toExponential()).slice(0, r.indexOf('e') + 1) + u)))
							: new B(f + '')).c[0]
				)
					for ((f = (u = n.e) + l) < 3 && (f = 0); ; )
					...
					null === i
						...
						: ((r =
								null == e
									...
									: (H(e, 2, S.length, 'Base'), a(X($(n.c), i, '0'), 10, e, t, !0))),
						  t < 0 && n.c[0] && (r = '-' + r)),
					r
				)
			}),
		...
		'function' == typeof define && define.amd
			...
			? (module.exports = r)
			: (e || (e = 'undefined' != typeof self && self ? self : window), (e.BigNumber = r))
})(this)
