...
- Allow any key in BigNumber.Instance in _bignumber.d.ts_.
...
- Add `_isBigNumber` to prototype in _bignumber.mjs_.
...
- 01/11/2018
- Rest parameter must be array type in _bignumber.d.ts_.
...
- #170 Make `isBigNumber` a type guard in _bignumber.d.ts_.
- [BREAKING CHANGE] `BigNumber.min` and `BigNumber.max`: don't accept an array.
- Update _.travis.yml_.
- Remove _bower.json_.
