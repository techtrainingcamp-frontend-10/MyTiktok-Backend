...
const { ConfigArray, ConfigDependency, IgnorePattern, OverrideTester } = require('./config-array')
...
class ConfigArrayFactory {
	 ...
	 */
	constructor({ additionalPluginPool = new Map(), cwd = process.cwd(), resolvePluginsRelativeTo, builtInRules, resolver = ModuleResolver, eslintAllPath, eslintRecommendedPath } = {}) {
