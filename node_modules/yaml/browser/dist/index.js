  ...
  _createClass(Anchors, [
    ...
    },
    {
      ...
      value: function setAnchor(node, name) {
        ...
        var prev =
          node &&
          Object.keys(map).find(function (a) {
            return map[a] === node
          })
...
function resolveYamlDirective(doc, directive) {
  ...
  if (!documentOptions[version]) {
    ...
    var _msg2 = 'Document will be parsed as YAML '
      .concat(v0, ' rather than YAML ')
      .concat(version)
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      ...
      switch (name) {
        ...
        default:
          if (name) {
            var _msg3 = 'YAML only supports %TAG and %YAML directives, and not %'.concat(
              name
            )
    ...
    },
    {
      ...
      value: function toString() {
        ...
        if (this.contents) {
          ...
          var onChompKeep = contentComment
            ? null
            : function () {
...
function createNode(value) {
  ...
  var options = Object.assign(
    {},
    Document.defaults[defaultOptions.version],
    defaultOptions
  )
