  ...
  _createClass(CollectionItem, [
    ...
    },
    {
      ...
      value: function setOrigRanges(cr, offset) {
        offset = _get(
          _getPrototypeOf(CollectionItem.prototype),
          'setOrigRanges',
          this
        ).call(this, cr, offset)
...
var Collection = /*#__PURE__*/ (function (_Node) {
  ...
  _createClass(Collection, [
    ...
    },
    {
      ...
      value: function setOrigRanges(cr, offset) {
        offset = _get(
          _getPrototypeOf(Collection.prototype),
          'setOrigRanges',
          this
        ).call(this, cr, offset)
...
var Document = /*#__PURE__*/ (function (_Node) {
  ...
  _createClass(Document, [
    ...
    },
    {
      ...
      value: function setOrigRanges(cr, offset) {
        offset = _get(
          _getPrototypeOf(Document.prototype),
          'setOrigRanges',
          this
        ).call(this, cr, offset)
...
var BlockValue = /*#__PURE__*/ (function (_Node) {
  ...
  _createClass(BlockValue, [
        ...
        for (var ch = src[offset]; ch === '\n'; ch = src[offset]) {
          ...
          if (!this.blockIndent) {
            ...
            if (!this.error) {
              ...
              var _msg = 'Block scalars must not be less indented than their '.concat(
                _src
              )
    ...
    },
    {
      ...
      value: function setOrigRanges(cr, offset) {
        offset = _get(
          _getPrototypeOf(BlockValue.prototype),
          'setOrigRanges',
          this
        ).call(this, cr, offset)
...
var FlowCollection = /*#__PURE__*/ (function (_Node) {
  ...
  _createClass(FlowCollection, [
    ...
    },
    {
      ...
      value: function setOrigRanges(cr, offset) {
        offset = _get(
          _getPrototypeOf(FlowCollection.prototype),
          'setOrigRanges',
          this
        ).call(this, cr, offset)
        this.items.forEach(function (node) {
      ...
      },
      {
        ...
        get: function get() {
          ...
          var _this$context = this.context,
            ...
            src = _this$context.src
          if (src[end - 1] !== '"')
            errors.push(new YAMLSyntaxError(this, 'Missing closing "quote')) // Using String#replace is too painful with escaped newlines preceded by
