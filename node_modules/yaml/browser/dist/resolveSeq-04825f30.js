  ...
  _createClass(Collection, [
    ...
    },
    {
      ...
      value: function toString(ctx, _ref9, onComment, onChompKeep) {
        ...
        var inFlow =
          this.type === Type.FLOW_MAP ||
          this.type === Type.FLOW_SEQ ||
          ctx.inFlow
        ...
        if (nodes.length === 0) {
          ...
          if (
            hasItemWithNewLine ||
            strings.reduce(function (sum, str) {
  ...
  _createClass(YAMLSeq, [
    ...
    },
    {
      ...
      value: function toString(ctx, onComment, onChompKeep) {
        ...
        return _get(_getPrototypeOf(YAMLSeq.prototype), 'toString', this).call(
          this,
          ctx,
          {
  ...
  _createClass(YAMLMap, [
    ...
    },
    {
      ...
      value: function toString(ctx, onComment, onChompKeep) {
        ...
        return _get(_getPrototypeOf(YAMLMap.prototype), 'toString', this).call(
          this,
          ctx,
          {
            blockItem: function blockItem(n) {
    ...
    },
    {
      ...
      value: function toString(ctx, onComment) {
        ...
        if (seq.items.length > 1)
          return _get(_getPrototypeOf(Merge.prototype), 'toString', this).call(
            this,
            ctx,
            onComment
          )
        ...
        var str = _get(_getPrototypeOf(Merge.prototype), 'toString', this).call(
          this,
          ctx,
          onComment
        )
...
function foldFlowLines(text, indent, mode, _ref) {
  var indentAtStart = _ref.indentAtStart,
    ...
    minContentWidth =
      _ref$minContentWidth === void 0 ? 20 : _ref$minContentWidth,
    onFold = _ref.onFold,
...
function resolveTag(doc, node, tagName) {
  ...
  try {
    ...
    var msg = 'The tag '
      .concat(tagName, ' is unavailable, falling back to ')
      .concat(fallback)
