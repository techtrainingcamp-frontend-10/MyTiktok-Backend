...
test('stringify()', function (t) {
	...
	t.test('stringifies symbols', { skip: !hasSymbols() }, function (st) {
		...
		st.equal(qs.stringify({ a: [Symbol.iterator] }, { encodeValuesOnly: true, arrayFormat: 'brackets' }), 'a[]=Symbol%28Symbol.iterator%29')
		st.end()
	})
	...
	t.test('stringifies bigints', { skip: !hasBigInt }, function (st) {
		...
		st.equal(qs.stringify({ a: [three] }, { encodeValuesOnly: true, arrayFormat: 'brackets' }), 'a[]=3')
		st.equal(qs.stringify({ a: [three] }, { encodeValuesOnly: true, encoder: encodeWithN, arrayFormat: 'brackets' }), 'a[]=3n')
		st.end()
	})
	...
	t.test('stringifies an array value', function (st) {
		...
		st.equal(qs.stringify({ a: ['b', 'c', 'd'] }, { arrayFormat: 'comma' }), 'a=b%2Cc%2Cd', 'comma => comma')
	...
	t.test('stringifies a nested array value with dots notation', function (st) {
		...
		st.equal(qs.stringify({ a: { b: ['c', 'd'] } }, { allowDots: true, encode: false, arrayFormat: 'comma' }), 'a.b=c,d', 'comma: stringifies with dots + comma')
	...
	t.test('can sort the keys at depth 3 or more too', function (st) {
		...
		st.equal(
			qs.stringify({ a: 'a', z: { zj: { zjb: 'zjb', zja: 'zja' }, zi: { zib: 'zib', zia: 'zia' } }, b: 'b' }, { sort: sort, encode: false }),
			'a=a&b=b&z[zi][zia]=zia&z[zi][zib]=zib&z[zj][zja]=zja&z[zj][zjb]=zjb'
		)
		st.equal(
			qs.stringify({ a: 'a', z: { zj: { zjb: 'zjb', zja: 'zja' }, zi: { zib: 'zib', zia: 'zia' } }, b: 'b' }, { sort: null, encode: false }),
