...
test('parse()', function (t) {
	...
	t.test('add keys to objects', function (st) {
		...
		st.deepEqual(qs.parse('a[b]=c&a=toString', { plainObjects: true }), { __proto__: null, a: { __proto__: null, b: 'c', toString: true } }, 'can overwrite prototype with plainObjects true')
