...
class DelayWhenSubscriber<T, R> extends OuterSubscriber<T, R> {
	...
	constructor(destination: Subscriber<T>, private delayDurationSelector: (value: T, index: number) => Observable<any>) {
		super(destination)
	}

	notifyNext(outerValue: T, _innerValue: any, _outerIndex: number, _innerIndex: number, innerSub: InnerSubscriber<T, R>): void {
