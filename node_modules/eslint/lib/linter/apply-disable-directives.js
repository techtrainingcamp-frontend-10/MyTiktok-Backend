...
module.exports = ({ directives, problems, reportUnusedDisableDirectives = 'off' }) => {
	...
	return reportUnusedDisableDirectives !== 'off'
		? lineDirectivesResult.problems.concat(blockDirectivesResult.unusedDisableDirectives).concat(lineDirectivesResult.unusedDisableDirectives).sort(compareLocations)
