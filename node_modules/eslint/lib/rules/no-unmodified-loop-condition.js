	...
	for (let i = 0; i < conditions.length; ++i) {
		...
		for (let j = 0; !condition.modified && j < modifiers.length; ++j) {
			...
			const inLoop =
				...
				Boolean((funcNode = getEncloseFunctionDeclaration(modifier)) && (funcVar = astUtils.getVariableByName(modifier.from.upper, funcNode.id.name)) && funcVar.references.some(condition.isInLoop))
