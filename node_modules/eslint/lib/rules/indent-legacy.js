	...
	create(context) {
		...
		if (context.options.length) {
			if (context.options[0] === 'tab') {
				indentSize = 1
				indentType = 'tab'
			} /* istanbul ignore else : this will be caught by options validation */ else if (typeof context.options[0] === 'number') {
		...
		function isOuterIIFE(node) {
			 ...
			 */
			while (
				(stmt.type === 'UnaryExpression' && (stmt.operator === '!' || stmt.operator === '~' || stmt.operator === '+' || stmt.operator === '-')) ||
