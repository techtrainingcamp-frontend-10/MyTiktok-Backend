		...
		function validateBraceSpacing(node, first, second, penultimate, last) {
			...
			if (astUtils.isTokenOnSameLine(penultimate, last)) {
				const shouldCheckPenultimate =
					(options.arraysInObjectsException && astUtils.isClosingBracketToken(penultimate)) || (options.objectsInObjectsException && astUtils.isClosingBraceToken(penultimate))
