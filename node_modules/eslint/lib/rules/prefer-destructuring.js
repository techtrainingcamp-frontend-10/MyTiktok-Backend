...
module.exports = {
	...
	create(context) {
		...
		if (enabledTypes) {
			normalizedOptions =
				typeof enabledTypes.array !== 'undefined' || typeof enabledTypes.object !== 'undefined' ? { VariableDeclarator: enabledTypes, AssignmentExpression: enabledTypes } : enabledTypes
		}
