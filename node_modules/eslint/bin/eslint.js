...
function getErrorMessage(error) {
	...
	if (typeof error.messageTemplate === 'string') {
		try {
			const templateFilePath = path.resolve(__dirname, `../messages/${error.messageTemplate}.txt`)
...
;(async function main() {
	...
	process.exitCode = await require('../lib/cli').execute(process.argv, process.argv.includes('--stdin') ? await readStdin() : null)
})().catch(onFatalError)
