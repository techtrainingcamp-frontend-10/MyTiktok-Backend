	...
	options = options.reduce((o, option) => {
		...
		return [
			...
			Object.assign(option, {
				...
				stdout:
					this instanceof task_wrapper_1.TaskWrapper ? ((_a = settings === null || settings === void 0 ? void 0 : settings.stdout) !== null && _a !== void 0 ? _a : this.stdout()) : process.stdout,
...
function defaultCancelCallback(settings) {
	...
	} /* istanbul ignore next */ else if ((settings === null || settings === void 0 ? void 0 : settings.error) !== false) {
