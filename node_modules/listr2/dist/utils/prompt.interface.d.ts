...
export declare type PromptOptions<T extends boolean = false> =
	| Unionize<
			{
...
export declare type PromptTypes =
	| 'AutoComplete'
	| 'BasicAuth'
	| 'Confirm'
	| 'Editable'
	...
	| 'Text'
	| 'Toggle'
export declare type PromptOptionsType<T> = T extends 'AutoComplete'
	? ArrayPromptOptions
	: T extends 'BasicAuth'
	? StringPromptOptions
	: T extends 'Confirm'
