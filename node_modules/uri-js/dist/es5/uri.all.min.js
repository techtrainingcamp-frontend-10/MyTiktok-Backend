...
!(function (e, r) {
	...
	function l(e, r) {
		...
		return (
			e.scheme && (e.scheme = String(e.scheme).replace(r.PCT_ENCODED, n).toLowerCase().replace(r.NOT_SCHEME, '')),
			e.userinfo !== undefined && (e.userinfo = String(e.userinfo).replace(r.PCT_ENCODED, n).replace(r.NOT_USERINFO, h).replace(r.PCT_ENCODED, o)),
			e.host !== undefined && (e.host = String(e.host).replace(r.PCT_ENCODED, n).toLowerCase().replace(r.NOT_HOST, h).replace(r.PCT_ENCODED, o)),
			e.path !== undefined &&
				(e.path = String(e.path)
					.replace(r.PCT_ENCODED, n)
					.replace(e.scheme ? r.NOT_PATH : r.NOT_PATH_NOSCHEME, h)
					.replace(r.PCT_ENCODED, o)),
			e.query !== undefined && (e.query = String(e.query).replace(r.PCT_ENCODED, n).replace(r.NOT_QUERY, h).replace(r.PCT_ENCODED, o)),
			e.fragment !== undefined && (e.fragment = String(e.fragment).replace(r.PCT_ENCODED, n).replace(r.NOT_FRAGMENT, h).replace(r.PCT_ENCODED, o)),
			e
		)
	}
	function m(e) {
	...
	function v(e, r) {
		...
		if (o) {
			...
			var C = v.reduce(function (e, r, n) {
					if (!r || '0' === r) {
						var t = e[e.length - 1]
						t && t.index + t.length === n ? t.length++ : e.push({ index: n, length: 1 })
					}
					return e
				}, []),
	...
	function E(e) {
		...
		if (o) {
			W
				...
				n.scheme !== undefined || n.userinfo !== undefined || n.host !== undefined || n.port !== undefined || n.path || n.query !== undefined
					? n.scheme === undefined
				...
				r.reference && 'suffix' !== r.reference && r.reference !== n.reference && (n.error = n.error || 'URI is not a ' + r.reference + ' reference.')
	...
	function C(e, r) {
		...
		return (
			...
			('number' != typeof e.port && 'string' != typeof e.port) || (t.push(':'), t.push(String(e.port))),
	...
	function A(e, r) {
		...
		return (
			...
			(n = n || {}),
			!n.tolerant && r.scheme
				? ((o.scheme = r.scheme), (o.userinfo = r.userinfo), (o.host = r.host), (o.port = r.port), (o.path = y(r.path || '')), (o.query = r.query))
				: (r.userinfo !== undefined || r.host !== undefined || r.port !== undefined
						? ((o.userinfo = r.userinfo), (o.host = r.host), (o.port = r.port), (o.path = y(r.path || '')), (o.query = r.query))
						: (r.path
								? ('/' === r.path.charAt(0)
										? (o.path = y(r.path))
										: ((e.userinfo === undefined && e.host === undefined && e.port === undefined) || e.path
												? e.path
										  ...
										  (o.path = y(o.path))),
								  (o.query = r.query))
								: ((o.path = e.path), r.query !== undefined ? (o.query = r.query) : (o.query = e.query)),
	...
	var F = u(!1),
		...
		B = { version: '2.1.0', ucs2: { decode: p, encode: $ }, decode: Z, encode: G, toASCII: Y, toUnicode: Q },
		J = {},
		K = /^(?:([^:\/?#]+):)?(?:\/\/((?:([^\/?#@]*)@)?(\[[^\/?#\]]+\]|[^\/?#:]*)(?:\:(\d*))?))?([^?#]*)(?:\?([^#]*))?(?:#((?:.|\n|\r)*))?/i,
