...
declare const getStream: {
	...
	*/
	buffer(stream: Stream, options?: getStream.OptionsWithEncoding): Promise<Buffer>
	...
	*/
	array<StreamObjectModeType>(stream: Stream, options?: getStream.Options): Promise<StreamObjectModeType[]>
	array(stream: Stream, options: getStream.OptionsWithEncoding<'buffer'>): Promise<Buffer[]>
	array(stream: Stream, options: getStream.OptionsWithEncoding<BufferEncoding>): Promise<string[]>
